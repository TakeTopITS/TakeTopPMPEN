                                            ...
                                            <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,XiangMuZuoYeRenWu%>"></asp:Label>
                                                    </td>
                                                    <td width="5">
                                                            ...
                                                            <tr>
                                                             <td width="5%" align="center">
                                                                ...
                                                                <td width="20%" align="center">
                                                                    <strong>
                                                                        <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,ZuoYeBianMa%>"></asp:Label></strong></td>
                                                                <td width="40%" align="center">
                                                                    <strong>
                                                                        <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,ZuoYeMingCheng%>"></asp:Label></strong>
                                                                </td>
                                                                <td width="15%" align="center">
                                                                    <strong>
                                                                        <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,KaiShiRiQi%>"></asp:Label></strong></td>
                                                                <td width="15%" align="center">
                                                                    <strong>
                                                                        <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,JieShuRiQi%>"></asp:Label></strong>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            <table style="width: 90%;" cellpadding="3" cellspacing="0" class="formBgStyle">
                                <tr style="display: none;">
                                    ...
                                    <td style="text-align: left; height: 19px;" class="formItemBgStyle" colspan="2">
                                ...
                                <tr>
                                    ...
                                    <td class="formItemBgStyle" colspan="2" style="text-align: left">
                                        ...
                                        至<asp:TextBox ID="DLC_EndDate" runat="server" ReadOnly="false"></asp:TextBox>
