<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTCustomerQuestionResultReviewWF_YOUP.aspx.cs" Inherits="TTCustomerQuestionResultReviewWF_YOUP" %>
                                            ...
                                            <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                        <asp:Label ID="Label23" runat="server" Text="<%$ Resources:lang,KeFuXiaoGuoPingShen%>"></asp:Label>
                                                    </td>
                                                    <td width="5">
                                                            ...
                                                            <td>
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        ...
                                                                        <td width="5%" align="left">
                                                                            <strong>
                                                                                <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,KeHuDengJi%>"></asp:Label></strong>
                                                                        </td>
                                                                        <td width="10%" align="left">
                                                                            <strong>
                                                                                <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,XingMing%>"></asp:Label></strong>
                                                                        </td>
                                                                        <%--         <td width="10%" align="left">
                                                                        <strong><asp:Label runat="server" Text="<%$ Resources:lang,ShenFenZhengHao%>"></asp:Label></strong>
                                                                    </td>
                                                                    <td width="10%" align="left">
                                                                        <strong><asp:Label runat="server" Text="<%$ Resources:lang,DianHuaYi%>"></asp:Label></strong>
                                                                    </td>
                                                                    <td width="10%" align="left">
                                                                        <strong><asp:Label runat="server" Text="<%$ Resources:lang,DianHuaEr%>"></asp:Label></strong>
                                                                    </td>--%>
                                                                        <td width="10%" align="left">
                                                                            <strong>
                                                                                <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,ShouCiZiXun%>"></asp:Label></strong>
                                                                        </td>
                                                                        <td width="15%" align="left">
                                                                            <strong>
                                                                                <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,KeHuLaiYuan%>"></asp:Label></strong>
                                                                        </td>
                                                                        <td width="15%" align="left">
                                                                            <strong>
                                                                                <asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,HangYeLeiXing%>"></asp:Label></strong>
                                                                        </td>
                                                                        <td width="5%" align="left">
                                                                            <strong>
                                                                        ...
                                                                        <td width="5%" align="left">
                                                                            <strong>
                                                                                <asp:Label ID="Label22" runat="server" Text="<%$ Resources:lang,JiLuRen%>"></asp:Label></strong>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                    ...
                                                    <table border="0" cellpadding="4" cellspacing="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td class="tdLeft" style="width: 5%; text-align: center; font-size: 10pt;">
                                                                <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,JiBenZiLiao%>"></asp:Label>
                                                            </td>
                                            ...
                                            <table width="95%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                <tr>
                                                    <td align="left" class="formItemBgStyle">
                                                        <b style="text-align: left">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,KFXGPSGZL%>"></asp:Label>:</b> (<asp:HyperLink ID="HL_RelatedWorkFlowTemplate"
                                                                runat="server" Enabled="false" Target="_blank">
                                                                <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,GuanLianGongZuoLiuMuBan%>"></asp:Label>
                                                        </asp:HyperLink>)
                                                    </td>
                                                </tr>
                                                <tr style="font-size: 10pt">
                                                    <td style="text-align: left; width: 100%;" class="formItemBgStyle">
                                                        <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,MingCheng%>"></asp:Label>£º<asp:TextBox ID="TB_WLName" runat="server" Width="234px"></asp:TextBox>&nbsp;
                                                    <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,LeiXing%>"></asp:Label>£º
                                                        ...
                                                        &nbsp;&nbsp;<asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,GongZuoLiuMuBan%>"></asp:Label>£º<asp:DropDownList ID="DL_TemName" runat="server" DataTextField="TemName"
                                                            DataValueField="TemName" Width="180px">
                                                        </asp:DropDownList>
                                                        &nbsp; &nbsp;<asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,ChaXunGuanJianZi%>"></asp:Label>£º<asp:TextBox ID="TB_KeyWord" runat="server" Width="60px"></asp:TextBox>
                                                ...
                                                <tr style="font-size: 10pt">
                                                    <td style="text-align: left; width: 100%; height: 51px;" class="formItemBgStyle">
                                                        <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,ShuoMing%>"></asp:Label>£º<asp:TextBox ID="TB_Description" runat="server" TextMode="MultiLine" Width="712px"
                                                            Height="79px"></asp:TextBox>&nbsp;
                                                    </td>
                                                </tr>
                                                <tr style="font-size: 10pt">
                                                    <td style="text-align: left; width: 100%;" class="formItemBgStyle">
                                                        <span style="font-size: 10pt">£¨<asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,YaoQiuShouDaoXinXi%>"></asp:Label>£º<asp:CheckBox ID="CB_Mail" runat="server"
                                        ...
                                        <td>
                                            <table align="left" width="90%">
                                                <tr>
                                                    <td align="left">
                                                        <b>
                                                            <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,DuiYingGongZuoLiuLieBiao%>"></asp:Label>£º</b>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="left">
                                                                    ...
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td width="45%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,GongZuoLiu%>"></asp:Label></strong>
                                                                            </td>
                                                                            <td width="20%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,ShenQingShiJian%>"></asp:Label></strong>
                                                                            </td>
                                                                            <td width="15%" align="left">
                                                                                <strong>
                                                        ...
                                                        <asp:DataGrid ID="DataGrid4" runat="server" AutoGenerateColumns="False" Height="1px"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundColumn DataField="CreateTime" HeaderText="ÉêÇëÊ±¼ä" DataFormatString="{0:yyyy-MM-dd HH:mm:ss}">
