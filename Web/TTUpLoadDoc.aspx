<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTUpLoadDoc.aspx.cs" Inherits="TTUpLoadDoc" %>
        ...
        jQuery(function () {
            ...
            uploader.on('uploadBeforeSend', function (obj, data) {
                ...
                data = $.extend(data, {
                    ...
                    relatedType: "KnowledgeManagement",
                    relatedID: "0",
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ShangChuaWenJian%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                    ...
                                    <table style="width: 100%;" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td valign="top" align="left">
                                                ...
                                                <table style="width: 100%;" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td style="text-align: left; padding: 5px 5px 0px 5px; border-right: solid 1px #D8D8D8; vertical-align: top;">
                                                                ...
                                                                <ContentTemplate>
                                                                    ...
                                                                    <asp:DataGrid runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:BoundColumn DataField="RelatedName" HeaderText="关联名" Visible="false">
                                                                                <ItemStyle CssClass="itemBorder" Horizontalalign="left" />
                                                                            </asp:BoundColumn>
                                                                        </Columns>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <asp:UpdatePanel ID="UpdatePanel11" runat="server" UpdateMode="Conditional">
                                                                                                    ...
                                                                                                    <Triggers>
                                                                                                        <asp:PostBackTrigger ControlID="DL_Visible" />
                                                                                                    </Triggers>
                                                                                                </asp:UpdatePanel>
                                                                                            </td>
                                                                                            <td>
                                                                                            ...
                                                                                            <td>
                                                                                                <asp:Label ID="LB_RelatedDepartCode" runat="server"></asp:Label>
                                                                                                ...
                                                                                                <asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,ZuoZhe%>"></asp:Label>
                                                                                    ...
                                                                                    <table>
                                                                                        <tr>
                                                                                            <td>
                                                                                                ...
                                                                                                <asp:Label ID="Label15" runat="server" Text="<%$ Resources:lang,TZJSZCY%>"></asp:Label><asp:TextBox ID="TB_Message" runat="server" Width="224px"></asp:TextBox>
                                                                        ...
                                                                        <table style="width: 98%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                                            <tr>
                                                                                <td style="background-color: ButtonFace; width: 100%; text-align: left; height: 11px;"
                                                                                    ...
                                                                                    <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,WJPSSQ%>"></asp:Label>
                                                                                </td>
                                                                            </tr>
                                                                            <tr style="font-size: 10pt">
                                                                                <td style="width: 100%;" class="formItemBgStyleForAlignLeft">
                                                                                    <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,MingChen%>"></asp:Label><asp:TextBox ID="TB_WLName" runat="server" Width="309px"></asp:TextBox>
                                                                                    <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,LeiXing%>"></asp:Label>
                                                                                    <asp:DropDownList ID="DL_WFType" runat="server">
                                                                                        <asp:ListItem Value="DocumentReview" Text="<%$ Resources:lang,WenJianPingSheng%>" />
                                                                                    </asp:DropDownList>
                                                                                    <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,GongZuoLiuMoBan%>"></asp:Label><asp:DropDownList ID="DL_TemName" runat="server" DataTextField="TemName"
                                                                                        DataValueField="TemName" Width="144px">
                                                                                    </asp:DropDownList>
                                                                                    <asp:HyperLink ID="HL_WLTem" runat="server" NavigateUrl="~/TTWorkFlowTemplate.aspx"
                                                                                        Target="_blank">
                                                                                        <asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,MobanWeiHu%>"></asp:Label>
                                                                                    </asp:HyperLink>
                                                                            ...
                                                                            <tr style="font-size: 10pt">
                                                                                <td style="width: 100%;" class="formItemBgStyleForAlignLeft">
                                                                                    <span style="font-size: 10pt">
                                                                                        <asp:Label ID="Label22" runat="server" Text="<%$ Resources:lang,YaoQiuShouDaoXinXi%>"></asp:Label>（<asp:CheckBox ID="CB_RequiredMail" runat="server"
                                                                                            ...
                                                                                            <td>
                                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td width="20%" align="left">
                                                                                                            <strong>
                                                                                                                <asp:Label ID="Label26" runat="server" Text="<%$ Resources:lang,ShenQingShiJian%>"></asp:Label></strong>
                                                                                                        </td>
                                                                                                        <td width="10%" align="left">
                                                                                                            <strong>
