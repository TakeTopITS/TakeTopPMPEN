<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTMyMemberCustomerQuestions.aspx.cs" Inherits="TTMyMemberCustomerQuestions" %>
                                                        ...
                                                        <td style="padding: 5px 5px 5px 5px;">
                                                            ...
                                                            <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False" ShowHeader="false"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundColumn DataField="PhoneNumber" HeaderText="Telephone">
                                                                        <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="8%" />
                                                                    </asp:BoundColumn>
