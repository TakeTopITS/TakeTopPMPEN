<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="TTMakeReq.aspx.cs"
    Inherits="TTMakeReq" %>
                ...
                <ContentTemplate>
                    <div id="AboveDiv">
                        <table id="AboveTable" cellpadding="0" width="100%" cellspacing="0" class="bian">
                                                ...
                                                <table width="245" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,JianLiHeFenPaiXuQiu%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                                        ...
                                                        <td>
                                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" background="ImagesSkin/main_n_bj.jpg">
                                                                <tr>
                                                                    ...
                                                                    <td width="5%" align="center">
                                                                        <strong>
                                                                            <asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,ShanChu %>" /></strong>
                                                                    </td>
                                                                    <td width="5%" align="center">
                                                                        <strong>
                                                                            <asp:Label ID="Label64" runat="server" Text="<%$ Resources:lang,FenPai%>" /></strong>
                                                                                ...
                                                                                <td width="50%" align="center">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,XuQiuMingCheng%>"></asp:Label></strong>
                                                                                </td>
                                                                                <td width="10%" align="center">
                                                                                    <strong>
                            ...
                            <tr style="display: none;">
                                <td>&nbsp;<asp:HyperLink ID="HL_RunReqByWF" runat="server" Enabled="False" Target="_blank" Visible="false">---&gt;<asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,XuQiuChuLiLiuChengMoShi%>"></asp:Label></asp:HyperLink>
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popwindow"
                                                    ...
                                                    <table style="width: 98%">
                                                        <tr>
                                                            ...
                                                            <td style="text-align: center;" colspan="2">
                                                                <asp:HyperLink ID="HL_RelatedDoc" runat="server" Enabled="False" Visible="false" NavigateUrl="~/TTReqRelatedDoc.aspx"
                                                                    Target="_blank">
                                                                    <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,XiangGuanWenDang%>"></asp:Label>
                                                                </asp:HyperLink>
                                                                &nbsp;<asp:HyperLink ID="HL_ApproveRecord" runat="server" Enabled="False" Visible="false" NavigateUrl="~/TTReqAssignRecord.aspx"
                                                                    Target="_blank">
                                            ...
                                            <table style="width: 100%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                <%-- <tr>
                                                    <td colspan="8" align="center" style="padding-right: 7%;">
                                                        <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,XiangGuanYeWuDan %>"></asp:Label>
                                                    </td>
                                                </tr>--%>
                                                <tr>
                        ...
                        <div id="popwindow_footer" class="layui-layer-btn" style="border-top: 1px solid #ccc;">
                            <asp:LinkButton ID="LinkButton1" runat="server" class="layui-layer-btn notTab" OnClientClick="window.frames['IFrame_RelatedInformation'].document.getElementById('BT_SaveXMLFile').click()" OnClick="BT_New_Click" Text="<%$ Resources:lang,BaoCun%>"></asp:LinkButton><a class="layui-layer-btn notTab" onclick="return popClose();"><asp:Label ID="Label28" runat="server" Text="<%$ Resources:lang,GuanBi%>" /></a>
                        </div>
                                        ...
                                        <table style="width: 100%;" cellpadding="3" cellspacing="0" class="formBgStyle">
                                            <tr>
                                                <td style="text-align: right" class="auto-style2">
                                                    <asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,ShouLiRen%>"></asp:Label>：
                                                </td>
                                            ...
                                            <tr>
                                                <td style="text-align: right" class="auto-style2">
                                                    <asp:Label ID="Label23" runat="server" Text="<%$ Resources:lang,KaiShiShiJian%>"></asp:Label>：
                                                </td>
                                                <td style="text-align: left;" class="formItemBgStyle">
                                                ...
                                                <td style="text-align: right" class="formItemBgStyle">
                                                    <asp:Label ID="Label24" runat="server" Text="<%$ Resources:lang,JieShu%>"></asp:Label>：
                                                </td>
                                                <td style="text-align: left;" class="formItemBgStyle">
                                        ...
                                        <table width="100%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                            <tr>
                                                <td style="width: 220px; border-right: solid 1px #D8D8D8; padding: 5px 5px 5px 5px;"
                                                    valign="top" align="left" class="formItemBgStyle">
                                                ...
                                                <td style="width: 170px; text-align: center; padding-right: 5px; border-right: solid 1px #D8D8D8;" class="formItemBgStyle">
