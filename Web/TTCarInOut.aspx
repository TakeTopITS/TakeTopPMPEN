                                                            ...
                                                            <div id="CarAssignListDivID" style="width: 100%; height: 550px; overflow: auto;">
                                                                ...
                                                                <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" Height="1px"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundColumn DataField="CarCode" HeaderText="³µÅÆºÅ">
                                                                    ...
                                                                    <table border="1" style="width: 100%; border-collapse: collapse; margin: 0px auto;"
                                                                        ...
                                                                        <tr>
                                                                            <td width="15%" style="text-align: right">
                                                                                <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,ChuFaShiJian%>"></asp:Label>£º
                                                                            </td>
                                                                            <td style="width: 35%; text-align: left">
                                                                                <%#DataBinder.Eval(Container.DataItem, "RealDepartTime")%>
                                                                            </td>
                                                                            <td width="15%" style="text-align: right">
                                                                                <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,ShouCheShiJian%>"></asp:Label>£º
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td style="width: 15%; text-align: right">
                                                                                <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,PaiCheDanHao%>"></asp:Label>£º
                                                                            </td>
                                                                            <td style="width: 35%; text-align: left">
                                                                                <%#DataBinder.Eval(Container.DataItem, "ID")%>
                                                                            </td>
                                                                            <td style="width: 15%; text-align: right">
                                                                                <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,ChePaiHaoMa%>"></asp:Label>£º
                                                                            </td>
                                                                            <td style="text-align: left">
                                                                        ...
                                                                        <tr>
                                                                            <td style="text-align: right">
                                                                                <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,ShenQingBuMen%>"></asp:Label>£º
                                                                            </td>
                                                                            <td style="text-align: left">
                                                                                <%#DataBinder.Eval(Container.DataItem, "DepartName")%>
                                                                            </td>
                                                                            <td style="text-align: right">
                                                                                <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,ShenQingRen%>"></asp:Label>£º
                                                                            </td>
                                                                            <td style="text-align: left">
                                                                        ...
                                                                        <tr>
                                                                            <td style="text-align: right">
                                                                                <asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,SiJi%>"></asp:Label>£º
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td style="text-align: right">
                                                                                <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,YongCheShiJian%>"></asp:Label>£º
                                                                            </td>
                                                                            <td style="text-align: left">
                                                                                <%#DataBinder.Eval(Container.DataItem, "DepartTime", "{0:yyyy/MM/dd HH:MM}")%>
                                                                            </td>
                                                                            <td style="text-align: right">
                                                                                <asp:Label ID="Label15" runat="server" Text="<%$ Resources:lang,HuanCheShiJian%>"></asp:Label>£º
                                                                            </td>
                                                                            <td style="text-align: left">
                                                                        ...
                                                                        <tr>
                                                                            <td style="text-align: right">
                                                                                <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,ShangCheDiDian%>"></asp:Label>£º
                                                                            </td>
                                                                            <td style="text-align: left">
                                                                                <%#DataBinder.Eval(Container.DataItem, "BoardingSite")%>
                                                                            </td>
                                                                            <td style="text-align: right">
                                                                                <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,MuDiDi%>"></asp:Label>£º
                                                                            </td>
                                                                            <td style="text-align: left">
                                                                        ...
                                                                        <tr>
                                                                            <td style="text-align: right">
                                                                                <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,SuiCheRen%>"></asp:Label>£º
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td style="height: 60px; text-align: right">
                                                                                <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,ChuCheYuanYin%>"></asp:Label>£º
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td style="text-align: right">
                                                                                <asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,ZhuangTai%>"></asp:Label>£º
                                                                            </td>
                                                                            <td colspan="3" style="text-align: left">
                                                                                ...
                                                                                <table width="100%">
                                                                                    <tr>
                                                                                        <td width="8%" align="right">
                                                                                            <asp:Label ID="Label22" runat="server" Text="<%$ Resources:lang,ZongLiCheng%>"></asp:Label>£º
                                                                                        </td>
                                                                                        <td width="8%" align="left">
                                                                                            <%#DataBinder.Eval(Container.DataItem, "Mileage")%>
                                                                                        </td>
                                                                                        <td width="10%" align="right">
                                                                                            <asp:Label ID="Label23" runat="server" Text="<%$ Resources:lang,DangCiLiCheng%>"></asp:Label>£º
                                                                                        </td>
                                                                                        <td width="8%" align="left">
                                                                                            <%#DataBinder.Eval(Container.DataItem, "CurrentMileage")%>
                                                                                        </td>
                                                                                        <td width="8%" align="left">
                                                                                            <asp:Label ID="Label24" runat="server" Text="<%$ Resources:lang,GuoLuFei%>"></asp:Label>£º
                                                                                        </td>
                                                                                        <td width="8%" align="left">
                                                                                            <%#DataBinder.Eval(Container.DataItem, "RoadToll")%>
                                                                                        </td>
                                                                                        <td width="8%" align="left">
                                                                                            <asp:Label ID="Label25" runat="server" Text="<%$ Resources:lang,TingCheFei%>"></asp:Label>£º
                                                                                        </td>
                                                                                        <td width="8%" align="left">
                                                                                            <%#DataBinder.Eval(Container.DataItem, "ParkingCharge")%>
                                                                                        </td>
                                                                                        <td width="8%" align="left">
                                                                                            <asp:Label ID="Label26" runat="server" Text="<%$ Resources:lang,JiaYou%>"></asp:Label>£º
                                                                                        </td>
                                                                                        <td width="8%" align="left">
                                                                                            <%#DataBinder.Eval(Container.DataItem, "OilVolume")%>
                                                                                        </td>
                                                                                        <td width="8%" align="left">
                                                                                            <asp:Label ID="Label27" runat="server" Text="<%$ Resources:lang,JiaYouFei%>"></asp:Label>£º
                                                                                        </td>
