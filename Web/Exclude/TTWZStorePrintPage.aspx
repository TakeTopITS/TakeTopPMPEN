                ...
                <tr>
                    <td  class="formItemBgStyleForAlignLeft">
                        <table class="formBgStyle" style="width: 100%;">
                            <tr>
                                <td colspan="3" style="text-align: center;" class="formItemBgStyleForAlignLeft">
                                    <h1>
                    ...
                    <td valign="top" style="padding-top: 0px;">
                        ...
                        <asp:Repeater ID="RT_List" runat="server" OnItemDataBound="RT_List_ItemDataBound">
                            ...
                            <ItemTemplate>
                                ...
                                <tr>
                                    ...
                                    <td class="formItemBgStyleForAlignLeft"><%# Eval("DLCode") %></td>
                                    <td class="formItemBgStyleForAlignLeft"><%# Eval("DLName") %></td>
                                    <td class="formItemBgStyleForAlignLeft"><%# Eval("上期结额") %></td>
                                    <td class="formItemBgStyleForAlignLeft"><%# Eval("本期收额") %></td>
                                    <td class="formItemBgStyleForAlignLeft"><%# Eval("累计收额") %></td>
                                    <td class="formItemBgStyleForAlignLeft"><%# Eval("本期发额") %></td>
                                    <td class="formItemBgStyleForAlignLeft"><%# Eval("累计发额") %></td>
                                    <td class="formItemBgStyleForAlignLeft"><%# Eval("本期结额") %></td>
                                    <td class="formItemBgStyleForAlignLeft"><%# Eval("平均占用") %></td>
                        ...
                        <table class="formBgStyle" style="width:100%;">
                            <tr>
                                ...
                                <td class="formItemBgStyleForAlignLeft" style="width:15%;">&nbsp;</td>
                                <td class="formItemBgStyleForAlignLeft" style="width:10%;">
