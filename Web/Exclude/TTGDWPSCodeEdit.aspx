                                        ...
                                        <tr>
                                            <td valign="top" style="padding-top: 5px;">
                                                <table style="width: 80%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                    <tr>
                                                        <td  class="formItemBgStyleForAlignLeft">WPSNo£º
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">
                                                            <asp:TextBox ID="TXT_WPSNo" runat="server"></asp:TextBox>
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">Description£º
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">
                                                    ...
                                                    <tr>
                                                        <td  class="formItemBgStyleForAlignLeft">Remarks£º
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td style="text-align: center" class="formItemBgStyleForAlignLeft" colspan="4">
                                                            ...
                                                            <input type="button" value="·µ»Ø" id="BT_Return" class="inpu" onclick="window.location.href = 'TTGDWPSCodeList.aspx'" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
