                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td  class="formItemBgStyleForAlignLeft">
                                                <input type="button" class="inpuLong" value="–¬‘ˆπ‹æ∂≥ﬂ¥Á" onclick="window.location.href = 'TTGDStandardSizeEdit.aspx'" />
                                            </td>
                                        </tr>
                                        <tr>
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateColumn>
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <%--<asp:Button ID="Button1" CssClass="inpu" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"ID") %>' CommandName="del" Text="…æ≥˝" />--%>
                                                                    
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
                                                            <asp:BoundColumn DataField="ID" HeaderText="À≥–Ú∫≈">
                                                            ...
                                                            <asp:BoundColumn DataField="ODGB" HeaderText="Õ‚æ∂">
                                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="Center" Width="10%" />
                                                            </asp:BoundColumn>
                                                            <asp:BoundColumn DataField="ODANSI" HeaderText="Õ‚æ∂ANSI">
                                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="Center" Width="10%" />
                                                            </asp:BoundColumn>
                                                            <asp:BoundColumn DataField="BQMainCode" HeaderText="÷˜“™±‡∫≈">
