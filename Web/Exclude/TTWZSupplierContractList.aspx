                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,GongYingShangRuWangHeTondJianShen%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                                    ...
                                                    <tr>
                                                        <td  class="formItemBgStyleForAlignLeft">
                                                            <table class="formBgStyle">
                                                                <tr>
                                                                    <td class="formItemBgStyleForAlignLeft" colspan="5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,HeTongJianShen%>"></asp:Label></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="formItemBgStyleForAlignLeft">
                                                                ...
                                                                <asp:DataGrid ID="DG_List" runat="server" AllowPaging="true" AutoGenerateColumns="False"
                                                                    ...
                                                                    <Columns>
                                                                        <asp:TemplateColumn>
                                                                            ...
                                                                            <ItemTemplate>
                                                                                ...
                                                                                <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Eval("ID")+"|"+Eval("Progress") %>' CommandName="click" CssClass="notTab">
                                                                                    <asp:Label ID="Label52" runat="server" Text="<%$ Resources:lang,CaoZuo%>"></asp:Label></asp:LinkButton>
                                                                        ...
                                                                        <asp:TemplateColumn>
                                                                            ...
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="Label43" runat="server" Text="<%$ Resources:lang,YouBian%>"></asp:Label>
                                                                            </HeaderTemplate>
                                                                            <ItemTemplate>
                                                                        ...
                                                                        <asp:TemplateColumn>
                                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="3%" />
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="Label44" runat="server" Text="<%$ Resources:lang,FaRenDaiBiao%>"></asp:Label>
                                                                            </HeaderTemplate>
                                                                            <ItemTemplate>
