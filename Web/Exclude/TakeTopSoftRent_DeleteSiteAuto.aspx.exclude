<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TakeTopSoftRent_DeleteSiteAuto.aspx.cs" Inherits="TakeTopSoftRent_DeleteSiteAuto" %>
                                ...
                                <td width="70%">
                                        <div id="DIV_Message"  style="text-align:center;padding-top:100px;">   
                                            ...
                                            <tr>
                                                ...
                                                <td style="color:red;">
                                                    <asp:Label ID="LB_Message" runat="server"  Text ="正在删除你的应用站点，大概需要5分钟，请耐心等候......"></asp:Label>  
                                                </td>
                                            </tr>
                                        </table>
                                        </div> 
