<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TakeTopSoftRent_UpdateSiteVirtualDirectoryPhysicalPath.aspx.cs" Inherits="TakeTopSoftRent_UpdateSiteVirtualDirectoryPhysicalPath" %>
                                ...
                                <td width="70%">
                                        <div id="DIV_Message"  style="text-align:center;padding-top:100px;">   
                                            ...
                                            <tr>
                                                ...
                                                <td style="color:red;">
                                                    <asp:Label ID="LB_Message" runat="server"  Text ="正在保存这个应用站点的虚拟目录的绝对路径，大概需要1分钟，请耐心等候......"></asp:Label>  
                                                </td>
                                            </tr>
                                        </table>
                                        </div> 
