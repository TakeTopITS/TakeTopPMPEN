                        ...
                        <tr>
                            <td align="center" style="padding-top: 5px;">
                                <table cellpadding="2" cellspacing="0" class="formBgStyle" width="100%">
                                    ...
                                    <tr>
                                        <td  class="formItemBgStyleForAlignLeft" style="width: 150px; vertical-align: middle;">
                                        ...
                                        <td  class="formItemBgStyleForAlignLeft" colspan="3" style="vertical-align: middle"><asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <div>
                                ...
                                <table cellpadding="2" cellspacing="0" class="formBgStyle" width="95%">
                                    <tr>
                                        <td align="center"  class="formItemBgStyleForAlignLeft">&nbsp;&nbsp;&nbsp; <asp:Label ID="Label57" runat="server" Text="<%$ Resources:lang,GongPingRenWuShuLieBiao%>"></asp:Label></td>
                                    </tr>
                                    <tr>
