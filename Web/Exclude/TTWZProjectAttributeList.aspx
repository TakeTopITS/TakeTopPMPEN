                                            ...
                                            <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,XiangMuShuXing%>"></asp:Label>
                                                    </td>
                                                    <td width="5">
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td  class="formItemBgStyleForAlignLeft">
                                            <input type="button" class="inpuLong" value="新增项目属性" onclick="window.location.href = 'TTWZProjectAttributeEdit.aspx'" />
                                        </td>
                                    </tr>
                                    <tr>
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td width="14%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,XiangMuShuXing %>"></asp:Label></strong>
                                                                    </td>
                                                                    <td width="72%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,ShuXingShuoMing %>"></asp:Label></strong>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                ...
                                                <asp:DataGrid ID="DG_List" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn>
                                                            ...
                                                            <HeaderTemplate>
                                                                <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,XiangMuShuXing%>"></asp:Label>
                                                            </HeaderTemplate>
                                                            <ItemTemplate>
                                                                <%# ShareClass.StringCutByRequire(Eval("AttributeCode").ToString(), 192) %>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn>
                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="72%" />
                                                            <HeaderTemplate>
                                                                <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,ShuXingShuoMing%>"></asp:Label>
                                                            </HeaderTemplate>
                                                            <ItemTemplate>
                                                                <%# ShareClass.StringCutByRequire(Eval("AttributeDesc").ToString(), 20) %>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                    </Columns>
                                    ...
                                    <tr>
                                        <td valign="top" style="padding-top: 5px;">
                                            <div style="width: 50%;">
                                                        ...
                                                        <td>
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td width="14%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,XiangMuXingZhi %>"></asp:Label></strong>
                                                                    </td>
                                                                    <td width="72%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,XingZhiShuoMing %>"></asp:Label></strong>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                ...
                                                <asp:DataGrid ID="DG_ProjectNature" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                    CellPadding="4" ForeColor="#333333" GridLines="None" Height="1px" PageSize="20" ShowHeader="False"
                                                    Width="100%" OnItemCommand="DG_ProjectNature_ItemCommand" OnPageIndexChanged="DG_ProjectNature_PageIndexChanged">
                                                    <Columns>
                                                        <asp:TemplateColumn>
                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="Center" Width="14%" />
                                                            <HeaderTemplate>
                                                        ...
                                                        <asp:TemplateColumn>
                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="14%" />
                                                            <HeaderTemplate>
                                                                <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,XiangMuXingZhi%>"></asp:Label>
                                                            </HeaderTemplate>
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateColumn>
                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="72%" />
                                                            <HeaderTemplate>
                                                                <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,XingZhiShuoMing%>"></asp:Label>
                                                            </HeaderTemplate>
                                                            <ItemTemplate>
                                                                <%# ShareClass.StringCutByRequire(Eval("NatureDesc").ToString(), 20) %>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                    </Columns>
                                                    <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                                ...
                                                <asp:Label ID="LB_ProjectNatureSQL" runat="server" Visible="False"></asp:Label>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                                <cc1:TabContainer CssClass="ajax_tab_menu" ID="TabContainer1" Width="100%" runat="server" ActiveTabIndex="0">
                                    <cc1:TabPanel ID="TabPanel1" runat="server" HeaderText="项目属性" TabIndex="0">
                                        <HeaderTemplate>
                                    ...
                                    <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="项目性质">
                                        <HeaderTemplate>
