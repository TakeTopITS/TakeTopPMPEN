                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,YongTuLieBiao%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td  class="formItemBgStyleForAlignLeft">
                                                <input type="button" class="inpuLong" value="新增用途" onclick="window.location.href = 'TTGDApplicationEdit.aspx'" />
                                            </td>
                                        </tr>
                                        <tr>
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        ...
                                                                        <td width="20%" align="center">
                                                                            <strong>
                                                                                <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,GuanXianYongTu%>"></asp:Label></strong>
                                                                        </td>
                                                                        ...
                                                                        <td width="20%" align="center">
                                                                            <strong>
                                                                                <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,XiTong%>"></asp:Label></strong>
                                                                        </td>
                                                    ...
                                                    <asp:DataGrid ID="DG_List" runat="server" AllowPaging="true" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateColumn>
                                                                ...
                                                                <ItemTemplate>
                                                                    <a href='TTGDApplicationEdit.aspx?id=<%# DataBinder.Eval(Container.DataItem,"ID") %>'>
                                                            ...
                                                            <asp:BoundColumn DataField="LineUser" HeaderText="管线用途">
