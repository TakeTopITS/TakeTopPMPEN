<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTGDSelectorStandardSizeList.aspx.cs" Inherits="TTGDSelectorStandardSizeList" %>
    ...
    <script type="text/jscript">
        ...
        function clickMember(resultList) {
            ...
            if (resultList != "" && resultList != undefined) {
                ...
                window.parent.document.getElementById("TXT_Size").value = resultList;
                                                                    ...
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td width="90%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,ChiCun%>"></asp:Label></strong>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                        ...
                                                        <asp:DataGrid ID="DG_List" runat="server" AllowPaging="False" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                <asp:TemplateColumn>
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <input id='<%#Eval("Size") %>' type="radio" name="name1" />
                                                                    </ItemTemplate>
                                                                </asp:TemplateColumn>
