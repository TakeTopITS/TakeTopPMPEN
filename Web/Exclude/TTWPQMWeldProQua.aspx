                            ...
                            <td align="center" style="padding-top: 5px;">
                                <table cellpadding="2" cellspacing="0" class="formBgStyle" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td  class="formItemBgStyleForAlignLeft" rowspan="3" style="vertical-align: middle">
                                            <asp:Label ID="Label27" runat="server" Text="<%$ Resources:lang,PingDingXiangMu%>"></asp:Label> </td>
                                        <td  class="formItemBgStyleForAlignLeft" colspan="3" rowspan="3" style="vertical-align: middle">
                                ...
                                <table cellpadding="2" cellspacing="0" class="formBgStyle" width="95%">
                                    <tr>
                                        <td align="center"  class="formItemBgStyleForAlignLeft">&nbsp;&nbsp;&nbsp; <asp:Label ID="Label36" runat="server" Text="<%$ Resources:lang,HanJieGongYiPingDingLieBiao%>"></asp:Label> </td>
                                    </tr>
                                    <tr>
