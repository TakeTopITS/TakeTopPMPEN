                                        ...
                                        <tr>
                                            <td>
                                                <table style="width: 80%;" cellpadding="0" cellspacing="0" class="formBgStyle">
                                                    ...
                                                    <tr>
                                                        <td  class="formItemBgStyleForAlignLeft">Form<asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,Cong%>"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;To<asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,Dao%>"></asp:Label>£º
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
