                            ...
                            <td align="center" style="padding-top: 5px;">
                                <table cellpadding="2" cellspacing="0" class="formBgStyle" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td  class="formItemBgStyleForAlignLeft">d：</td>
                                        <td  class="formItemBgStyleForAlignLeft">
                                            <asp:TextBox ID="TB_DValue" runat="server" CssClass="shuru" Width="120px"></asp:TextBox>
                                        </td>
                                        <td  class="formItemBgStyleForAlignLeft">α：</td>
                                        <td  class="formItemBgStyleForAlignLeft">
                                ...
                                <table cellpadding="2" cellspacing="0" class="formBgStyle" width="95%">
                                    <tr>
                                        <td align="center"  class="formItemBgStyleForAlignLeft">&nbsp;&nbsp;&nbsp;<asp:Label ID="Label40" runat="server" Text="<%$ Resources:lang,LiHuaLieBiao%>"></asp:Label> ：</td>
                                    </tr>
                                    <tr>
