                                                                            ...
                                                                            <asp:DataGrid ID="DG_ObjectList" runat="server" AllowPaging="False" AutoGenerateColumns="False"
                                                                                ...
                                                                                <Columns>
                                                                                    <asp:TemplateColumn>
                                                                                        ...
                                                                                        <ItemTemplate>
                                                                                            <asp:Button ID="LB_Add" runat="server" CssClass="inpu"  Text="<%$ Resources:lang,ShuaZe%>" CommandName="add" CommandArgument='<%#Eval("ObjectCode")+"|"+Eval("Model")+"|"+Eval("Grade")+"|"+Eval("Unit")+"|"+Eval("ConvertUnit")+"|"+Eval("ConvertRatio") %>' />
