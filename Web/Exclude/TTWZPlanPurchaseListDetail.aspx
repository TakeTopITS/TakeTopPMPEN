                                                            ...
                                                            <table class="formBgStyle">
                                                                <tr>
                                                                    <td class="formItemBgStyleForAlignLeft">
                                                                        ...
                                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                        <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,TiHuanDaiMa%>"></asp:Label><asp:TextBox ID="TXT_ObjectCode" runat="server" ReadOnly="true"></asp:TextBox>&nbsp;<asp:Button ID="BT_Replace" runat="server"  Text="<%$ Resources:lang,TiHuan%>" CssClass="inpu" OnClick="BT_Replace_Click" />
                                                                        &nbsp;<asp:Button ID="BT_CancelReplace" runat="server" CssClass="inpu" OnClick="BT_CancelReplace_Click"  Text="<%$ Resources:lang,QuXiao%>" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="formItemBgStyleForAlignLeft">
                                                                                    ...
                                                                                    <td>
                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                            <tr>
                                                                                                ...
                                                                                                <td width="5%" align="right">
                                                                                                    <strong>
                                                                                                        <asp:Label ID="Label47" runat="server"  Text="<%$ Resources:lang,ShiChangHangQing%>"></asp:Label></strong>
                                                                                                </td>
                                                                                                <td width="5%" align="center">
                                                                                                    <strong>
