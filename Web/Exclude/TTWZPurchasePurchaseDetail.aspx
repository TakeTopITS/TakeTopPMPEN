                                                        ...
                                                        <td  style="width: 60%; padding: 5px 5px 5px 5px;" class="formItemBgStyleForAlignLeft" valign="top">
                                                            <table class="formBgStyle" style="width: 75%;">
                                                                <tr>
                                                                    ...
                                                                    <td class="formItemBgStyleForAlignLeft" style="display: none;"><asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,ZhuanYeLeiBie%>"></asp:Label>：</td>
                                                                ...
                                                                <tr>
                                                                    <td class="formItemBgStyleForAlignLeft"><asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,CaiGouShuLiang%>"></asp:Label>：</td>
                                                                    <td class="formItemBgStyleForAlignLeft">
                                                                    ...
                                                                    <td class="formItemBgStyleForAlignLeft"><asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,HuanSuanShuLiang%>"></asp:Label>：</td>
                                                                    <td class="formItemBgStyleForAlignLeft">
                                                                    ...
                                                                    <td class="formItemBgStyleForAlignLeft"><asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,YuJiFeiYong%>"></asp:Label>：</td>
                                                                    <td class="formItemBgStyleForAlignLeft">
                                                                        <asp:TextBox ID="TXT_PlanMoney" runat="server"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="formItemBgStyleForAlignLeft"><asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,ShengChanChangJia%>"></asp:Label>：</td>
                                                                    <td class="formItemBgStyleForAlignLeft">
                                                                        <asp:TextBox ID="TXT_Factory" runat="server"></asp:TextBox>
                                                                    </td>
                                                                    <td class="formItemBgStyleForAlignLeft"><asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,GuiGeShuBianHao%>"></asp:Label>：</td>
                                                                    <td class="formItemBgStyleForAlignLeft">
                                                                        <asp:TextBox ID="TXT_StandardCode" runat="server"></asp:TextBox>
                                                                    </td>
                                                                    <td class="formItemBgStyleForAlignLeft"><asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,BeiZhu%>"></asp:Label>：</td>
                                                                    <td class="formItemBgStyleForAlignLeft">
