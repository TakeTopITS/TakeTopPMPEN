                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server"  Text="<%$ Resources:lang,FaLiaoChanCaiLiao%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                                                ...
                                                                <asp:DataGrid ID="DG_Store" runat="server" AllowPaging="False" AutoGenerateColumns="False"
                                                                    ...
                                                                    <Columns>
                                                                        <asp:TemplateColumn>
                                                                            ...
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="LinkButton3" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"ID") %>' CommandName="add" CssClass="notTab">添加</asp:LinkButton>
