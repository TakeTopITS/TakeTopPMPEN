                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,HanKouGengXinDaiMa%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td align="left" class="formItemBgStyle">
                                                <input type="button" class="inpuLong" value="新增焊口更新代码" onclick="window.location.href = 'TTGDJoinRevisionEdit.aspx'" />
                                            </td>
                                        </tr>
                                        <tr>
                                                    ...
                                                    <asp:DataGrid ID="DG_List" runat="server" AllowPaging="true" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateColumn>
                                                                ...
                                                                <ItemTemplate>
                                                                    <a href='TTGDJoinRevisionEdit.aspx?id=<%# DataBinder.Eval(Container.DataItem,"ID") %>'>
