                                                        ...
                                                        <Columns>
                                                            <asp:TemplateColumn>
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Button ID="Button1" CssClass="inpu" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"ID") %>' CommandName="del"  Text="<%$ Resources:lang,ShanChu%>" />
                                                    ...
                                                    <asp:Repeater ID="RT_List" runat="server">
                                                        <ItemTemplate>
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formBgStyle">
                                                                    <tr>
                                                                        <td width="4%" align="center" class="formItemBgStyleForAlignLeft">
                                                                            <strong>
                                                                        ...
                                                                        <td width="8%" align="center" class="formItemBgStyleForAlignLeft">
                                                                            <strong>
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="13" class="formItemBgStyleForAlignLeft">
                                                                            &nbsp;
                                                                        </td>
                                                                    </tr>
                                                                </table>
