                                                ...
                                                <table class="formBgStyle">
                                                    ...
                                                    <tr>
                                                        <td class="formItemBgStyleForAlignLeft">
                                                            ...
                                                            <asp:Label ID="Label64" runat="server" Text="<%$ Resources:lang,BiaoDuanYi%>"></asp:Label>：<asp:TextBox ID="TXT_SupplierCode1" runat="server" Width="50"></asp:TextBox><asp:Button ID="BT_SupplierCode1" runat="server"  Text="<%$ Resources:lang,ShuaZe%>" CssClass="inpu" />&nbsp;
                                                            <asp:Label ID="Label65" runat="server" Text="<%$ Resources:lang,BiaoDuanEr%>"></asp:Label>：<asp:TextBox ID="TXT_SupplierCode2" runat="server" Width="50"></asp:TextBox><asp:Button ID="BT_SupplierCode2" runat="server"  Text="<%$ Resources:lang,ShuaZe%>" CssClass="inpu" />&nbsp;
                                                            <asp:Label ID="Label66" runat="server" Text="<%$ Resources:lang,BiaoDuanSan%>"></asp:Label>：<asp:TextBox ID="TXT_SupplierCode3" runat="server" Width="50"></asp:TextBox><asp:Button ID="BT_SupplierCode3" runat="server"  Text="<%$ Resources:lang,ShuaZe%>" CssClass="inpu" />&nbsp;
