                                        ...
                                        <tr>
                                            <td valign="top" style="padding-top: 5px;">
                                                <table style="width: 100%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                    <tr>
                                                        <td style="width: 800px;"  class="formItemBgStyleForAlignLeft">
                                                            <table class="formBgStyle" width="60%">
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: center" class="formItemBgStyleForAlignLeft" colspan="4">
                                                                        ...
                                                                        &nbsp;<asp:Button ID="btnTurnCancel" runat="server" CssClass="inpu" Enabled="false"  Text="<%$ Resources:lang,QuXiaoYiJiao%>" OnClick="btnTurnCancel_Click" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="formItemBgStyleForAlignRight" colspan="4">&nbsp;&nbsp;
                                                                        ...
                                                                        <td>
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr>
                                                                                    ...
                                                                                    <td width="5%" align="center">
                                                                                        <strong>
                                                                                            <asp:Label ID="Label18" runat="server"  Text="<%$ Resources:lang,QianShouRiJi%>"></asp:Label></strong>
                                                                                    </td>
                                                                                    <td width="5%" align="center">
                                                                                        <strong>
