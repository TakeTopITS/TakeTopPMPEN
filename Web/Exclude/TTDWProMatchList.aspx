<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTDWProMatchList.aspx.cs" Inherits="TTDWProMatchList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
            ...
            if (widthValue > 1200) {
                $("#tableContent1")[0].style.marginLeft = 80 + "px";
            } else {
                $("#tableContent1")[0].style.marginLeft = 11 + "px";
            }
            ...
            if (pre_scrollTop != (document.documentElement.scrollTop || document.body.scrollTop)) {
                ...
                if (obj_head) {
                    ...
                    if (topHeight < 103) {
                        ...
                        //obj_head2.style.top = 105 + 60 + topHeight + "px";
                        obj_head.style.top = 1 + topHeight  + "px";
                        obj_head2.style.top = 1 + topHeight + 60 + "px";
                    } else {
                        //obj_head.style.top = topHeight + "px";
                        //obj_head2.style.top = topHeight + 60 + "px";
                                        ...
                                        <table cellpadding="2" cellspacing="0" class="formBgStyle">
                                            <tr style="font-size: 12pt">
                                                <td class="formItemBgStyleForAlignLeft">
                                                    <div id="divAll" style="height: 100%;">
                                                        <table class="formBgStyle">
                                                            <tr>
                                                                <td class="formItemBgStyleForAlignLeft">
                                                                    <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,ChanPinLeiXing%>"></asp:Label>：</td>
                                                                <td class="formItemBgStyleForAlignLeft">
                                                                ...
                                                                <td class="formItemBgStyleForAlignLeft">
                                                                    <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,YuanLaio%>"></asp:Label>：</td>
                                                                <td class="formItemBgStyleForAlignLeft">
                                                                    <asp:TextBox ID="TXT_MatchName" runat="server"></asp:TextBox>
                                                                </td>
                                                                <td class="formItemBgStyleForAlignLeft">
                                                                    <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,ChanPinBianHao%>"></asp:Label>：</td>
                                                                <td class="formItemBgStyleForAlignLeft">
                                                                    <asp:TextBox ID="TXT_ProductCode" runat="server"></asp:TextBox>
                                                                </td>
                                                                <td class="formItemBgStyleForAlignLeft">
                                                                    <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,ChanPinPaiHao%>"></asp:Label>：</td>
                                                                <td class="formItemBgStyleForAlignLeft">
                                                                    <asp:TextBox ID="TXT_ProductName" runat="server"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="formItemBgStyleForAlignLeft" colspan="10">
                                                        ...
                                                        <div style="position: absolute;left: 4px; top: 100px;">
                                                            <table class="formBgStyle">
                                                                <tr>
                                                                    <td rowspan="3" style="width: 70px;" class="formItemBgStyleForAlignLeft">
                                                                        <table class="formBgStyle" id="tableLeft" style="position: absolute; left: 8px; top: 1px; width: 70px;">
                                                                            <tr>
                                                                                <td class="formItemBgStyleForAlignLeft">
                                                                                    <table class="formBgStyle" style="width: 70px;">
                                                                                        <tr>
                                                                                            <td style="height: 60px; width: 70px;" class="formItemBgStyleForAlignLeft">&nbsp;</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td style="height: 60px; width: 70px;" class="formItemBgStyleForAlignLeft">
                                                                                                <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,YuanLiaoDaiHao%>"></asp:Label></td>
                                                                                        </tr>
                                                                                    </table>
                                                                                    <table class="formBgStyle" style="width: 100%; word-break: break-all; word-wrap: break-word;">
                                                                    ...
                                                                    <td class="formItemBgStyleForAlignLeft">
                                                                        <table id="tableHead" class="formBgStyle" style="position: absolute; height: 60px; left: 88px; top: 7px; margin: 0 0 0 0; word-break: break-all; word-wrap: break-word;">
                                                                            <tr>
                                                                ...
                                                                <tr>
                                                                    <td class="formItemBgStyleForAlignLeft">
                                                                        <table id="tableHead2" class="formBgStyle" style="position: absolute; height: 60px; left: 88px; top: 62px; margin: 0 0 0 0; word-break: break-all; word-wrap: break-word;">
                                                                            <tr>
                                                                ...
                                                                <tr valign="top">
                                                                    <td class="formItemBgStyleForAlignLeft" valign="top">
                                                                        <div id="divContent1" style="vertical-align:top;">
                                                                            <table id="tableContent1" class="formBgStyle" style="margin-top: 123px;margin-left: 80px; word-break: break-all; word-wrap: break-word;">
