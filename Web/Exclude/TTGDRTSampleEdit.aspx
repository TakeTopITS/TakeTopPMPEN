                                            ...
                                            <td valign="top" style="padding-top: 5px;">
                                                <table style="width: 80%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                    <tr>
                                                        ...
                                                        <td  class="formItemBgStyleForAlignLeft">joint£º
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">
                                                    ...
                                                    <tr>
                                                        <td  class="formItemBgStyleForAlignLeft">Cover£º
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">
                                                            <asp:TextBox ID="TXT_Cover" runat="server"></asp:TextBox>
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">Cover Date£º
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">
                                                            <asp:TextBox ID="TXT_CoverDate" runat="server" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"></asp:TextBox>
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">RT Lot No£º
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">
                                                    ...
                                                    <tr>
                                                        <td  class="formItemBgStyleForAlignLeft">RT Sample No£º
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">
                                                            <asp:TextBox ID="TXT_RTSampleNo" runat="server"></asp:TextBox>
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">rt_instr_no£º
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">
                                                            <asp:TextBox ID="TXT_RTInstrNo" runat="server"></asp:TextBox>
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">rt_sample_serial_no£º
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">
                                                    ...
                                                    <tr>
                                                        <td  class="formItemBgStyleForAlignLeft">Remark£º
                                                        </td>
