                                    ...
                                    <table class="formBgStyle">
                                        <tr>
                                            <td class="formItemBgStyleForAlignLeft" >
                                                <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,JianHao%>"></asp:Label>£º
                                            </td>
                                            <td class="formItemBgStyleForAlignLeft">
                                                <asp:TextBox ID="TXT_CheckCode" runat="server"></asp:TextBox>
                                            </td>
                                            <td class="formItemBgStyleForAlignLeft" >
                                                <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,DaoHuoShuLiang%>"></asp:Label>£º
                                            </td>
                                            <td class="formItemBgStyleForAlignLeft">
                                        ...
                                        <tr>
                                            <td class="formItemBgStyleForAlignLeft" >
                                                <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,DaoHuoMingCheng%>"></asp:Label>£º
                                            </td>
                                        ...
                                        <tr>
                                            <td class="formItemBgStyleForAlignLeft" >
                                                <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,DaoHuoGuiGe%>"></asp:Label>£º
                                            </td>
                                            <td class="formItemBgStyleForAlignLeft" colspan="3">
                                        ...
                                        <tr>
                                            <td class="formItemBgStyleForAlignLeft" >
                                                <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ShengChanChangJia%>"></asp:Label>£º
                                            </td>
                                            <td class="formItemBgStyleForAlignLeft" colspan="3">
                                        ...
                                        <tr>
                                            <td class="formItemBgStyleForAlignLeft" >
                                                <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,ZhiXingBiaoZhun%>"></asp:Label>£º
                                            </td>
                                            <td class="formItemBgStyleForAlignLeft">
                                                <asp:TextBox ID="TXT_ExecutionStandard" runat="server" ></asp:TextBox>
                                            </td>
                                            <td class="formItemBgStyleForAlignLeft" >
                                                <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,LuPiHao%>"></asp:Label>£º
                                            </td>
                                            <td class="formItemBgStyleForAlignLeft">
                                        ...
                                        <tr>
                                            <td class="formItemBgStyleForAlignLeft" >
                                                <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,CaiJianZiLiao%>"></asp:Label>£º
                                            </td>
                                            <td class="formItemBgStyleForAlignLeft">
                                                <asp:FileUpload ID="FUP_CheckDocument" runat="server" />
                                                <asp:Button ID="BT_CheckDocument" runat="server"  Text="<%$ Resources:lang,ShangChuan%>" CssClass="inpu" OnClick="BT_CheckDocument_Click" /><br />
                                            ...
                                            <td class="formItemBgStyleForAlignLeft" >
                                                <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,JiaoHuoZhuangTai%>"></asp:Label>£º
                                            </td>
                                            <td class="formItemBgStyleForAlignLeft">
                                        ...
                                        <tr>
                                            <td class="formItemBgStyleForAlignLeft" >
                                                <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,FuYanJiLu%>"></asp:Label>£º
                                            </td>
                                            <td class="formItemBgStyleForAlignLeft">
                                            ...
                                            <td class="formItemBgStyleForAlignLeft" >
                                                <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,CaiJianYuan%>"></asp:Label>£º
                                            </td>
                                            <td class="formItemBgStyleForAlignLeft">
                                        ...
                                        <tr>
                                            <td class="formItemBgStyleForAlignLeft" >
                                                <asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,BeiZhu%>"></asp:Label>£º
                                            </td>
                                            <td class="formItemBgStyleForAlignLeft">
                                                <asp:TextBox ID="TXT_Remark" runat="server" Width="300px" ></asp:TextBox>
                                            </td>
                                            <td class="formItemBgStyleForAlignLeft" >
                                                <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,CaiJianRiQi%>"></asp:Label>£º
                                            </td>
                                            <td class="formItemBgStyleForAlignLeft">
                                        ...
                                        <tr>
                                            <td align="center" class="formItemBgStyleForAlignLeft" colspan="4">
