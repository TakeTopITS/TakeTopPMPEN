                                                ...
                                                <tr>
                                                    <td class="formItemBgStyleForAlignLeft" width="100%">
                                                        <table class="formBgStyle">
                                                            <tr>
                                                                <td class="formItemBgStyleForAlignLeft">&nbsp;<asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,Nian%>"></asp:Label>：<asp:DropDownList ID="DDL_TYear" runat="server"></asp:DropDownList>
                                                                </td>
                                        ...
                                        <td class="formItemBgStyleForAlignLeft" width="100%">
                                            <div style="width: 100%; height: 100%; overflow: auto;">
                                                <table cellpadding="2" cellspacing="0" class="formBgStyle" style="width: 100%;">
                                                    <tr>
                                                        <td class="formItemBgStyleForAlignLeft" width="100%" style="overflow: auto;">
                                                            <div class="wrap_m">
