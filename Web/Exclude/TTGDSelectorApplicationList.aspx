<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTGDSelectorApplicationList.aspx.cs" Inherits="TTGDSelectorApplicationList" %>
    ...
    <script type="text/jscript">
        ...
        function clickMember(resultList) {
            ...
            if (resultList != "" && resultList != undefined) {
                ...
                window.parent.document.getElementById("TXT_MediumCode").value = resultList;
                                        ...
                                        <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                    <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,JieZhi%>"></asp:Label>
                                                </td>
                                                <td width="5">
                                                        ...
                                                        <asp:DataGrid ID="DG_List" runat="server" AllowPaging="False" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                <asp:TemplateColumn>
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <input id='<%#Eval("LineUser") %>' type="radio" name="name1" />
                                                                    </ItemTemplate>
                                                                </asp:TemplateColumn>
