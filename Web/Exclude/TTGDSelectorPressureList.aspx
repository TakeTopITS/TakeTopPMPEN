    ...
    <script type="text/jscript">
        ...
        function clickMember(resultList) {
            ...
            if (resultList != "" && resultList != undefined) {
                ...
                window.parent.document.getElementById("TXT_PressurePackNo").value = resultList;
            }
                                                                    ...
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td width="90%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,ShiYaBaoHao%>"></asp:Label></strong>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
