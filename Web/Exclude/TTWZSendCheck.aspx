                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server"  Text="<%$ Resources:lang,FaLiaoChanCaiJian%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateColumn>
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Button ID="Button1" runat="server" CssClass="inpu"  Text="<%$ Resources:lang,KaiPiao%>" CommandName="ticket" CommandArgument='<%# Eval("SendCode") %>' Enabled ='<%# Eval("Progress").ToString()=="材检" ? true : false %>' />
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
