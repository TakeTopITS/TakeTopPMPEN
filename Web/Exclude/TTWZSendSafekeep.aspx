<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTWZSendSafekeep.aspx.cs" Inherits="TTWZSendSafekeep" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server"  Text="<%$ Resources:lang,FaLiaoChanBaoGuanYuan%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                                    ...
                                                    <asp:DataGrid ID="DG_Send" runat="server" AllowPaging="true" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateColumn>
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:LinkButton ID="LinkButton1" runat="server" CssClass="inpu"  CommandName="cancelAccount" CommandArgument='<%# Eval("SendCode") %>' Visible='<%# Eval("Progress").ToString()=="发料" ? true : false %>' >
                                                                        <asp:Label ID="Label44" runat="server"  Text="<%$ Resources:lang,QuXiaoShangZhang%>"></asp:Label></asp:LinkButton>

                                                                    <a href='TTWZSendPrintPage.aspx?sendCode=<%# DataBinder.Eval(Container.DataItem,"SendCode") %>'>
                                                                        <asp:Label ID="Label38" runat="server" Text="<%$ Resources:lang,DaYin%>"></asp:Label></a>
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
                                                            ...
                                                            <asp:TemplateColumn>
                                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="Center" Width="3%" />
                                                                <HeaderTemplate>
                                                                    <asp:Label ID="Label39" runat="server" Text="<%$ Resources:lang,KaiPiaoRiQi%>"></asp:Label>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateColumn>
                                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="3%" />
                                                                <HeaderTemplate>
                                                                    <asp:Label ID="Label40" runat="server" Text="<%$ Resources:lang,WuZiMingCheng%>"></asp:Label>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateColumn>
                                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="3%" />
                                                                <HeaderTemplate>
                                                                    <asp:Label ID="Label41" runat="server" Text="<%$ Resources:lang,HuoWeiHao%>"></asp:Label>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateColumn>
                                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="2%" />
                                                                <HeaderTemplate>
                                                                    <asp:Label ID="Label42" runat="server" Text="<%$ Resources:lang,JianHao%>"></asp:Label>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateColumn>
                                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="4%" />
                                                                <HeaderTemplate>
                                                                    <asp:Label ID="Label43" runat="server" Text="<%$ Resources:lang,LingLiaoDanWei%>"></asp:Label>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
