<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTDWMatchTypeList.aspx.cs" Inherits="TTDWMatchTypeList" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,YuanLiaoLeiXing%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                                ...
                                                <table style="width: 100%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                    <tr style="font-size: 12pt">
                                                        <td  style="width: 45%; padding: 5px 5px 5px 5px; font-size: 12px;" class="formItemBgStyleForAlignLeft" valign="top">
                                                            ...
                                                            <table class="formBgStyle" width="100%">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td  class="formItemBgStyleForAlignLeft">
                                                                        <asp:TextBox ID="TXT_MatchType" runat="server"></asp:TextBox>
                                                                    </td>
                                                                    <td  class="formItemBgStyleForAlignLeft">
                                                                        <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,MiaoShu%>"></asp:Label>：</td>
                                                                    <td  class="formItemBgStyleForAlignLeft">
                                                                        <asp:TextBox ID="TXT_MatchDesc" runat="server"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                        ...
                                                        <td class="formItemBgStyleForAlignLeft" width="80%">
                                                            <asp:DataGrid ID="DG_MatchType" runat="server" AllowPaging="true" AutoGenerateColumns="False"
                                                                CellPadding="4" ForeColor="#333333" GridLines="None" Height="1px" PageSize="10" ShowHeader="True"
                                                                Width="100%" OnItemCommand="DG_MatchType_ItemCommand" OnPageIndexChanged="DG_MatchType_PageIndexChanged">
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundColumn DataField="MatchType" HeaderText="类型">
                                                                        <ItemStyle CssClass="itemBorder" HorizontalAlign="Center" />
                                                                    </asp:BoundColumn>
                                                                    <asp:BoundColumn DataField="MatchDesc" HeaderText="描述">
                                                                        <ItemStyle CssClass="itemBorder" HorizontalAlign="Center" />
                                                                    </asp:BoundColumn>
                                                                </Columns>
                                                            ...
                                                            <asp:Label ID="LB_MatchTypeSql" runat="server" Visible="False"></asp:Label>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
