<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTAPPWLRelatedDoc.aspx.cs" Inherits="TTAPPWLRelatedDoc" %>
                                                                    ...
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td width="5%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label15" runat="server" Text="<%$ Resources:lang,ShanChu %>"></asp:Label></strong>
                                                                            </td>
                                                        ...
                                                        <table class="FullBorderTable" style="width: 100%">
                                                            <tr>
                                                                <td style="width: 100%; height: 21px; text-align: left;">
                                                                    <span><strong>
                                                                        <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,WenJianShangChuan%>"></asp:Label>
                                                                    </strong>
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="width: 100%; height: 25px; text-align: left;">
                                                                    ...
                                                                    <asp:DropDownList ID="DL_Visible" runat="server" DataTextField="HomeName" DataValueField="GroupName" CssClass="DDList" />
                                                                    &nbsp;
                                                            ...
                                                            <tr>
                                                                <td style="width: 100%; text-align: left;">
                                                                    <div>
                                                                        <asp:Label ID="Label1" Text="<%$ Resources:lang,WenJianShangChuan%>" runat="server"></asp:Label>：
                                                                        <br />
                                                                    ...
                                                                    <div id="uploader" class="wu-example">
                                                                        <div id="thelist" class="uploader-list">
                                                                            <asp:Label ID="Label28" Text="<%$ Resources:lang,DuWenJianShangZhuan%>" runat="server"></asp:Label>：
                                                                        </div>
                                                                        <div id="btns" class="btns" style="text-align: left;">
                                                                            <table>
                                                                                <tr>
                                                                                    <td>
                                                                                        <div id="picker">
                                                                                            <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,XuanZeWenJian%>"></asp:Label>
                                                                                        </div>
                                                                                    </td>
                                                                                    <td style="padding-top: 10px; padding-left: 20px;">
                                                                                        <button id="ctlBtn" class="btn btn-default">
                                                                                            <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,ShangChuan%>"></asp:Label>
                                                                                        </button>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                        ...
                                                        <table style="width: 100%">
                                                            <tr>
                                                                <td style="background-color: ButtonFace; width: 100%; text-align: left; height: 11px;">
                                                                    <asp:Label ID="Label27" runat="server" Text="<%$ Resources:lang,WenJianPingShenShenQing%>"></asp:Label>：<asp:Label ID="LB_DocID" runat="server"></asp:Label>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <table width="98%" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                                        <tr style="font-size: 10pt">
                                                                            <td style="text-align: left; width: 100%;" class="formItemBgStyle">
                                                                                ...
                                                                                &nbsp;&nbsp;<asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,GongZuoLiuMoBan%>"></asp:Label>
                                                                                ...
                                                                                <asp:HyperLink ID="HL_WLTem" runat="server" NavigateUrl="~/TTWorkFlowTemplate.aspx"
                                                                                    Target="_blank">
                                                                                    <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,MoBanWeiHu%>"></asp:Label>
                                                                                </asp:HyperLink>&nbsp;
                                                                                        ...
                                                                                        <td>
                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                <tr>
                                                                                                    <td width="10%" align="left">
                                                                                                        <strong>
                                                                                                            <asp:Label ID="Label22" runat="server" Text="<%$ Resources:lang,BianHao%>"></asp:Label>
                                                                                                        </strong>
                                                                                                    </td>
                                                                                                    <td width="40%" align="left">
                                                                                                        <strong>
                                                                                                            <asp:Label ID="Label23" runat="server" Text="<%$ Resources:lang,GongZuoLiu%>"></asp:Label>
                                                                                                        </strong>
                                                                                                    </td>
