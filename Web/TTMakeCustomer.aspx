<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTMakeCustomer.aspx.cs" Inherits="TTMakeCustomer" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function setBusinessFormIFrameHeight() {
            ...
            document.getElementById("TabContainer1_TabPanel16_IFrame_RelatedInformation").height = (winHeight.toString().replace("px", "") - 160);
        }
...
<body>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,KeHuDangAn%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                            ...
                                            <td style="border-right: solid 1px #D8D8D8; padding: 10px 5px 5px 5px"
                                                ...
                                                <table cellpadding="0" cellspacing="0" width="100%" style="padding-bottom: 5px;">
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                            <asp:Label ID="Label177" runat="server" Text="<%$ Resources:lang,LianXiRen%>"></asp:Label>：
                                                        </td>
                                                        <td align="left">
                                                    ...
                                                    <tr>
                                                        <td align="right">
                                                            <asp:Label ID="Label182" runat="server" Text="<%$ Resources:lang,FenGuanDaiLiShang%>"></asp:Label>：
                                                        </td>
                                                        <td align="left">
                                                            <asp:TextBox ID="TB_AgencyName" runat="server" Width="120px"></asp:TextBox>
                                                        </td>
                                                        <td align="right">
                                                            <asp:Label ID="Label183" runat="server" Text="<%$ Resources:lang,QuYu%>"></asp:Label>：
                                                        </td>
                                                        <td align="left">
                                                            <asp:TextBox ID="TB_FindArea" runat="server" Width="120px"></asp:TextBox>
                                                        </td>
                                                        <td align="right">
                                                            <asp:Label ID="Label184" runat="server" Text="<%$ Resources:lang,ShengFen%>"></asp:Label>：
                                                        </td>
                                                        <td align="left">
                                                            <asp:TextBox ID="TB_FindState" runat="server" Width="120px"></asp:TextBox>
                                                        </td>
                                                        <td align="right">
                                                            <asp:Label ID="Label185" runat="server" Text="<%$ Resources:lang,ChengShi%>"></asp:Label>：
                                                        </td>
                                                        <td align="left">
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td width="5%" align="left">
                                                            <strong>
                                                                <asp:Label ID="Label188" runat="server" Text="<%$ Resources:lang,BianJi %>" /></strong>
                                                        </td>
                                                        <td width="5%" align="left">
                                                            <strong>
                                                                <asp:Label ID="Label189" runat="server" Text="<%$ Resources:lang,ShanChu %>" /></strong>
                                                        </td>
    ...
    <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="10%" />
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td width="5%" align="left">
                                                                                        <strong>
                                                                                            <asp:Label ID="Label187" runat="server" Text="<%$ Resources:lang,ShanChu %>" /></strong>
                                                                                    </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="formItemBgStyle" style="text-align: left">
                                                    ...
                                                    <NickLee:NumberBox MaxAmount="1000000000000" MinAmount="-1000000000000" ID="NB_Price" runat="server" OnBlur="" OnFocus="" OnKeyPress=""
                                                        PositiveColor="" Width="85px">
                                                        0.00</NickLee:NumberBox></td>
                ...
                <Triggers>
                    <asp:PostBackTrigger ControlID="BT_ExportCustomerRelatedUser" />
                </Triggers>
            </asp:UpdatePanel>
