<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTMakeDefect.aspx.cs" Inherits="TTMakeDefect" %>
                    ...
                    <div id="AboveDiv">
                        <table id="AboveTable" cellpadding="0" width="100%" cellspacing="0" class="bian">
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" Height="1px"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundColumn DataField="DefectName" HeaderText="缺陷名称">
                            ...
                            <tr style="display: none;">
                                <td>&nbsp;<asp:HyperLink ID="HL_RunDefectByWF" runat="server" Enabled="False" Target="_blank" Visible="false">---&gt;<asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,QueXianChuLiLiuChengMoShi%>"></asp:Label></asp:HyperLink>
