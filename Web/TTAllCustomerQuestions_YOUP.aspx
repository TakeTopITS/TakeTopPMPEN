                            ...
                            <tr>
                                <td height="31" class="page_topbj">
                                    <table width="96%" border="0" align="left" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td align="left">
                                                <table width="325" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td width="29">
                                                            <%--<img src="Logo/main_top_l.jpg" alt="" width="29" height="31" />--%></td>
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,ChaKanSuoYouKeHuFuWuZhuangTai%>"></asp:Label>：<asp:DropDownList ID="DL_ServiceStatus" runat="server"
                                                                AutoPostBack="True"
                                                ...
                                                &nbsp;
                                                <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ShouCiZiXunShiJianDuan%>"></asp:Label>：<asp:TextBox ID="TextBox1" runat="server" ReadOnly="false"></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                ...
                                                                                <td width="5%" align="left">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,KeHuDengJi%>"></asp:Label></strong>
                                                                                </td>
                                                                                ...
                                                                                <td width="20%" align="left">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,JiBenZiLiao%>"></asp:Label></strong></td>
                                                                                <td width="12%" align="left">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,ShouCiZiXun%>"></asp:Label></strong></td>
                                                                                <td width="12%" align="left">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,KeHuLaiYuan%>"></asp:Label></strong></td>
                                                                                <td width="12%" align="left">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,HangYeLeiXing%>"></asp:Label></strong>
                                                                                </td>
                                                                                ...
                                                                                <td width="7%" align="left">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,ShouLiZhuangTai%>"></asp:Label></strong>
                                                                                </td>
