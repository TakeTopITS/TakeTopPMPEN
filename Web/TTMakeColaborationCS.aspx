<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTMakeColaborationCS.aspx.cs"
    Inherits="TTMakeColaborationCS" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,JianLiXieZuo%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                                ...
                                                <td>
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,JueSeZu%>"></asp:Label></strong>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td width="100%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,JueSeChengYuan%>"></asp:Label></strong>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                    ...
                                    <td style="padding: 5px 5px 5px 5px; vertical-align: top; border-right: solid 1px #D8D8D8"
                                        ...
                                        <table width="100%" cellpadding="5" cellspacing="0" class="formBgStyle">
                                            ...
                                            <tr>
                                                ...
                                                <td class="formItemBgStyleForAlignLeft">
                                                    <CKEditor:CKEditorControl ID="CKEditor1" runat="server" Width="99%" Height="250px" Visible="false"></CKEditor:CKEditorControl>
                                                    <CKEditor:CKEditorControl runat="server" ID="HTEditor1" Width="99%" Height="250px" Visible="false" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td  style="width: 15%; height: 24px" class="formItemBgStyleForAlignLeft">
                                                    <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ZhuangTai%>"></asp:Label>：
                                                </td>
