lk<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTProjectMemberGradeList.aspx.cs" Inherits="TTProjectMemberGradeList" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,NianJi%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                                            ...
                                                            <div style="width: 60%;">
                                                                        ...
                                                                        <td>
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr>
                                                                                    ...
                                                                                    <td width="30%" align="left">
                                                                                        <strong>
                                                                                            <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,GuiShuBuMen%>"></asp:Label></strong>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                                ...
                                                                <asp:DataGrid ID="DG_List" runat="server" AllowPaging="true" AutoGenerateColumns="False"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundColumn DataField="DepartName" HeaderText="归属部门">
                                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="30%" />
                                                                        </asp:BoundColumn>
                                                                    </Columns>
