<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTGoodsApplicationOrderView.aspx.cs" Inherits="TTGoodsApplicationOrderView" %>
                ...
                <table style="width: 980px;">
                            ...
                            <table width="100%">
                                <tr>
                                    ...
                                    <td width="550px" style="font-size: xx-large; text-align: center;" class="auto-style1">
                                        <br />
                                        <asp:Label ID="LB_ReportName" runat="server" Text="<%$ Resources:lang,ShangPinLingYongDan%>"></asp:Label>
                                        <br />
                                    </td>
                                    <td>&nbsp;</td>
                                </tr>
                                    ...
                                    <table class="bian" style="width: 100%; border-collapse: collapse; margin: 0px auto;" cellpadding="4"
                                        ...
                                        <tr>
                                            ...
                                            <%# Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "ApplyTime")).ToString("yyyy/MM/dd")%>
                                              ...
                                              <td style="text-align: left">
                                                  <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,LeiXing%>"></asp:Label>：<asp:CheckBox ID="CheckBox1" runat="server" />
                                                  <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,LingLiao%>"></asp:Label>
                                                  <asp:CheckBox ID="CheckBox2" runat="server" />
                                                  <asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,BuLiao%>"></asp:Label>
                                                  <asp:CheckBox ID="CheckBox3" runat="server" />
                                                  <asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,XiaoShou%>"></asp:Label>
                                              </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="text-align: left" colspan="2">
                                                <asp:Label ID="Label15" runat="server" Text="<%$ Resources:lang,LingYongLiYou%>"></asp:Label>：
                    ...
                    <tr>
                        <td style="text-align: left">
                                    ...
                                    <td>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="8%" align="center">
                                                    <strong>
                                                        <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,PinPai%>"></asp:Label></strong>
                                                </td>
                            ...
                            <asp:DataGrid runat="server" AutoGenerateColumns="False" ShowHeader="false" GridLines="Both"
                            ...
                            <table width="80%">
                                <tr>
                                    <td class="formItemBgStyle" style="text-align: left;" width="150px">
                                        <asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,ShenQingRen%>"></asp:Label>：</td>
                                    <td class="formItemBgStyle" style="text-align: left;"></td>
                                    <td class="formItemBgStyle" style="text-align: left;" width="150px">
                                        <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,BuMenZhuGuan%>"></asp:Label>：</td>
                                    <td class="formItemBgStyle" style="text-align: left;"></td>
                                    <td class="formItemBgStyle" style="text-align: left;" width="150px">
                                        <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,CangGuan%>"></asp:Label>：</td>
                                    <td class="formItemBgStyle" style="text-align: left;"></td>
                                    <td class="formItemBgStyle" style="text-align: left;" width="150px">
                                        <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,ShenHe%>"></asp:Label>：</td>
                                    <td class="formItemBgStyle" style="text-align: left;"></td>
                                </tr>
                            </table>
                        </td>
