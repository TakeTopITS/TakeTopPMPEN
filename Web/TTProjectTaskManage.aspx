<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTProjectTaskManage.aspx.cs"
    Inherits="TTProjectTaskManage" %>
                                                                    ...
                                                                    <td align="left" style="width: 100%; padding: 5px 5px 5px 5px;">
                                                                        <cc2:TabContainer CssClass="ajax_tab_menu" ID="TabContainer1" runat="server" ActiveTabIndex="0" Width="100%">
                                                                            <cc2:TabPanel ID="TabPanel1" runat="server" HeaderText="我要处理的任务：">
                                                                                ...
                                                                                <ContentTemplate>
                                                                                    ...
                                                                                    <table style="width: 100%;" cellpadding="0" cellspacing="0">
                                                                                        <tr>
                                                                                            <td style="width: 100%; padding-top: 3px;" align="left">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td style="width: 100%; text-align: Left;">
                                                                                                            ...
                                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td width="23%" align="left">
                                                                                                                        ...
                                                                                                                        <strong>
                                                                                                                            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,WoDeGongZuo %>"></asp:Label></strong>
                                                                                                                    </td>
                                                                                                                    <td width="5%" align="left">

                                                                                                                        <strong>
                                                                                                                            <asp:Label ID="Label67" runat="server" Text="<%$ Resources:lang,YouXianJi %>"></asp:Label></strong>
                                                                                                                    </td>
                                                                                                                    ...
                                                                                                                    <td width="8%" align="left">
                                                                                                                        ...
                                                                                                                        <strong>
                                                                                                                            <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,RenWuHao %>"></asp:Label></strong>
                                                                                                                    </td>

                                                                                                                    <td width="8%" align="left">

                                                                                                                        <strong>
                                                                                                                            <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,FenPaiRen %>"></asp:Label></strong>
                                                                                                                    </td>
                                                                                                ...
                                                                                                <asp:Label ID="LB_TotalNumber1" runat="server"></asp:Label>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </ContentTemplate>
                                                                            ...
                                                                            <cc2:TabPanel ID="TabPanel2" runat="server" HeaderText="已处理但没分派的任务">
                                                                                <HeaderTemplate>
                                                                                    <asp:Label ID="Label41" runat="server" Text="<%$ Resources:lang,YCLDMFPDRW%>" ToolTip="<%$ Resources:lang,YCLDMFPDRW%>"></asp:Label>
                                                                                </HeaderTemplate>
                                                                                <ContentTemplate>
                                                                                    ...
                                                                                    <table style="width: 100%;">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                            ...
                                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td width="23%" align="left">
                                                                                                                        ...
                                                                                                                        <strong>
                                                                                                                            <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,WoDeGongZuo%>"></asp:Label></strong>
                                                                                                                    </td>
                                                                                                                    <td width="5%" align="left">

                                                                                                                        <strong>
                                                                                                                            <asp:Label ID="Label68" runat="server" Text="<%$ Resources:lang,YouXianJi %>"></asp:Label></strong>
                                                                                                                    </td>
                                                                                                                    <td width="12%" align="left">
                                                                                                                    ...
                                                                                                                    <td width="8%" align="left">
                                                                                                                        ...
                                                                                                                        <strong>
                                                                                                                            <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,RenWuHao%>"></asp:Label></strong>
                                                                                                                    </td>

                                                                                                                    <td width="8%" align="left">

                                                                                                                        <strong>
                                                                                                                            <asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,FenPaiRen%>"></asp:Label></strong>
                                                                                                                    </td>
                                                                                                ...
                                                                                                <asp:Label ID="LB_TotalNumber2" runat="server"></asp:Label>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </ContentTemplate>
                                                                                                ...
                                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td width="5%" align="left">
                                                                                                            ...
                                                                                                            <strong>
                                                                                                                <asp:Label ID="Label69" runat="server" Text="<%$ Resources:lang,YouXianJi %>"></asp:Label></strong>
                                                                                                        </td>
                                                                                                        <td width="8%" align="left">
                                                                                                            <strong>
                                                                                                        ...
                                                                                                        <td width="12%" align="left">
                                                                                                            <strong>
                                                                                                                <asp:Label ID="Label261" runat="server" Text="<%$ Resources:lang,KaiShiShiJian%>"></asp:Label></strong>
                                                                                                        </td>
                                                                                                        <td width="12%" align="left">
                                                                                                            <strong>
                                                                                                ...
                                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td width="5%" align="left">
                                                                                                            ...
                                                                                                            <strong>
                                                                                                                <asp:Label ID="Label70" runat="server" Text="<%$ Resources:lang,YouXianJi %>"></asp:Label></strong>
                                                                                                        </td>
                                                                                                        <td width="12%" align="left">
                                                                                                            <strong>
                                                                                                ...
                                                                                                <table style="width: 100%;" cellpadding="0" cellspacing="0">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td style="width: 100%; text-align: Left;">
                                                                                                                        ...
                                                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td width="18%" align="left">
                                                                                                                                    <strong>
                                                                                                                                        <asp:Label ID="Label45" runat="server" Text="<%$ Resources:lang,RenWuNeiRong %>"></asp:Label></strong>
                                                                                                                                </td>

                                                                                                                                <td width="8%" align="left">
                                                                                                                                    <strong>
                                                                                                                                        <asp:Label ID="Label46" runat="server" Text="<%$ Resources:lang,YouXianJi %>"></asp:Label></strong>
                                                                                                                                </td>
                                                                                                                                ...
                                                                                                                                <td width="5%" align="left">
                                                                                                                                    <strong>
                                                                                                                                        <asp:Label ID="Label48" runat="server" Text="<%$ Resources:lang,JieShuShiJian %>"></asp:Label></strong>
                                                                                                                                </td>
                                                                                                                                ...
                                                                                                                                <td width="7%" align="left">
                                                                                                                                    <strong>
                                                                                                                                        <asp:Label ID="Label50" runat="server" Text="<%$ Resources:lang,FeiYongYuSuan %>"></asp:Label></strong>
                                                                                                                                </td>

                                                                                                                                <td width="7%" align="left">
                                                                                                                                    <strong>
                                                                                                                                        <asp:Label ID="Label51" runat="server" Text="<%$ Resources:lang,GongShiYuSuan %>"></asp:Label></strong>
                                                                                                                                </td>

                                                                                                                                <td width="5%" align="left">
                                                                                                                                    <strong>
                                                                                                                                        <asp:Label ID="Label52" runat="server" Text="<%$ Resources:lang,FeiYong %>"></asp:Label></strong>
                                                                                                                                </td>

                                                                                                                                <td width="5%" align="left">
                                                                                                                                    <strong>
                                                                                                                                        <asp:Label ID="Label53" runat="server" Text="<%$ Resources:lang,GongShi2 %>"></asp:Label></strong>
                                                                                                                                </td>

                                                                                                                                <td width="5%" align="left">
                                                                                                                                    <strong>
                                                                                                                                        <asp:Label ID="Label54" runat="server" Text="<%$ Resources:lang,ZhuangTai %>"></asp:Label></strong>
                                                                                                                                </td>
                                                                                                            ...
                                                                                                            <asp:Label ID="LB_TotalNumber4" runat="server"></asp:Label>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                                ...
                                                                                                <table style="width: 100%;" cellpadding="0" cellspacing="0">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td style="width: 100%; text-align: Left;">
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td width="5%" align="left">
                                                                                                                                    <strong>
                                                                                                                                        <asp:Label ID="Label56" runat="server" Text="<%$ Resources:lang,BianHao %>"></asp:Label></strong>
                                                                                                                                </td>

                                                                                                                                <td width="5%" align="left">
                                                                                                                                    <strong>
                                                                                                                                        <asp:Label ID="Label57" runat="server" Text="<%$ Resources:lang,LeiXing %>"></asp:Label></strong>
                                                                                                                                </td>

                                                                                                                                <td width="18%" align="left">
                                                                                                                                    <strong>
                                                                                                                                        <asp:Label ID="Label58" runat="server" Text="<%$ Resources:lang,RenWuNeiRong %>"></asp:Label></strong>
                                                                                                                                </td>

                                                                                                                                <td width="8%" align="left">
                                                                                                                                    <strong>
                                                                                                                                        <asp:Label ID="Label59" runat="server" Text="<%$ Resources:lang,YouXianJi %>"></asp:Label></strong>
                                                                                                                                </td>

                                                                                                                                <td width="5%" align="left">
                                                                                                                                    <strong>
                                                                                                                                        <asp:Label ID="Label60" runat="server" Text="<%$ Resources:lang,KaiShiShiJian %>"></asp:Label></strong>
                                                                                                                                </td>

                                                                                                                                <td width="5%" align="left">
                                                                                                                                    <strong>
                                                                                                                                        <asp:Label ID="Label61" runat="server" Text="<%$ Resources:lang,JieShuShiJian %>"></asp:Label></strong>
                                                                                                                                </td>

                                                                                                                                <td width="100px" align="left">
                                                                                                                                    <strong>
                                                                                                                                        <asp:Label ID="Label62" runat="server" Text="<%$ Resources:lang,JinDu %>"></asp:Label></strong>
                                                                                                                                </td>

                                                                                                                                <td width="7%" align="left">
                                                                                                                                    <strong>
                                                                                                                                        <asp:Label ID="Label63" runat="server" Text="<%$ Resources:lang,FeiYongYuSuan %>"></asp:Label></strong>
                                                                                                                                </td>

                                                                                                                                <td width="7%" align="left">
                                                                                                                                    <strong>
                                                                                                                                        <asp:Label ID="Label64" runat="server" Text="<%$ Resources:lang,GongShiYuSuan %>"></asp:Label></strong>
                                                                                                                                </td>

                                                                                                                                <td width="5%" align="left">
                                                                                                                                    <strong>
                                                                                                                                        <asp:Label ID="Label65" runat="server" Text="<%$ Resources:lang,FeiYong %>"></asp:Label></strong>
                                                                                                                                </td>

                                                                                                                                <td width="5%" align="left">
                                                                                                                                    <strong>
                                                                                                                                        <asp:Label ID="Label66" runat="server" Text="<%$ Resources:lang,GongShi2 %>"></asp:Label></strong>
                                                                                                                                </td>
                                                                                                            ...
                                                                                                            <asp:Label ID="LB_TotalNumber6" runat="server" Visible="False"></asp:Label>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </table>
