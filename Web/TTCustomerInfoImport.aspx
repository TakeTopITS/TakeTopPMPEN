<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTCustomerInfoImport.aspx.cs" Inherits="TTCustomerInfoImport" %>
                                                ...
                                                <table width="1600" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,KeHuXinXiDaoRu%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                                            ...
                                                            <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                                                <ContentTemplate>
                                                                    <div>
                                                                        ...
                                                                        ：<a href="Template/客户档案信息导入模板.xls"><asp:Label ID="Label29" runat="server" Text="<%$ Resources:lang,KHXXDRMB%>"></asp:Label>
                                                                        </a>
                                                                        <div id="ProgressBar">
                                                        ...
                                                        <td>
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td width="10%" align="center">
                                                                        <strong>
                                                                            <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,Email%>"></asp:Label></strong>
                                                                    </td>
                                                                    <td width="20%" align="center">
                                                                        <strong>
                                                                    ...
                                                                    <td width="10%" align="center">
                                                                        <strong>
                                                                            <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,JianLiRiQi%>"></asp:Label></strong>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
