                                                            ...
                                                            <td>
                                                                <table width="100%" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                                    <tr>
                                                                        ...
                                                                        <td class="formItemBgStyle" align="right">
                                                                            <asp:Label ID="Label27" runat="server" Text="项目附件"></asp:Label>：
                                                                        </td>
                                                                        <td class="formItemBgStyle" align="left">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <input type="button" id="btnLeader" class="inpu" runat="server" value="选择" onclick="SelectEmployee('TTWZSelectorMember.aspx', 'TabContainer1_TabPanel1_HF_Leader', 'TabContainer1_TabPanel1_TXT_Leader')" />
                                                                        ...
                                                                        <input type="button" id="BT_FeeManage" class="inpu" runat="server" value="选择" onclick="SelectEmployee('TTWZSelectorMember.aspx', 'TabContainer1_TabPanel1_HF_FeeManage', 'TabContainer1_TabPanel1_TXT_FeeManage')" />
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <input type="button" id="BT_MaterialPerson" class="inpu" runat="server" value="选择" onclick="SelectEmployee('TTWZSelectorMember.aspx', 'TabContainer1_TabPanel1_HF_MaterialPerson', 'TabContainer1_TabPanel1_TXT_MaterialPerson')" />
