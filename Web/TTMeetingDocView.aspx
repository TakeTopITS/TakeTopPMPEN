<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTMeetingDocView.aspx.cs" Inherits="TTMeetingDocView" %>
                                ...
                                <td style="width: 100%; text-align: right">
                                    ...
                                    <span style="font-size: 11pt">
                                        <asp:Label ID="LB_UserName" runat="server"
                                            Visible="False"></asp:Label><span style="font-size: 11pt">
                                    ...
                                    <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundColumn DataField="Address" Visible="False">
                                                <HeaderStyle BorderColor="#394f66" BorderStyle="Solid" BorderWidth="1px" Font-Bold="true" Width="40px" />
                                            </asp:BoundColumn>
                                        </Columns>
