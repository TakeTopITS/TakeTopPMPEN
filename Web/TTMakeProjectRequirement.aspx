<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTMakeProjectRequirement.aspx.cs"
    Inherits="TTMakeProjectRequirement" %>
                                        ...
                                        <tr>
                                            <td align="left">
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td width="29" style="padding-top:5px;">
                                                            <%--<img src="Logo/main_top_l.jpg" alt="" width="29" height="31" />--%>
                                                        </td>
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="LB_tiCreateReq" runat="server" Text="<%$ Resources:lang,CreateProjectReq%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                            ...
                                            <td align="left" style="padding-top:5px;">
                                                <asp:Button ID="BT_AllReq" runat="server" Width="220px" OnClick="BT_AllReq_Click" CssClass="inpu"
                                                    Text="<%$ Resources:lang,FindAllReq%>" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td align="left" style="padding: 5px 5px 5px 5px">
                                                ...
                                                <table width="100%" align="left" border="0" cellpadding="0" cellspacing="0" background="ImagesSkin/main_n_bj.jpg">
                                                    <tr>
                                                        <td width="7">
                                                        ...
                                                        <td>
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td width="5%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,ShanChu %>" /></strong>
                                                                    </td>
                                                                    ...
                                                                    <td width="10%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="LB_dgReqType" runat="server" Text="<%$ Resources:lang,Type %>"></asp:Label></strong>
                                                                    </td>
                                                ...
                                                <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" Height="1px"
                                                    Horizontalalign="left" Width="100%" OnItemCommand="DataGrid1_ItemCommand" OnPageIndexChanged="DataGrid1_PageIndexChanged"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundColumn DataField="ReqID" HeaderText="ID">
                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="5%" />
                                                        </asp:BoundColumn>
                                                        <asp:BoundColumn DataField="ReqType" HeaderText="Type">
                                                            <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="10%" />
                                                        </asp:BoundColumn>
                                                        <asp:BoundColumn DataField="ReqName" HeaderText="需求名称">
                                                    ...
                                                    <HeaderStyle Horizontalalign="left" Font-Bold="True" BackColor="#507CD1" ForeColor="White" />
                                        ...
                                        <tr style="display: none;">
                                            <td>
                                                <asp:HyperLink ID="HL_RunReqByWF" runat="server" Enabled="False" Target="_blank" Text="<%$ Resources:lang,hlRunReqByWF %>" Visible="False"></asp:HyperLink>
                                                &nbsp;<asp:HyperLink ID="HL_ReqReview" runat="server" Enabled="False" Target="_blank" Text="<%$ Resources:lang,hlReqReview %>"></asp:HyperLink>
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="text-align: left; overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <cc1:TabContainer CssClass="ajax_tab_menu" ID="TabContainer1" Width="100%" runat="server" ActiveTabIndex="0">
                                <cc1:TabPanel ID="TabPanel1" runat="server" HeaderText="基本信息" TabIndex="0">
                                    ...
                                    <ContentTemplate>
                                        <table width="100%" align="left" cellpadding="0" cellspacing="0" style="border-left: solid 1px #D6DAE2;">

                                            <tr>
                                                <td class="formItemBgStyle">
                                                    <asp:Label ID="LB_ReqID" runat="server" Visible="false"></asp:Label><asp:Label ID="LB_tbReqType" runat="server" Text="<%$ Resources:lang,Type %>"></asp:Label>:
                                                </td>
                                            ...
                                            <tr>
                                                <td class="formItemBgStyle">
                                                    <asp:Label ID="LB_tbReqName" runat="server" Text="<%$ Resources:lang,Name %>"></asp:Label>:
                                                </td>
                                                <td style="text-align: left" class="formItemBgStyle">
                                                    <asp:TextBox ID="TB_ReqName" runat="server" Width="90%"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="formItemBgStyle">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left;" class="formItemBgStyle">
                                                    <asp:TextBox ID="DLC_ReqFinishedDate" runat="server"></asp:TextBox>
                                                    <ajaxToolkit:CalendarExtender Format="yyyy-MM-dd" ID="CalendarExtender3" runat="server" TargetControlID="DLC_ReqFinishedDate" Enabled="True">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" class="formItemBgStyle">
                                                    ...
                                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                                                   <asp:HyperLink ID="HL_ApproveRecord" runat="server" Enabled="False" Visible="false" NavigateUrl="~/TTReqAssignRecord.aspx" Target="_blank" Text="<%$ Resources:lang,ApprovedRecord %>"></asp:HyperLink>
                                                    &nbsp;<asp:HyperLink ID="HL_RelatedDoc" runat="server" Enabled="False" Visible="false" NavigateUrl="~/TTReqRelatedDoc.aspx" Target="_blank" Text="<%$ Resources:lang,RelatedDoc %>"></asp:HyperLink>
