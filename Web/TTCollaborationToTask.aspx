<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTCollaborationToTask.aspx.cs" Inherits="TTCollaborationToTask" %>
                ...
                <ContentTemplate>
                                                            ...
                                                            <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    ...
                                                                    <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,XieZuoZhuanRenWu%>"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                                    ...
                                                                    <td>
                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            <tr>
                                                                                ...
                                                                                <td align="left" width="7%">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,FeiYong%>"></asp:Label></strong>
                                                                                </td>
                                                                                <td align="left" width="5%">
                                                                                    <strong>
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="text-align: left; overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <cc1:TabContainer CssClass="ajax_tab_menu" ID="TabContainer1" Width="100%" runat="server" ActiveTabIndex="0">
                                <cc1:TabPanel ID="TabPanel1" runat="server" HeaderText="基本信息" TabIndex="0">
                                    <HeaderTemplate>
                                        <asp:Label ID="Label40" runat="server" Text="<%$ Resources:lang,JiBenXinXi%>"></asp:Label>
                                    </HeaderTemplate>
                                    <ContentTemplate>
                                        <table style="width: 100%;" cellpadding="3" cellspacing="0" class="formBgStyle">
                                            <tr>
                                                <td style="width: 7%;" class="formItemBgStyle">
                                            ...
                                            <tr style="display: none;">
                                                ...
                                                <td colspan="5" style="text-align: left" class="formItemBgStyle">
                                                    <asp:Button ID="BT_Close" runat="server" CssClass="inpu" Enabled="False"
                                                        OnClick="BT_Close_Click" Text="<%$ Resources:lang,GuanBi %>" />
                                                    &nbsp;<asp:Button ID="BT_Active" runat="server" CssClass="inpu" Enabled="False" OnClick="BT_Active_Click"
                                ...
                                <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="关联信息" TabIndex="2">
                                    <HeaderTemplate>
                                        <asp:Label ID="Label41" runat="server" Text="<%$ Resources:lang,XiangGuanYeWuDan%>"></asp:Label>
                                    </HeaderTemplate>
                                    <ContentTemplate>
                                            ...
                                            <table style="width: 100%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                <%--  <tr>
                                                    <td colspan="8" align="left">
                                                        <asp:Label ID="Label36" runat="server" Text="<%$ Resources:lang,XiangGuanYeWuDan %>"></asp:Label>
                                                    </td>
                                                </tr>--%>
                                                <tr>
                                                    <td style="width: 10%; " class="formItemBgStyle">
                                                    ...
                                                    <td style="width: 20%; " class="formItemBgStyle">
                                                        <asp:Label ID="Label39" runat="server" Text="<%$ Resources:lang,YunXuHouXuXiuGe%>"></asp:Label>：
                                                    </td>
                                                    <td style="text-align: left;" class="formItemBgStyle">
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popAssignWindow" name="noConfirm"
                        ...
                        <div id="popwindow_content1" class="layui-layer-content" style="overflow: auto; text-align: left; padding: 0px 5px 0px 5px;">
                            ...
                            <table cellpadding="3" cellspacing="0" style="width: 100%" class="formBgStyle">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 20%; " class="formItemBgStyle">
                                        <asp:Label ID="Label44" runat="server" Text="<%$ Resources:lang,ShouLiRen%>"></asp:Label>：</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="formItemBgStyle" colspan="3" style="height: 21px; text-align: left">
                                                ...
                                                <span style="font-size: 10pt">
                                                    <asp:Label ID="Label49" runat="server" Text="<%$ Resources:lang,TongZhiShouLiRen%>"></asp:Label></span>
                                                <asp:TextBox ID="TB_Message" runat="server" Width="350px"></asp:TextBox>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            ...
                                                            <td width="6%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label52" runat="server" Text="<%$ Resources:lang,RenWuHao%>"></asp:Label></strong>
                                                            </td>
                                                            <td width="8%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label53" runat="server" Text="<%$ Resources:lang,FenPaiRen%>"></asp:Label></strong>
                                                            </td>
                                                            <td width="8%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label54" runat="server" Text="<%$ Resources:lang,ShouLiRen%>"></asp:Label></strong>
                                                            </td>
                                                            <td width="12%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label55" runat="server" Text="<%$ Resources:lang,ShouLiRenDeGongZuo%>"></asp:Label></strong>
                                                            </td>
                                                            <td width="10%" align="left">
                                                                <strong>
                                                            ...
                                                            <td width="10%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label59" runat="server" Text="<%$ Resources:lang,LuXian%>"></asp:Label></strong>
                                                            </td>
                                                            <td width="7%" align="left">
                                                                <strong>
                                ...
                                <tr>
                                    <td style="text-align: left; display: none;">
                                        <asp:Label ID="LB_CollaborationID" runat="server" Visible="False"></asp:Label>
                        ...
                        <div id="popwindow_footer1" class="layui-layer-btn" style="border-top: 1px solid #ccc;">
                            <asp:LinkButton ID="LinkButton2" runat="server" class="layui-layer-btn notTab" OnClick="BT_New_Click" Text="<%$ Resources:lang,BaoCun%>"></asp:LinkButton><a class="layui-layer-btn notTab" onclick="return popClose();"><asp:Label ID="Label61" runat="server" Text="<%$ Resources:lang,GuanBi%>" /></a>
                        </div>
                        <span class="layui-layer-setwin"><a onclick="return popClose();" class="layui-layer-ico layui-layer-close layui-layer-close1 notTab" href="javascript:;"></a></span>
                    </div>
                    ...
                    <asp:DataList ID="DataList1" runat="server" CellPadding="0" ForeColor="#333333" Width="100%" Visible="false">
                        <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                        <ItemTemplate>
