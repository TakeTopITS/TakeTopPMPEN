<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTMyMemberCustomers.aspx.cs" Inherits="TTMyMemberCustomers" %>
                                                ...
                                                <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ChaKanZhiJieChengYuanKeHu%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                                        ...
                                                        <td>
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="right">
                                                                        <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,QuYu%>"></asp:Label>：
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>&nbsp;
                                                                    <asp:Button ID="BT_FindType" runat="server" CssClass="inpu" Text="<%$ Resources:lang,ChaXun%>" OnClick="BT_Find_Click" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
