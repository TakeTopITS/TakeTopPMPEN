<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTBMPurchaseApplication.aspx.cs" Inherits="TTBMPurchaseApplication" %>
    ...
    <center>
        <form id="form1" runat="server">
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,FenBaoShenQing%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                    ...
                                    <table cellpadding="2" cellspacing="0" class="formBgStyle" width="75%">
                                        <tr>
                                             <td align="left">
                                                ...
                                                <cc1:CalendarExtender ID="CalendarExtender5" runat="server" Format="yyyy-MM-dd" TargetControlID="TextBox3" Enabled="True"></cc1:CalendarExtender>
                                                ...
                                                <cc1:CalendarExtender ID="CalendarExtender6" runat="server" Format="yyyy-MM-dd" TargetControlID="TextBox4" Enabled="True"></cc1:CalendarExtender>
                                                        ...
                                                        <td>
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td width="10%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,ShenQingRiQi %>"></asp:Label>
                                                                        </strong>
                                                                    </td>
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px; text-align: left;">
                            ...
                            <table cellpadding="2" cellspacing="0" class="formBgStyle" width="100%">
                                ...
                                <tr style="color: #000000">
                                    ...
                                    <td colspan="3"  class="formItemBgStyleForAlignLeft" style="height: 30px">
            ...
            <NickLee:NumberBox MaxAmount="1000000000000" MinAmount="-1000000000000" ID="NB_ExpectedAmount" runat="server" Width="150px">0.00</NickLee:NumberBox>
                                ...
                                <tr style="color: #000000">
                                    <td class="formItemBgStyleForAlignLeft" style="height: 30px">
                                        <asp:Label ID="Label90" runat="server" Text="<%$ Resources:lang,ZhuangTai%>"></asp:Label>
                                        ：</td>
                                    <td class="formItemBgStyleForAlignLeft" colspan="3" style="height: 30px">
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popwindowWorkflow"
                                ...
                                <tr>
                                    ...
                                    <td align="left" style="width: 650px; height: 27px">
                                        ...
                                        <asp:DropDownList ID="DL_WFType" runat="server">
                                            <asp:ListItem Value="SubcontractApplication" Text="<%$ Resources:lang,LaoWuFenBaoShengQing%>" />
                                        </asp:DropDownList>
                                        <asp:HyperLink
                        ...
                        <div id="popwindow_footer0001" class="layui-layer-btn" style="border-top: 1px solid #ccc;">
                            <asp:LinkButton ID="LinkButton1" runat="server" class="layui-layer-btn notTab" OnClick="BT_New_Click" Text="<%$ Resources:lang,BaoCun%>"></asp:LinkButton><a class="layui-layer-btn notTab" onclick="return popClose();"><asp:Label ID="Label40" runat="server" Text="<%$ Resources:lang,GuanBi%>" /></a>
                        </div>
                        <span class="layui-layer-setwin"><a onclick="return popClose();" class="layui-layer-ico layui-layer-close layui-layer-close1 notTab" href="javascript:;"></a></span>
                    </div>
