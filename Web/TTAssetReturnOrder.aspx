                                ...
                                <tr>
                                    <td width="50%" class="formItemBgStyle">
                                        <table align="left" width="100%" cellpadding="1" cellspacing="0" class="formBgStyle">
                                            <tr>
                                                <td width="15%" align="right" class="formItemBgStyle">
                                                    <div style="display: none;">
                                                        <asp:Label ID="LB_ID" runat="server"></asp:Label>
                                                    </div>
                                                    <asp:Label ID="Label23" runat="server" Text="<%$ Resources:lang,LaiYuan%>"></asp:Label>：
                                                </td>
                                                <td width="15%" align="left" class="formItemBgStyle">
                                                ...
                                                <td width="60px" align="right" class="formItemBgStyle">ID:</td>
                                                <td width="15%" align="left" class="formItemBgStyle">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2" style="text-align: left" class="formItemBgStyle">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td class="formItemBgStyle" style="">
