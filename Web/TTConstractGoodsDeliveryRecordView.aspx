<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTConstractGoodsDeliveryRecordView.aspx.cs" Inherits="TTConstractGoodsDeliveryRecordView" %>
                                                    ...
                                                    <tr>
                                                        <td style="height: 20px;" align="left">
                                                            <table width="90%">
                                                                ...
                                                                <tr>
                                                                    <td align="right">
                                                                        <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,YingShouZongShu%>"></asp:Label>：<asp:Label ID="LB_ReceivablesNumber" runat="server"></asp:Label>&#160;<asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,ShiShouZongShu%>"></asp:Label>：<asp:Label
                                                                        ID="LB_ReceiverNubmer" runat="server"></asp:Label>
                                                                        &#160;<asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,DaiShouZongShu%>"></asp:Label>：<asp:Label ID="LB_UNReceiverNumber" runat="server"></asp:Label>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="left">
                                                                        <table align="left" cellpadding="3" cellspacing="0" class="formBgStyle" width="98%">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td style="text-align: left;" colspan="5" class="formItemBgStyle">
                                                                                    <asp:TextBox ID="TB_DeliveryGoodsSpec" runat="server" Height="20px"  Enabled="false" Width="99%"></asp:TextBox></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="formItemBgStyle" style="">
                                                                            ...
                                                                            <tr>
                                                                                <td class="formItemBgStyle" style="">
                                                                                    <asp:Label ID="Label31" runat="server" Text="<%$ Resources:lang,FaHuoShiJian%>"></asp:Label>： </td>
                                                                                <td class="formItemBgStyle" style="text-align: left">
                                                                                ...
                                                                                <td class="formItemBgStyle" style="">
                                                                                    <asp:Label ID="Label32" runat="server" Text="<%$ Resources:lang,SongHuoDiZhi%>"></asp:Label>：</td>
                                                                                <td class="formItemBgStyle" style="text-align: left" colspan="3">
                                                                                    <asp:TextBox ID="TB_DeliveryAddress" runat="server" Enabled="false" Height="20px" Width="99%"></asp:TextBox>
                                                                                </td>
                                                                            </tr>
