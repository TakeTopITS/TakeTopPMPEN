                            ...
                            <tr>
                                <td style="padding: 5px 5px 5px 5px;">
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td class="formItemBgStyleForAlignLeft" style="margin-top: 5px">
                                                                    ...
                                                                    <td>
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                ...
                                                                                <td width="5%" align="left"><strong>Bom</strong> </td>
                                                                                <td width="6%" align="left"><strong>
                                                            ...
                                                            <asp:DataGrid ID="DataGrid2" runat="server" AutoGenerateColumns="False" ShowHeader="False"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateColumn HeaderText="保存">
                                                                        ...
                                                                        <ItemStyle CssClass="itemBorder" Width="5%" HorizontalAlign="left" />
                                                                    </asp:TemplateColumn>
                                                                    <asp:BoundColumn DataField="Unit" HeaderText="Unit">
                                                                        <ItemStyle CssClass="itemBorder" HorizontalAlign="left" Width="4%" />
                                                                    </asp:BoundColumn>
                                                                ...
                                                                <tr style="font-size: 10pt">
                                                                    ...
                                                                    <td class="formItemBgStyleForAlignLeft">
                                                                        <asp:DropDownList ID="DL_WFType" runat="server">
                                                                            <asp:ListItem Value="PlanApproval" Text="<%$ Resources:lang,JiHuaShengPi%>" />
