...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        window.onload = function () {
            ...
            if (companyName != null) {
                document.getElementById("TB_CompanyName").value = companyName;
