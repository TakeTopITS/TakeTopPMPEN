<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTReceivablesPayableHandleView.aspx.cs" Inherits="TTReceivablesPayableHandleView" %>
                                                            ...
                                                            <cc2:TabContainer CssClass="ajax_tab_menu" ID="TabContainer1" runat="server" ActiveTabIndex="0"
                                                                ...
                                                                <cc2:TabPanel ID="TabPanel1" runat="server" HeaderText=" 收款进度" TabIndex="0">
                                                                    ...
                                                                    <ContentTemplate>
                                                                        <table width="100%">
                                                                            <tr>
                                                                                <td>
                                                                                    ...
                                                                                    <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" Width="100%" PageSize="15"
                                                                        ...
                                                                        <asp:Label ID="LB_Status" runat="server" Visible="False"></asp:Label><asp:Label ID="LB_UserCode" runat="server" Visible="False"></asp:Label><asp:Label ID="LB_UserName" runat="server" Visible="False"></asp:Label><asp:Label ID="LB_ConstractCode" runat="server" Visible="False"></asp:Label><asp:Label ID="LB_ConstractID" runat="server" Visible="False"></asp:Label>
                                                                    </ContentTemplate>
                                                                </cc2:TabPanel>
                                                                        ...
                                                                        <table width="100%" cellpadding="0" cellspacing="0">
                                                                            <tr>
                                                                                <td colspan="2">
                                                                                    ...
                                                                                    <asp:DataGrid ID="DataGrid2" runat="server" AutoGenerateColumns="False" Width="100%" PageSize="15"
                                                                                        ...
                                                                                        <Columns>
                                                                                            ...
                                                                                            <asp:BoundColumn DataField="OutOfPocketAccount" HeaderText="ActualPaymentAmount">
                                                                                                <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="6px" />
                                                                                            </asp:BoundColumn>
                                                                                            <asp:BoundColumn DataField="InvoiceAccount" HeaderText="开票金额">
                                                                                                <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="6%" />
                                                                                            </asp:BoundColumn>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td align="right">
                                                                                    <asp:Label ID="Label37" runat="server" Text="<%$ Resources:lang,YingFuZongE%>"></asp:Label>：<asp:Label ID="LB_PayableAmount" runat="server"></asp:Label>&nbsp;<asp:Label ID="Label35" runat="server" Text="<%$ Resources:lang,ShiFuZongE%>"></asp:Label>：<asp:Label
