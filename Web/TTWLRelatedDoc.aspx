<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="TTWLRelatedDoc.aspx.cs" Inherits="TTWLRelatedDoc" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,GongZuoLiuXiangWenJian%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                            ...
                            <tr>
                                <td>
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td style="width: 18%; text-align: left; padding: 5px 5px 0px 5px; border-right: solid 1px #D8D8D8; vertical-align: top;"
                                                rowspan="5">
                                            ...
                                            <td style="width: 98%; text-align: left; display: none;">
