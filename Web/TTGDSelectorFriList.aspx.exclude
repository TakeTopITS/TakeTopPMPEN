<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTGDSelectorFriList.aspx.cs" Inherits="TTGDSelectorFriList" %>
    ...
    <script type="text/jscript">
        ...
        function clickMember(resultList) {
            ...
            if (resultList != "" && resultList != undefined) {
                ...
                window.parent.document.getElementById(id).value = resultList;
                                    ...
                                    <td align="left">
                                        <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">FRI
                                                </td>
                                                <td width="5">
                                                        ...
                                                        <asp:DataGrid ID="DG_List" runat="server" AllowPaging="False" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                <asp:TemplateColumn>
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <input id='<%#Eval("FRICode") %>' type="radio" name="name1" />
                                                                    </ItemTemplate>
                                                                </asp:TemplateColumn>
                                                                <asp:BoundColumn DataField="FRICode" HeaderText="FRI">
