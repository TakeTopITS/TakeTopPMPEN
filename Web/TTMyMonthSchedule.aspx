<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTMyMonthSchedule.aspx.cs"
    Inherits="TTMyMonthSchedule" Culture="zh-CN" %>
            ...
            <ContentTemplate>
                <div id="AboveDiv">
                    <table cellpadding="0" cellspacing="0" width="100%" class="bian">
                                    ...
                                    <tr>
                                        <td align="left">
                                         ...
                                         <td width="30%" align="right" style="padding-right: 10px;">
                                            <asp:HyperLink ID="HL_MySchedule" Font-Underline="false" runat="server" NavigateUrl="TTMySchedule.aspx" Text="<%$ Resources:lang,WeekSchedule%>"></asp:HyperLink>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td align="left" style="padding: 2px 8px 8px 5px;">
