<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTBMSupplierBidRecordFile.aspx.cs" Inherits="TTBMSupplierBidRecordFile" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,TouBiaoWenJian%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                            ...
                            <tr>
                                <td align="center" style="padding-top: 5px;">
                                    ...
                                    <table cellpadding="2" cellspacing="0" class="formBgStyle" width="75%">
                                        <tr>
                                             <td align="center">
                                                <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,WenJianXinXi%>"></asp:Label>：
