<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTTenderFinanceList_BYJF.aspx.cs" Inherits="TTTenderFinanceList_BYJF" %>
                                                ...
                                                <tr>
                                                    <td align="left">
                                                        ...
                                                        <asp:DropDownList ID="DL_WarningType" runat="server">
                                                            <asp:ListItem />
                                                            <asp:ListItem Value="BidDocumentPurchase" Text="<%$ Resources:lang,BiaoShuGouMai%>" />
                                                            <asp:ListItem Value="PayDeposit" Text="<%$ Resources:lang,JiaoBaoZhengJin%>" />
                                                            <asp:ListItem Value="ReceiveDeposit" Text="<%$ Resources:lang,ShouBaoZhengJin%>" />
                                                            <asp:ListItem Value="BidOpening" Text="<%$ Resources:lang,KaiBiao%>" />
                                                            <asp:ListItem Value="PayWinningBidFee" Text="<%$ Resources:lang,JiaoZhongBiaoFei%>" />
                                                        </asp:DropDownList>
                                        ...
                                        <td align="center" style="padding-top: 5px;">
                                            <table background="ImagesSkin/main_n_bj.jpg" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    ...
                                                    <td width="35%" align="left">
                                                        <strong>
                                                            <asp:Label ID="Label35" runat="server" Text="<%$ Resources:lang,XiangMuSuoSuoZhuanYe%>"></asp:Label></strong>
                                                    </td>
                                            ...
                                            <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" OnItemCommand="DataGrid1_ItemCommand"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundColumn DataField="TenderContent" HeaderText="<%$ Resources:lang,XiangMuSuoSuoZhuanYe%>">
                                ...
                                <td style="width: 100%; border-right: solid 1px #D8D8D8; padding: 2px 2px 2px 2px;" valign="top">
                                    <table class="formBgStyle" cellpadding="3" cellspacing="0" style="width: 98%; margin-top: 2px; background-color: white;"
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left;">
                                                <asp:Label ID="Label54" runat="server" Text="<%$ Resources:lang,JiShuFuZeRen%>"></asp:Label>：
                                            </td>
                                            <td align="left" colspan="2">
                                                <table>
                                                    <tr>
