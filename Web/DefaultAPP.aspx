                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                    ...
                                    <asp:TextBox ID="TB_UserCode" runat="server" Text="请输入你的登录帐号(UserCode)" onFocus="javascript:this.value='';document.getElementById('LB_ErrorMsg').style.display = 'none';" ForeColor="#000000" class="dengl" Width="100%"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
