                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" align="left" class="bian">
                            ...
                            <tr>
                                ...
                                <td align="left" style="padding-top: 5px; width: 50%;">
                                    ...
                                    <table cellpadding="2" cellspacing="0" class="formBgStyle" width="100%">
                                        <tr>
                                            <td  class="formItemBgStyleForAlignLeft">&nbsp;<asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,ZhaoBiaoXinXi%>"></asp:Label>：</td>
                                        </tr>
                                        <tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <table cellpadding="2" cellspacing="0" class="formBgStyle" width="98%">
                                        <tr>
                                            <td   class="formItemBgStyleForAlignLeft">&nbsp;<asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,TouBiaoLiShiXinXiLieBiao%>"></asp:Label>：</td>
                                        </tr>
                                        <tr>
