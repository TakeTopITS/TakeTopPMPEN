<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTAllProjectChildTree.aspx.cs" Inherits="TTAllProjectChildTree" %>
                    ...
                    <tr>
                        <td valign="top">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td valign="top" width="220" style="padding: 5px 5px 0px 5px; border-right: solid 1px #D8D8D8" align="left">
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:DataList ID="DataList1" runat="server" Width="100%" CellPadding="0" ForeColor="#333333">
                                                        ...
                                                        <ItemTemplate>
                                                            <table style="width: 98%; "  cellpadding="4" cellspacing="0" class="bian">
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 10%; text-align: right">
                                                                        <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,FeiYongYuSuan%>"></asp:Label>                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: right">
                                                                        <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,RenLiYuSuan%>"></asp:Label>                                                                    </td>
                                                                    <td style="text-align: left">
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: right;">
                                                                        <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,LiXiangRen%>"></asp:Label>                                                                    </td>
                                                                    <td style="text-align: left">
                                                                        <%#DataBinder .Eval (Container .DataItem,"UserName") %>
                                                                    </td>
                                                                    <td style="text-align: right;">
                                                                        <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,GongShiYuSuan%>"></asp:Label>                                                                    </td>
                                                                    <td style="text-align: left">
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: right">
                                                                        <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,KaiShiRiQi%>"></asp:Label>                                                                    </td>
                                                                    <td style=" text-align: left">
                                                                        <%#DataBinder .Eval (Container .DataItem, "BeginDate","{0:yyyy/MM/dd}") %>
                                                                    </td>
                                                                    <td style="text-align: right">
                                                                        <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,JieShuRiQi%>"></asp:Label>                                                                    </td>
                                                                    <td style="text-align: left">
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: right">
                                                                        <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,LiXiangRiQi%>"></asp:Label>                                                                    </td>
                                                                    <td style="text-align: left">
                                                                ...
                                                                <tr>
                                                                    <td style=" text-align: right;">
                                                                        <asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,XiangXiYaoQiu%>"></asp:Label>                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: right;">
                                                                        <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,YanShouBiaoZhun%>"></asp:Label>                                                                    </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:HyperLink ID="HL_RelatedDoc" runat="server" NavigateUrl="TTProRelatedDoc.aspx"
                                                                    Target="_blank" Visible="False" Text="<%$ Resources:lang,XiangGuanWenJian%>"></asp:HyperLink>
                                                            </td>
                                                            <td>
                                                                <asp:HyperLink ID="HL_RelatedReq" runat="server" NavigateUrl="TTProRelatedReqSummary.aspx"
                                                                    Target="_blank" Visible="False" Text="<%$ Resources:lang,XiangGuanXuQiu%>"></asp:HyperLink>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <asp:HyperLink ID="HL_RelatedRisk" runat="server" NavigateUrl="TTProRelatedRisk.aspx"
                                                                    Target="_blank" Visible="False" Text="<%$ Resources:lang,XiangGuanFengXian%>"></asp:HyperLink>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <asp:HyperLink ID="HL_RelatedMeeting" runat="server" NavigateUrl="TTProRelatedRisk.aspx"
                                                                    Target="_blank" Visible="False" Text="<%$ Resources:lang,XiangMuHuiYi%>"></asp:HyperLink>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:HyperLink ID="HL_ExpenseSummary" runat="server" NavigateUrl="~/TTProjectExpenseReport.aspx"
                                                                    Target="_blank" Visible="False" Text="<%$ Resources:lang,XiangMuFeiYong%>"></asp:HyperLink>
                                                            </td>
                                                            <td>
                                                                <asp:HyperLink ID="HL_TaskRecordAssignSummary" runat="server" Target="_blank" Visible="False" Text="<%$ Resources:lang,RenWuFenPaiJiLuHuiZong%>"></asp:HyperLink>
                                                            </td>
                                                            <td>
