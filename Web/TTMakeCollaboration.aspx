<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="TTMakeCollaboration.aspx.cs"
    Inherits="TTMakeCollaboration" %>
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 5px 5px 5px 5px; vertical-align: top; border-right: solid 1px #D8D8D8"
                                        ...
                                        <table width="95%" cellpadding="5" cellspacing="0" class="formBgStyle">
                                            ...
                                            <tr>
                                                <td align="right" style="width: 15%; height: 21px;" class="formItemBgStyleForAlignLeft">
