<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTAssetScrapeReport.aspx.cs"
    Inherits="TTAssetScrapeReport" %>
                ...
                <ContentTemplate>
                    ...
                    <table style="width: 980px;">
                        ...
                        <tr>
                            ...
                            <td style="text-align: right;">
                                <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,BaoFeiRen%>"></asp:Label>：</td>
                            <td colspan="2">
                                ...
                                <table style="width: 100%;">
                                    <tr>
                                        <td style="width: 100%; height: 80px; font-size: xx-large; text-align: center;">
                                            <br />
                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ZiChanBaoFeiBaoBiao%>"></asp:Label>
                                            <br />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="5" style="text-align: left;">
                                            <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,BaoFeiZongShu%>"></asp:Label>：<asp:Label ID="LB_TotalNumber" runat="server"></asp:Label>
                                            &nbsp;
                                                        <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,HuiShouZongJinE%>"></asp:Label>：<asp:Label ID="LB_TotalAmount" runat="server"></asp:Label>
                                                    ...
                                                    <td>
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                ...
                                                                <td width="8%" align="left">
                                                                    <strong>
                                                                        <asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,YuanYongHu%>"></asp:Label></strong>
                                                                </td>
                                                                <td width="8%" align="left">
                                                                    <strong>
                                                                        <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,CaoZuoZhe%>"></asp:Label></strong>
                                                                </td>
                                                                <td width="8%" align="left">
                                                                    <strong>
                                                                        <asp:Label ID="Label15" runat="server" Text="<%$ Resources:lang,BaoFeiShuLiang%>"></asp:Label></strong>
                                                                </td>
                                                                <td width="8%" align="left">
                                                                    <strong>
                                                                        <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,HuiShouJinE%>"></asp:Label></strong>
                                                                </td>
                                                                <td width="12%" align="left">
                                                                    <strong>
                                                                        <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,BaoFeiYuanYin%>"></asp:Label></strong>
                                                                </td>
                                                                <td width="12%" align="left">
                                                                    <strong>
                                                                        <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,BaoFeiHouYongTu%>"></asp:Label></strong>
                                                                </td>
                                                                <td width="8%" align="left">
                                                                    <strong>
                                                                        <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,BaoFeiShiJian%>"></asp:Label></strong>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
