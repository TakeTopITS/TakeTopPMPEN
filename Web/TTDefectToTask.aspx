<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTDefectToTask.aspx.cs" Inherits="TTDefectToTask" %>
                                    ...
                                    <table style="width: 100%;" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    ...
                                                                    <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,QueXianZhuanRenWu%>"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                        ...
                                                        <td>
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                <tr>
                                                                    ...
                                                                    <td align="left" width="7%">
                                                                        <strong>
                                                                            <asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,FeiYong%>"></asp:Label></strong>
                                                                    </td>
                                                                    <td align="left" width="5%">
                                                                        <strong>
                                        ...
                                        <tr>
                                            <td style="text-align: left;">
                                                <asp:Label ID="LB_DefectRecordID" runat="server" Visible="False"></asp:Label>
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="text-align: left; overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <cc1:TabContainer CssClass="ajax_tab_menu" ID="TabContainer1" Width="100%" runat="server" ActiveTabIndex="0">
                                ...
                                <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="关联信息" TabIndex="2">
                                    <HeaderTemplate>
                                        <asp:Label ID="Label43" runat="server" Text="<%$ Resources:lang,XiangGuanYeWuDan%>"></asp:Label>
                                    </HeaderTemplate>
                                    <ContentTemplate>
                            ...
                            <table style="width: 100%;" cellpadding="3" cellspacing="0" class="bian">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" style="text-align: center">
                                        <span style="color: #0000ff;"><a href="TTDocumentTreeView.aspx?RelatedType=Defect&RelatedID=<%#DataBinder .Eval (Container .DataItem ,"DefectID")%>"
                                            target="_blank">
                                            <asp:Label ID="Label64" runat="server" Text="<%$ Resources:lang,XiangGuanWenJian%>"></asp:Label></a> &nbsp;<a href="TTDefectAssignRecord.aspx?DefectID=<%#DataBinder .Eval (Container .DataItem ,"DefectID")%>"
