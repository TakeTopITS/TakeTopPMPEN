<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTCreateOtherTask.aspx.cs" Inherits="TTCreateOtherTask" %>
                ...
                <ContentTemplate>
                                                            ...
                                                            <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    ...
                                                                    <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ChuangJianRenWu%>"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                                    ...
                                                                    <td>
                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            <tr>
                                                                               ...
                                                                               <td width="5%" align="left">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label40" runat="server" Text="<%$ Resources:lang,FenPai %>" /></strong>
                                                                                </td>
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popwindow"
                                                ...
                                                <td align="left">
                                                    <table style="width: 100%;" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-align: left" class="formItemBgStyle">
                                                                <NickLee:NumberBox MaxAmount="1000000000000" MinAmount="-1000000000000" ID="NB_RealManHour" runat="server" Enabled="False" Width="67px"
                                        ...
                                        <asp:Panel ID="Panel_RelatedBusiness" runat="server" Visible="false">
                                            <table style="width: 100%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 20%; " class="formItemBgStyle">
                                                        <asp:Label ID="Label53" runat="server" Text="<%$ Resources:lang,YunXuHouXuXiuGe%>"></asp:Label>：
                                                    </td>
                                                    <td style="text-align: left;" class="formItemBgStyle">
                        ...
                        <div id="popwindow_footer11" class="layui-layer-btn" style="border-top: 1px solid #ccc;">
                            <asp:LinkButton ID="LinkButton1" runat="server" class="layui-layer-btn notTab" OnClientClick="window.frames['IFrame_RelatedInformation'].document.getElementById('BT_SaveXMLFile').click()" OnClick="BT_New_Click" Text="<%$ Resources:lang,BaoCun%>"></asp:LinkButton><a class="layui-layer-btn notTab" onclick="return popClose();"><asp:Label ID="Label54" runat="server" Text="<%$ Resources:lang,GuanBi%>" /></a>
                        </div>
                        ...
                        <div id="popwindow_content1" class="layui-layer-content" style="overflow: auto; text-align: left; padding: 0px 5px 0px 5px;">
                            ...
                            <table cellpadding="3" cellspacing="0" style="width: 100%" class="formBgStyle">
                                ...
                                <tr>
                                    ...
                                    <td class="formItemBgStyle" style="width: 50%; text-align: left;">
                                        <asp:DropDownList ID="DL_RecordType" runat="server" DataTextField="Type" DataValueField="Type">
                                        </asp:DropDownList>
                                        <asp:Label ID="LB_ID" runat="server"></asp:Label>
                                    </td>
                                    <td style="width: 10%; " class="formItemBgStyle">&nbsp;<asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,ShouLiRen%>"></asp:Label>：</td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" align="left" class="formItemBgStyle">
                                        ...
                                        <CKEditor:CKEditorControl ID="HE_Operation" runat="server" Height="100px" Width="95%" Visible="False" />
                                        <CKEditor:CKEditorControl runat="server" ID="HT_Operation" Width="95%" Height="10px" Visible="False" />
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            ...
                                                            <td width="10%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label23" runat="server" Text="<%$ Resources:lang,KaiShiShiJian%>"></asp:Label></strong>
                                                            </td>
                                                            <td width="10%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label24" runat="server" Text="<%$ Resources:lang,JieShuShiJian%>"></asp:Label></strong>
                                                            </td>
                                                            ...
                                                            <td width="5%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label26" runat="server" Text="<%$ Resources:lang,LuXian%>"></asp:Label></strong>
                                                            </td>
                                                            <td width="7%" align="left">
                                                                <strong>
                                            ...
                                            <tr>
                                                <td colspan="5" style="text-align: left; height: 4px;" class="formItemBgStyle">
                                                    ...
                                                    &nbsp;&nbsp;<asp:HyperLink ID="HL_AssignRecord" runat="server" Enabled="False" NavigateUrl="TTTaskAssignRecord.aspx"
                                                        Target="_blank">
                                                        <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,FenPaiJiLu%>"></asp:Label>
                                                    </asp:HyperLink>

                                                    &nbsp; &nbsp;
                                                    <asp:HyperLink ID="HL_ActorGroup" runat="server" Enabled="False"
                                                        NavigateUrl="~/TTProjectRelatedActorGroup.aspx" Target="_blank">
                                                        <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,JueSeZuSheZhi%>"></asp:Label>
                                                    </asp:HyperLink>

                                                    &nbsp; &nbsp;
                                                       <asp:HyperLink ID="HL_RunTaskByWF" runat="server" Enabled="False" Target="_blank" Visible="false">---&gt;<asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,RenWuChuLiLiuChengMoShi%>"></asp:Label></asp:HyperLink>
                                                    &nbsp;&nbsp;
                                                    <asp:HyperLink ID="HL_TaskReview" runat="server" Enabled="False" Visible="false" Target="_blank">---&gt;<asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,RenWuPingShen%>"></asp:Label></asp:HyperLink>
                                                    &nbsp;&nbsp;<asp:HyperLink ID="HL_RelatedWorkFlowTemplate" runat="server" Enabled="False"
                                                        ...
                                                        <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,GuanLianGongZuoLiuMuBan%>"></asp:Label>
                                                    </asp:HyperLink>
                                                    &nbsp;&nbsp;
