<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTMyInvolvedProjectTree.aspx.cs"
    Inherits="TTMyInvolvedProjectTree" %>
                                            ...
                                            <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,XiangMuShuLiuLan%>"></asp:Label>
                                                    </td>
                                                    <td width="5">
                        ...
                        <tr>
                            <td valign="top">
                                <table style="width: 100%;" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="300" valign="top" style="padding: 5px 5px 5px 5px; border-right: solid 1px #D8D8D8"
                                            align="left">
                                            <asp:TreeView ID="TreeView1" runat="server" NodeWrap="True" OnSelectedNodeChanged="TreeView1_SelectedNodeChanged"
                                                ShowLines="True" Width="300">
                                        ...
                                        <td style="vertical-align: top; width: 98%; height: 1px">
                                            <table cellpadding="5" cellspacing="5" width="100%">
                                                <tr>
                                                    <td align="left" style="padding-left: 32px; padding-top: 5px;">
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        <asp:DataList ID="DataList1" runat="server" Width="95%" CellPadding="0" ForeColor="#333333">
                                                ...
                                                <tr>
                                                    <td align="left" style="padding: 5px 0px 0px 35px">
                                                        <asp:Label ID="LB_DailyWork" runat="server" Font-Bold="False" Text="<%$ Resources:lang,XiangMuWanChengQingKuang%>" Visible="False"></asp:Label><br />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <table width="90%" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:HyperLink ID="HL_RelatedDoc" runat="server" NavigateUrl="TTDocumentTreeView.aspx"
                                                                        Target="_blank" Visible="False">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:HyperLink ID="HL_LeadReview" runat="server" NavigateUrl="TTLeadReviewSummary.aspx"
                                                                        Target="_blank" Visible="False">
                                                                        <asp:Label ID="Label25" runat="server" Text="<%$ Resources:lang,ShangJiPingHeHuiZong%>"></asp:Label></asp:HyperLink>
                                                                </td>
                                                                <td>
                                                                    <asp:HyperLink ID="HL_TransferProject" runat="server" NavigateUrl="~/TTTransferProjectRecord.aspx"
                                                                        Target="_blank" Visible="False">
                                                                        <asp:Label ID="Label26" runat="server" Text="<%$ Resources:lang,XiangMuJingLiBianGengJiLu%>"></asp:Label></asp:HyperLink>
                                                                </td>
                                                                <td>
                                                                    <asp:HyperLink ID="HL_CustomerInfo" runat="server" Font-Size="10pt" NavigateUrl="~/TTCustomerInfo.aspx"
                                                                        Target="_blank" Visible="False">
                                                                        <asp:Label ID="Label27" runat="server" Text="<%$ Resources:lang,KeHuZiLiao%>"></asp:Label></asp:HyperLink>
                                                                </td>
                                                                <td>
                                                                    <asp:HyperLink ID="HL_VendorInfo" runat="server" Font-Size="10pt" NavigateUrl="~/TTVendorInfo.aspx"
                                                                        Target="_blank" Visible="False">
                                                                        <asp:Label ID="Label28" runat="server" Text="<%$ Resources:lang,GongYingShangZiLiao%>"></asp:Label></asp:HyperLink>
                                                                </td>
                                                                <td>&nbsp;
                                                                </td>
                                                                <td></td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:DataList ID="DataList2" runat="server" CellPadding="0" Width="95%" ForeColor="#333333">
                                                            <SelectedItemStyle BackColor="#D1DDF1" Font-Bold="True" ForeColor="#333333" />
                                                            <HeaderStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                                            <ItemTemplate>
                                                                <table style="width: 100%;" cellpadding="4" cellspacing="0" class="bian">
                                                                    <tr>
                                                                        <td style="width: 10%; height: 20px; text-align: right">
                                                                            <asp:Label ID="Label29" runat="server" Text="<%$ Resources:lang,ChengYuan%>"></asp:Label>:
                                                                        </td>
                                                                        <td style="width: 20%; height: 20px;" align="left">
                                                                            <span style="font-size: 9pt"></span>
                                                                            <%#DataBinder .Eval (Container .DataItem ,"UserName") %>
                                                                        </td>
                                                                        <td style="width: 10%; height: 20px; text-align: left">
                                                                            <asp:Label ID="Label30" runat="server" Text="<%$ Resources:lang,RiQi%>"></asp:Label>:
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td style="height: 20px; text-align: right">
                                                                            <asp:Label ID="Label31" runat="server" Text="<%$ Resources:lang,FeiYong%>"></asp:Label>:
                                                                        </td>
                                                                        <td style="height: 20px;" align="left">
                                                                            <%#DataBinder .Eval (Container .DataItem ,"Charge") %>
                                                                        </td>
                                                                        <td style="height: 20px; text-align: left">
                                                                            <asp:Label ID="Label32" runat="server" Text="<%$ Resources:lang,WanChengBaiFenBi%>"></asp:Label>:
                                                                        </td>
                                                                        <td align="left">
                                                                    ...
                                                                    <tr>
                                                                        <td style="text-align: right">
                                                                            <asp:Label ID="Label33" runat="server" Text="<%$ Resources:lang,MeiRiZongJie%>"></asp:Label>:
                                                                        </td>
                                                                        <td colspan="3" style="width: 560px; text-align: left">
