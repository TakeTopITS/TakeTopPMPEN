                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,BianJiCiXuDaiMa%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                                ...
                                                <table style="width: 80%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                    <tr>
                                                        <td style="text-align: right" class="formItemBgStyle">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,DaiHao%>"></asp:Label>£º
                                                        </td>
                                                        <td style="text-align: left" class="formItemBgStyle">
                                                            <asp:TextBox ID="TXT_Code" runat="server"></asp:TextBox>
                                                        </td>
                                                        <td style="text-align: right" class="formItemBgStyle">
                                                            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,ShuoMing%>"></asp:Label>£º
                                                        </td>
                                                        <td style="text-align: left" class="formItemBgStyle">
                                                    ...
                                                    <tr>
                                                        <td style="text-align: right" class="formItemBgStyle">
                                                            <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,BeiZhu%>"></asp:Label>£º
                                                        </td>
                                                    ...
                                                    <input type="button" value="·µ»Ø" id="BT_Return" class="inpu" onclick="window.location.href = 'TTGDOrderCodeList.aspx'" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
