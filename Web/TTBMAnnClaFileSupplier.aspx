<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTBMAnnClaFileSupplier.aspx.cs" Inherits="TTBMAnnClaFileSupplier" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,QiaoBiaoChengQingXinXiHuiHan%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                            ...
                            <tr>
                                <td align="center" style="padding-top: 5px;">
                                    ...
                                    <table cellpadding="2" cellspacing="0" class="formBgStyle" width="75%">
                                        <tr>
                                            <td align="center">
                                                <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,HuiHanXinXi%>"></asp:Label>：<asp:TextBox ID="TextBox1" runat="server" Width="120px"></asp:TextBox>

                                                <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,HuiHanRiQi%>"></asp:Label>：<asp:TextBox ID="TextBox3" runat="server" Width="100px" ReadOnly="false"></asp:TextBox>
                                                <cc1:CalendarExtender ID="CalendarExtender5" runat="server" Format="yyyy-MM-dd" TargetControlID="TextBox3">
                                                </cc1:CalendarExtender>
                                                <asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,Zhi%>"></asp:Label><asp:TextBox ID="TextBox4" runat="server" Width="100px" ReadOnly="false"></asp:TextBox>
                                    ...
                                    <table cellpadding="2" cellspacing="0" class="formBgStyle" width="100%">
                                        <tr>
                                            <td   class="formItemBgStyleForAlignLeft">&nbsp;&nbsp;&nbsp;
                                                <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,TouBiaoHuiHanXinXiLieBiao%>"></asp:Label>：</td>
                                        </tr>
                                        <tr>
                                            <td class="formItemBgStyleForAlignLeft">
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td width="20%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,ZhaoBiaoYaoQingHan%>"></asp:Label></strong>
                                                                    </td>
                                                                    <td width="25%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,ChengQingNeiRong%>"></asp:Label></strong>
                                                                    </td>
                                                                    <td width="15%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,HuiHanShiJian%>"></asp:Label></strong>
                                                                    </td>
                                                                    <td width="30%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,HuiHanNeiRong%>"></asp:Label></strong>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                ...
                                                <asp:DataGrid ID="DataGrid2" runat="server" AutoGenerateColumns="False" Height="1px"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="招标公告/邀请函名称">
                                                            <ItemTemplate>
                                                                <%# GetBMAnnInvitationByPlanName(Eval("AnnClaFileID").ToString()) %>
                                                            </ItemTemplate>
                            ...
                            <table cellpadding="2" cellspacing="0" class="formBgStyle" width="900px">
                                ...
                                <tr style="color: #000000">
                                    <td class="formItemBgStyleForAlignLeft" style="width: 150px; height: 30px">
                                        <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,ChengQingNeiRong%>"></asp:Label>： </td>
                                ...
                                <tr style="color: #000000">
                                    <td class="formItemBgStyleForAlignLeft" style="width: 150px; height: 30px">
                                        <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,HuiHanNeiRong%>"></asp:Label>：</td>
                                ...
                                <tr>
                                    ...
                                    <td class="formItemBgStyleForAlignLeft">
                                        <asp:Button ID="BT_Update" runat="server" OnClick="BT_Update_Click" CssClass="inpu"
                                            Text="<%$ Resources:lang,HuiHan%>" Enabled="False" />
                                    </td>
                                    <td class="formItemBgStyleForAlignLeft"></td>
                                    <td class="formItemBgStyleForAlignLeft"></td>
                                </tr>
                            </table>
                            <asp:TextBox ID="TB_ID" runat="server" CssClass="shuru" Enabled="False" Visible="False"></asp:TextBox>
