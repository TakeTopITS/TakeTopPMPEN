<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTMyCreatedProjectTreeByType.aspx.cs" Inherits="TTMyCreatedProjectTreeByType" %>
                ...
                <tr>
                    <td>
                        <table width="100%" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="230" style="padding: 5px 5px 0px 5px; border-right: solid 1px #D8D8D8" valign="top"
                                    align="left">
                                    <asp:TreeView ID="TreeView1" runat="server" OnSelectedNodeChanged="TreeView1_SelectedNodeChanged"
                                        ShowLines="True" Width="230" NodeWrap="True">
