<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTDIYChildWorkFlowForm.aspx.cs" Inherits="TTDIYChildWorkFlowForm" %>
    ...
    <center>
        ...
        <form id="form1" runat="server">
            <div style="z-index: -2;">
                                        ...
                                        <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                    <asp:Label ID="LB_WFType" runat="server"></asp:Label>
                                                </td>
                                                <td width="5">
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td colspan="2" class="tdRight" style="width: 320px;" align="left">
                                              <asp:TextBox ID="TB_WLDescription" runat="server" Font-Size="10pt"      Width="99%" ></asp:TextBox>
                                        </td>
                                        <td class="tdLeft" align="right"></td>
                                        <td colspan="2" class="tdRight" align="left" style="cursor:pointer; background-color:forestgreen;color:white;">

                                            <asp:Label ID="LB_SubmitCheck" runat="server" Text="<%$ Resources:lang,TJZGZLQCL%>"  onclick="autoClickActiveButton();"></asp:Label>
                ...
                <asp:Label ID="LB_XSNFile" runat="server" Visible="false" Font-Size="11pt"></asp:Label>
                ...
                <tr>
                    <td id="td_WFMain" width="370" style="padding: 5px 5px 5px 5px; vertical-align: top;">
                        <table width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <table style="width: 370px;" cellpadding="3" cellspacing="0">
                                        <tr style="display: none;">
                                            <td colspan="3" class="tdRight" style="text-align: center; width: 370px;">
                                                ...
                                                &nbsp;&nbsp; 
                                                              <asp:HyperLink ID="HL_RedirectToMyWFDetail" runat="server" Target="_blank" Font-Size="10pt" Text="<%$ Resources:lang,ZhiXingJinDu%>"></asp:HyperLink>

                                            </td>
                                            <td class="tdLeft" align="right">&nbsp;</td>
                                            <td colspan="2" class="tdRight" align="left">
                                                <asp:HyperLink ID="HL_RelatedDoc" runat="server" Enabled="False" Font-Size="10pt" Text="<%$ Resources:lang,XiangGuanWenDang%>"
                                        ...
                                        <tr style="display: none;">
                                            <td colspan="3" class="tdRight" style="text-align: center; padding: 2px 0px 2px 5px; border-bottom: solid 1px  #D8D8D8; width: 370px;">
                                                ...
                                                <asp:HyperLink ID="HL_WLTem" runat="server" NavigateUrl="~/TTWorkFlowTemplate.aspx" Text="<%$ Resources:lang,MuBanWeiHu%>" Target="_blank" Font-Names="宋体" Font-Size="10pt" />
                            ...
                            <tr>
                                <td class="tdRight" align="center" style="padding: 20px 1px 1px 1px;" onmousemove="document.getElementById('DL_WorkFlow').style.width = '500px'" onmouseout="document.getElementById('DL_WorkFlow').style.width = '370px'">
                                    <asp:DropDownList ID="DL_WorkFlow" runat="server" AutoPostBack="True" Width="370px" Height="350px"
