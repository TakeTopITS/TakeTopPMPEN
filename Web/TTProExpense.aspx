                                ...
                                <td style="text-align: left; padding: 5px 5px 5px 5px;" valign="top" align="left">
                                    ...
                                    <asp:DataGrid ID="DataGrid3" runat="server" AutoGenerateColumns="False" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundColumn DataField="ExpenseName" HeaderText="<%$ Resources:lang,FeiYongMingCheng%>">
                    ...
                    <asp:Panel ID="Panel1" runat="server" CssClass="modalPopup" Style="display: none;"
                        ...
                        <div>
                            <table>
                                ...
                                <tr>
                                    <td style="width: 420px; padding: 5px 5px 5px 5px;" valign="top" align="left">
                                        <asp:Button ID="BT_ActiveYes" runat="server" CssClass="inpu" Text="YES" OnClick="BT_ActiveYes_Click" /><asp:Button
                                            ID="BT_ActiveNo" runat="server" CssClass="inpu" Text="NO" OnClick="BT_ActiveNo_Click" />
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popClaimWindow"
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table style="width: 700px;" cellpadding="3" cellspacing="0" class="formBgStyle">
                                ...
                                <tr>
                                    <td style="width: 100px; height: 30px" class="formItemBgStyleForAlignLeft">
                                        <asp:Label ID="LB_tbPurpose" runat="server" Text="<%$ Resources:lang,Purpose%>"></asp:Label>
                                    </td>
                                    <td style="width: 550px; height: 30px" class="formItemBgStyleForAlignLeft">
                                        <asp:TextBox ID="TB_Purpose" runat="server" Height="69px" TextMode="MultiLine" Width="501px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 100px; height: 6px" class="formItemBgStyleForAlignLeft">
                                        <asp:Label ID="LB_tbStatus" runat="server" Text="<%$ Resources:lang,Status%>"></asp:Label>
                                    </td>
                                    <td style="width: 550px; height: 6px" class="formItemBgStyleForAlignLeft">
                        ...
                        <div id="popwindow_content1" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td align="left" style="height: 22px; text-align: left;"><strong>
                                ...
                                <tr>
                                    ...
                                    <td align="left" style="width: 100%; height: 22px; text-align: left;">
