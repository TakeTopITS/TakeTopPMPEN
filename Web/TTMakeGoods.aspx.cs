...
public partial class TTMakeGoods : System.Web.UI.Page
{
    ...
    protected void AddDetail()
    {
        ...
        string strCIOID, strOwnerCode, strType, strGoodsCode, strGoodsName, strSN, strModelNumber, strSpec, strManufacturer, strPosition, strWHPosition, strMemo;
        ...
        strWHPosition = DL_WHPosition.SelectedValue.Trim();
        ...
        if (strSourceType == "GoodsPJRecord")
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click2333", "alert('" +LanguageHandle.GetWord("ZZDiShiRuKuLiangChaoChuXuQiuLi").ToString().Trim()+"')", true);
            }
        }
