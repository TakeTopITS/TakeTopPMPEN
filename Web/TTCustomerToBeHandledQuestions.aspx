<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTCustomerToBeHandledQuestions.aspx.cs" Inherits="TTCustomerToBeHandledQuestions" %>
...
<body>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" style="padding-top: 1px; padding-bottom: 1px; padding-right: 8px;">
                                                <asp:Button ID="BT_AllQuestion" runat="server" CssClass="inpuLong" OnClick="BT_AllQuestion_Click"
                                                    Text="<%$ Resources:lang,SuoYouDaiFenPaiKeHuWenTi%>" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                                ...
                                                <table style="width: 100%; height: 1px">
                                                    <tr>
                                                        <td style="text-align: left;">
                                                            <asp:Label ID="Label122342" runat="server" Text="<%$ Resources:lang,DaiFenPaiDeKeHuFuWu%>"></asp:Label>：
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 100%; padding: 5px 5px 5px 5px;">
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                ...
                                                                                <td width="16%" align="left">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,FuWuXuQiu%>"></asp:Label></strong>
                                                                                </td>
                                                                                <td width="8%" align="left">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,YaoQiuDaFuShiJian%>"></asp:Label></strong>
                                                                                </td>

                                                                                 <td align="left" width="5%"><strong>
                                                                                    <asp:Label ID="Label23" runat="server" Text="<%$ Resources:lang,JieDuan%>"></asp:Label>
                                                                                </strong></td>

                                                                                <td align="left" width="5%"><strong>
                                                                                    <asp:Label ID="Label24" runat="server" ext="<%$ Resources:lang,YingLu%>"></asp:Label>
                                                                                </strong></td>

                                                                                <td width="11%" align="left">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,TiJiaoShiJian%>"></asp:Label></strong>
                                                                                </td>
                                                                                <td width="8%" align="left">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,TiChuZhe%>"></asp:Label></strong>
                                                                                </td>
                                                            ...
                                                            <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundColumn DataField="Stage" HeaderText="<%$ Resources:lang,JieDuan%>">
                                                                        <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="5%" />
                                                                    </asp:BoundColumn>
                                                                    <asp:TemplateColumn>
                                                                        <ItemTemplate>
    ...
    <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="5%" />
                                                    ...
                                                    <tr>
                                                        <td style="text-align: left;">
                                                            <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,ZJCYCLZDKHFW%>"></asp:Label>：
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 100%; padding: 5px 5px 5px 5px;">
                                                                    ...
                                                                    <td>
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                ...
                                                                                <td width="16%" align="left">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label15" runat="server" Text="<%$ Resources:lang,FuWuXuQiu%>"></asp:Label></strong>
                                                                                </td>
                                                                                <td width="8%" align="left">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,YaoQiuDaFuShiJian%>"></asp:Label></strong>
                                                                                </td>

                                                                                 <td align="left" width="5%"><strong>
                                                                                    <asp:Label ID="Label25" runat="server" Text="<%$ Resources:lang,JieDuan%>"></asp:Label>
                                                                                </strong></td>

                                                                                <td align="left" width="5%"><strong>
                                                                                    <asp:Label ID="Label26" runat="server" ext="<%$ Resources:lang,YingLu%>"></asp:Label>
                                                                                </strong></td>

                                                                                <td width="11%" align="left">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,TiJiaoShiJian%>"></asp:Label></strong>
                                                                                </td>
                                                                                <td width="8%" align="left">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,TiChuZhe%>"></asp:Label></strong>
                                                                                </td>
                                                                                <td width="14%" align="left">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,GongSi%>"></asp:Label></strong>
                                                                                </td>
                                                                                <td width="7%" align="left">
                                                                                    <strong>
