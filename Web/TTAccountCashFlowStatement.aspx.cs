...
public partial class TTAccountCashFlowStatement : System.Web.UI.Page
{
    string strUserCode;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Label1.Text = ShareClass.GetPageTitle(this.GetType().BaseType.Name + ".aspx"); bool blVisible = TakeTopSecurity.TakeTopLicense.GetAuthobility(this.GetType().BaseType.Name + ".aspx", strUserCode);  //Label1.Text = ShareClass.GetPageTitle(this.GetType().BaseType.Name + ".aspx"); bool blVisible = TakeTopSecurity.TakeTopLicense.GetAuthobility(this.GetType().BaseType.Name + ".aspx","现金流量表", strUserCode);
        if (blVisible == false)
        {
    ...
    protected void LoadAccountFinancialSet()
    {
        ...
        DL_Financial.Items.Insert(0, new ListItem("--Select--", "0"));
    }
    ...
    protected void BT_Query_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "alert('"+LanguageHandle.GetWord("ZZTSCWZTJCWJWBXJC")+"')", true);
            DL_Financial.Focus();
            DL_Interval.Focus();
            return;
        }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            ...
            {
                Random a = new Random();
                string fileName = LanguageHandle.GetWord("XianJinLiuLiangBiao") + DateTime.Now.ToString("yyyy-MM-dd-HH-mm-ss") + "-" + a.Next(100, 999) + ".xls";
