                ...
                <ContentTemplate>
                    ...
                    <table cellpadding="3" cellspacing="0" class="formBgStyle" style="width: 1200px;">
                        <tr>
                            ...
                            <td style="text-align: right;" class="formItemBgStyle">
                                <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,JiaFangFuZeRen%>"></asp:Label>：
                        ...
                        <tr>
                            <td style="text-align: right;" class="formItemBgStyle">
                                <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,YingShouKaiShiShiJian%>"></asp:Label>：
                            </td>
                            <td align="left" class="formItemBgStyle">
                            ...
                            <td style="text-align: right;" class="formItemBgStyle">
                                <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,YingShouJieShuShiJian%>"></asp:Label>：
                            </td>
                            <td align="left" class="formItemBgStyle">
                    ...
                    <table width="1200px" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td style="width: 1000px; text-align: left;">
                                <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,YingShouZongE%>"></asp:Label>：<asp:Label ID="LB_ReceivablesAmount" runat="server"></asp:Label>
                                &nbsp;
                                <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,ShiShouZongE%>"></asp:Label>：<asp:Label ID="LB_ReceiverAmount" runat="server"></asp:Label>
                            ...
                            <td>
                                <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" ShowHeader="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="ReceivablesTime" DataFormatString="{0:yyyy/MM/dd}" HeaderText="应收时间">
                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="Center" Width="8%" />
                                        </asp:BoundColumn>
