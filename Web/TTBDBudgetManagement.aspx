                                                ...
                                                <table width="85%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                    <tr>
                                                        <td class="formItemBgStyle" style="text-align: center;">
                                                            ...
                                                            <asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,KeMu%>"></asp:Label>：
                                                            <asp:TextBox ID="txt_AccountName" runat="server" Width="100px"></asp:TextBox>
                                                            <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,NianFen%>"></asp:Label>：
                                                            ...
                                                            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,YueFen%>"></asp:Label>：
                                                ...
                                                <table background="ImagesSkin/main_n_bj.jpg" border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td align="left" class="page_topbj">&nbsp;
                                                            <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,YuSuanFeiYongBiaoZhun%>"></asp:Label>： </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                ...
                                                <table align="center" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td align="left" class="page_topbj" colspan="6">&nbsp;&nbsp;&nbsp;<asp:Label ID="lbl_BudgetID" runat="server"></asp:Label>
                                                            &nbsp;<asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,YuSuanFeiYongJiLu%>"></asp:Label>：
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="6">
