...
public partial class TTMakeConstract : System.Web.UI.Page
{
...
TB_Exception.Language = Session["LangCode"].ToString();
    ...
    protected void BT_Import_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (strWordFile != "")
            {
                ...
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "alert('" + LanguageHandle.GetWord("ZZDRCG") + "')", true);
            }
            else
            {
    ...
    protected void LoadUsingConstract(string strUserCode)
    {
        ...
        strHQL = "from Constract as constract where constract.RecorderCode = " + "'" + strUserCode + "'" + " and constract.Status not in ('Archived','Deleted')  order by constract.SignDate DESC,constract.ConstractCode DESC";
    ...
    protected void LoadDeletedConstract(string strUserCode)
    {
        ...
        strHQL = "from Constract as constract where constract.RecorderCode = " + "'" + strUserCode + "'" + " and constract.Status = 'Deleted' order by constract.SignDate DESC,constract.ConstractCode DESC";
