                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ChaKanSuoYouWenDang%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                            ...
                            <tr>
                                <td>
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td width="240px" valign="top" style="padding: 5px 5px 0px 5px; border-right: solid 1px #D8D8D8">
                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td style="width: 240px; text-align: left;">
                                                            <asp:TreeView ID="TreeView1" runat="server" NodeWrap="True" OnSelectedNodeChanged="TreeView1_SelectedNodeChanged"
                                                                Width="240px" ShowLines="True" Font-Size="10pt" Font-Bold="False" Font-Names="宋体">
                                                    ...
                                                    <tr>
                                                        <td style="width: 240px; height: 19px; text-align: left">
                                                            <asp:Label ID="LB_FindCondition" runat="server" Font-Bold="False" Font-Size="9pt"
                                                    ...
                                                    <tr>
                                                        <td style="width: 240px; text-align: left;">
                                                            <span style="font-size: 10pt">
                                                                <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,JieHaoDian%>"></asp:Label>：</span><asp:Label ID="LB_DocTypeID" runat="server"
                                                                    Width="39px" Font-Size="10pt">0</asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 240px; height: 14px; text-align: left; background: Buttonface;"></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 240px; height: 13px;" align="left">

                                                            <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,LeiXing%>"></asp:Label>：</span><asp:TextBox ID="TB_DocType" runat="server"
                                                    ...
                                                    <tr>
                                                        <td style="width: 240px; text-align: left;">
                                                            ...
                                                            <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,QuanXian%>"></asp:Label>：</span><asp:DropDownList ID="DL_Authority" DataTextField="HomeName"
                                                    ...
                                                    <tr>
                                                        <td style="width: 240px; text-align: left;">
                                                            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,ShunXu%>"></asp:Label>：<NickLee:NumberBox MaxAmount="1000000000000" MinAmount="-1000000000000" ID="NB_DocTypeSort" runat="server" Width="40px" Precision="0">00</NickLee:NumberBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td style="width: 240px; text-align: left;">
                                                            <span style="font-size: 8pt;">
                                                                <asp:Label ID="Label15" runat="server" Text="<%$ Resources:lang,ZhiYouDiYiCengJieDianQuanXianSheWeiGongGongQiTaRenCaiKeYiKanDaoQingBuYaoChongFuHeSuiBianSheZhiJieDian%>"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 240px; height: 14px; text-align: left; background: Buttonface;"></td>
                                            ...
                                            <td valign="top" style="text-align: left; padding-left: 10px">
                                                <table style="width: 99%; height: 12px; margin-top: 5px">
                                                    <tr>
                                                        <td style="background: #F0F0F0; width: 100%;" align="left">
                                                            <table style="width: 98%; height: 12px;">
                                                                <tr>
                                                                    <td style="background: #F0F0F0; width: 600px; text-align: left;">
                                                                        <table>
                                                                            <tr>
                                                                                <td>
                                                                                    <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,ZongHeChaXunWenJianMing%>"></asp:Label>：</td>
                                                                                <td>
                                                                                    <asp:TextBox ID="TB_DocName" runat="server" Width="132px"></asp:TextBox></td>
                                                                                <td>&nbsp;
                                                                                <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,ShangChuanZheXingMing%>"></asp:Label>：</td>
                                                                                <td>
                                                                                    <asp:TextBox ID="TB_UploadManName" runat="server" Width="64px"></asp:TextBox></td>
                                                                                <td>
                                                                                    <asp:Button ID="BT_Find" runat="server" OnClick="BT_Find_Click"
                                                                                        CssClass="inpu" Text="<%$ Resources:lang,ChaXun%>" /></td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                    <td style="background: #F0F0F0; width: 200px; text-align: right;">
                                                                        <asp:HyperLink ID="HyperLink1" runat="server" Font-Names="宋体" Font-Size="10pt" NavigateUrl="TTUploadDoc.aspx"
                                                                            Target="_blank">
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                ...
                                                                                <td width="8%" align="center">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,FuLei%>"></asp:Label></strong>
                                                                                </td>
                                                                                <td width="10%" align="center">
                                                                                    <strong>
                                                                                ...
                                                                                <td width="10%" align="center">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,BuMen%>"></asp:Label></strong>
                                                                                </td>
                                                                                <td width="10%" align="center">
                                                                                    <strong>
                                                            ...
                                                            <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                                ShowHeader="false" GridLines="None" Height="1px" OnPageIndexChanged="DataGrid1_PageIndexChanged"
                                                                PageSize="37" Width="100%" CellPadding="4" ForeColor="#333333">
                                                                <Columns>
