<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTMakeReqThirdPart.aspx.cs"
    Inherits="TTMakeReqThirdPart" %>
                ...
                <ContentTemplate>
                    <table cellpadding="0" cellspacing="0" width="100%" class="bian">
                        ...
                        <tr style="display: none;">
                            <td>
                                <asp:HyperLink ID="HL_RunReqByWF" runat="server" Enabled="False" Target="_blank" Visible="false">---&gt;<asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,XuQiuChuLiLiuChengMoShi%>"></asp:Label></asp:HyperLink>
                                &nbsp;
                                                                <asp:HyperLink ID="HL_ReqReview" runat="server" Enabled="False" Visible="false" Target="_blank">---&gt;<asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,XuQiuPingShen%>"></asp:Label></asp:HyperLink>
                                &nbsp;
