<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTMakeAssetPurchase.aspx.cs"
    Inherits="TTMakeAssetPurchase" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ZiChanCaiGouShenQing%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td width="10%" align="left">
                                                            <strong>
                                                                <asp:Label ID="Label97" runat="server" Text="<%$ Resources:lang,FaQiShengQing%>" /></strong>
                                                        </td>
                                    ...
                                    <asp:DataGrid ID="DataGrid5" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <%--  <asp:TemplateColumn HeaderText="收付款">
                                                            ...
                                                            <ItemTemplate>
                                                                <a href='TTReceivablesPayableDetailView.aspx?RelatedID=<%# DataBinder.Eval(Container.DataItem,"POID") %>&RelatedType=AssetPO' target="_blank">
                                            ...
                                            <asp:TemplateColumn HeaderText="打印">
                                                <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="5%" />
                                                <ItemTemplate>
                                                    <a href='TTAssetPurchaseOrderView.aspx?POID=<%# DataBinder.Eval(Container.DataItem,"POID") %>' target="_blank">
                                                                                    ...
                                                                                    <td>
                                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                            <tr>
                                                                                                ...
                                                                                                <td width="10%" align="left">
                                                                                                    <strong>
                                                                                                        <asp:Label ID="Label90" runat="server" Text="<%$ Resources:lang,XingHao %>"></asp:Label></strong>
                                                                                                </td>
                                                                                                <td width="15%" align="left">
                                                                                                    <strong>
                                                                                                        <asp:Label ID="Label91" runat="server" Text="<%$ Resources:lang,GuiGe %>"></asp:Label></strong>
                                                                                                </td>
                                                                                                <td align="left" width="8%"><strong>
                                                        ...
                                                        <cc1:TabPanel ID="TabPanel3" runat="server" HeaderText="关联合同">
                                                            ...
                                                            <ContentTemplate>
                                                                <table align="left" cellpadding="0" cellspacing="0" width="98%">
                                                                    <tr>
                                                                        <td align="left">
                                                                            <asp:Label ID="Label2424231" runat="server" Font-Bold="True" Width="100%"></asp:Label></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                                        ...
                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                            <tr>
                                                                                                <td width="7%" align="left"><strong>
                                                                                                    <asp:Label ID="Label61" runat="server" Text="<%$ Resources:lang,HeTongDaiMa%>"></asp:Label></strong> </td>
                                                                                                <td width="17%" align="left"><strong>
                                                                                                    <asp:Label ID="Label62" runat="server" Text="<%$ Resources:lang,HeTongMingCheng%>"></asp:Label></strong> </td>
                                ...
                                <tr>
                                    <td width="50%" style="padding-top: 5px;">
                                        ...
                                        <table align="left" cellpadding="3" cellspacing="0" class="formBgStyle" width="99%">
                                            ...
                                            <tr>
                                                <td class="formItemBgStyleForAlignLeft" style="width: 15%; ">
                                                    <asp:Label ID="Label34" runat="server" Text="<%$ Resources:lang,ShenQingRen %>"></asp:Label>： </td>
                                                <td class="formItemBgStyleForAlignLeft" colspan="2"  >
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <asp:TextBox ID="TB_ApplicantCode" runat="server" Width="80px" Enabled="false"></asp:TextBox></td>
                                                            <td>
                                            ...
                                            <tr>
                                                <td class="formItemBgStyleForAlignLeft">
                                                    <asp:Label ID="Label36" runat="server" Text="<%$ Resources:lang,DaiMa %>"></asp:Label>： </td>
                                                <td class="formItemBgStyleForAlignLeft">
                                                    <asp:TextBox ID="TB_AssetCode" runat="server" Width="80px"></asp:TextBox></td>
                                                <td class="formItemBgStyleForAlignLeft">
                                            ...
                                            <tr>
                                                <td class="formItemBgStyleForAlignLeft">
                                                    <asp:Label ID="Label38" runat="server" Text="<%$ Resources:lang,XingHao %>"></asp:Label>：</td>
                                            ...
                                            <tr>
                                                <td class="formItemBgStyleForAlignLeft">
                                                    <asp:Label ID="Label40" runat="server" Text="<%$ Resources:lang,GouMaiLiYou %>"></asp:Label>： </td>
                                            ...
                                            <tr>
                                                <td class="formItemBgStyleForAlignLeft">
                                                    <asp:Label ID="Label44" runat="server" Text="<%$ Resources:lang,GongYingShang %>"></asp:Label>： </td>
                                                <td class="formItemBgStyleForAlignLeft" colspan="4" style="height: 18px; ">

                                                    <asp:TextBox ID="TB_Supplier" runat="server" Width="40%"></asp:TextBox>
                                                    <asp:Label ID="Label45" runat="server" Text="<%$ Resources:lang,DianHua %>"></asp:Label>：
                                                    <asp:TextBox ID="TB_SupplierPhone" runat="server" Width="20%"></asp:TextBox>
                                                    <asp:DropDownList ID="DL_VendorList" runat="server" Style="width: 100px;" AutoPostBack="True" DataTextField="VendorName" DataValueField="VendorCode" OnSelectedIndexChanged="DL_VendorList_SelectedIndexChanged"></asp:DropDownList>
                                    ...
                                    <td>
                                        ...
                                        <cc1:TabContainer CssClass="ajax_tab_menu" ID="TabContainer2" runat="server" ActiveTabIndex="0" Width="100%">
                                            ...
                                            <cc1:TabPanel ID="TabPanel5" runat="server" HeaderText="资产库存列表">
                                                <HeaderTemplate>
                                                    <asp:Label ID="Label72" runat="server" Text="<%$ Resources:lang,ZiChanKuCunLieBiao%>"></asp:Label>
                                                </HeaderTemplate>
                                                <ContentTemplate>
                                                                ...
                                                                <td>
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td width="10%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label73" runat="server" Text="<%$ Resources:lang,DaiMa%>"></asp:Label></strong>
                                                                            </td>
                                                                            ...
                                                                            <td width="10%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label75" runat="server" Text="<%$ Resources:lang,XingHao%>"></asp:Label></strong>
                                                                            </td>
                                                                            <td width="14%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label76" runat="server" Text="<%$ Resources:lang,GuiGe%>"></asp:Label></strong>
                                                                            </td>
                                                                            <td width="10%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label77" runat="server" Text="<%$ Resources:lang,LeiXing%>"></asp:Label></strong>
                                                                            </td>
                                                                            <td width="6%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label78" runat="server" Text="<%$ Resources:lang,ShuLiang%>"></asp:Label></strong>
                                                                            </td>
                                                                            <td width="6%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label79" runat="server" Text="<%$ Resources:lang,DanJia%>"></asp:Label></strong>
                                                                            </td>
                                                                            <td width="10%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label80" runat="server" Text="<%$ Resources:lang,RuKuShiJian%>"></asp:Label></strong>
                                                                            </td>
                                                                            <td width="10%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label81" runat="server" Text="<%$ Resources:lang,ChangJia%>"></asp:Label></strong>
                                                                            </td>
                                                                            <td width="10%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label82" runat="server" Text="<%$ Resources:lang,DiZhi%>"></asp:Label></strong>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                            ...
                                            <cc1:TabPanel ID="TabPanel6" runat="server" HeaderText="资产查询列表">
                                                ...
                                                <ContentTemplate>
                                                    <asp:Label ID="Label83" runat="server" Text="<%$ Resources:lang,QingXuanQuYaoCaiGouDeZiChan%>"></asp:Label>：
                                                                ...
                                                                <td>
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td width="15%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label84" runat="server" Text="<%$ Resources:lang,DaiMa%>"></asp:Label></strong>
                                                                            </td>
                                                                            ...
                                                                            <td width="10%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label86" runat="server" Text="<%$ Resources:lang,LeiXing%>"></asp:Label></strong>
                                                                            </td>
                                                                            <td width="35%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label87" runat="server" Text="<%$ Resources:lang,GuiGe%>"></asp:Label></strong>
                                                                            </td>
                                                                            <td width="20%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label88" runat="server" Text="<%$ Resources:lang,DanJia%>"></asp:Label></strong>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popAssignWindow" name="noConfirm"
                        ...
                        <div id="popwindow_content1" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table cellpadding="3" cellspacing="0" class="formBgStyle" width="100%">
                                ...
                                <tr style="font-size: 10pt">
                                    ...
                                    <td class="formItemBgStyleForAlignLeft">
                                        <asp:DropDownList ID="DL_WFType" runat="server">
                                            <asp:ListItem Value="AssetProcurement" />
                                ...
                                <tr style="font-size: 10pt">
                                    <td class="formItemBgStyleForAlignLeft"></td>
                                    <td class="formItemBgStyleForAlignLeft" style="height: 19px;">（<asp:Label ID="Label54" runat="server" Text="<%$ Resources:lang,YaoQiuShouDaoChuLiXinXi %>"></asp:Label>：<asp:CheckBox ID="CB_SMS" runat="server" Text="<%$ Resources:lang,DuanXin %>" /><asp:CheckBox
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td align="left"><strong>
                                                                <asp:Label ID="Label23" runat="server" Text="<%$ Resources:lang,BuMeRenYuan %>"></asp:Label></strong> </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td align="right" width="6">
