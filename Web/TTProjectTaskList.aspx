<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTProjectTaskList.aspx.cs" Inherits="TTProjectTaskList" %>
                                                                    ...
                                                                    <td align="left" style="width: 100%; padding: 5px 5px 5px 5px;">
                                                                        <cc2:TabContainer CssClass="ajax_tab_menu" ID="TabContainer1" runat="server" ActiveTabIndex="0" Width="100%">
                                                                            ...
                                                                            <cc2:TabPanel ID="TabPanel2" runat="server" HeaderText="已处理但没分派的任务">
                                                                                <HeaderTemplate>
                                                                                    <asp:Label ID="Label71" runat="server" Text="<%$ Resources:lang,YCLDMFPDRW%>" ToolTip="<%$ Resources:lang,YCLDMFPDRW%>"></asp:Label>
                                                                                </HeaderTemplate>
                                                                                <ContentTemplate>
