<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTProTaskRelatedDoc.aspx.cs"
    Inherits="TTProTaskRelatedDoc" %>
                        ...
                        <tr>
                            <td style="padding: 5px 0px 0px 5px; text-align: left;">
                                <cc1:TabContainer CssClass="ajax_tab_menu" ID="TabContainer1" runat="server" ActiveTabIndex="0" Width="98%">
                                                                            ...
                                                                            <table class="FullBorderTable" style="width: 100%">
                                                                                ...
                                                                                <tr>
                                                                                    <td style="width: 100%; text-align: left;">
                                                                                        <div>
                                                                                            <asp:Label ID="Label26" Text="<%$ Resources:lang,WenJianShangChuan%>" runat="server"></asp:Label>：<br />
                                                                                        ...
                                                                                        <div id="uploader" class="wu-example">
                                                                                            <div id="thelist" class="uploader-list">
                                                                                                <asp:Label ID="Label27" Text="<%$ Resources:lang,DuWenJianShangZhuan%>" runat="server"></asp:Label>：
                                                                                            </div>
                                                                                            <div id="btns" class="btns">
                                                                                                <table>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <div id="picker">
                                                                                                                <asp:Label ID="Label28" runat="server" Text="<%$ Resources:lang,XuanZeWenJian%>"></asp:Label>
                                                                                                            </div>
                                                                                                        </td>
                                                                                                        <td style="padding-top: 10px; padding-left: 20px;">
                                                                                                            <button id="ctlBtn" class="btn btn-default">
                                                                                                                <asp:Label ID="Label44" runat="server" Text="<%$ Resources:lang,ShangChuan%>"></asp:Label>
                                                                                                            </button>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </table>
                                                                        ...
                                                                        <asp:View ID="View2" runat="server">
                                                                            ...
                                                                            <table style="width: 98%" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="background-color: ButtonFace; width: 100%; text-align: left; height: 11px;" class="formItemBgStyleForAlignLeft">
                                                                                        <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,WenJianPingShenShenQing %>"></asp:Label>：<asp:Label ID="LB_DocID" runat="server"></asp:Label>
                                                                                    </td>
                                                                                </tr>
                                                                                        ...
                                                                                        <table width="100%">
                                                                                            ...
                                                                                            <tr style="font-size: 10pt">
                                                                                                ...
                                                                                                <td style="text-align: left; width: 100%;">
                                                                                                    <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,MingCheng %>"></asp:Label>：<asp:TextBox ID="TB_WLName" runat="server" Width="309px"></asp:TextBox>
                                                                                            ...
                                                                                            <tr style="font-size: 10pt">
                                                                                                ...
                                                                                                <td style="text-align: left; width: 100%; height: 51px;">
                                                                                                    <asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,ShuoMing %>"></asp:Label>：<asp:TextBox ID="TB_Description" runat="server" TextMode="MultiLine" Width="441px"
                                                                                            ...
                                                                                            <tr style="font-size: 10pt">
                                                                                                ...
                                                                                                <td style="text-align: left; width: 100%;">
                                                                                                    ...
                                                                                                    <span style="font-size: 10pt">（<asp:Label ID="Label22" runat="server" Text="<%$ Resources:lang,YaoQiuShouDaoXinXi %>"></asp:Label>：<asp:CheckBox ID="CB_RequiredMail" runat="server"
                                                                                                        Font-Size="10pt" Text="<%$ Resources:lang,YouJian %>" /><asp:CheckBox ID="CB_RequiredSMS" runat="server" Font-Size="10pt"
                                                                                                            Text="<%$ Resources:lang,DuanXin %>" />） </span>
                                                                            ...
                                                                            <table width="98%" cellpadding="0" cellspacing="0">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td align="left">
                                                                                        <asp:Label ID="Label23" runat="server" Text="<%$ Resources:lang,DuiYingPingShenJiLu %>"></asp:Label>：
                                                                                    </td>
                                                                                </tr>
                                                                                                                ...
                                                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td width="40%" align="left">
                                                                                                                            ...
                                                                                                                            <strong>
                                                                                                                                <asp:Label ID="Label25" runat="server" Text="<%$ Resources:lang,GongZuoLiu %>"></asp:Label></strong>
                                                                                                                        </td>

                                                                                                                        <td width="20%" align="left">

                                                                                                                            <strong>
                                                                                                                                <asp:Label ID="Label2996" runat="server" Text="<%$ Resources:lang,ShenQingShiJian %>"></asp:Label></strong>
                                                                                                                        </td>

                                                                                                                        <td width="20%" align="left">

                                                                                                                            <strong>
                                                                                                                                <asp:Label ID="Label2007" runat="server" Text="<%$ Resources:lang,ZhuangTai %>"></asp:Label></strong>
                                                                                                                        </td>
                                    ...
                                    <cc1:TabPanel ID="TabPanel3" runat="server" HeaderText="模板下载">
                                        <HeaderTemplate>
                                            <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,WenDangMoBan%>"></asp:Label>
                                        </HeaderTemplate>
                                        <ContentTemplate>
                                                    ...
                                                    <td style="width: 100%; height: 23px; text-align: center;">
                                                                ...
                                                                <td>
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td width="20%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label39" runat="server" Text="<%$ Resources:lang,WenJianMing %>"></asp:Label></strong>
                                                                            </td>
                                                                            <td width="9%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label40" runat="server" Text="<%$ Resources:lang,ZuoZhe %>"></asp:Label></strong>
                                                                            </td>
                                                                            <td width="9%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label41" runat="server" Text="<%$ Resources:lang,ShangChuanZhe %>"></asp:Label></strong>
                                                                            </td>
                                                                            <td width="15%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label43" runat="server" Text="<%$ Resources:lang,ShangChuanShiJian %>"></asp:Label></strong>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                        ...
                                                        <asp:DataGrid runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundColumn DataField="RelatedType" HeaderText="<%$ Resources:lang,DaLei%>">
                                                                    <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="7%" />
                                                                </asp:BoundColumn>
