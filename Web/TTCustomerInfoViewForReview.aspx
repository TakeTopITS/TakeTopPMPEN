<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTCustomerInfoViewForReview.aspx.cs" Inherits="TTCustomerInfoViewForReview" %>
...
<body>
                                                        ...
                                                        <table width="300" border="0" align="left" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                ...
                                                                <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                                    <asp:Label ID="Label30" runat="server" Text="<%$ Resources:lang,KeHuZiLiao%>"></asp:Label>
                                                                </td>
                                                                <td width="5">
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="90%">
                                                                    ...
                                                                    <table width="100%">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="width: 10%; text-align: right;" class="formItemBgStyle">
                                                                                ...
                                                                                <asp:Label ID="Label114" runat="server" Text="<%$ Resources:lang,BeiZhu %>"></asp:Label>： </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="right" class="formItemBgStyle">
                                                                                ...
                                                                                <asp:Label ID="Label125" runat="server" Text="备案状态"></asp:Label>:</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <table cellpadding="4" cellspacing="0" style="width: 100%;" class="bianTable">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="height: 20px; text-align: left" colspan="5"><%#DataBinder .Eval (Container .DataItem ,"RegistrationAddressCN") %></td>
                                                                                </tr>
                                                                    ...
                                                                    <asp:HyperLink ID="HL_RelatedContactInfor" runat="server" Enabled="False" Target="_blank" Text="<%$ Resources:lang,XiangGuanLianXiRen %>"></asp:HyperLink></td>
                                                            </tr>
                                                        </table>
                                                    </ContentTemplate>
                                                </cc2:TabPanel>
    ...
    <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="10%" />
                                                ...
                                                <cc2:TabPanel ID="TabPanel4" runat="server" HeaderText="关联项目">
                                                                    ...
                                                                    <asp:DataGrid ID="DataGrid6" runat="server" AutoGenerateColumns="False" ShowHeader="False"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:HyperLinkColumn DataNavigateUrlField="ConstractCode" DataNavigateUrlFormatString="TTConstractView.aspx?ConstractCode={0}"
                                                                                DataTextField="ConstractName" HeaderText="合同名称">
