<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTMakeGoodsPurchase.aspx.cs" Inherits="TTMakeGoodsPurchase" %>
        ...
        <form id="form1" runat="server">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,CaiGouDan%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                        ...
                                        <tr>
                                            <td width="60%" align="center">
                                                <table runat="server" id="Table_FindAll">
                                                    <tr>
                                                        <td align="left">（<asp:Label ID="Label71" runat="server" Text="<%$ Resources:lang,BianHao%>"></asp:Label>：
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>&nbsp;</td>
                                                        <td align="left">
                                                            <asp:Label ID="Label170" runat="server" Text="<%$ Resources:lang,DanHao%>"></asp:Label>：
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="TB_POCode" runat="server" Width="120px"></asp:TextBox>
                                                        </td>
                                                        <td>&nbsp;</td>
                                                        <td align="left">
                                                            <asp:Label ID="Label171" runat="server" Text="<%$ Resources:lang,GongYingShang%>"></asp:Label>：
                                                        </td>
                                                        <td>
                                            ...
                                            <td>
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td width="5%" align="center">
                                                            <strong>
                                                                <asp:Label ID="Label219" runat="server" Text="<%$ Resources:lang,ShanChu %>" /></strong>
                                                        </td>
                                                        <td width="8%" align="center">
                                                            <strong>
                                                                <asp:Label ID="Label220" runat="server" Text="<%$ Resources:lang,FaQiShengQing%>" /></strong>
                                                        </td>
                                                        ...
                                                        <td align="center" width="10%">
                                                            <strong>
                                                                <asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,CaiGouShiJian%>"></asp:Label></strong>
                                                        </td>
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        <table width="98%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                            <tr>
                                                <td class="formItemBgStyle" style="text-align: right" width="80px">
                                                ...
                                                <td class="formItemBgStyle" colspan="3" align="left">
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Button ID="BT_FindVendor" runat="server" CssClass="inpu" Text="<%$ Resources:lang,ChaXun%>" OnClick="BT_FindVendor_Click" />
                                                            </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="formItemBgStyle" colspan="3" align="left">
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <asp:TextBox ID="TB_Contacts" runat="server" Width="130px"></asp:TextBox></td>
                                                            <td align="right">
                                                                <asp:Label ID="Label46" runat="server" Text="<%$ Resources:lang,DianHua %>"></asp:Label>：</td>
                                                            <td>
                                                                <asp:TextBox ID="TB_SupplierPhone" runat="server" Width="130px"></asp:TextBox></td>
                                                            <td align="right">
                                                                <asp:Label ID="Label103" runat="server" Text="<%$ Resources:lang,ChuanZhen %>"></asp:Label>：</td>
                                                            <td>
                                                                <asp:TextBox ID="TB_FaxNumber" runat="server" Width="130px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="formItemBgStyle" style="text-align: left">
                                                    <NickLee:NumberBox ID="NB_TaxRate" runat="server" MaxAmount="1000000000000" MinAmount="-1000000000000" OnBlur="" OnFocus="" OnKeyPress="" PositiveColor="" Width="85px" Amount="0" Precision="3">0</NickLee:NumberBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="formItemBgStyle" style="text-align: right">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <NickLee:NumberBox MaxAmount="1000000000000" MinAmount="-1000000000000" ID="NB_RelatedID" runat="server" OnBlur="" OnFocus="" OnKeyPress=""
                                                                    PositiveColor="" Precision="0" Width="53px">
                                                                    0</NickLee:NumberBox>
                                                            </td>
                                                            <td>
                                                                ...
                                                                <cc1:ModalPopupExtender ID="ModalPopupExtender2" runat="server" Enabled="True"
                                                                    TargetControlID="BT_SelectConstract" PopupControlID="Panel6" CancelControlID="IMBT_CloseCS"
                                                                    BackgroundCssClass="modalBackground" Y="150">
                                                                </cc1:ModalPopupExtender>
                                                            </td>
                                                        </tr>
                                                                        ...
                                                                        <td>
                                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                <tr>
                                                                                    ...
                                                                                    <td width="5%" align="center">
                                                                                        <strong>
                                                                                            <asp:Label ID="Label81" runat="server" Text="<%$ Resources:lang,ShanChu %>" /></strong>
                                                                                    </td>
                                                                                    ...
                                                                                    <td align="center" width="6%"><strong>
                                                                                        <asp:Label ID="Label213" runat="server" Text="<%$ Resources:lang,PinPai %>"></asp:Label>
                                                                                    ...
                                                                                    <td align="center" width="5%"><strong>BOM
                                                                                    </strong></td>
                                ...
                                <tr>
                                    <td width="43%">
                                        ...
                                        <table align="center" cellpadding="3" cellspacing="0" class="formBgStyle" width="99%">
                                            <tr>
                                                <td class="formItemBgStyle" style="width: 70px; text-align: right">
                                                ...
                                                <td class="formItemBgStyle" style="width: 100px; text-align: right">ID:</td>
                                                <td class="formItemBgStyle" style="text-align: left">
                                            ...
                                            <tr>
                                                <td class="formItemBgStyle" style="text-align: right">
                                                    <asp:Label ID="Label113" runat="server" Text="<%$ Resources:lang,PinPai %>"></asp:Label>：</td>
                                                <td class="formItemBgStyle" colspan="4" style="text-align: left">
                                            ...
                                            <tr>
                                                ...
                                                <td class="formItemBgStyle" style="text-align: left">
                                                    <NickLee:NumberBox MaxAmount="1000000000000" MinAmount="-1000000000000" ID="NB_Number" runat="server" OnBlur="" OnFocus="" OnKeyPress=""
                                                        PositiveColor="" Width="80px" Precision="3">
                                            ...
                                            <tr>
                                                ...
                                                <td class="formItemBgStyle" style="text-align: left">
                                                    ...
                                                    <cc1:ModalPopupExtender ID="ModalPopupExtender1" runat="server"
                                                        Enabled="True" TargetControlID="BT_GoodsBOM" PopupControlID="Panel5"
                                    ...
                                    <td width="50%">
                                        <cc1:TabContainer ID="TabContainer2" runat="server" ActiveTabIndex="0"
                                                    ...
                                                    ：
                                                        <div id="Div1" style="width: 100%; height: 300px; overflow: auto;">
                                                            ...
                                                            <asp:DataGrid ID="DataGrid6" runat="server" AutoGenerateColumns="False" ShowHeader="False"
                                                                Height="1px" Width="200%" OnItemCommand="DataGrid6_ItemCommand" CellPadding="4"
                                                                ForeColor="#333333" GridLines="None">
                                                                <Columns>
                                                                    <asp:TemplateColumn HeaderText="代码">
                                                                        <ItemTemplate>
                                                    ...
                                                    <table style="width: 100%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                        <tr>
                                                            <td style="text-align: right;" class="formItemBgStyle">
                                                                <asp:Label ID="Label33" runat="server" Text="<%$ Resources:lang,Code%>"></asp:Label>:
                                                            </td>
                                                                    ...
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td width="5%" align="center"><strong>
                                                                                <asp:Label ID="Label2" runat="server" Text="已领料量"></asp:Label></strong></td>
                                                                            <td width="6%" align="center"><strong>
                                                                            ...
                                                                            <td width="6%" align="center">
                                                                                <strong>
                                                                                    <asp:Label ID="Label209" runat="server" Text="<%$ Resources:lang,CaiGouDanJia%>"></asp:Label></strong>
                                                                            </td>
                                                                            <td align="center" width="6%">
                                                                                <strong>
                                                                                    <asp:Label ID="Label210" runat="server" Text="<%$ Resources:lang,JinE%>"></asp:Label></strong>
                                                                            </td>
                                                                            <td>&nbsp;
                                                                            </td>
                                                                        </tr>
                                            ...
                                            <cc1:TabPanel ID="TabPanel4" runat="server" HeaderText="项目BOM" TabIndex="22">
                                                <HeaderTemplate>
                                            ...
                                            <cc1:TabPanel ID="TabPanel7" runat="server" HeaderText="采购需求计划" TabIndex="3">
                                                ...
                                                <ContentTemplate>
                                                    ...
                                                    <div id="DivID2" style="width: 100%; height: 300px; overflow: auto; text-align: left;">
                                                        <table width="100%">
                                                            <tr>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <asp:Button ID="BT_Find" runat="server" CssClass="inpu" Text="<%$ Resources:lang,ChaXun %>" OnClick="BT_Find_Click" /></td>
                                                            </tr>
                                                        </table>
                                                        <table width="200%" border="0" cellpadding="0" cellspacing="0" background="ImagesSkin/main_n_bj.jpg">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td width="10%" align="center"><strong>
                                                                                <asp:Label ID="Label216" runat="server" Text="<%$ Resources:lang,PinPai %>"></asp:Label></strong> </td>
                                                        ...
                                                        <asp:DataGrid ID="DataGrid8" runat="server" AutoGenerateColumns="False" ShowHeader="False"
                                                            Height="1px" Width="200%" CellPadding="4" OnItemCommand="DataGrid8_ItemCommand"
                                                            ForeColor="#333333" GridLines="None">
                                                            <Columns>
                                                                <asp:BoundColumn DataField="ID" HeaderText="编号" Visible="False">
                                                                    <ItemStyle CssClass="itemBorder" HorizontalAlign="Center" />
                                            ...
                                            <cc1:TabPanel ID="TabPanel3" runat="server" HeaderText="关联合同">
                                                <HeaderTemplate>
                                                    <asp:Label ID="Label2221" runat="server" Text="<%$ Resources:lang,GuanLianHeTong%>"></asp:Label>
                                                </HeaderTemplate>
                                                <ContentTemplate>
                                                    <br />
                                                    ...
                                                    <div id="GoodsListDivID" style="width: 100%; height: 300px; overflow: auto;">
                                                        ...
                                                        <asp:DataGrid ID="DataGrid13" runat="server" AutoGenerateColumns="False" ShowHeader="False" OnItemCommand="DataGrid13_ItemCommand"
                                                            Height="1px" Width="200%" CellPadding="4" ForeColor="#333333" GridLines="None">
                                                            <Columns>
                                                            ...
                                                            <SelectedItemStyle BackColor="#D1DDF1" Font-Bold="True" ForeColor="#333333" />
                                                            <PagerStyle HorizontalAlign="Center" Mode="NumericPages" NextPageText="" PrevPageText="" CssClass="notTab" />
                                                        </asp:DataGrid><asp:Label ID="Label6" runat="server" Visible="False"></asp:Label><asp:Label ID="Label69" runat="server" Font-Bold="False" Font-Size="9pt"
                                                ...
                                                <td>
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td width="5%" align="center">
                                                                <strong>
                                                                    <asp:Label ID="Label86" runat="server" Text="<%$ Resources:lang,BianJi %>" /></strong>
                                                            </td>
                                                            <td width="5%" align="center">
                                                                <strong>
                                                                    <asp:Label ID="Label146" runat="server" Text="<%$ Resources:lang,ShanChu %>" /></strong>
                                                            </td>
                        ...
                        <div id="popwindow_content22" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table width="100%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                <tr>
                                    ...
                                    <td class="formItemBgStyle" width="35%" align="left">
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popHistoryPriceSelectWindow" name="fixedDiv"
                        style="z-index: 9999; width: 820px; height: 500px; position: absolute; overflow: hidden; display: none; border-radius: 10px;">
                        <div class="layui-layer-title" style="background: #e7e7e8;" id="popwindow_title22">
                        ...
                        <div id="popwindow_content22" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table align="center" cellpadding="0" cellspacing="0" width="99%">
                                ...
                                <tr>
                                    <td>
                                                ...
                                                <td>
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            ...
                                                            <td align="center" width="5%"><strong>
                                                                <asp:Label ID="Label174" runat="server" Text="<%$ Resources:lang,BianHao %>"></asp:Label>
                                                            </strong></td>

                                                            <td align="center" width="8%"><strong>
                                                                <asp:Label ID="Label175" runat="server" Text="<%$ Resources:lang,DaiMa %>"></asp:Label>
                                                            </strong></td>
                                                            <td align="center" width="10%"><strong>
                                                                <asp:Label ID="Label176" runat="server" Text="<%$ Resources:lang,MingCheng %>"></asp:Label>
                                                            </strong></td>
                                                            <td align="center" width="10%"><strong>
                                                                <asp:Label ID="Label177" runat="server" Text="<%$ Resources:lang,XingHao %>"></asp:Label>
                                                            </strong></td>
                                                            <td align="center" width="13%"><strong>
                                                                <asp:Label ID="Label189" runat="server" Text="<%$ Resources:lang,GuiGe %>"></asp:Label>
                                                            </strong></td>
                                                            <td align="center" width="8%"><strong>
                                                                <asp:Label ID="Label190" runat="server" Text="<%$ Resources:lang,ShuLiang %>"></asp:Label>
                                                            </strong></td>
                                                            <td align="center" width="6%"><strong>
                                                                <asp:Label ID="Label206" runat="server" Text="单价"></asp:Label>
                                                            </strong></td>
                                                            <td align="center" width="6%"><strong>
                                                            ...
                                                            <td align="center"><strong>
                                                                <asp:Label ID="Label193" runat="server" Text="<%$ Resources:lang,gongyingshang %>"></asp:Label>
                                                            </strong></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                        ...
                                        <asp:DataGrid ID="DataGrid15" runat="server" AutoGenerateColumns="False"
                                            CellPadding="4" ForeColor="#333333" GridLines="None" Height="1px" OnItemCommand="DataGrid15_ItemCommand"
                                            ShowHeader="False"
                                            Width="110%">
                                            <Columns>
                                                ...
                                                <asp:TemplateColumn HeaderText="Delete">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="LBT_Select" CommandName="Select" runat="server" Text="<%$ Resources:lang,xuanze %>"></asp:LinkButton>
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="itemBorder" HorizontalAlign="Center" Width="5%" />
                                                </asp:TemplateColumn>
                                                <asp:BoundColumn DataField="ID" HeaderText="ID">
                                ...
                                <tr>
                                    <td style="text-align: left;">Other Supplier:
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                                ...
                                                <td>
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            ...
                                                            <td align="center" width="5%"><strong></strong></td>
                                                            <td align="center" width="5%"><strong>
                                                                <asp:Label ID="Label194" runat="server" Text="<%$ Resources:lang,BianHao %>"></asp:Label>
                                                            </strong></td>

                                                            <td align="center" width="8%"><strong>
                                                                <asp:Label ID="Label195" runat="server" Text="<%$ Resources:lang,DaiMa %>"></asp:Label>
                                                            </strong></td>
                                                            <td align="center" width="10%"><strong>
                                                                <asp:Label ID="Label198" runat="server" Text="<%$ Resources:lang,MingCheng %>"></asp:Label>
                                                            </strong></td>
                                                            <td align="center" width="10%"><strong>
                                                                <asp:Label ID="Label199" runat="server" Text="<%$ Resources:lang,XingHao %>"></asp:Label>
                                                            </strong></td>
                                                            <td align="center" width="13%"><strong>
                                                                <asp:Label ID="Label200" runat="server" Text="<%$ Resources:lang,GuiGe %>"></asp:Label>
                                                            </strong></td>
                                                            <td align="center" width="8%"><strong>
                                                                <asp:Label ID="Label201" runat="server" Text="<%$ Resources:lang,ShuLiang %>"></asp:Label>
                                                            </strong></td>
                                                            <td align="center" width="6%"><strong>
                                                                <asp:Label ID="Label205" runat="server" Text="单价"></asp:Label>
                                                            </strong></td>
                                                            <td align="center" width="6%"><strong>
                                                            ...
                                                            <td align="center"><strong>
                                                                <asp:Label ID="Label204" runat="server" Text="<%$ Resources:lang,gongyingshang %>"></asp:Label>
                                                            </strong></td>
                                                        </tr>
                                                    </table>
                                                </td>
                        ...
                        <div id="popwindow_footer11" class="layui-layer-btn" style="border-top: 1px solid #ccc;">
                            <a class="layui-layer-btn notTab" onclick="return popClose();">
                                <asp:Label ID="Label197" runat="server" Text="<%$ Resources:lang,GuanBi%>" /></a>
                        </div>
                        <span class="layui-layer-setwin"><a onclick="return popClose();" class="layui-layer-ico layui-layer-close layui-layer-close1 notTab" href="javascript:;"></a></span>
                    </div>
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popBOMWindow" name="fixedDivNoConfirm"
                        ...
                        <div id="popwindow_footer11" class="layui-layer-btn" style="border-top: 1px solid #ccc;">
                            <a class="layui-layer-btn notTab" onclick="return popClose();">
                                <asp:Label ID="Label208" runat="server" Text="<%$ Resources:lang,GuanBi%>" /></a>
                        </div>
                        <span class="layui-layer-setwin"><a onclick="return popClose();" class="layui-layer-ico layui-layer-close layui-layer-close1 notTab" href="javascript:;"></a></span>
                    </div>
