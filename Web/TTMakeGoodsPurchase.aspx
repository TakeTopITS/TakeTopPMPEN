                                    ...
                                    <td colspan="2" align="left">
                                        <table width="98%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3" class="formItemBgStyleForAlignLeft" style="width: 120px;">
                                                                        ...
                                                                        <td>
                                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                <tr>
                                                                                    ...
                                                                                    <td align="left" width="5%"><strong>BOM
                                                                                    </strong></td>
                                ...
                                <tr>
                                    <td width="43%">
                                        ...
                                        <table align="left" cellpadding="3" cellspacing="0" class="formBgStyle" width="99%">
                                            <tr>
                                                <td class="formItemBgStyleForAlignLeft" style="width: 70px; ">
                                                ...
                                                <td class="formItemBgStyleForAlignLeft" style="width: 100px; ">ID:</td>
                                                <td class="formItemBgStyleForAlignLeft">
                                            ...
                                            <tr>
                                                <td class="formItemBgStyleForAlignLeft">BomVerID:</td>
                                                <td class="formItemBgStyleForAlignLeft">
                                    ...
                                    <td width="50%">
                                        <cc1:TabContainer ID="TabContainer2" runat="server" ActiveTabIndex="0"
                                                                    ...
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td width="5%" align="left"><strong>
                                                                                <asp:Label ID="Label2" runat="server" Text="MaterialIssuedQuantity"></asp:Label></strong></td>
                                                                            <td width="6%" align="left"><strong>
                                            ...
                                            <cc1:TabPanel ID="TabPanel4" runat="server" HeaderText="ProjectBOM" TabIndex="22">
                                                <HeaderTemplate>
                        ...
                        <div id="popwindow_content22" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table width="100%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                <tr>
                                    ...
                                    <td class="formItemBgStyleForAlignLeft" width="35%" align="left">
