<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTAllProjectDocuments.aspx.cs"
    Inherits="TTAllProjectDocuments" %>
                        ...
                        <tr>
                            <td height="31" class="page_topbj">
                                <table width="96%" border="0" align="left" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td align="left">
                                            <table width="945" border="0" align="left" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="29">
                                                        <%--<img src="Logo/main_top_l.jpg" alt="" width="29" height="31" />--%></td>
                                                    <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                        <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,XiangMuWenDangGuanLiZongHeChaXun%>"></asp:Label>：<span><asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,WenJianLeiXing%>"></asp:Label>：<asp:DropDownList ID="DL_DocType"
                                                            runat="server" Width="150px" DataTextField="Type" DataValueField="Type">
                                                        </asp:DropDownList>&nbsp;
                                                            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,WenJianMing%>"></asp:Label>：<asp:TextBox ID="TB_DocName" runat="server" Width="132px"></asp:TextBox>
                                                            &nbsp;
                                                            <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,ShangChuanZheXingMing%>"></asp:Label>：<asp:TextBox ID="TB_UploadManName" runat="server" Width="64px"></asp:TextBox>
                                                            &nbsp; &nbsp;<asp:Button ID="BT_Find" runat="server" OnClick="BT_Find_Click"
                                                                CssClass="inpu" Text="<%$ Resources:lang,ChaXun%>" />)
                                                    </td>
                                                    <td width="5">
                                ...
                                <table cellpadding="0" cellspacing="0" width="100%" style="margin-top: 5px">
                                    <tr>
                                        <td style="width: 100%; height: 1px; text-align: left;">
                                            <asp:Label ID="LB_FindCondition1" runat="server"></asp:Label>
                                            &nbsp;<asp:Label ID="LB_FindCondition2" runat="server"></asp:Label>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                ...
                                                                <td width="32%" align="left">
                                                                    <strong>
                                                                        <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,WenJianMing%>"></asp:Label></strong>
                                                                </td>
                                                                ...
                                                                <td width="5%" align="left">
                                                                    <strong>
                                                                        <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,XiangGuan%>"></asp:Label></strong>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
