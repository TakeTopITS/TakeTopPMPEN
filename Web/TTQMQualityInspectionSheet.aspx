<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTQMQualityInspectionSheet.aspx.cs" Inherits="TTQMQualityInspectionSheet" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ZhiLiangBaoYan%>"></asp:Label></td>
                                                        <td width="5">
                            ...
                            <tr>
                                <td align="left" style="padding-top: 5px;">
                                    ...
                                    <table cellpadding="2" cellspacing="0" class="formBgStyle" width="75%">
                                        <tr>
                                             <td align="left">
                                                <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,BaoYanXinXi%>"></asp:Label>：<asp:TextBox ID="TextBox1" runat="server" Width="120px"></asp:TextBox>
                                          
                                                <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,HeTongXinXi%>"></asp:Label>：<asp:TextBox ID="TextBox2" runat="server" Width="120px"></asp:TextBox>
                                           
                                                <asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,BaoYanRiQi%>"></asp:Label>：<asp:TextBox ID="TextBox3" runat="server" Width="90px" ReadOnly="false"></asp:TextBox>
                                            ...
                                            <td class="formItemBgStyleForAlignLeft">
                                                        ...
                                                        <td>
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td width="15%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,BaoYanRiQi%>"></asp:Label></strong>
                                                                    </td>
                                                                    <td width="20%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,BaoJianJieGuo%>"></asp:Label></strong>
                                                                    </td>
                                                                    <td width="30%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,ChuLiJieGuo%>"></asp:Label></strong>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                ...
                                                <asp:DataGrid ID="DataGrid2" runat="server" AutoGenerateColumns="False" Height="1px"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundColumn DataField="AcceptDate" HeaderText="报验日期" DataFormatString="{0:yyyy-MM-dd}">
                                                            <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="15%" />
                                                            <HeaderStyle BorderColor="#394f66" BorderStyle="Solid" BorderWidth="1px" Font-Bold="true"
                                                                Horizontalalign="left" />
                                                        </asp:BoundColumn>
                                                        <asp:BoundColumn DataField="InspectionResults" HeaderText="报检结果">
                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="20%" />
                                                            <HeaderStyle BorderColor="#394f66" BorderStyle="Solid" BorderWidth="1px" Font-Bold="true"
                                                                Horizontalalign="left" />
                                                        </asp:BoundColumn>
                                                        <asp:BoundColumn DataField="DealResults" HeaderText="处理结果">
                            ...
                            <table cellpadding="2" cellspacing="0" class="formBgStyle" width="900px">
                                ...
                                <tr style="color: #000000">
                                    ...
                                    <td class="formItemBgStyleForAlignRight" style="height: 30px">
                                        <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,BaoYanRiQi%>"></asp:Label>：</td>
                                    <td class="formItemBgStyleForAlignLeft" style="height: 30px">
                                        <asp:TextBox ID="DLC_AcceptDate" runat="server" CssClass="shuru" Width="150px" ReadOnly="false"></asp:TextBox>
                                        <cc1:CalendarExtender ID="CalendarExtender2" runat="server" Format="yyyy-MM-dd" TargetControlID="DLC_AcceptDate">
                                        </cc1:CalendarExtender>
                                    </td>
                                </tr>
                                <tr style="color: #000000">
                                    ...
                                    <td class="formItemBgStyleForAlignRight" style="height: 30px">
                                        <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,BaoYanLeiXing%>"></asp:Label>：</td>
                                    <td class="formItemBgStyleForAlignLeft" style="height: 30px">
                                        <asp:TextBox ID="TB_Type" runat="server" CssClass="shuru" Width="150px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr style="color: #000000">
                                    ...
                                    <td class="formItemBgStyleForAlignLeft" style="height: 30px">
                                        <asp:DropDownList ID="DL_Status" runat="server" CssClass="shuru">
                                            <asp:ListItem Value="Reported" Text="<%$ Resources:lang,YiBaoYan%>" />
                                ...
                                <tr style="color: #000000;">
                                    <td class="formItemBgStyleForAlignRight" style="width: 150px; height: 30px">
                                        <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,BaoJianJieGuo%>"></asp:Label>：</td>
                                    <td class="formItemBgStyleForAlignLeft" style="height: 30px" colspan="3">

                                        <asp:TextBox ID="TB_InspectionResults" runat="server" CssClass="shuru" Height="35px" TextMode="MultiLine" Width="90%"></asp:TextBox>

                                    </td>
                                </tr>
                                <tr style="color: #000000;">
                                    <td class="formItemBgStyleForAlignRight" style="width: 150px; height: 30px">
                                        <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,ChuLiJieGuo%>"></asp:Label>：</td>
                                    <td class="formItemBgStyleForAlignLeft" colspan="3" style="height: 30px">
                                        <asp:TextBox ID="TB_DealResults" runat="server" CssClass="shuru" Height="35px" TextMode="MultiLine" Width="90%"></asp:TextBox>
                                    </td>
                                </tr>
