<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTPersonalSpaceNewsList.aspx.cs" Inherits="TTPersonalSpaceNewsList" %>
                                    ...
                                    <div class="TabTitle">
                                        <ul id="myTab2r">
                                            <li id="LI_ToDoList" class="active" onmouseover="nTabs(this,0);">
                                                <asp:Label ID="LB_NewsTypeName" runat="server" />
                                            </li>
                                        </ul>
                                    </div>
                                    <!-- 内容开始 -->
