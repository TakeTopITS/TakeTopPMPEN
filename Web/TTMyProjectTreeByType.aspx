<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTMyProjectTreeByType.aspx.cs" Inherits="TTMyProjectTreeByType" %>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:HyperLink ID="HL_RelatedMeeting" runat="server"
                                                                        NavigateUrl="TTProRelatedRisk.aspx" Target="_blank" Visible="False">
                                                                        <asp:Label ID="Label23" runat="server" Text="<%$ Resources:lang,XiangMuHuiYi%>"></asp:Label>
                                                                    </asp:HyperLink>
                                                                </td>
                                                                <td>
                                                                    <asp:HyperLink ID="HL_StatusChangeRecord" runat="server" NavigateUrl="TTUserFeebackSummary.aspx"
                                                                        Target="_blank" Visible="False">
                                                                        <asp:Label ID="Label24" runat="server" Text="<%$ Resources:lang,ZhuangTaiBianGengJiLu%>"></asp:Label>
                                                                    </asp:HyperLink>
                                                                </td>
                                                                <td>
                                                                    <asp:HyperLink ID="HL_LeadReview" runat="server" NavigateUrl="TTLeadReviewSummary.aspx"
                                                                        Target="_blank" Visible="False">
                                                                        <asp:Label ID="Label25" runat="server" Text="<%$ Resources:lang,ShangJiPingHeHuiZong%>"></asp:Label>
                                                                    </asp:HyperLink>
                                                                </td>
                                                                <td>
                                                                    <asp:HyperLink ID="HL_TransferProject" runat="server" NavigateUrl="~/TTTransferProjectRecord.aspx"
                                                                        Target="_blank" Visible="False">
                                                                        <asp:Label ID="Label26" runat="server" Text="<%$ Resources:lang,XiangMuJingLiBianGengJiLu%>"></asp:Label>
                                                                    </asp:HyperLink>
                                                                </td>
                                                                <td>
                                                                    <asp:HyperLink ID="HL_CustomerInfo" runat="server" Font-Size="10pt" NavigateUrl="~/TTCustomerInfo.aspx"
                                                                        Target="_blank" Visible="False">
                                                                        <asp:Label ID="Label27" runat="server" Text="<%$ Resources:lang,KeHuZiLiao%>"></asp:Label>
                                                                    </asp:HyperLink>
                                                                </td>
                                                                <td>
                                                                    <asp:HyperLink ID="HL_VendorInfo" runat="server" Font-Size="10pt" NavigateUrl="~/TTVendorInfo.aspx"
                                                                        Target="_blank" Visible="False">
                                                                        <asp:Label ID="Label28" runat="server" Text="<%$ Resources:lang,GongYingShangZiLiao%>"></asp:Label>
                                                                    </asp:HyperLink>
                                                                </td>
                                                                <td>&nbsp;</td>
                                                                <td></td>
