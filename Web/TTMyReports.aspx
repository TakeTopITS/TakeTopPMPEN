<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTMyReports.aspx.cs" Inherits="TTMyReports" %>
                                            ...
                                            <table width="300" border="0" align="left" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,WoYaoYueDuDeBaoBiao%>"></asp:Label>
                                                    </td>
                                                    <td width="5">
                                    ...
                                    <tr>
                                            ...
                                            <table width="100%" cellpadding="0" cellspacing="0">
                                                                    ...
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td width="40%" align="left" style="font-size: smaller;">
                                                                                <strong>
                                                                                    <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,BaoBiaoLeiXing%>"></asp:Label></strong>
                                                                            </td>
                                                                            <td width="60%" align="left" style="font-size: smaller;">
                                                                                <strong>
                                                                                    <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,BaoBiaoMuBan%>"></asp:Label></strong>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <table width="100%">
                                                            <tr>
                                                                <td class="tdLeft" align="left" width="40%" style="padding: 1px 1px 1px 1px;">
                                                                    <asp:ListBox ID="LLB_ReportType" runat="server" AutoPostBack="True" Width="100%"
                                                                        Height="600" DataTextField="Type" DataValueField="Type" OnSelectedIndexChanged="LLB_ReportType_SelectedIndexChanged"></asp:ListBox>
                                                                </td>
                                                                <td class="tdRight" align="left" width="60%" style="padding: 1px 1px 1px 1px;">
                                                                    <asp:ListBox ID="LLB_ReportTemplate" runat="server" AutoPostBack="True" Width="100%"
                                                                        Height="600px" DataTextField="TemName" DataValueField="ID" OnSelectedIndexChanged="LLB_ReportTemplate_SelectedIndexChanged"></asp:ListBox>
                                                                </td>
                                                            </tr>
                                                        </table>
                                        ...
                                        <td style="padding: 5px 5px 5px 5px; text-align: left;">
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                ...
                                                                <td width="35%" align="left">
                                                                    <strong>
                                                                        <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,BaoBiaoMing%>"></asp:Label></strong>
                                                                </td>
                                                                <td width="20%" align="left">
                                                                    <strong>
                                                                        <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,BaoBiaoMuBan%>"></asp:Label></strong>
                                                                </td>
                                            ...
                                            <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                PageSize="7" ShowHeader="False" Height="1px" OnItemCommand="DataGrid1_ItemCommand"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn>
                                                        <ItemTemplate>
                                                            <asp:Button ID="BT_Read" CommandName="Read" CssClass="inpu" runat="server" Text="<%$ Resources:lang,YiYue%>" />
                                                        </ItemTemplate>
                                                        <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="10%" />
                                                    </asp:TemplateColumn>
                                                </Columns>
                                            ...
                                            <br />
                                            <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,YiYueBaoBiao%>"></asp:Label>：<br />
                                                    ...
                                                    <td>
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td width="7%" align="left">
                                                                    <strong>
                                                                        <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,XuHao%>"></asp:Label></strong>
                                                                </td>
                                                                <td width="40%" align="left">
                                                                    <strong>
                                                                        <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,BaoBiaoMing%>"></asp:Label></strong>
                                                                </td>
                                                                <td width="20%" align="left">
                                                                    <strong>
                                                                        <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,BaoBiaoMuBan%>"></asp:Label></strong>
                                                                </td>
                                            ...
                                            <asp:DataGrid ID="DataGrid2" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                PageSize="7" ShowHeader="False" Height="1px" OnPageIndexChanged="DataGrid2_PageIndexChanged" OnItemCommand="DataGrid2_ItemCommand"
