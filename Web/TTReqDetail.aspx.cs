...
public partial class TTReqDetail : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Page.IsPostBack != true)
        {
            ...
            string strNewProjectCode = ShareClass.GetCodeByRule("ProjectCode", "OtherProject", strReqID);
    ...
    protected void BT_Assign_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "alert('" + LanguageHandle.GetWord("ZZJGSLRDMCWCWCRJC").ToString().Trim() + "')", true);
            return;
        }
