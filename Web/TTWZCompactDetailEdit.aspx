                                                            ...
                                                            <table class="formBgStyle" width="80%">
                                                                <tr>
                                                                    <td style="text-align: left" class="formItemBgStyle">
                                                                        <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,HeTongShuLiang%>"></asp:Label>£º</td>
                                                                    <td style="text-align: left" class="formItemBgStyle">
                                                                        <asp:TextBox ID="TXT_CompactNumber" runat="server"></asp:TextBox>
                                                                    </td>
                                                                    <td style="text-align: left" class="formItemBgStyle">
                                                                        <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,HeTongDanJia%>"></asp:Label>£º</td>
                                                                    <td style="text-align: left" class="formItemBgStyle">
                                                                        <asp:TextBox ID="TXT_CompactPrice" runat="server"></asp:TextBox>
                                                                    </td>
                                                                    <td style="text-align: left" class="formItemBgStyle">
                                                                        <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,HeTongJinE%>"></asp:Label>£º</td>
                                                                    <td style="text-align: left" class="formItemBgStyle">
                                                                ...
                                                                <tr>
                                                                     <td style="text-align: left" class="formItemBgStyle">
                                                                         <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,ShengChanChangJia%>"></asp:Label>£º</td>
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: left" class="formItemBgStyle">
                                                                        <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,GuiGeShuBianHao%>"></asp:Label>£º</td>
                                                                    <td style="text-align: left" class="formItemBgStyle" colspan="5">
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: left" class="formItemBgStyle">
                                                                        <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,BeiZhu%>"></asp:Label>£º</td>
                                                                    <td style="text-align: left" class="formItemBgStyle" colspan="5">
