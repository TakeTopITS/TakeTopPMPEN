<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTProjectRelatedDefectDoc.aspx.cs" Inherits="TTProjectRelatedDefectDoc" %>
                                                                ...
                                                                <td valign="top" style="height: 24px; text-align: center;">
                                                                    ...
                                                                    <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:HyperLinkColumn DataNavigateUrlField="Address"
                                                                                DataNavigateUrlFormatString="{0}" DataTextField="DocName" HeaderText="文件名"
                                                                                Target="_blank">
                                                                            ...
                                                                            <asp:TemplateColumn>
                                                                                ...
                                                                                <ItemTemplate>
                                                                                    <asp:Button ID="BT_Review" runat="server" CssClass="inpu" CommandName="Review" Text="<%$ Resources:lang,PingShen%>" />
                                                                                </ItemTemplate>
                                                                            ...
                                                                            <table style="width: 100%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,LeiXing%>"></asp:Label>：
                                                                                        ...
                                                                                        </asp:HyperLink>&nbsp;&nbsp;<asp:Button ID="BT_Refrash" runat="server" Text="<%$ Resources:lang,ShuaXin%>" CssClass="inpu" OnClick="BT_Refrash_Click" />
                                                                                    </td>
                                                                                </tr>
