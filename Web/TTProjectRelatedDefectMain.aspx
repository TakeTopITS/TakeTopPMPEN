<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTProjectRelatedDefectMain.aspx.cs" Inherits="TTProjectRelatedDefectMain" %>
                                    ...
                                    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="LB_tiRelatedDefect" runat="server" Text="<%$ Resources:lang,RelatedDefect%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                            ...
                                            <td style="text-align: right; padding-top: 5px; padding-right: 5px;">
                                                ...
                                                <asp:Button ID="BT_RecordDefect" runat="server" CssClass="inpuYello" Text="<%$ Resources:lang,JiLuQueXian %>" OnClick="BT_RecordDefect_Click" />
                                                ...
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td style="padding-top: 5px;">
                                                            <asp:Label ID="LB_tiDefectType" runat="server" Text="<%$ Resources:lang,Type%>"></asp:Label>：
                                                        </td>
                                                        <td style="padding-top: 5px;">
                                                            <asp:DropDownList ID="DL_DefectType" runat="server" DataTextField="DefectType" DataValueField="DefectType">
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td style="padding-top: 5px;">
                                                        ...
                                                        <td style="padding-top: 5px;">
                                                            <asp:Button ID="BT_AllDefect" runat="server" CssClass="inpuLong" OnClick="BT_AllDefect_Click" Text="<%$ Resources:lang,AllDefect%>" />
                                                        </td>
                                                        <td style="padding-top: 3px;">)
                                                        </td>
                                                    </tr>
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td width="5%" align="center">
                                                                        <strong>
                                                                            <asp:Label ID="LB_dgDefectID" runat="server" Text="<%$ Resources:lang,ID%>"></asp:Label></strong>
                                                                    </td>
                                                ...
                                                <asp:DataGrid ID="DataGrid2" runat="server" AutoGenerateColumns="False" Height="1px"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:HyperLinkColumn DataNavigateUrlField="DefectID" DataNavigateUrlFormatString="TTProRelatedDefectView.aspx?DefectID={0}"
                                                            DataTextField="DefectName" HeaderText="名称" Target="_blank">
                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="40%" />
                                                        </asp:HyperLinkColumn>
                                                        <asp:BoundColumn DataField="DefectFinishedDate" HeaderText="缺陷日期" DataFormatString="{0:yyyy/MM/dd}">
                                                        ...
                                                        <asp:TemplateColumn>
                                                            <ItemTemplate>
                                                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%#String.Format("TTDefectToTask.aspx?DefectID={0}&ProjectID={1}",DataBinder.Eval(Container.DataItem,"DefectID"),DataBinder.Eval(Container.DataItem,"ProjectID")) %>'
                                                                    Target="_blank">
                                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
