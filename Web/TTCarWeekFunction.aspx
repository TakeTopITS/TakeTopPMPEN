<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTCarWeekFunction.aspx.cs" Inherits="TTCarWeekFunction" %>
                                                            ...
                                                            <td class="formItemBgStyle" style="height: 10%; width: 100%;">
                                                                <table style="width: 100%; text-align: center;" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: right;" width="15%" class="formItemBgStyle">
                                                                            <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,ZhouJianMingCheng%>"></asp:Label>：
                                                                        </td>
                                                                        <td style="text-align: left;" width="19%" class="formItemBgStyle">
                                                                    ...
                                                                    <table class="formBgStyle" width="100%">
                                                                        <tr>
                                                                            <td style="text-align: right;" class="formItemBgStyle">
                                                                                <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,YuLiuZiDuanYi%>"></asp:Label>：
                                                                            </td>
                                                                            <td align="left" class="formItemBgStyle">
                                                                                <asp:TextBox ID="TXT_Ext1" runat="server"></asp:TextBox>
                                                                            </td>
                                                                            <td align="right" class="formItemBgStyle">
                                                                                <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,YuLiuZiDuanEr%>"></asp:Label>：
                                                                            </td>
                                                                            <td align="left" class="formItemBgStyle">
                                                                        ...
                                                                        <tr>
                                                                            <td style="text-align: right;" class="formItemBgStyle">
                                                                                <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,YuLiuZiDuanSan%>"></asp:Label>：
                                                                            </td>
                                                                            <td style="text-align: left;" class="formItemBgStyle">
                                                                                <asp:TextBox ID="TXT_Ext3" runat="server"></asp:TextBox>
                                                                            </td>
                                                                            <td style="text-align: right;" class="formItemBgStyle">
                                                                                <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,YuLiuZiDuanSi%>"></asp:Label>：
                                                                            </td>
                                                                            <td style="text-align: left;" class="formItemBgStyle">
