                                        ...
                                        <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                    <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ShiShiLuXian%>"></asp:Label>
                                                </td>
                                                <td width="5">
                                                                    ...
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td width="8%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,ShiShiLuXian%>"></asp:Label></strong>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            ...
                                                            <Columns>
                                                                <asp:TemplateColumn>
                                                                    ...
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <asp:Button ID="BT_Review" CommandArgument='<%# Eval("ID") %>' runat="server" CssClass="inpu" Text="<%$ Resources:lang,XuanZe%>" CommandName="select" />
                                                                ...
                                                                <asp:TemplateColumn>
                                                                    ...
                                                                    <HeaderTemplate>
                                                                        <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,ShiShiLuXian%>"></asp:Label>
                                                                    </HeaderTemplate>
                                                                    <ItemTemplate>
                                                                        <%# ShareClass.StringCutByRequire(Eval("ProjectPlanName").ToString(), 190) %>
                                                                    </ItemTemplate>
                                                                </asp:TemplateColumn>
                                                            </Columns>
