                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,YLSYJZLB%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td align="left" class="formItemBgStyle">
                                                <input type="button" class="inpuLong" value="新增压力试验介质" onclick="window.location.href = 'TTGDTestMediumEdit.aspx'" />
                                            </td>
                                        </tr>
                                        <tr>
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        ...
                                                                        <td width="74%" align="left">
                                                                            <strong>
                                                                                <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ShiYaNJieZhi%>"></asp:Label></strong>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                    ...
                                                    <asp:DataGrid ID="DG_List" runat="server" AllowPaging="true" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateColumn>
                                                                ...
                                                                <ItemTemplate>
                                                                    <a href='TTGDTestMediumEdit.aspx?id=<%# DataBinder.Eval(Container.DataItem,"ID") %>'>
                                                            ...
                                                            <asp:BoundColumn DataField="ID" HeaderText="代号">
                                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="Center" Width="20%" />
                                                            </asp:BoundColumn>
                                                            <asp:BoundColumn DataField="TestMedium" HeaderText="试验介质">
