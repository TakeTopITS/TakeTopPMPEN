<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTCreatedProjectSAAS.aspx.cs" Inherits="TTCreatedProjectSAAS" %>
                                        ...
                                        <tr>
                                            <td valign="top" style="padding-top: 5px">
                                                <table style="width: 100%;" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td align="center" style="width: 100%; vertical-align: top; padding: 5px 5px 5px 5px">
          ...
          <asp:Label ID="LB_Status" runat="server" Text="<%$ Resources:lang,Status%>"></asp:Label></strong>--%>
                                                            ...
                                                            <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" Height="1px" PageSize="10"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:HyperLinkColumn DataNavigateUrlField="ProjectID" DataNavigateUrlFormatString="TTCreatedProjectDetailSAAS.aspx?ProjectID={0}"
                                                                    ...
                                                                    <asp:TemplateColumn>
                                                                        ...
                                                                        <ItemStyle CssClass="itemBorder" HorizontalAlign="Center" VerticalAlign="Middle" Width="70px" />
                                                                    </asp:TemplateColumn>
                                                                    <asp:TemplateColumn>
                                                                        <ItemTemplate>
                                            ...
                                            <td width="165px" valign="top" style="border-left: solid 1px #D8D8D8;">
                                                <table style="width: 98%" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td style="width: 165; height: 22px; text-align: center; padding-top: 5px">
                                                    ...
                                                    <tr>
                                                        <td style="width: 165; text-align: center; padding: 5px 5px 5px 5px;">
                                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" background="ImagesSkin/main_n_bj.jpg">
                                                                <tr>
                                                                    <td width="7">
                                                                        <img src="ImagesSkin/main_n_l.jpg" width="7" height="26" />
