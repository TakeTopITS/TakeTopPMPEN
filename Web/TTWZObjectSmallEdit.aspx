                                                                                ...
                                                                                <Columns>
                                                                                    <asp:TemplateColumn>
                                                                                        ...
                                                                                        <ItemTemplate>
                                                                                            ...
                                                                                            <%--<asp:LinkButton runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"XLCode") %>' CommandName='<%# Eval("CreateProgress").ToString()=="录入" ? "request" : "returnRequest" %>' CssClass="notTab" Text='<%# Eval("CreateProgress").ToString()=="录入" ? "Application" : "退回" %>'></asp:LinkButton>--%>
