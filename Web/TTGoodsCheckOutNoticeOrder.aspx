<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTGoodsCheckOutNoticeOrder.aspx.cs" Inherits="TTGoodsCheckOutNoticeOrder" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ChuHuoTongZhi%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                ...
                                <td align="left" style="padding: 5px 5px 5px 5px" valign="top">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td width="10%" align="left">
                                                            <strong>
                                                                <asp:Label ID="Label95" runat="server" Text="<%$ Resources:lang,FaQiShengQing%>" /></strong>
                                                        </td>
                                    ...
                                    <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnItemCommand="DataGrid1_ItemCommand" OnPageIndexChanged="DataGrid1_PageIndexChanged" PageSize="25" ShowHeader="false" Width="100%">
                                        <Columns>
                                            ...
                                            <asp:BoundColumn DataField="COOID" HeaderText="COOID">
                                                <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="5%" />
                                            </asp:BoundColumn>
                            ...
                            <table align="left" cellpadding="3" cellspacing="0" class="formBgStyle" style="width: 98%;">
                                <tr>
                                    ...
                                    <td align="left" class="formItemBgStyle" style="width: 35%">
                                        <asp:TextBox ID="TB_COOName" runat="server" Width="95%"></asp:TextBox>
                                    </td>
                                    ...
                                    <td align="left" class="formItemBgStyle">
                                        <asp:DropDownList ID="DL_Type" runat="server">
                                            <asp:ListItem Text="<%$ Resources:lang,ChuHuoShenQing%>" Value="SALE" />
                                        </asp:DropDownList>
                                        <asp:Label ID="LB_COOID" runat="server" Visible="false"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td align="left" class="formItemBgStyle">
                                        <asp:DropDownList ID="DL_Status" runat="server" OnSelectedIndexChanged="DL_Status_SelectedIndexChanged">
                                            <asp:ListItem Text="<%$ Resources:lang,XinJian%>" Value="New" />
                                            <asp:ListItem Text="<%$ Resources:lang,ShenPiZhong%>" Value="InProgress" />
                                            <asp:ListItem Text="<%$ Resources:lang,WanCheng%>" Value="Completed" />
                                                ...
                                                <td>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="5%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label59" runat="server" Text="<%$ Resources:lang,BianJi %>" /></strong>
                                                            </td>
                                                            <td width="5%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label61" runat="server" Text="<%$ Resources:lang,ShanChu %>" /></strong>
                                                            </td>
                                                            ...
                                                            <td width="6%" align="left"><strong>
                                                                ...
                                                                <asp:Label ID="Label89" runat="server" Text="<%$ Resources:lang,KeHuXingHao %>"></asp:Label></strong> </td>
                                                            ...
                                                            <td width="6%" align="left"><strong>
                                                                ...
                                                                <asp:Label ID="Label25" runat="server" Text="<%$ Resources:lang,PinPai %>"></asp:Label>PCS</strong> </td>

                                                            <td width="6%" align="left"><strong>

                                                                <asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,ShuLiang %>"></asp:Label>PCS</strong> </td>

                                                            <td width="6%" align="left"><strong>

                                                                <asp:Label ID="Label90" runat="server" Text="<%$ Resources:lang,ZhuangXiangShuLiang %>"></asp:Label></strong> </td>
                                                            ...
                                                            <td width="6%" align="left"><strong>
                                                                ...
                                                                <asp:Label ID="Label91" runat="server" Text="<%$ Resources:lang,WanChengZhuangTai %>"></asp:Label></strong> </td>

                                                            <td align="left"><strong>

                                                                <asp:Label ID="Label92" runat="server" Text="<%$ Resources:lang,ChuHuShiJian %>"></asp:Label></strong> </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                        ...
                                        <table cellpadding="3" cellspacing="0" class="formBgStyle" style="width: 100%;">
                                            <tr>
                                                ...
                                                <td class="formItemBgStyle" align="left">
                                                    ...
                                                    </asp:DropDownList><asp:Label ID="LB_DetailID" runat="server" Visible="false"></asp:Label>
                                                </td>
                                                <td class="formItemBgStyle">ID:</td>
                                                <td class="formItemBgStyle" align="left">
                                            ...
                                            <tr>
                                                <td class="formItemBgStyle">
                                                    <asp:Label ID="Label44" runat="server" Text="<%$ Resources:lang,DaiMa %>"></asp:Label>：
                                                </td>
                                                <td style="text-align: left" class="formItemBgStyle" colspan="3">
                                            ...
                                            <tr>
                                                <td class="formItemBgStyle" style="">
                                                    ...
                                                    ： </td>
                                                <td class="formItemBgStyle" style="text-align: left; height: 19px;" colspan="3">
                                            ...
                                            <tr>
                                                <td class="formItemBgStyle" style="">
                                                    <asp:Label ID="Label80" runat="server" Text="<%$ Resources:lang,KeHuXingHao %>"></asp:Label>：
                                                </td>
                                                <td colspan="3" class="formItemBgStyle" style="text-align: left;">
                                                    <asp:TextBox ID="TB_CustomerModelNumber" runat="server" Width="90%"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="formItemBgStyle" style="">
                                                    <asp:Label ID="Label87" runat="server" Text="<%$ Resources:lang,TiaoMa %>"></asp:Label>：
                                                </td>
                                                <td colspan="3" class="formItemBgStyle" style="text-align: left;">
                                                    <asp:TextBox ID="TB_BarCode" runat="server" Width="90%"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="formItemBgStyle" style="">
                                                    <asp:Label ID="Label81" runat="server" Text="<%$ Resources:lang,ZhiZaoDanHao %>"></asp:Label>：
                                                </td>
                                                <td colspan="3" class="formItemBgStyle" style="text-align: left;">
                                                    <asp:DropDownList ID="DL_PDName" runat="server" DataTextField="PDName" DataValueField="PDID">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td class="formItemBgStyle" style="">
                                                    ...
                                                    ： </td>
                                                <td colspan="3" class="formItemBgStyle" style="width: 150px; text-align: left">
                                            ...
                                            <tr>
                                                <td class="formItemBgStyle" style="">
                                                    <asp:Label ID="Label82" runat="server" Text="<%$ Resources:lang,ZhuangXiangShuLiang %>"></asp:Label>
                                                    ： </td>
                                                <td colspan="3" class="formItemBgStyle" style="width: 150px; text-align: left">
                                                    <NickLee:NumberBox ID="NB_BoxNumber" runat="server" MaxAmount="1000000000000" MinAmount="-1000000000000" OnBlur="" OnFocus="" OnKeyPress="" PositiveColor="" Width="85px" Precision="3">0.000</NickLee:NumberBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="formItemBgStyle" style="">
                                            ...
                                            <tr>
                                                <td class="formItemBgStyle" style="">
                                                    ...
                                                    <asp:Label ID="Label83" runat="server" Text="<%$ Resources:lang,WanChengZhuangTai %>"></asp:Label>
                                                    ：
                                                </td>
                                                <td colspan="3" class="formItemBgStyle" style="width: 150px; text-align: left">
                                                    <asp:DropDownList ID="DL_FinishStatus" runat="server">
                                            ...
                                            <tr>
                                                <td class="formItemBgStyle" style="">
                                                    <asp:Label ID="Label84" runat="server" Text="<%$ Resources:lang,JiaoHuDiZhi %>"></asp:Label>
                                                    ：
                                                </td>
                                                <td colspan="3" class="formItemBgStyle" style="text-align: left;">
                                                    <asp:TextBox ID="TB_DeliveryAddress" runat="server" Width="90%"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right" class="formItemBgStyle">
                                                    <asp:Label ID="Label85" runat="server" Text="<%$ Resources:lang,ChuHuShiJian %>"></asp:Label>
                                                    ： </td>
                                                <td colspan="3" align="left" class="formItemBgStyle">
                                                    <asp:TextBox ID="DLC_CheckOutTime" runat="server"></asp:TextBox>
                                                    <cc1:CalendarExtender ID="CalendarExtender3" runat="server" Format="yyyy-MM-dd" TargetControlID="DLC_CheckOutTime" Enabled="True">
                                                    </cc1:CalendarExtender>
                                                </td>
                                            </tr>
                                            <tr>
                                    ...
                                    <td align="left">
                                        ...
                                        <cc1:TabContainer CssClass="ajax_tab_menu" ID="TabContainer2" runat="server" ActiveTabIndex="0" Width="100%">
                                            <cc1:TabPanel ID="TabPanel8" runat="server">
                                                ...
                                                <ContentTemplate>
                                                    <asp:Label ID="Label46" runat="server" Text="<%$ Resources:lang,QingXuanQuYaoXiaoShouDeLiaoPin %>"></asp:Label>：<asp:Label ID="Label2" runat="server" Visible="False"></asp:Label>
                                                                    ...
                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" width="10%"><strong>
                                                                                <asp:Label ID="Label49" runat="server" Text="<%$ Resources:lang,XingHao %>"></asp:Label></strong></td>
                                                                            <td align="left" width="24%"><strong>
                                                                                <asp:Label ID="Label50" runat="server" Text="<%$ Resources:lang,GuiGe %>"></asp:Label></strong></td>
                                                                            <td width="10%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label34" runat="server" Text="<%$ Resources:lang,PinPai %>"></asp:Label></strong>
                                                                            </td>
                                                                            <td width="10%" align="left"><strong>
                                                                                <asp:Label ID="Label53" runat="server" Text="<%$ Resources:lang,ShuLiang %>"></asp:Label></strong></td>
                                                                            <td align="left"><strong>
                                                                                <asp:Label ID="Label54" runat="server" Text="<%$ Resources:lang,DanWei %>"></asp:Label></strong></td>
                                                                            <td align="left"><strong>
                                                                                <asp:Label ID="Label55" runat="server" Text="<%$ Resources:lang,DanJia %>"></asp:Label></strong></td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                                <td align="right" width="6">
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td width="15%" align="left"><strong>
                                                                                                <asp:Label ID="Label94" runat="server" Text="<%$ Resources:lang,XingHao %>"></asp:Label></strong></td>
                                            ...
                                            <cc1:TabPanel ID="TabPanel3" runat="server" TabIndex="2">
                                                <HeaderTemplate>
                                                    <asp:Label ID="Label62" runat="server" Text="<%$ Resources:lang,XiaoShouDan%>"></asp:Label>:
                                                                    <asp:Label ID="LB_SOID" runat="server"></asp:Label>&#160;<asp:Label ID="Label63" runat="server" Text="<%$ Resources:lang,MingXi%>"></asp:Label>：
                                                </HeaderTemplate>
                                                <ContentTemplate>
                                                    <br />
                                                    <div id="Div1" style="width: 100%; height: 300px; overflow: auto;">
                                                                ...
                                                                <td>
                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" width="10%"><strong>
                                                                                <asp:Label ID="Label93" runat="server" Text="<%$ Resources:lang,YiTongZhiChuKu %>"></asp:Label></strong></td>
                                                                            <td align="left" width="10%"><strong>
                                    ...
                                    <td align="left" style="width: 550px; height: 6px">
                                        ...
                                        ：
                                                                                        <asp:DropDownList ID="DL_WFType" runat="server">
                                                                                            <asp:ListItem Text="<%$ Resources:lang,ChuHuoShengQing%>" Value="ShippingRequest" />
                                                                                        </asp:DropDownList>
                                                ...
                                                <td align="left">
                                                    ...
                                                    <asp:DataGrid ID="DataGrid4" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="1px" PageSize="5" ShowHeader="False" Width="98%">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:HyperLinkColumn DataNavigateUrlField="WLID" DataNavigateUrlFormatString="TTMyWorkDetailMain.aspx?WLID={0}" DataTextField="WLName" HeaderText="Workflow" Target="_blank">
