<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="TTReqDetail.aspx.cs"
    Inherits="TTReqDetail" %>
            ...
            <ContentTemplate>
                <div id="AboveDiv">
                    <table id="AboveTable" cellpadding="0" width="100%" cellspacing="0" class="bian">
                                                                                            ...
                                                                                            <table width="95%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                                                                <tr>
                                                                                                    <td class="formItemBgStyleAlignLeft">
                                                                                                        <table>
                                                                                                            <tr>
                                                                                                                <td class="formItemBgStyleAlignLeft" colspan="2">
                                                                                                                    ...
                                                                                                                    <asp:Label ID="LB_AssignID" runat="server" Visible="False"></asp:Label><span>
                                                                                                                        ...
                                                                                                                        &#160;<asp:Button ID="BT_Approve" runat="server" CssClass="inpu" OnClick="BT_Approve_Click" Visible="False"
                                                                                                                            Text="<%$ Resources:lang,ShouLi %>" />&nbsp;&nbsp;<asp:Button ID="BT_Refuse" runat="server" CssClass="inpu" OnClick="BT_Refuse_Click" Visible="False"
                                                                                                                                Text="<%$ Resources:lang,JuJue %>" />&nbsp;&nbsp;<asp:Button ID="BT_Activity" runat="server" CssClass="inpu" OnClick="BT_Activity_Click" Visible="False"
                                                                                                                                    Text="<%$ Resources:lang,HuoDong %>" />&nbsp; &nbsp;&#160;<asp:Button ID="BT_TBD" runat="server" CssClass="inpu" OnClick="BT_TBD_Click" Visible="False" Text="<%$ Resources:lang,GuaQi %>" />

                                                                                                                </td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td class="formItemBgStyleAlignLeft" style="width: 10%; ">
                                                                                                                ...
                                                                                                                <td class="formItemBgStyleAlignLeft" style="text-align: left;">&nbsp;</td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td class="formItemBgStyleAlignLeft" style="width: 10%; "></td>
                                                                                                                <td class="formItemBgStyleAlignLeft" align="left">
                                                                                                                    <table>
                                                                                                                        <tr>
                                                                                                                            <td>
                                                                                                                                <asp:Button ID="BT_Save" runat="server" CssClass="inpu" OnClick="BT_Save_Click" Text="<%$ Resources:lang,baocun %>" /></td>
                                                                                                                            <td style ="padding-left :30px;"><asp:Button ID="BT_CloseReq" runat="server" CssClass="inpuClose" ToolTip="<%$ Resources:lang,GuanBi%>" Enabled="False"
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td>
                                                                                                        <table width="100%">
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td class="formItemBgStyleAlignLeft" style="height: 20px;">
                                                                                                                    <asp:Label ID="Label27" runat="server" Text="<%$ Resources:lang,GongZuoYaoQiu %>"></asp:Label>
                                                                                                                    ： </td>
                                                                                                                <td class="formItemBgStyleAlignLeft" colspan="3" style="height: 20px">
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td class="formItemBgStyleAlignLeft" colspan="3">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td class="formItemBgStyleAlignLeft" style="text-align: left;">
                                                                                                        <table cellpadding="4" cellspacing="0" width="100%">
                                                                                                            <tr>
                                                                                                                <td class="formItemBgStyleAlignLeft" style="text-align: left;"><strong>
                        ...
                        <tr style="display: none;">
                            <td align="right">
                                <asp:HyperLink ID="HL_ReqReview" runat="server" Target="_blank" Text="<%$ Resources:lang,XuQiuPingShen %>" Visible="false"></asp:HyperLink>
                ...
                <div class="layui-layer layui-layer-iframe" id="popwindow" name="fixedDivNoConfirm"
                    ...
                    <div id="popwindow_content" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                        ...
                        <table>
                            <tr>
                                <td class="formItemBgStyleAlignLeft" rowspan="11" style="padding: 5px 5px 5px 5px;">
                                ...
                                <td width="170px" class="formItemBgStyleAlignLeft" rowspan="11" style="padding: 5px 5px 5px 5px;" valign="top">
                ...
                <div class="layui-layer layui-layer-iframe" id="popTranferProjectWindow" name="fixedDivNoConfirm"
                    ...
                    <div id="popwindow_content" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                        ...
                        <asp:Label ID="Label42" runat="server" Text="<%$ Resources:lang,ZhuanChengXiangMu%>"></asp:Label>
                        <table cellpadding="3" cellspacing="0" class="formBgStyle">
                            ...
                            <tr>
                                ...
                                <td style="width: 395px; height: 62px; vertical-align: top;" class="formItemBgStyleAlignLeft">
                                    ...
                                    <asp:TextBox ID="TB_TransferProject" runat="server" Width="328px"></asp:TextBox>
                                    <br />
                                    <br />
                            ...
                            <tr>
                                <td style="height: 11px" class="formItemBgStyleAlignLeft">
