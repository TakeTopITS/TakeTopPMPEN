                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,SuoYouYiShanChuWenJianGuanLi%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                    ...
                                    <table style="margin-top: 5px; width: 98%;">
                                        <tr>
                                            <td style="background: #f0f0f0; width: 100%; text-align: left">
                                                <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,ZongHeChaXun%>"></asp:Label>：<span><asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,WenJianMing%>"></asp:Label>：<asp:TextBox ID="TB_HazyFind" runat="server" Width="150px"></asp:TextBox>
                                                    <asp:Button ID="BT_HazyFind" runat="server" OnClick="BT_HazyFind_Click"
                                                        CssClass="inpu" Text="<%$ Resources:lang,MoHuChaXun%>" />&nbsp;
                                                    <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,ShangChuanZhe%>"></asp:Label>：<asp:TextBox ID="TB_UploaderName"
                                        ...
                                        <tr>
                                            <td style="background: #f0f0f0; width: 100%; height: 18px; text-align: left">
                                        ...
                                        <tr>
                                            <td style="width: 100%; height: 1px; text-align: center;">
                                                ...
                                                <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False" ShowHeader="false"
                                                    ...
                                                    OnItemCommand="DataGrid1_ItemCommand" PageSize="32" Width="100%" CellPadding="4"
