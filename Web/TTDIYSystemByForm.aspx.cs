...
public partial class TTDIYSystemByForm : System.Web.UI.Page
{
    ...
    protected void LoadWorkFlow(string strWFType, string strTemName, string strRelatedCode)
    {
        ...
        if (!string.IsNullOrEmpty(strRelatedCode))
        {
            strHQL = "Select * from T_WorkFlow as workFlow where workFlow.WLType = " + "'" + strWFType + "'" + " and workFlow.TemName = " + "'" + strTemName + "'" + " and workFlow.CreatorCode = " + "'" + strUserCode + "'" + " and workFlow.RelatedCode = '" + strRelatedCode + "' and char_length(rtrim(ltrim(workFlow.XSNFile)))>0 Order by workFlow.CreateTime DESC";
        }
        else
        {
            strHQL = "Select * from T_WorkFlow as workFlow where workFlow.WLType = " + "'" + strWFType + "'" + " and workFlow.TemName = " + "'" + strTemName + "'" + " and workFlow.CreatorCode = " + "'" + strUserCode + "'" + " and char_length(rtrim(ltrim(workFlow.XSNFile)))>0 Order by workFlow.CreateTime DESC";
        }
