                                            ...
                                            <td class="formItemBgStyleForAlignLeft">
                                                ...
                                                <asp:DataGrid ID="DataGrid2" runat="server" AutoGenerateColumns="False" Height="1px" PageSize="25"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundColumn DataField="BookClassificationName" HeaderText="StandardClassification">
                                                            <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="7%" />
                                                            <HeaderStyle BorderColor="#394f66" BorderStyle="Solid" BorderWidth="1px" Font-Bold="true"
                                                                Horizontalalign="left" />
                                                        </asp:BoundColumn>
                                                        ...
                                                        <asp:BoundColumn DataField="PublicationDate" HeaderText="ImplementationDate" DataFormatString="{0:yyyy-MM-dd}">
                                                            <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="8%" />
                                                            <HeaderStyle BorderColor="#394f66" BorderStyle="Solid" BorderWidth="1px" Font-Bold="true"
                                                                Horizontalalign="left" />
                                                        </asp:BoundColumn>
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popwindow"
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table cellpadding="2" cellspacing="0" class="formBgStyle" width="100%">
                                ...
                                <tr style="color: #000000">
                                    ...
                                    <td class="formItemBgStyleForAlignLeft" style="height: 30px">
                                        <asp:DropDownList ID="DL_Status" runat="server">
                                            <asp:ListItem Value="Current" Text="<%$ Resources:lang,XianXing%>" />
                                            <asp:ListItem Value="Obsolete" Text="<%$ Resources:lang,ZuoFei%>" />
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                ...
                                <tr style="color: #000000; display: none">
                                    ...
                                    <td class="formItemBgStyleForAlignLeft" style="height: 30px">
                                        <asp:DropDownList ID="DL_Source" runat="server">
                                            <asp:ListItem Value="Purchase" Text="<%$ Resources:lang,GouMai%>" />
                                            <asp:ListItem Value="Donation" Text="<%$ Resources:lang,JuanZeng%>" />
                                        </asp:DropDownList>
                                    </td>
                                    <td class="formItemBgStyleForAlignRight" style="height: 30px">
                                ...
                                <tr style="color: #000000">
                                    <td class="formItemBgStyleForAlignRight" style="height: 30px">&nbsp;<asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,DengJiZhe%>"></asp:Label>：</td>
                                    <td class="formItemBgStyleForAlignLeft" style="height: 30px">
