                ...
                <ContentTemplate>
                                                        ...
                                                        <ContentTemplate>
                                                            <table  style="width: 98%; text-align: left;" cellpadding="3" cellspacing="0">
                                                                <tr style="display: none">
                                                                    ...
                                                                    <td style="text-align: Right;" width="130px" class="formItemBgStyleAlignLeft">
                                                                        <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,YongHuBianMa %>"></asp:Label>：
                                                                    </td>
                                                                    <td style="text-align: left;" width="130px" class="formItemBgStyleAlignLeft">
                                                                        <asp:Label ID="LB_TrainingUserCode" runat="server"></asp:Label>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="formItemBgStyleAlignLeft" style="width: 100px; ">
                                                                    ...
                                                                    <td class="formItemBgStyleAlignLeft" style="text-align: Right;" width="130px">
                                                                ...
                                                                <tr>
                                                                    <td class="formItemBgStyleAlignLeft" colspan="4" style="text-align: center">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <table width="100%" cellpadding="3" cellspacing="0" >
                                                                                ...
                                                                                <td colspan="4">
                                                                                    ...
                                                                                    <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" GridLines="None"
                                                                                        ...
                                                                                        <Columns>
                                                                                            ...
                                                                                            <asp:HyperLinkColumn DataNavigateUrlField="AttachPath" DataNavigateUrlFormatString="{0}"  Text ="Attachment" HeaderText="扫描件" Target="_blank">
                                                                            ...
                                                                            <tr>
                                                                                <td style="width: 100px;" class="formItemBgStyleAlignLeft"></td>
                                                                                <td colspan="3" class="formItemBgStyleAlignLeft">
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popwindow"
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table>
                                <tr>
                                    <td class="formItemBgStyleAlignLeft" colspan="1" >
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popwindowHolder"
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            <table>
                               ...
                               <%-- <tr>
                                    <td class="formItemBgStyleAlignLeft" style="width: 100px; ">&nbsp;</td>
                                    <td class="formItemBgStyleAlignLeft" colspan="3">
