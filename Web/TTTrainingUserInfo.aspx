                                                        ...
                                                        <ContentTemplate>
                                                            <table  style="width: 98%; text-align: left;" cellpadding="3" cellspacing="0">
                                                                <tr style="display: none">
                                                                    ...
                                                                    <td style="text-align: Right;" width="130px" class="formItemBgStyleForAlignLeft">
                                                                        <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,YongHuBianMa %>"></asp:Label>：
                                                                    </td>
                                                                    <td style="text-align: left;" width="130px" class="formItemBgStyleForAlignLeft">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="formItemBgStyleForAlignLeft" style="text-align: Right;" width="130px">
                                                                        <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,XingBie %>"></asp:Label>：
                                                                    </td>
                                                                    <td class="formItemBgStyleForAlignLeft" style="text-align: left;" width="130px">
                                                                ...
                                                                <tr>
                                                                    <td class="formItemBgStyleForAlignLeft" colspan="4" style="text-align: left">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <table width="100%" cellpadding="3" cellspacing="0" >
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="4" align="right" class="formItemBgStyleForAlignLeft" style="padding: 5px 5px 5px 5px;">
