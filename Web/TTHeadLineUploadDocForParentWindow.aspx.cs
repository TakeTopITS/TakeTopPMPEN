...
public partial class TTHeadLineUploadDocForParentWindow : System.Web.UI.Page
{
    ...
    protected void BtnUP_Click(object sender, EventArgs e)
    {
        ...
        if (AttachFile.HasFile)
        {
            ...
            string strFileName3 = "Headline" + DateTime.Now.ToString("yyyyMMddHHMMssff") + strExtendName;
