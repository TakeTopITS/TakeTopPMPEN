                                    ...
                                    <contenttemplate>
                                        ...
                                        <table style="width: 98%;" cellpadding="5" cellspacing="0" class="formBgStyle">
                                            <tr>
                                                ...
                                                <td style="width: 150px; text-align: left" class="formItemBgStyleForAlignLeft">
                                                    <asp:DropDownList ID="DL_Type" runat="server" DataTextField="Type" DataValueField="Type">
                                                    </asp:DropDownList>
                                                </td>
                                                <td style="width: 166px;" class="formItemBgStyleForAlignLeft">
                                                ...
                                                <td style="width: 93px; text-align: left" class="formItemBgStyleForAlignLeft">
                                            ...
                                            <tr>
                                                <td rowspan="2" style="width: 10%;" class="formItemBgStyleForAlignLeft">
                                            ...
                                            <tr>
                                                <td style="width: 10%;  height: 16px;" class="formItemBgStyleForAlignLeft">
                                                    <asp:Label ID="Label31" runat="server" Text="<%$ Resources:lang,ZhuangTai %>"></asp:Label>
                                                    ：
                                                </td>
                                                <td style="text-align: left; width: 150px; height: 16px;" class="formItemBgStyleForAlignLeft">
                                                ...
                                                <td style="width: 150px; height: 16px;" class="formItemBgStyleForAlignLeft">
                                                ...
                                                <td style="width: 93px; height: 16px; text-align: left;" class="formItemBgStyleForAlignLeft">
                                            ...
                                            <tr style="display: none;">
                                                <td style="width: 10%;" class="formItemBgStyleForAlignLeft">&nbsp;<asp:Label ID="LB_Status" runat="server" Visible="False"></asp:Label>
                                                </td>
                                                <td colspan="5" style="width: 10%; text-align: left;" class="formItemBgStyleForAlignLeft">
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popAssignWindow" name="noConfirm"
                        ...
                        <div id="popwindow_content1" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table cellpadding="5" cellspacing="0" class="formBgStyle" style="width: 98%">
                                ...
                                <tr>
                                    <td style="width: 10%; height: 21px;" class="formItemBgStyleForAlignLeft">
                                ...
                                <tr>
                                    <td style="width: 10%; height: 21px;" class="formItemBgStyleForAlignLeft"></td>
                                    <td colspan="2" style="height: 21px; text-align: center" class="formItemBgStyleForAlignLeft">
                                    ...
                                    <td style="height: 21px; text-align: left" class="formItemBgStyleForAlignLeft"></td>
                                </tr>
                                <tr>
                                    <td style="width: 10%; height: 21px;" class="formItemBgStyleForAlignLeft"></td>
                                    <td colspan="3" style="height: 21px; text-align: left" class="formItemBgStyleForAlignLeft">
                                ...
                                <tr>
                                    <td colspan="4" style="text-align: left" class="formItemBgStyleForAlignLeft">
                                        <table width="100%" border="0" cellpadding="0" cellspacing="0" background="ImagesSkin/main_n_bj.jpg">
                                            <tr>
                                                <td width="7">
