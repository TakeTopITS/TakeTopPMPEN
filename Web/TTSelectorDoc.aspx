                                        ...
                                        <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                    <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,WenDang%>"></asp:Label>
                                                </td>
                                                <td width="5">
                                                                    ...
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td width="5%" align="center">
                                                                                <strong>
                                                                                    <input id='checkAll' type="checkbox" onclick="ChooseAll(this)" style="display: none;" /><asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,PingHeYiJian%>"></asp:Label>操作</strong>
                                                                            </td>
                                                            ...
                                                            <Columns>
                                                                <asp:TemplateColumn>
                                                                    ...
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <input id='<%# Eval("DocID") %>' type="checkbox" name="dlCode" />
                                                                ...
                                                                <asp:TemplateColumn>
                                                                    <ItemStyle CssClass="itemBorder" HorizontalAlign="Center" Width="8%" />
                                                                    <HeaderTemplate>
                                                                        <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,WenJianMing%>"></asp:Label>
                                                                    </HeaderTemplate>
                                                                    <ItemTemplate>
                                                                        <%# ShareClass.StringCutByRequire(Eval("DocName").ToString(), 190) %>
                                                                    </ItemTemplate>
                                                                </asp:TemplateColumn>
                                                            </Columns>
