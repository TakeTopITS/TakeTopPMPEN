<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTGoodsAfterSaleTaskDetail.aspx.cs" Inherits="TTGoodsAfterSaleTaskDetail" %>
                                                            ...
                                                            <table style="width: 98%;">
                                                                <tr>
                                                                    <td colspan="2" style="text-align: left;">
                                                                        <span class="style1">
                                                                            <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,RenWuFenPaiJiLuZiLiao%>"></asp:Label>：</span>
                                                                        （
                                                                        
                                                                        <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,GuanLian%>"></asp:Label><asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,ShangPinXinXi%>"></asp:Label>：
                                                                        <asp:HyperLink ID="HL_RelatedGoods" runat="server" Target="_blank"></asp:HyperLink>，
                                                                          &nbsp;
                                                                                    ...
                                                                                    <table cellpadding="4" cellspacing="0" style="width: 100%;">
                                                                                        <tr>
                                                                                            <td style="width: 15%; text-align: right;">
                                                                                                ...
                                                                                                ： </td>
                                                                                            <td align="left" style="width: 20%"><%# DataBinder.Eval(Container.DataItem,"ID") %></td>
                                                                                            ...
                                                                                            <td style="text-align: right">
                                                                                                ...
                                                                                                ： </td>
                                                                                            <td align="left"><%# DataBinder.Eval(Container.DataItem,"ManHour") %></td>
                                                                                            <td style="text-align: right">
                                                                                                <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,FeiYong%>"></asp:Label>
                                                                                                ： </td>
                                                                                            <td align="left"><%# DataBinder.Eval(Container.DataItem,"Expense") %></td>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td style="text-align: right;">
                                                                                                ...
                                                                                                ： </td>
                                                                                            <td colspan="7" style="text-align: left"><b><%# DataBinder.Eval(Container.DataItem,"Operation") %></b></td>
                                                                                        </tr>
                                                                                        <tr style="display: none;">
                                                                                            <td style="text-align: right;">
                                                                                                <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,KaiShiShiJian%>"></asp:Label>
                                                                                                ： </td>
                                                                                            <td align="left"><%# DataBinder.Eval(Container.DataItem,"BeginDate","{0:yyyy/MM/dd}") %></td>
                                                                                            <td style="text-align: right;">
                                                                                                <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,JieShuShiJian%>"></asp:Label>
                                                                                                ： </td>
                                                                                            <td align="left"><%# DataBinder.Eval(Container.DataItem, "EndDate", "{0:yyyy/MM/dd}")%></td>
                                                                                            <td style="text-align: right;">
                                                                                                <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,FenPaiRen%>"></asp:Label>
                                                                                                ： </td>
                                                                                            <td style="text-align: left;"><%# DataBinder.Eval(Container.DataItem,"AssignManName") %></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td style="text-align: right">
                                                                                                <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,WoDeFanKui%>"></asp:Label>
                                                                                                ： </td>
                                                                                            <td colspan="7" style="text-align: left"><%# DataBinder.Eval(Container.DataItem,"OperatorContent") %></td>
                                                                                        </tr>
                                                                                        <tr style="display: none;">
                                                                                        </tr>
                                                                                    </table>
                                                                ...
                                                                <tr>
                                                                    <td align="left" colspan="2">
                                                                        <cc1:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" CssClass="ajax_tab_menu" Width="98%">
                                                                            <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="TaskHandling">
                                                                                ...
                                                                                <ContentTemplate>
                                                                                    <table cellpadding="3" cellspacing="0" class="formBgStyle" width="80%">
                                                                                                ...
                                                                                                <table width="100%">
                                                                                                    <tr>
                                                                                                        <td align="left" width="20%">
                                                                                                            <asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,WoDeZongJie %>"></asp:Label>
                                                                                                        ...
                                                                                                        <td align="right">
                                                                                                            <asp:Repeater ID="Repeater1" runat="server">
                                                                                                                <ItemTemplate>
                                                                                                                    <a href='<%# DataBinder.Eval(Container.DataItem,"ModulePage") %>' target="iframe"><%# DataBinder.Eval(Container.DataItem,"HomeModuleName") %>&nbsp; </a>
                                                                                                                </ItemTemplate>
                                                                                                            </asp:Repeater>
                                                                                                            <%--    <asp:HyperLink ID="HL_TestCase" runat="server" NavigateUrl="TTMakeTaskTestCase.aspx" Text="<%$ Resources:lang,CeShiYongLi %>"
                                                                                                                Target="_blank"></asp:HyperLink>
                                                                                                            &nbsp;<asp:HyperLink ID="HL_TaskAssignRecord" runat="server" NavigateUrl="TTTaskAssignRecord.aspx" Text="<%$ Resources:lang,SuoYouFenPaiJiLu %>"
                                                                                                                Target="_blank"></asp:HyperLink>
                                                                                                            &nbsp;
                                                                                                            <asp:HyperLink ID="HL_TaskRelatedDoc" runat="server" NavigateUrl="TTProTaskRelatedDoc.aspx" Text="<%$ Resources:lang,XiangGuanWenDang %>"
                                                                                                                Target="_blank"></asp:HyperLink>

                                                                                                            &nbsp;&nbsp;<asp:HyperLink ID="HL_GoodsApplication" runat="server" Target="_blank" Text="<%$ Resources:lang,PeiJianShenLing %>"></asp:HyperLink>

                                                                                                            &nbsp;<asp:HyperLink ID="HL_ProjectDetail" runat="server" Target="_blank">
                                                                                                                <asp:Label runat="server" Text="<%$ Resources:lang,DangTianXiangMuRiZhi %>" ID="Label19"></asp:Label>
                                                                                                            </asp:HyperLink>
                                                                                                            &nbsp;<asp:HyperLink ID="HL_RelatedCustomer" runat="server" Enabled="False"
                                                                                                                NavigateUrl="TTMakeCustomer.aspx" Target="_blank">
                                                                                                                <asp:Label ID="Label23" runat="server" Text="<%$ Resources:lang,GuanLianKeHu %>"></asp:Label>
                                                                                                            </asp:HyperLink>--%>
                                                                                                            <asp:HyperLink ID="HL_TaskReview" runat="server" Enabled="False" Target="_blank" Visible="False">
                                                                                                                ---&gt;<asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,RenWuPingShen %>"></asp:Label>
                                                                                                            </asp:HyperLink>
                                                                                                            <asp:HyperLink ID="HL_MakeProjectReq" runat="server" Target="_blank" Visible="False">
                                                                                                                --&gt;<asp:Label ID="Label26" runat="server" Text="<%$ Resources:lang,JianLiHeFenPaiXuQiu %>"></asp:Label>
                                                                                                            </asp:HyperLink>
                                                                                                            &nbsp; &nbsp; </td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="left" class="formItemBgStyle" style="width: 100%;">
                                                                                                <table cellpadding="3" cellspacing="0" class="formBgStyle" width="100%">
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td class="formItemBgStyle" style="text-align: Left;">
                                                                                                            ...
                                                                                                            <NickLee:NumberBox ID="TB_Expense" runat="server" MaxAmount="1000000000000" MinAmount="-1000000000000" OnBlur="" OnFocus="" OnKeyPress="" PositiveColor="" Visible="False" Width="60px">0.00</NickLee:NumberBox>
                                                                                                            &nbsp;&nbsp;<asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,HaoFeiGongShi %>"></asp:Label>
                                                                                                            :
                                                                                                            <NickLee:NumberBox ID="NB_ManHour" runat="server" MaxAmount="1000000000000" MinAmount="-1000000000000" OnBlur="" OnFocus="" OnKeyPress="" PositiveColor="" Width="60px">0.00</NickLee:NumberBox>
                                                                                                            &nbsp;&nbsp;<asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,JinDu %>"></asp:Label>
                                                                                                            ：<NickLee:NumberBox ID="NB_FinishPercent" runat="server" MaxAmount="1000000000000" MinAmount="-1000000000000" OnBlur="" OnFocus="" OnKeyPress="" PositiveColor="" Precision="0" Width="60px">0</NickLee:NumberBox>
                                                                                                            ...
                                                                                                            ： 
                                                                                                            <NickLee:NumberBox ID="NB_TaskProgress" runat="server" Enabled="False" MaxAmount="1000000000000" MinAmount="-1000000000000" OnBlur="" OnFocus="" OnKeyPress="" PositiveColor="" Precision="0" Width="60px">0</NickLee:NumberBox>
                                                                                                            <asp:Label ID="Label10" runat="server" Font-Bold="True" Text="%"></asp:Label>
                                                                                                            &nbsp;&nbsp;
                                                                                                            <asp:Button ID="BT_StartupBusinessForm" runat="server" CssClass="inpu" OnClick="BT_StartupBusinessForm_Click" Text="<%$ Resources:lang,XiangGuanYeWuDan %>" />
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td class="formItemBgStyle" style="width: 10%; ">
                                                                                                            ...
                                                                                                            <table>
                                                                                                                <tr>
                                                                                                                    <td>
                                                                                                                        ...
                                                                                                                        &nbsp;<asp:Button ID="BT_TBD" runat="server" CssClass="inpu" OnClick="BT_TBD_Click" Text="<%$ Resources:lang,GuaQi %>" />
                                                                                                                    </td>
                                                                                                                    <td style="padding-left: 20px;">
                                                                                                                        <asp:Button ID="BT_CloseTask" runat="server" CssClass="inpuClose" Enabled="False" OnClick="BT_CloseTask_Click" ToolTip="<%$ Resources:lang,GuanBi%>" />
                                                                                                                        &nbsp;<asp:Button ID="BT_ActiveTask" runat="server" CssClass="inpuActive" Enabled="False" OnClick="BT_ActiveTask_Click" ToolTip="<%$ Resources:lang,JiHuo%>" />
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </table>
                                                                                                        </td>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td class="formItemBgStyle" colspan="2">
                                                                                                            ...
                                                                                                            <asp:Label ID="Label27" runat="server" Text="<%$ Resources:lang,TongZhiFenPaiRen %>"></asp:Label>
                                                                            ...
                                                                            <cc1:TabPanel ID="TabPanel1" runat="server" HeaderText="继续分派">
                                                                                <HeaderTemplate>
                                                                                    <asp:Label ID="Label45" runat="server" Text="<%$ Resources:lang,JiXuFenPai%>"></asp:Label>
                                                                                </HeaderTemplate>
                                                                                <ContentTemplate>
                                                                                    <table cellpadding="3" cellspacing="0" class="formBgStyle" width="98%">
                                                                                        <tr>
                                                                                            <td class="formItemBgStyle" style="width: 100%; text-align: left;"><strong>
                                                                                                <asp:Label ID="Label25" runat="server" Text="<%$ Resources:lang,YJXFPRWQXZSLRHSRGZYQ %>"></asp:Label>
                                                                                                ：<asp:Label ID="LB_ID" runat="server" Visible="False"></asp:Label>
                                                                                            </strong></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td align="left" class="formItemBgStyle">
                                                                                                <table cellpadding="3" cellspacing="0" class="formBgStyle" width="800">
                                                                                                    <tr>
                                                                                                        <td class="formItemBgStyle" style="width: 10%; ">
                                                                                                            <asp:Label ID="Label28" runat="server" Text="<%$ Resources:lang,LeiXing %>"></asp:Label>
                                                                                                            ： </td>
                                                                                                        ...
                                                                                                        <td class="formItemBgStyle" style="width: 20%; ">
                                                                                                            <asp:Label ID="Label29" runat="server" Text="<%$ Resources:lang,ShouLiRen %>"></asp:Label>
                                                                                                            ： </td>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td class="formItemBgStyle" style="width: 10%; ">
                                                                                                            <asp:Label ID="Label30" runat="server" Text="<%$ Resources:lang,GongZuoYaoQiu %>"></asp:Label>
                                                                                                            ： </td>
                                                                                                        <td class="formItemBgStyle" colspan="3">
                                                                                                            <CKEditor:CKEditorControl ID="HE_Operation" runat="server" Height="150px" Width="" />
                                                                                                            <CKEditor:CKEditorControl ID="HT_Operation" runat="server" Height="150px" Visible="False" Width="" />
                                                                                                            <asp:DropDownList ID="DL_WorkRequest" runat="server" AutoPostBack="True" DataTextField="Operation" DataValueField="Operation" OnSelectedIndexChanged="DL_WorkRequest_SelectedIndexChanged">
                                                                                                            </asp:DropDownList>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td class="formItemBgStyle" style="width: 10%; ">
                                                                                                            <asp:Label ID="Label31" runat="server" Text="<%$ Resources:lang,KaiShiShiJian %>"></asp:Label>
                                                                                                            ： </td>
                                                                                                        <td class="formItemBgStyle" style="width: 20%">
                                                                                                        ...
                                                                                                        <td class="formItemBgStyle" style="width: 20%; ">
                                                                                                            ...
                                                                                                            ： </td>
                                                                                                        <td class="formItemBgStyle" style="width: 50%">
                                                                                                            <asp:TextBox ID="DLC_EndDate" runat="server" AutoPostBack="True" OnTextChanged="DLC_EndDate_TextChanged"></asp:TextBox>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td class="formItemBgStyle" colspan="4">
                                                                                                            ...
                                                                                                            <asp:Label ID="Label33" runat="server" Text="<%$ Resources:lang,TongZhiShouLiRen %>"></asp:Label>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="left" class="formItemBgStyle"><strong>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="left" class="formItemBgStyle">
                                                                                                        ...
                                                                                                        <td>
                                                                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td align="left" width="8%"><strong>
                                                                                                                        <asp:Label ID="Label37" runat="server" Text="<%$ Resources:lang,LeiXing %>"></asp:Label>
                                                                                                                    </strong></td>
                                                                                                                    <td align="left" width="8%"><strong>
                                                                                                                        <asp:Label ID="Label38" runat="server" Text="<%$ Resources:lang,ShouLiRen %>"></asp:Label>
                                                                                                                    </strong></td>
                                                                                                                    <td align="left" width="24%"><strong>
                                                                                                                        <asp:Label ID="Label39" runat="server" Text="<%$ Resources:lang,ShouLiRenDeGongZuo %>"></asp:Label>
                                                                                                                    </strong></td>
                                                                                                                    <td align="left" width="12%"><strong>
                                                                                                                        <asp:Label ID="Label40" runat="server" Text="<%$ Resources:lang,KaiShiShiJian %>"></asp:Label>
                                                                                                                    </strong></td>
                                                                                                                    <td align="left" width="12%"><strong>
                                                                                                                        <asp:Label ID="Label41" runat="server" Text="<%$ Resources:lang,JieShuShiJian %>"></asp:Label>
                                                                                                                    </strong></td>
                                                                                                                    <td align="left" width="9%"><strong>
                                                                                                                        <asp:Label ID="Label42" runat="server" Text="<%$ Resources:lang,FeiYong %>"></asp:Label>
                                                                                                                    </strong></td>
                                                                                                                    <td align="left" width="10%"><strong>
                                                                                                                        <asp:Label ID="Label43" runat="server" Text="<%$ Resources:lang,LuXian %>"></asp:Label>
                                                                                                                    </strong></td>
                                                                                                                    <td align="left" width="9%"><strong>
                                                                                                ...
                                                                                                <asp:DataGrid ID="DataGrid2" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" Height="1px" OnItemCommand="DataGrid2_ItemCommand" ShowHeader="False" Width="100%">
                                                                                                    <Columns>
