<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTLTAllCustomerRequirement.aspx.cs" Inherits="TTLTAllCustomerRequirement" %>
                            ...
                            <tr>
                                <td height="31" class="page_topbj">
                                    <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td align="left">
                                                <table width="455" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td width="29">
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:DropDownList ID="DL_ServiceStatus" runat="server"
                                                                AutoPostBack="True"
                                                                OnSelectedIndexChanged="DL_ServiceStatus_SelectedIndexChanged">
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td width="4%" align="center">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label12342" runat="server" Text="<%$ Resources:lang,BianHao%>"></asp:Label></strong>
                                                                                </td>
