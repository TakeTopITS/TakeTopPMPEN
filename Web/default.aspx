...
<body>
                        ...
                        <div class="loginForm clearfix">
                            ...
                            <p>
                                ...
                                <em><a href="#" class="codea">
                                    <asp:Image ID="IM_CheckCode" src="TTCheckCode.aspx" runat="server" /></a></em>
    ...
    <div class="layui-layer layui-layer-iframe" id="popwindow" name="fixedDiv" style="z-index: 9999; width: 450px; height: 230px; position: absolute; overflow: hidden; display: none; border-radius: 10px;">
