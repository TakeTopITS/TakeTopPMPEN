...
<head id="Head1" runat="server">
    ...
    <style>
        ...
        .Nfo{height: 100%;}
        .lfbox{ padding-right: 80px;margin-bottom: 100px;}
        .lfbox p{ height: 60px;font: 36px/60px "microsoft yahei";color: #fff;display: flex;justify-content: flex-end; text-align: right;}
