<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTProjectImplementTotalFinanceReport.aspx.cs" Inherits="TTProjectImplementTotalFinanceReport" %>
                                    ...
                                    <table>
                                        <tr>
                                            <td>
                                                ...
                                                <iframe runat="server" id="IFrame_Chart_ProjectAnnualOutput" src="TTTakeTopAnalystChartSet.aspx" style="width: 800px; height: 295px; border: 1px solid white; overflow: hidden;"></iframe>

                                                <%--  <asp:Chart ID="Chart_ProjectAnnualOutput" runat="server" ImageType="Png" Width="600px">
                                                <Legends>
                                            ...
                                            <td>
                                                ...
                                                <%--  <asp:Chart ID="Chart_ConstractStatus" runat="server" Width="300px">
                                                <Series>
                                            ...
                                            <td>
                                                <iframe runat="server" id="IFrame_Chart_ProjectImplementStatus" src="TTTakeTopAnalystChartSet.aspx" style="width: 600px; height: 295px; border: 1px solid white; overflow: hidden;"></iframe>


                                                <%--  <asp:Chart ID="Chart_ProjectImplementStatus" runat="server" Width="600px" Palette="BrightPastel" BorderWidth="2" BorderColor="#cc9900">
                                                    <Series>
                                                        <asp:Series ChartArea="ChartArea1" ChartType="Column" Legend="Legend1" Name="Series1">
                                                        </asp:Series>
                                                    </Series>
                                                    <ChartAreas>
