                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,WuZiDaiMaShiYongBiaoJi%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                                ...
                                                <table style="width: 100%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                    <tr>
                                                        <td align="left" style="width: 45%; padding: 5px 5px 5px 5px;" class="formItemBgStyle" valign="top">
                                                            <asp:Button ID="BT_Title" runat="server" Text="<%$ Resources:lang,WuZiDaiMaChongZuoBiaoJi%>" OnClick="BT_Title_Click" CssClass="inpuLong" />&nbsp;
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
