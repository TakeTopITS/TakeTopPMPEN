                                        ...
                                        <ContentTemplate>
                                            <table style="width: 98%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                <tr>
                                                    ...
                                                    <td style="width: 15%; text-align: left" class="formItemBgStyleForAlignLeft">
                                                    ...
                                                    <td style="text-align: left; width: 15%;" class="formItemBgStyleForAlignLeft">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3" rowspan="2" style="text-align: left" class="formItemBgStyleForAlignLeft">
                                            ...
                                            <asp:Panel ID="Panel_RelatedBusiness" runat="server" Visible="false">
                                                <table style="width: 100%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 20%; text-align: left;" class="formItemBgStyleForAlignLeft">
                                                        ...
                                                        <td style="text-align: left;" class="formItemBgStyleForAlignLeft"></td>
                                                    </tr>
                                                </table>
                                            </asp:Panel>
                            ...
                            <div id="popwindow_content1" class="layui-layer-content" style="overflow: auto; text-align: left; padding: 0px 5px 0px 5px;">
                                ...
                                <table style="width: 100%" cellpadding="2" cellspacing="0" class="formBgStyle">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left" colspan="2" class="formItemBgStyleForAlignLeft">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" style="text-align: left" class="formItemBgStyleForAlignLeft">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4" style="text-align: left; height: 9px;" class="formItemBgStyleForAlignLeft">
                                    ...
                                    <tr>
                                        <td align="left">
                                            <table style="width: 100%;" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                <tr>
                                                    <td colspan="5" style="text-align: left; height: 4px;" class="formItemBgStyleForAlignLeft">
