<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTPlanToTask.aspx.cs" Inherits="TTPlanToTask" %>
                    ...
                    <div id="AboveDiv">
                                                            ...
                                                            <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    ...
                                                                    <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,JiHuaDaoRenWu%>"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                                        ...
                                                                        <strong>
                                                                            <asp:Label ID="Label64" runat="server" Text="<%$ Resources:lang,FenPai%>" /></strong>
                                                                                            ...
                                                                                            <td align="left" width="20%">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,RenWu%>"></asp:Label></strong>
                                                                                            </td>
                                                                                            <td align="left" width="8%">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,YouXianJi%>"></asp:Label></strong>
                                                                                            </td>
                                                                                            <td align="left" width="8%">
                                                                                                <strong>
                                                                                            ...
                                                                                            <td align="left" width="5%">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,YuSuan%>"></asp:Label></strong>
                                                                                            </td>
                                                                                            <td align="left" width="7%">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,WanChengChengDu%>"></asp:Label></strong>
                                                                                            </td>
                                                                                            <td align="left" width="7%">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,FeiYong%>"></asp:Label></strong>
                                                                                            </td>
                                                                                            <td align="left" width="5%">
                                                                                                <strong>
                        ...
                        <div class="layui-layer layui-layer-iframe" id="popwindow"
                                        ...
                                        <ContentTemplate>
                                            <table style="width: 98%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                <tr>
                                                    ...
                                                    <td style="width: 15%; text-align: left" class="formItemBgStyleAlignLeft">
                                                        <asp:DropDownList ID="DL_Type" runat="server" DataTextField="Type" DataValueField="Type">
                                                        </asp:DropDownList>
                                                        <asp:Label ID="LB_TaskNO" runat="server" Width="26px" Enabled="False"></asp:Label>
                                                    </td>
                                                    <td style="width: 20%;" class="formItemBgStyleAlignLeft">
                                                        <asp:Label ID="Label24" runat="server" Text="<%$ Resources:lang,YouXianJi %>"></asp:Label>:
                                                    </td>
                                                    <td style="text-align: left; width: 15%;" class="formItemBgStyleAlignLeft">
                                                    ...
                                                    <td style="width: 15%;" class="formItemBgStyleAlignLeft">
                                                        <asp:Label ID="Label25" runat="server" Text="<%$ Resources:lang,FeiYongYuSuan %>"></asp:Label>：
                                                    </td>
                                                    <td style="width: 15%; text-align: left" class="formItemBgStyleAlignLeft">
                                                        <NickLee:NumberBox MaxAmount="1000000000000" MinAmount="-1000000000000" ID="NB_Budget" runat="server" Width="65px" OnBlur="" OnFocus=""
                                                            OnKeyPress="" PositiveColor="">0.00</NickLee:NumberBox>
                                                    </td>
                                                </tr>
                                                <tr>

                                                    <td rowspan="2"  class="formItemBgStyleAlignLeft">

                                                        <asp:Label ID="Label26" runat="server" Text="<%$ Resources:lang,RenWu %>"></asp:Label>：
                                                    </td>

                                                    <td colspan="3" rowspan="2" style="text-align: left" class="formItemBgStyleAlignLeft">

                                                        <asp:TextBox ID="TB_Task" runat="server" Width="99%" Height="80px" TextMode="MultiLine"></asp:TextBox>
                                                    </td>

                                                    <td class="formItemBgStyleAlignLeft">

                                                        <asp:Label ID="Label27" runat="server" Text="<%$ Resources:lang,ShiJiFeiYong %>"></asp:Label>：
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="formItemBgStyleAlignLeft">
                                                        ...
                                                        <asp:Label ID="Label28" runat="server" Text="<%$ Resources:lang,GongShiYuSuan %>"></asp:Label>：
                                                    </td>

                                                    <td style="text-align: left" class="formItemBgStyleAlignLeft">

                                                        <NickLee:NumberBox MaxAmount="1000000000000" MinAmount="-1000000000000" ID="NB_ManHour" runat="server" Width="65px" OnBlur="" OnFocus=""
                                                            OnKeyPress="" PositiveColor="">0.00</NickLee:NumberBox>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="formItemBgStyleAlignLeft">
                                                        ...
                                                        <asp:Label ID="Label29" runat="server" Text="<%$ Resources:lang,KaiShiShiJian %>"></asp:Label>：
                                                    </td>
                                                    ...
                                                    <td class="formItemBgStyleAlignLeft">
                                                        ...
                                                        <asp:Label ID="Label30" runat="server" Text="<%$ Resources:lang,JieShuShiJian %>"></asp:Label>:
                                                    </td>
                                                    ...
                                                    <td style="text-align: left" class="formItemBgStyleAlignLeft">
                                                        ...
                                                        <NickLee:NumberBox MaxAmount="1000000000000" MinAmount="-1000000000000" ID="NB_RealManHour" runat="server" Enabled="False" Width="63px"
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="5" style="text-align: left;" class="formItemBgStyleAlignLeft">
                                                        <table width="100%">
                                                            <tr>
                                                                <td>
                                                                    <NickLee:NumberBox MaxAmount="1000000000000" ID="NB_RequireNumber" runat="server" Width="60px" MinAmount="0">
                                                                      0 0.00
                                                                    </NickLee:NumberBox>
                                                                </td>
                                                                <td style="text-align: right;">
                                                                    <asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,YiWanChenLiang %>" />：
                                                                </td>
                                                                <td style="text-align: left;">
                                                                    <NickLee:NumberBox ID="NB_FinishedNumber" runat="server" Amount="0" MaxAmount="1000000000000" MinAmount="0" Precision="2" Width="60px">
                                                                     0 0.00
                                                                    </NickLee:NumberBox></td>
                                                                <td style="text-align: right;">
                                                                    <asp:Label ID="Label32" runat="server" Text="<%$ Resources:lang,DanJia %>" /></td>
                                                               <td style="text-align: left;">
                                                                    <NickLee:NumberBox ID="NB_Price" runat="server" MaxAmount="1000000000000" MinAmount="0" Width="60px" OnBlur="" OnFocus="" OnKeyPress="" PositiveColor="">0.00</NickLee:NumberBox>
                                                                </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="formItemBgStyleAlignLeft" >
                                                        ...
                                                        ： </td>
                                                    <td class="formItemBgStyleAlignLeft" style="text-align: left;">
                                                        <asp:Label ID="LB_MakeDate" runat="server"></asp:Label>
                                                    </td>
                                                    <td class="formItemBgStyleAlignLeft" >
                                                        <asp:Label ID="Label34" runat="server" Text="<%$ Resources:lang,WanChengChengDu %>"></asp:Label>
                                                        ： </td>
                                                    <td class="formItemBgStyleAlignLeft" style="text-align: left;">
                                                        <NickLee:NumberBox ID="TB_FinishPercent" runat="server" Enabled="False" MaxAmount="1000000000000" MinAmount="-1000000000000" OnBlur="" OnFocus="" OnKeyPress="" PositiveColor="" Width="54px">0.00</NickLee:NumberBox>
                                                        % </td>
                                                </tr>
                                                <tr style="display: none;">
                                                    ...
                                                    <td colspan="5" style="text-align: left;" class="formItemBgStyleAlignLeft">
                                                        <asp:Button ID="BT_Close" runat="server" Enabled="False" Visible="False" CssClass="inpu" OnClick="BT_Close_Click"
                                                            Text="<%$ Resources:lang,GuanBi %>" />
                                                ...
                                                <table style="width: 100%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                    <%--  <tr>
                                                        <td colspan="8" align="left" style="padding-right: 7%;">
                                                            <asp:Label ID="Label40" runat="server" Text="<%$ Resources:lang,XiangGuanYeWuDan %>"></asp:Label>
                                                        </td>
                                                    </tr>--%>
                                                    <tr>
                                                        <td style="width: 10%; " class="formItemBgStyleAlignLeft">
                                                            <asp:Label ID="Label3333" runat="server" Text="<%$ Resources:lang,LeiXing %>"></asp:Label>: </td>
                                                        <td style="width: 20%; text-align: left;" class="formItemBgStyleAlignLeft">
                                                        ...
                                                        <td style="text-align: left;" class="formItemBgStyleAlignLeft"></td>
                                                    </tr>
                                                </table>
                                            </asp:Panel>
                            ...
                            <div id="popwindow_footer" class="layui-layer-btn" style="border-top: 1px solid #ccc;">
                                <asp:LinkButton ID="LinkButton1" runat="server" class="layui-layer-btn notTab" OnClientClick="window.frames['IFrame_RelatedInformation'].document.getElementById('BT_SaveXMLFile').click()" OnClick="BT_New_Click" Text="<%$ Resources:lang,BaoCun%>"></asp:LinkButton><a class="layui-layer-btn notTab" onclick="return popClose();"><asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,GuanBi%>" /></a>
                            </div>
                        ...
                        <div class="layui-layer layui-layer-iframe" id="popAssignWindow" name="noConfirm"
                            ...
                            <div id="popwindow_content1" class="layui-layer-content" style="overflow: auto; text-align: left; padding: 0px 5px 0px 5px;">
                                ...
                                <table style="width: 100%" cellpadding="2" cellspacing="0" class="formBgStyle">
                                    <tr>
                                        <td class="formItemBgStyleAlignLeft">
                                            ...
                                            <asp:Label ID="Label44" runat="server" Text="<%$ Resources:lang,CaoZuoZhe %>"></asp:Label>:
                                        </td>
                                        <td style="text-align: left;" class="formItemBgStyleAlignLeft">
                                            <asp:DropDownList ID="DL_OperatorCode" runat="server" DataTextField="UserName" DataValueField="UserCode" AutoPostBack="True"
                                                Width="100px" OnSelectedIndexChanged="DL_OperatorCode_SelectedIndexChanged">
                                            </asp:DropDownList>
                                            ...
                                            <asp:DropDownList ID="DL_PlanMember" runat="server" Visible="False" AutoPostBack="True" DataTextField="UserName" DataValueField="UserCode" OnSelectedIndexChanged="DL_PlanMember_SelectedIndexChanged">
                                            </asp:DropDownList>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 10%; " class="formItemBgStyleAlignLeft"></td>

                                        <td colspan="3" align="left" class="formItemBgStyleAlignLeft">

                                            <CKEditor:CKEditorControl ID="HE_Operation" runat="server" Height="100px" Width="90%" Visible="False" />

                                            <CKEditor:CKEditorControl runat="server" ID="HT_Operation" Width="90%" Height="100px" Visible="False" />
                                    ...
                                    <tr>
                                        ...
                                        <td class="formItemBgStyleAlignLeft">
                                            ...
                                            <asp:Label ID="Label46" runat="server" Text="<%$ Resources:lang,KaiShiShiJian %>"></asp:Label>:
                                        </td>
                                        ...
                                        <td style="text-align: left" class="formItemBgStyleAlignLeft">
                                            ...
                                            <ajaxToolkit:CalendarExtender Format="yyyy-MM-dd" ID="CalendarExtender4" runat="server" TargetControlID="DLC_TaskBegin" Enabled="True">
                                            </ajaxToolkit:CalendarExtender>
                                        </td>

                                        <td class="formItemBgStyleAlignLeft">

                                            <asp:Label ID="Label47" runat="server" Text="<%$ Resources:lang,JieShuShiJian %>"></asp:Label>:
                                        </td>
                                        ...
                                        <td style="text-align: left;" class="formItemBgStyleAlignLeft">
                                            ...
                                            <ajaxToolkit:CalendarExtender Format="yyyy-MM-dd" ID="CalendarExtender3" runat="server" TargetControlID="DLC_TaskEnd" Enabled="True">
                                            </ajaxToolkit:CalendarExtender>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="formItemBgStyleAlignLeft"></td>

                                        <td style="text-align: left" colspan="2" class="formItemBgStyleAlignLeft">

                                            <asp:Button ID="BT_UpdateAssign" runat="server" Text="<%$ Resources:lang,BaoCun %>" Enabled="False" OnClick="BT_UpdateAssign_Click"
                                                CssClass="inpu" />

                                            <asp:Button ID="BT_DeleteAssign" runat="server" Enabled="False" OnClick="BT_DeleteAssign_Click" OnClientClick="return confirm(getDeleteMsgByLangCode())"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" style="text-align: left" class="formItemBgStyleAlignLeft">
                                            ...
                                            <asp:CheckBox ID="CB_SendMail" runat="server" Font-Bold="False" Font-Size="10pt"
                                                Text="<%$ Resources:lang,FaYouJian %>" /><asp:Label ID="Label49" runat="server" Text="<%$ Resources:lang,TongZhiCaoZuoZhe %>"></asp:Label>

                                            <asp:TextBox ID="TB_Message" runat="server" Width="383px"></asp:TextBox><asp:Button
                                                ID="BT_Send" runat="server" OnClick="BT_Send_Click" Text="<%$ Resources:lang,FaSong %>" CssClass="inpu" />
                                        </td>
                                    </tr>

                                    <tr>

                                        <td colspan="4" style="text-align: left; height: 9px;" class="formItemBgStyleAlignLeft">

                                            <span><strong>

                                                <asp:Label ID="LB_TaskName" runat="server" Width="523px" Font-Size="10pt"
                                                    Visible="False" Font-Bold="False"></asp:Label></strong></span>
                                        </td>
                                    </tr>
                                </table>
                                <br />
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="9%" align="left">
                                                        ...
                                                        <strong>
                                                            ...
                                                            <asp:Label ID="Label50" runat="server" Text="<%$ Resources:lang,XuHao %>"></asp:Label></strong>
                                                    </td>
                                                    ...
                                                    <td width="11%" align="left">
                                                        ...
                                                        <strong>
                                                            ...
                                                            <asp:Label ID="Label52" runat="server" Text="<%$ Resources:lang,RenWu %>"></asp:Label></strong>
                                                    </td>
                                                    ...
                                                    <td width="8%" align="left">
                                                        ...
                                                        <strong>
                                                            ...
                                                            <asp:Label ID="Label53" runat="server" Text="<%$ Resources:lang,FenPaiZhe %>"></asp:Label></strong>
                                                    </td>
                                                    ...
                                                    <td width="8%" align="left">
                                                        ...
                                                        <strong>
                                                            ...
                                                            <asp:Label ID="Label54" runat="server" Text="<%$ Resources:lang,CaoZuoZhe %>"></asp:Label></strong>
                                                    </td>
                                                    ...
                                                    <td width="15%" align="left">
                                                        ...
                                                        <strong>
                                                            ...
                                                            <asp:Label ID="Label55" runat="server" Text="<%$ Resources:lang,GongZuo %>"></asp:Label></strong>
                                                    </td>
                                                    ...
                                                    <td width="12%" align="left">
                                                        ...
                                                        <strong>
                                                            ...
                                                            <asp:Label ID="Label56" runat="server" Text="<%$ Resources:lang,KaiShiShiJian %>"></asp:Label></strong>
                                                    </td>
                                                    ...
                                                    <td width="12%" align="left">
                                                        ...
                                                        <strong>
                                                            ...
                                                            <asp:Label ID="Label57" runat="server" Text="<%$ Resources:lang,JieShuShiJian %>"></asp:Label></strong>
                                                    </td>
                                                    ...
                                                    <td width="8%" align="left">
                                                        ...
                                                        <strong>
                                                            ...
                                                            <asp:Label ID="Label58" runat="server" Text="<%$ Resources:lang,FeiYong %>"></asp:Label></strong>
                                                    </td>
                                                    ...
                                                    <td width="8%" align="left">
                                                        ...
                                                        <strong>
                                                            ...
                                                            <asp:Label ID="Label59" runat="server" Text="<%$ Resources:lang,ZhuangTai %>"></asp:Label></strong>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                ...
                                <asp:DataGrid ID="DataGrid2" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="AssignManName" HeaderText="分派者">
                                        ...
                                        <asp:BoundColumn DataField="Operation" HeaderText="工作">
                            ...
                            <div id="popwindow_footer1" class="layui-layer-btn" style="border-top: 1px solid #ccc;">
                                <a class="layui-layer-btn notTab" onclick="return popClose();">
                                    <asp:Label ID="Label60" runat="server" Text="<%$ Resources:lang,GuanBi%>" /></a>
                            </div>
                            <span class="layui-layer-setwin"><a onclick="return popClose();" class="layui-layer-ico layui-layer-close layui-layer-close1 notTab" href="javascript:;"></a></span>
                        </div>
                                    ...
                                    <tr>
                                        <td align="left">
                                            <table style="width: 100%;" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                <tr>
                                                    <td colspan="5" style="text-align: left; height: 4px;" class="formItemBgStyleAlignLeft">
                                                        <asp:HyperLink ID="HL_TestCase" runat="server" Enabled="False" NavigateUrl="TTMakeTaskTestCase.aspx"
                                                            Target="_blank">
                                                            <asp:Label ID="Label37" runat="server" Text="<%$ Resources:lang,CeShiYongLi%>"></asp:Label>
                                                        </asp:HyperLink>
                                                     ...
                                                     <asp:HyperLink ID="HL_ActorGroup" runat="server" Enabled="False"
                                                        ...
                                                        &nbsp;&nbsp;
                                                       <asp:HyperLink ID="HL_RunTaskByWF" runat="server" Enabled="False" Target="_blank" Visible="false">---&gt;<asp:Label ID="Label39" runat="server" Text="<%$ Resources:lang,RenWuChuLiLiuChengMoShi%>"></asp:Label></asp:HyperLink>
                                                        &nbsp;&nbsp;
                                                    <asp:HyperLink ID="HL_TaskReview" runat="server" Enabled="False" Visible="false" Target="_blank">---&gt;<asp:Label ID="Label36" runat="server" Text="<%$ Resources:lang,RenWuPingShen%>"></asp:Label></asp:HyperLink>
                        ...
                        <asp:DataList ID="DataList1" runat="server" Width="98%" CellPadding="0" ForeColor="#333333" Visible="false">
                            <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                            <ItemTemplate>
                                <table cellpadding="5" cellspacing="0" style="width: 100%" class="bian">
                                    <tr>
