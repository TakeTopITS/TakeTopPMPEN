<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTInvolvedProDetailSAAS.aspx.cs" Inherits="TTInvolvedProDetailSAAS" %>
                                                            ...
                                                            <table width="95%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                                ...
                                                                <tr>
                                                                    <td colspan="2" class="formItemBgStyleForAlignLeft">
                                                                        ...
                                                                        &nbsp;<asp:TextBox ID="TB_Message" runat="server" Width="300px"></asp:TextBox><asp:Button
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0">
                                        ...
                                        <tr style="height: 15px; display: none;">
                                            <td style="text-align: left; height: 5px; padding-left: 40px;">
                                                <br />
                                                &nbsp;
                                                                                    --><asp:HyperLink ID="HL_LeadReview" runat="server" NavigateUrl="TTLeadReviewSummary.aspx" Font-Bold="True"
                                                                                        Target="_blank" Text="<%$ Resources:lang,LeadReviewSummary%>"></asp:HyperLink>

                                                &nbsp;<asp:HyperLink ID="HL_AssignTask" runat="server" Font-Bold="True" Target="_blank" Text="<%$ Resources:lang,hlAssignTask%>"></asp:HyperLink>

                                                &nbsp; 
                                                            <asp:HyperLink ID="HL_StatusChangeRecord" runat="server" NavigateUrl="TTUserFeebackSummary.aspx"
                                                                Target="_blank" Text="<%$ Resources:lang,StatusChangeRecord%>"></asp:HyperLink>
                                                &nbsp;
                                                            <asp:HyperLink ID="HL_TransferProject" runat="server" NavigateUrl="~/TTTransferProjectRecord.aspx"
                                                                Target="_blank" Text="<%$ Resources:lang,PMChangeRecord%>"></asp:HyperLink>
                                                ...
                                                <asp:HyperLink ID="HL_ProjectMeeting" runat="server" NavigateUrl="~/TTTransferProjectRecord.aspx"
                                                    Target="_blank" Text="<%$ Resources:lang,ProjectMeetingSummary%>"></asp:HyperLink>
                                                &nbsp;<asp:HyperLink ID="HL_RelatedReq" runat="server" NavigateUrl="TTProRelatedReqSummary.aspx"
                                                    Target="_blank" Text="<%$ Resources:lang,XiangMuXuQiu%>"></asp:HyperLink>
                                                ...
                                                &nbsp;<asp:HyperLink ID="HL_RunProjectByWF" runat="server" Target="_blank" Font-Bold="True" Text="<%$ Resources:lang,hlRunProjectByWF%>"></asp:HyperLink>
                                                &nbsp;<asp:HyperLink ID="HL_ExpenseApplyWL" runat="server" Font-Bold="True"
                                                    Target="_blank" Text="<%$ Resources:lang,hlApplyFunding%>"></asp:HyperLink>
                                                &nbsp;<asp:HyperLink ID="HL_AssignMeeting" runat="server" Font-Bold="True"
                                                    Target="_blank" Text="<%$ Resources:lang,hlArrangeMeeting%>"></asp:HyperLink>
                                                &nbsp;<asp:HyperLink ID="HL_MakeCollaborationThirdPart" runat="server" NavigateUrl="~/TTMakeCollaboration.aspx"
                                                    Font-Bold="True" Target="_blank" Text="<%$ Resources:lang,hlMakeCollaboration%>"></asp:HyperLink>
                                                &nbsp;--><asp:HyperLink ID="HL_WorkPlan" runat="server" Font-Bold="True" Target="_blank" Text="<%$ Resources:lang,GongZuoJiHua%>"></asp:HyperLink>
                                                <asp:HyperLink ID="HL_RelatedContactInfor" runat="server" Target="_blank" Text="<%$ Resources:lang,ProjectContact%>"></asp:HyperLink>

                                                <asp:HyperLink ID="HL_RelatedConstract" runat="server" NavigateUrl="TTProjectRelatedConstract.aspx"
                                                    Target="_blank" Text="<%$ Resources:lang,Constract%>"></asp:HyperLink>
                                                ...
                                                &nbsp;--><asp:HyperLink ID="HL_ReceivablesPayableHandle" runat="server" Font-Bold="True" Target="_blank" Text="<%$ Resources:lang,ShouFuKuanJiHua%>"></asp:HyperLink>
