                                            ...
                                            <td align="left">
                                                <table width="180" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">收款工作登记日志
                                                        </td>
                                                        <td width="5">
                                            ...
                                            <td>
                                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True" AllowPaging="True" OnPageIndexChanging="GridView2_PageIndexChanging">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="MoneyNum" HeaderText="收款额" DataFormatString="{0:N2}" HtmlEncode="False" />
