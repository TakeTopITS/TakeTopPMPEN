...
public partial class TTMakeGoodsByQRCode : System.Web.UI.Page
{
    ...
    protected void DataGrid5_ItemCommand(object sender, DataGridCommandEventArgs e)
    {
        if (e.CommandName != "Page")
        {
            ...
            try
            {
                ShareClass.LoadWareHousePositions(TB_WHName.Text.Trim(), DL_QrWHPosition);
            }
            catch
            {
            }
    ...
    protected void DataGrid1_ItemCommand(object sender, DataGridCommandEventArgs e)
    {
        ...
        if (e.CommandName != "Page")
        {
            ...
            if (e.CommandName == "Update")
            {
                ...
                try
                {
                    TB_WHPosition.Text = goodsCheckInOrderDetail.WHPosition;
                }
                catch
                {
                }
    ...
    protected void TB_GoodsCode_TextChanged(object sender, EventArgs e)
    {
        string strHQL;
    ...
    protected void TB_QrGoodsCode_TextChanged(object sender, EventArgs e)
    {
        string strHQL;

        string strGoodsCode = TB_QrGoodsCode.Text.Trim();
    ...
    protected void DL_QrWHPosition_SelectedIndexChanged(object sender, EventArgs e)
    {
        TB_WHPosition.Text = DL_QrWHPosition.SelectedValue;
    ...
    protected void AddDetail()
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click3432424234", "alert('" + LanguageHandle.GetWord("ZZYSRHYXDBNWKJC").ToString().Trim() + "')", true);
            ScriptManager.RegisterStartupScript(UpdatePanel1, GetType(), "pop", "popShow('popwindow','true','popDetailWindow') ", true);
        }
        else
        {
            ...
            goodsCheckInOrderDetail.WHPosition = TB_WHPosition.Text.Trim();
            ...
            try
            {
                ...
                ShareClass.addOrUpdateGoods(strCountMethod, "0", strCIOID, strGoodsCode, strGoodsName, strSN, deNumber, strUnitName,
                    strOwnerCode, strType, strSpec, strModelNumber, strPosition,TB_WHPosition.Text.Trim(), dePrice, strIsTaxPrice, strCurrencyType, dtBuyTime, intWarrantyPeriod,
    ...
    protected void UpdateDetail()
    {
        ...
        if (strOwnerCode == "" | strType == "" | strGoodsCode == "" | strSpec == "" | strPosition == "")
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "clickDFFASDDFASF", "alert('" + LanguageHandle.GetWord("ZZYSRHYXDBNWKJC").ToString().Trim() + "')", true);
            ScriptManager.RegisterStartupScript(UpdatePanel1, GetType(), "pop", "popShow('popwindow','true','popDetailWindow') ", true);
