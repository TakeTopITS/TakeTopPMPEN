<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTDIYWorkFlowForm.aspx.cs"
    Inherits="_TTDIYWorkFlowForm" Debug="true" ValidateRequest="false" %>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td  style="text-align:right; padding-left: 20px;">
                                        <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,GongZuoLiuMuBan%>"></asp:Label>：
                                    </td>
                                    <td>
                            ...
                            <td style="padding-left: 20px;">
                                <table>
                                    <tr>
                                        ...
                                        <td colspan="2" class="tdRight" style="width: 350px;" align="left">
                                            <asp:TextBox ID="TB_WLDescription" runat="server" Width="350px"></asp:TextBox>
                                        </td>
                                      
                                        <td class="tdRight" align="left" style="width: 100px;">
