<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTCreateReqDetail.aspx.cs"
    Inherits="TTCreateReqDetail" %>
                                                            ...
                                                            <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    ...
                                                                    <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,JLHFPXMXQ%>"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                                        ...
                                                                        <table width="100%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="formItemBgStyleForAlignLeft" colspan="2" style="padding-left: 20px;">
                                                                                    <asp:HyperLink ID="HL_RelatedDoc" runat="server" NavigateUrl="~/TTReqRelatedDoc.aspx" Text="<%$ Resources:lang,XiangGuanWenDang %>"
                                                                ...
                                                                <cc1:TabPanel ID="TabPanel3" runat="server" HeaderText="继续分派">
                                                                    ...
                                                                    <ContentTemplate>
                                                                        ...
                                                                        <table style="width: 93%;" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                                            <tr>
                                                                                <td width="70%"  class="formItemBgStyleForAlignLeft">
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            <table>
                                <tr>
                                    ...
                                    <td width="170px" class="formItemBgStyleForAlignLeft" rowspan="11" style="padding: 5px 5px 5px 5px;">
