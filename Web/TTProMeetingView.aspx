                                    ...
                                    <asp:DataGrid ID="DataGrid1" runat="server"  AutoGenerateColumns="False" ShowHeader="false"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:HyperLinkColumn DataNavigateUrlField="ID" DataNavigateUrlFormatString="TTMeetingView.aspx?ID={0}"
                                                DataTextField="Name" HeaderText="会议名称" Target="_blank">
                                            ...
                                            <asp:TemplateColumn Visible="False">
                                                <ItemTemplate>
                                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# DataBinder.Eval(Container, "DataItem.ID", "TTMeetingDoc.aspx?DocType=会议&RelatedID={0}") %>'
