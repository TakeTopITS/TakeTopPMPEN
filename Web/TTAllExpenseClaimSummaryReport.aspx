<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTAllExpenseClaimSummaryReport.aspx.cs"
    Inherits="TTAllExpenseClaimSummaryReport" %>
                                                ...
                                                <table width="265" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ChaKanSuoYouFeiYongBaoXiao%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                                                ...
                                                                <tr>
                                                                    <td colspan="3" style="text-align: left">
                                                                        ...
                                                                        <asp:DataGrid ID="DataGrid2" runat="server" AllowPaging="True" ShowHeader="false" PageSize="25"
                                                                            ...
                                                                            <ItemStyle CssClass="itemStyle" />
                                                                            <Columns>
                                                                                <asp:BoundColumn DataField="ECID" HeaderText="Number">
