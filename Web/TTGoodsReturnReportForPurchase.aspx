<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTGoodsReturnReportForPurchase.aspx.cs" Inherits="TTGoodsReturnReportForPurchase" %>
                                ...
                                <table style="width: 980px;">
                                    <tr>
                                        <td style="text-align: right;" width="6%">
                                            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,GongYingShangMingCheng%>"></asp:Label>：</td>
                                        <td align="left" width="25%">
                                            <asp:TextBox ID="TB_CustomerName" runat="server" Width="99%"></asp:TextBox>
                                        </td>
                                        <td style="text-align: left;" colspan="3">
                                            <asp:DropDownList ID="DL_Customer" runat="server" AutoPostBack="true" DataTextField="VendorName" DataValueField="VendorCode" OnSelectedIndexChanged="DL_Customer_SelectedIndexChanged" >
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <table style="width: 100%;">
                                    <tr>
                                        <td style="width: 100%; height: 80px; font-size: xx-large; text-align: center;">
                                            <br />
                                             <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,CaiGouTuiHuoBaoBiao%>"></asp:Label>
                                            <br />
                                        </td>
                                    </tr>
                                    <tr>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                             ...
                                                             <%--   <td align="center" width="4%">
                                                                    <strong>
                                                                        <asp:Label ID="Label22" runat="server" Text="VehicleNumber"></asp:Label></strong>
                                                                </td>
                                                                <td align="center" width="4%">
                                                                    <strong>
                                                                ...
                                                                <td align="center" width="4%">
                                                                    <strong>
                                                                        <asp:Label ID="Label23" runat="server" Text="仓库"></asp:Label></strong>
                                                                </td>--%>
                                                                ...
                                                                <td width="4%" align="center">
                                                                  ...
                                                                  <td width="4%" align="center">
                                                                    <strong>
                                                                        <asp:Label ID="Label29" runat="server" Text="<%$ Resources:lang,LaiYuan%>"></asp:Label></strong>
                                                                </td>
