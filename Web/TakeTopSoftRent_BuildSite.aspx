                                ...
                                <tr>
                                    <td width="70%">
                                        ...
                                        <div id="DIV_Message"  style="text-align:center;padding-top:100px;display:none;">
                                             <table>
                                                 <tr>
                                                    <td style="color:red;"><asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,ZhengZaiChuangJianNiDeYingYong%>"></asp:Label><asp:Label ID="Label1" runat="server" ForeColor="Red"></asp:Label>
                                                    </td>
                                                 </tr>
                                                   <tr>
                                        ...
                                        <div id="DIV_Top">
                                            ...
                                            <table class="ziti5" border="0" cellpadding="0" cellspacing="3" width="100%">
                                                ...
                                                <tr>
                                                    <td colspan="2" class="formItemBgStyleForAlignLeft"  ><asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,PingTaiMingChen%>"></asp:Label><font color="#FF0000">*</font>
                                                        <br />
                                                ...
                                                <tr>
                                                       <td colspan ="2" class="formItemBgStyleForAlignLeft"  ><asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,ZhanDianMingChen%>"></asp:Label><font color="#FF0000">*</font>
                                                           <br />
                                                ...
                                                <tr >
                                                   <td class="formItemBgStyleForAlignLeft"  style="width:100px;" >
                                                        <asp:Button ID="BT_Summit" runat="server" CssClass="inpu"  Height="30px" OnClientClick ="displayRelatedUI()"  OnClick="BT_Summit_Click"   Text="<%$ Resources:lang,ChuangJianZhanDian%>" />
                                                   </td>
                                                   <td class="formItemBgStyleForAlignLeft" >
                                                        <img id="Img_Message" src="Images/Processing.gif" alt="Building,please wait..." style="display:none;"/>
                                                        <span id="Span_Message" style="color:red;display:none;"><asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,ZhengZaiChuangJianZhanDianDa%>"></asp:Label></span>
                                            ...
                                            <li><asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,YinWeiYaoFuZhiZhanDianWenJian%>"></asp:Label></li>
                                            <li><asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,RuYouWenTiQingZhiJieLianXiKeFu%>"></asp:Label><br />
                                                <a href="tencent://message/?uin=3166455252&amp;Site=&amp;Menu=yes"><img align="absmiddle" src="images/qq.png" /><asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,KeFu%>"></asp:Label></a><asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,DianHua%>"></asp:Label><a href="tel:02151085119" class="call">021-51085119</a><br />
                                            </li>
