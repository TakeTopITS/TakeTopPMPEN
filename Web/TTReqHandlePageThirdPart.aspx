<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTReqHandlePageThirdPart.aspx.cs" Inherits="TTReqHandlePageThirdPart" %>
                                    ...
                                    <table width="96%" border="0" align="left" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td align="right" style="padding-top: 5px; display: none;">
                                                <asp:Button ID="BT_CreateReq" runat="server" CssClass="inpuLong" Text="<%$ Resources:lang,JianLiHeFenPaiXuQiu%>" OnClick="BT_CreateReq_Click" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td valign="top" style="padding: 0px 5px 5px 5px;">
                                    <cc2:TabContainer CssClass="ajax_tab_menu" ID="TabContainer2" runat="server" ActiveTabIndex="0" Width="100%">
                                        <cc2:TabPanel ID="TabPanel1" runat="server" HeaderText="正处理的需求：">
                                            <HeaderTemplate>
                                                                            ...
                                                                            <tr>
                                                                                <td align="left" width="100%">
                                                                                    <strong>
                                                                                        <table>
                                                                                            <tr>
                                                                                                <td align="left" style="text-align: center; padding-top: 4px;">
                                                                                                    <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,DaiChuLiDD %>"></asp:Label>
                                                                                                </td>
                                                                                                 <td style="padding-left: 10px; padding-top: 1px;">
                                                                                                    <asp:HyperLink ID="HL_CreateReq" runat="server"> <span style ="font-size:xx-large;color:red;"> +</span> </asp:HyperLink>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </strong>
                                                        ...
                                                        <td style="text-align: left; padding: 5px 5px 5px 5px">
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                ...
                                                                                <td width="38%" align="left"><strong>
                                                                                    <asp:Label ID="Label38" runat="server" Text="<%$ Resources:lang,XuQiuMingCheng%>"></asp:Label></strong></td>
                                                                                <td width="10%" align="left"><strong>
                                                                                    <asp:Label ID="Label39" runat="server" Text="<%$ Resources:lang,LeiXing%>"></asp:Label></strong></td>
                                                                                <td width="15%" align="left"><strong>
                                                                                    <asp:Label ID="Label40" runat="server" Text="<%$ Resources:lang,XuQiuRiQi%>"></asp:Label></strong></td>
                                                                                <td width="15%" align="left"><strong>
                                                                                    <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,JianLiRiQi%>"></asp:Label></strong></td>
                                                            ...
                                                            <asp:DataGrid ID="DataGrid5" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:HyperLinkColumn DataNavigateUrlField="ReqID" DataNavigateUrlFormatString="TTCreateReqDetailThirdPart.aspx?ReqID={0}"
                                                            ...
                                                            </asp:DataGrid><asp:Label ID="LB_Sql5" runat="server" Visible="False"></asp:Label></td>
                                                    </tr>
                                                </table>
                                                <br />
                                            </ContentTemplate>
