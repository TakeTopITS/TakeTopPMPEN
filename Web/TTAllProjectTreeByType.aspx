<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTAllProjectTreeByType.aspx.cs" Inherits="TTAllProjectTreeByType" %>
                                        ...
                                        <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                    <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,AnLeiXingLiuLanXiangMu%>"></asp:Label>
                                                </td>
                    ...
                    <tr>
                        <td>
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td valign="top" width="250" style="padding: 5px 5px 0px 5px; border-right: solid 1px #D8D8D8" align="left">
                                        <asp:TreeView ID="TreeView1" runat="server" OnSelectedNodeChanged="TreeView1_SelectedNodeChanged"
                                            ShowLines="True" Width="250" NodeWrap="True">
                                                            ...
                                                            <table style="width: 100%; "  cellpadding="4" cellspacing="0" class="bian">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 10%; text-align: right">
                                                                        <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,FeiYongYuSuan%>"></asp:Label>:
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: right">
                                                                        <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,XiangMuJingLi%>"></asp:Label>:
                                                                    </td>
                                                                    <td style="text-align: left">
                                                                        <%#DataBinder .Eval (Container .DataItem,"PMName") %>
                                                                    </td>
                                                                    <td style="text-align: right">
                                                                        <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,RenLiYuSuan%>"></asp:Label>:
                                                                    </td>
                                                                    <td style="text-align: left">
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: right;">
                                                                        <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,LiXiangRen%>"></asp:Label>:
                                                                    </td>
                                                                    <td style="text-align: left">
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: right">
                                                                        <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,KaiShiRiQi%>"></asp:Label>:
                                                                    </td>
                                                                    <td style="text-align: left">
                                                                        <%#DataBinder .Eval (Container .DataItem, "BeginDate","{0:yyyy/MM/dd}") %>
                                                                    </td>
                                                                    <td style="text-align: right">
                                                                        <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,JieShuRiQi%>"></asp:Label>:
                                                                    </td>
                                                                    <td style="text-align: left">
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: right">
                                                                        <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,LiXiangRiQi%>"></asp:Label>:
                                                                    </td>
                                                                    <td style="text-align: left">
                                                            ...
                                                            <table style="width: 100%;"  cellpadding="4" cellspacing="0" class="bian">
                                                                <tr>
                                                                    <td style="width: 10%; height: 20px; text-align: right">
                                                                        <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,ChengYuan%>"></asp:Label>:
                                                                    </td>
                                                                    <td style="width: 40%; height: 20px;" align="left">
                                                                            <%#DataBinder .Eval (Container .DataItem ,"UserName") %>
                                                                    </td>
                                                                    <td style="width: 10%; height: 20px; text-align: right">
                                                                        <asp:Label ID="Label15" runat="server" Text="<%$ Resources:lang,RiQi%>"></asp:Label>: 
                                                                ...
                                                                <tr>
                                                                    <td style="height: 20px; text-align: right">
                                                                        <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,FeiYong%>"></asp:Label>:
                                                                    </td>
                                                                    <td style="height: 20px;" align="left">
                                                                        <%#DataBinder .Eval (Container .DataItem ,"Charge") %>
                                                                    </td>
                                                                    <td style="height: 20px; text-align: right">
                                                                        <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,WanChengBaiFenBi%>"></asp:Label>:
                                                                    </td>
                                                                    <td align="left">
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: right">
                                                                        <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,MeiRiZongJie%>"></asp:Label>:
                                                                    </td>
