                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ChaKanSuoYouHuiYi%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                ...
                                <td style="padding: 5px 5px 5px 5px;">
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                                ...
                                                <table style="width: 100%;">
                                                    <tr>
                                                        <td style="text-align: left;">
                                                            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,JiangZhaoKaiDeHuiYi%>"></asp:Label>：
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 100%; height: 1px">
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                ...
                                                                                <td width="20%" align="center">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,HuiYiMingCheng%>"></asp:Label></strong>
                                                                                </td>
                                                            ...
                                                            <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                                Height="1px" OnPageIndexChanged="DataGrid1_PageIndexChanged" PageSize="10" Width="100%"
                                                    ...
                                                    <tr>
                                                        <td style="text-align: left;">
                                                            <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,YiZhaoKaiDeHuiYi%>"></asp:Label>：
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                                    ...
                                                                    <td>
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                ...
                                                                                <td width="20%" align="center">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,HuiYiMingCheng%>"></asp:Label></strong>
                                                                                </td>
                                                                                <td width="15%" align="center">
                                                                                    <strong>
                                                            ...
                                                            <asp:DataGrid ID="DataGrid2" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                                OnPageIndexChanged="DataGrid2_PageIndexChanged" Width="100%" CellPadding="4" PageSize ="10"
                                            ...
                                            <td width="180" style="padding: 5px 5px 5px 5px;" valign="top" align="center">
                                                <table width="100%">
                                                    <tr>
                                                        <td align="center">
                                                            <asp:Button ID="BT_AllMeeting" runat="server" CssClass="inpuLong" OnClick="BT_AllMeeting_Click"
                                                                Text="<%$ Resources:lang,WoSuoYouDeHuiYi%>" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="center">
                                                                    ...
                                                                    <td>
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td align="center">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,HuiYiShiLieBiao%>"></asp:Label></strong>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                            ...
                                                            <asp:DataGrid ID="DataGrid3" runat="server" AutoGenerateColumns="False" OnItemCommand="DataGrid3_ItemCommand"
                                                                ...
                                                                <ItemStyle CssClass="itemStyle" />
                                                                <Columns>
                                                                    <asp:TemplateColumn HeaderText="会议室列表：">
                                                                        <ItemTemplate>
