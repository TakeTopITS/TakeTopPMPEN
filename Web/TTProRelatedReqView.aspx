<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTProRelatedReqView.aspx.cs"
    Inherits="TTProRelatedReqView" %>
                                        ...
                                        <table style="width: 100%;" class="bian" cellpadding="4">
                                            ...
                                            <tr>
                                                <td style="height: 20px; text-align: right;">
                                                    <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,YaoQiuWanChengRiQi%>"></asp:Label>£º
                                                </td>
                                                <td style="height: 20px; text-align: left;">
                                                    <%#DataBinder .Eval (Container .DataItem ,"ReqFinishedDate","{0:yyyy/MM/dd}") %>
                                                </td>
                                                <td style="height: 20px; text-align: right;">
                                                    <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,JianLiRiQi%>"></asp:Label>£º
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="height: 20px; text-align: right;">
                                                    <a href="TTDocumentTreeView.aspx?RelatedType=Req&RelatedID=<%#DataBinder .Eval (Container .DataItem ,"ReqID")%>"
                                                        target="_blank">
