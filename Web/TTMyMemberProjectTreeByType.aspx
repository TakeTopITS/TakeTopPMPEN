<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTMyMemberProjectTreeByType.aspx.cs"
    Inherits="TTMyMemberProjectTreeByType" %>
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td style="width: 98%; height: 1px; vertical-align: top;">
                                            <table width="98%" style="margin-top: 5px" cellpadding="0" cellspacing="5">
                                                <tr>
                                                    <td align="left">
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:DataList ID="DataList2" runat="server" Width="100%" CellPadding="0"
                                                            ForeColor="#333333">
                                                            <SelectedItemStyle BackColor="#D1DDF1" Font-Bold="True" ForeColor="#333333" />
                                                            <HeaderStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                                            <ItemTemplate>
