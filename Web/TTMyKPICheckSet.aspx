<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTMyKPICheckSet.aspx.cs"
    Inherits="TTMyKPICheckSet" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,WoDeJiXiaoZiPing%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                ...
                                <tr>
                                        ...
                                        <asp:DataList ID="DataList2" runat="server" CellPadding="0" ForeColor="#333333" Height="16px"
                                            ...
                                            <ItemTemplate>
                                                <table cellpadding="4" cellspacing="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td align="left" class="tdLeft" style="color: Blue; font-style: italic;">
                                                            <asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,PingHeRen%>"></asp:Label>：<%#DataBinder.Eval(Container.DataItem, "LeaderName")%><br /><%#DataBinder.Eval(Container.DataItem, "Comment")%></td>
                                                    </tr>
                                                </table>
                                            </ItemTemplate>
                                            <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                        ...
                                        <asp:DataList ID="DataList4" runat="server" CellPadding="0" ForeColor="#333333" Height="16px"
                                            ...
                                            <ItemTemplate>
                                                <table cellpadding="4" cellspacing="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td align="left" class="tdLeft" style="color: Blue; font-style: italic;">
                                                            <asp:Label ID="Label23" runat="server" Text="<%$ Resources:lang,PingHeRen%>"></asp:Label>：<%#DataBinder.Eval(Container.DataItem, "HRName")%><br /><%#DataBinder.Eval(Container.DataItem, "Comment")%></td>
                                                    </tr>
                                                </table>
                                            </ItemTemplate>
                                            <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" valign="top" class="formItemBgStyle">
                                            <CKEditor:CKEditorControl ID="HE_SelfSummary" runat="server" Height="150px" Width="98%" Visible="false" />
                                            <CKEditor:CKEditorControl runat="server" ID="HT_SelfSummary" Width="98%" Height="150px" Visible="False" />
