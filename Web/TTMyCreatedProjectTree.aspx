<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTMyCreatedProjectTree.aspx.cs" Inherits="TTMyCreatedProjectTree" %>
                        ...
                        <tr>
                            <td>
                                <table width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="230" align="left" style="padding: 5px 5px 5px 5px; border-right: solid 1px #D8D8D8" valign="top">
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:DataList ID="DataList1" runat="server" Width="98%" CellPadding="0" CellSpacing="0"
                                                            ...
                                                            <ItemTemplate>
                                                                <table style="width: 100%;" cellpadding="4" class="bian" cellspacing="0">
                                                                    <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:HyperLink ID="HL_TaskRecordAssignSummary" runat="server"
                                                                        Target="_blank" Visible="False">
                                                                        <asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,XiangMuRenWu%>"></asp:Label></asp:HyperLink>
                                                                </td>
                                                                <td>
                                                                    <asp:HyperLink ID="HL_RelatedDoc" runat="server"
                                                                        NavigateUrl="TTDocumentTreeView.aspx" Target="_blank" Visible="False">
                                                                        <asp:Label ID="Label22" runat="server" Text="<%$ Resources:lang,XiangMuWenJian%>"></asp:Label></asp:HyperLink>
                                                                </td>
                                                                <td>
                                                                    <asp:HyperLink ID="HL_ImplePlan" runat="server" NavigateUrl="TTWorkPlanMain.aspx"
                                                                        Target="_blank" Visible="False">
                                                                        <asp:Label ID="Label23" runat="server" Text="<%$ Resources:lang,ShiShiJiHua%>"></asp:Label></asp:HyperLink>
                                                                </td>
                                                                <td>
                                                                    <asp:HyperLink ID="HL_RelatedUser" runat="server" NavigateUrl="TTProRelatedUser.aspx"
                                                                        Target="_blank" Visible="False">
                                                                        <asp:Label ID="Label24" runat="server" Text="<%$ Resources:lang,XiangMuChengYuan%>"></asp:Label></asp:HyperLink>
                                                                </td>
                                                                <td>
                                                                    <asp:HyperLink ID="HL_ExpenseSummary" runat="server"
                                                                        NavigateUrl="~/TTProjectExpenseReport.aspx" Target="_blank" Visible="False">
                                                                        <asp:Label ID="Label25" runat="server" Text="<%$ Resources:lang,XiangMuFeiYong%>"></asp:Label></asp:HyperLink>
                                                                </td>
                                                                <td>
                                                                    <asp:HyperLink ID="HL_RelatedRisk" runat="server"
                                                                        NavigateUrl="TTProRelatedRisk.aspx" Target="_blank" Visible="False">
                                                                        <asp:Label ID="Label26" runat="server" Text="<%$ Resources:lang,XiangGuanFengXian%>"></asp:Label></asp:HyperLink>
                                                                </td>
                                                                <td>
                                                                    <asp:HyperLink ID="HL_RelatedReq" runat="server"
                                                                        NavigateUrl="TTProRelatedReqSummary.aspx" Target="_blank" Visible="False">
                                                                        <asp:Label ID="Label27" runat="server" Text="<%$ Resources:lang,XiangMuXuQiu%>"></asp:Label></asp:HyperLink>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <asp:HyperLink ID="HL_RelatedMeeting" runat="server"
                                                                        NavigateUrl="TTProRelatedRisk.aspx" Target="_blank" Visible="False">
                                                                        <asp:Label ID="Label28" runat="server" Text="<%$ Resources:lang,XiangMuHuiYi%>"></asp:Label></asp:HyperLink>
                                                                </td>
                                                                <td>
                                                                    <asp:HyperLink ID="HL_StatusChangeRecord" runat="server" NavigateUrl="TTUserFeebackSummary.aspx"
                                                                        Target="_blank" Visible="False">
                                                                        <asp:Label ID="Label29" runat="server" Text="<%$ Resources:lang,ZhuangTaiBianGengJiLu%>"></asp:Label></asp:HyperLink>
                                                                </td>
                                                                <td>
                                                                    <asp:HyperLink ID="HL_LeadReview" runat="server" NavigateUrl="TTLeadReviewSummary.aspx"
                                                                        Target="_blank" Visible="False">
                                                                        <asp:Label ID="Label30" runat="server" Text="<%$ Resources:lang,ShangJiPingHeHuiZong%>"></asp:Label></asp:HyperLink>
                                                                </td>
                                                                <td>
                                                                    <asp:HyperLink ID="HL_TransferProject" runat="server" NavigateUrl="~/TTTransferProjectRecord.aspx"
                                                                        Target="_blank" Visible="False">
                                                                        <asp:Label ID="Label31" runat="server" Text="<%$ Resources:lang,XiangMuJingLiBianGengJiLu%>"></asp:Label></asp:HyperLink>
                                                                </td>
                                                                <td>
                                                                    <asp:HyperLink ID="HL_CustomerInfo" runat="server" Font-Size="10pt" NavigateUrl="~/TTCustomerInfo.aspx"
                                                                        Target="_blank" Visible="False">
                                                                        <asp:Label ID="Label32" runat="server" Text="<%$ Resources:lang,KeHuZiLiao%>"></asp:Label></asp:HyperLink>
                                                                </td>
                                                                <td>
                                                                    <asp:HyperLink ID="HL_VendorInfo" runat="server" Font-Size="10pt" NavigateUrl="~/TTVendorInfo.aspx"
                                                                        Target="_blank" Visible="False">
                                                                        <asp:Label ID="Label33" runat="server" Text="<%$ Resources:lang,GongYingShangZiLiao%>"></asp:Label></asp:HyperLink>
                                                                </td>
                                                                <td>&nbsp;</td>
                                                                <td></td>
                                                            </tr>
                                                                ...
                                                                <table style="width: 100%;" class="bian" cellpadding="4" cellspacing="0">
                                                                    <tr>
                                                                        <td style="width: 10%; height: 20px; text-align: right">
                                                                            <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,ChengYuan%>"></asp:Label>:
                                                                        </td>
                                                                        ...
                                                                        <td style="width: 10%; height: 20px; text-align: right">
                                                                            <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,RiQi%>"></asp:Label>:
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="height: 20px; text-align: right">
                                                                            <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,WanChengBaiFenBi%>"></asp:Label>:
                                                                        </td>
                                                                        <td align="left">
                                                                    ...
                                                                    <tr>
                                                                        <td style="text-align: right">
                                                                            <asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,MeiRiZongJie%>"></asp:Label>:
                                                                        </td>
