<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTProjectTaskDetail.aspx.cs"
    Inherits="TTProjectTaskDetail" %>
                                                            ...
                                                            <table style="width: 98%;">
                                                                <tr>
                                                                    <td colspan="2" style="text-align: left;">
                                                                        ...
                                                                        （<asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,GuanLianXiangMu%>"></asp:Label>：
                                                                        <asp:HyperLink ID="HL_RelatedProject" runat="server" Target="_blank"></asp:HyperLink>
                                                                        &nbsp;
                                                                            ...
                                                                            <asp:DataList ID="DataList2" runat="server" Width="100%" Height="1px" CellPadding="0"
                                                                                ...
                                                                                <ItemTemplate>
                                                                                    <table style="width: 100%;" cellpadding="4" cellspacing="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td style="text-align: right">
                                                                                                <asp:Label ID="Label26" runat="server" Text="<%$ Resources:lang,WoDeFanKui%>"></asp:Label>：
                                                                                            </td>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td style="text-align: left;" class="formItemBgStyle">
                                                                                                <table width="100%">
                                                                                                    <tr>
                                                                                                        <td align="left">
                                                                                                            <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,WoDeZongJie %>"></asp:Label>：<asp:Label ID="LB_AssignID" runat="server"
                                                                                                        ...
                                                                                                        <td align="right">
                                                                                                            ...
                                                                                                            <asp:HyperLink ID="HL_TaskReview" runat="server" Enabled="False" Target="_blank" Visible="False">
                                                                                                                ---&gt;<asp:Label ID="Label24" runat="server" Text="<%$ Resources:lang,RenWuPingShen %>"></asp:Label>
                                                                                                            </asp:HyperLink><asp:Label ID="LB_RouteNumber" runat="server" Visible="False"></asp:Label><asp:Label ID="LB_PlanID" runat="server" Visible="False"></asp:Label></td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td style="width: 100%;" align="left" class="formItemBgStyle">
                                                                                                <table width="100%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                                                                    <tr>
                                                                                                        <td style="width: 10%; padding-top:12px;" class="formItemBgStyle">
                                                                                                            <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,FeiYong %>"></asp:Label>： </td>
                                                                                                        <td style="text-align: Left;" class="formItemBgStyle">
                                                                                                            <table>
                                                                                                                <tr>
                                                                                                                    <td style="text-align: left;" >
                                                                                                                        <asp:HyperLink ID="HL_Expense" runat="server" NavigateUrl="TTProExpense.aspx" Target="_blank">
                                                                                                                            <asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,FeiYongMingXi %>"></asp:Label>
                                                                                                                        </asp:HyperLink>
                                                                                                                        ...
                                                                                                                        <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,HaoFeiGongShi %>"></asp:Label>:
                                                                                                                        <NickLee:NumberBox MaxAmount="1000000000000" MinAmount="-1000000000000" ID="NB_ManHour" runat="server" OnBlur="" OnFocus="" OnKeyPress=""
                                                                                                                            PositiveColor="" Width="50px">0.00</NickLee:NumberBox>&nbsp;&nbsp;<asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,JinDu %>"></asp:Label>：<NickLee:NumberBox MaxAmount="1000000000000" MinAmount="-1000000000000" ID="NB_FinishPercent" runat="server" OnBlur="" OnFocus="" OnKeyPress=""
                                                                                                                    ...
                                                                                                                    <td style="text-align: right;" >
                                                                                                                        <asp:Label ID="LB_UnitName" runat="server" ></asp:Label>
                                                                                                                    </td>
                                                                                                                    <td style="text-align: right;" >
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td style="padding-left: 20px;">
                                                                                                                        <asp:Button ID="BT_CloseTask" runat="server" Enabled="False" OnClick="BT_CloseTask_Click"
                                                                                                                            CssClass="inpuClose" ToolTip="<%$ Resources:lang,GuanBi%>" />&#160;<asp:Button ID="BT_ActiveTask" runat="server" Enabled="False" OnClick="BT_ActiveTask_Click"
                                                                                                                                CssClass="inpuActive" ToolTip="<%$ Resources:lang,JiHuo%>" /></td>
                                                                                                                </tr>
                                                                                                            </table>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td colspan="2" class="formItemBgStyle">
                                                                                                            <br />
                                                                                                            <asp:CheckBox ID="CB_ReturnMsg" runat="server" Font-Bold="False" Text="<%$ Resources:lang,FaXinXi %>" /><asp:CheckBox ID="CB_ReturnMail" runat="server" Font-Bold="False" Text="<%$ Resources:lang,FaYouJian %>" /><asp:Label ID="Label29" runat="server" Text="<%$ Resources:lang,TongZhiFenPaiRen %>"></asp:Label><asp:TextBox ID="TB_Message" runat="server" Width="50%"></asp:TextBox><asp:Button ID="BT_Send" runat="server" OnClick="BT_Send_Click" Text="<%$ Resources:lang,FaSong %>"
                                                                                                                CssClass="inpu" /></td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </td>
                                                                            ...
                                                                            <cc1:TabPanel ID="TabPanel1" runat="server" HeaderText="继续分派">
                                                                                ...
                                                                                <ContentTemplate>
                                                                                    <table width="98%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                                                        <tr>
                                                                                            <td style="width: 100%; text-align: left;" class="formItemBgStyle"><strong>
                                                                                                <asp:Label ID="Label30" runat="server" Text="<%$ Resources:lang,YJXFPRWQXZSLRHSRGZYQ %>"></asp:Label>：<asp:Label ID="LB_ID" runat="server" Visible="False"></asp:Label></strong></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td align="left" class="formItemBgStyle">
                                                                                                <table width="980" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                                                                    <tr>
                                                                                                        <td class="formItemBgStyle" style="width: 10%; ">
                                                                                                            <asp:Label ID="Label31" runat="server" Text="<%$ Resources:lang,LeiXing %>"></asp:Label>： </td>
                                                                                                        <td class="formItemBgStyle" style="width: 15%;">
                                                                                                            <asp:DropDownList ID="DL_RecordType" runat="server" DataTextField="Type" DataValueField="Type"></asp:DropDownList></td>
                                                                                                        <td class="formItemBgStyle" style="width: 20%; ">
                                                                                                            <asp:Label ID="Label32" runat="server" Text="<%$ Resources:lang,ShouLiRen %>"></asp:Label>： </td>
                                                                                                        <td class="formItemBgStyle" style="width: 55%;">
                                                                                                            <asp:DropDownList ID="DL_OperatorCode" runat="server" DataTextField="UserName" DataValueField="UserCode" AutoPostBack="True" OnSelectedIndexChanged="DL_OperatorCode_SelectedIndexChanged"></asp:DropDownList><asp:HyperLink ID="HL_MemberWorkload" Text="<%$ Resources:lang,ChaKanGongZuoFuHe %>" runat="server" Target="_blank"></asp:HyperLink><strong><asp:Label ID="LB_OperatorCode" runat="server" Visible="False"></asp:Label></strong></td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td class="formItemBgStyle" style="width: 10%; ">
                                                                                                            <asp:Label ID="Label34" runat="server" Text="<%$ Resources:lang,GongZuoYaoQiu %>"></asp:Label>： </td>
                                                                                                        <td class="formItemBgStyle" colspan="3">
                                                                                                            <CKEditor:CKEditorControl ID="HE_Operation" runat="server" Height="100px" Visible="False" Width="" /><CKEditor:CKEditorControl runat="server" ID="HT_Operation" Width="" Height="100px" Visible="False" /><asp:DropDownList ID="DL_WorkRequest" runat="server" AutoPostBack="True" DataTextField="Operation"
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td class="formItemBgStyle" style="width: 10%; ">
                                                                                                            <asp:Label ID="Label36" runat="server" Text="<%$ Resources:lang,KaiShiShiJian %>"></asp:Label>： </td>
                                                                                                        ...
                                                                                                        <td class="formItemBgStyle" style="">
                                                                                                            <asp:Label ID="Label35" runat="server" Text="<%$ Resources:lang,JieShuShiJian %>"></asp:Label>： </td>
                                                                                                        <td class="formItemBgStyle">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td class="formItemBgStyle" colspan="4">
                                                                                                            <asp:CheckBox ID="CB_SendMsg" runat="server" Font-Bold="False" Text="<%$ Resources:lang,FaXinXi %>" /><asp:CheckBox ID="CB_SendMail" runat="server" Font-Bold="False" Text="<%$ Resources:lang,FaYouJian %>" /><asp:Label ID="Label37" runat="server" Text="<%$ Resources:lang,TongZhiShouLiRen %>"></asp:Label><asp:TextBox ID="TB_AssignMessage" runat="server" Width="45%"></asp:TextBox><asp:Button ID="BT_SendAssignMsg" runat="server" CssClass="inpu" OnClick="BT_SendAssignMsg_Click"
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="left" class="formItemBgStyle"><strong>
                                                                                                <asp:Label ID="Label38" runat="server" Text="<%$ Resources:lang,CiRenWuFenPaiJiLuZiJiLu %>"></asp:Label>（<span style="font-size: 9pt"><asp:Label ID="Label39" runat="server" Text="<%$ Resources:lang,XuanZeKeZaiShangMianXiuGai %>"></asp:Label>）：</span></strong> </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td align="left" class="formItemBgStyle">
                                                                                                            ...
                                                                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td align="left" width="8%"><strong>
                                                                                                                        <asp:Label ID="Label41" runat="server" Text="<%$ Resources:lang,LeiXing %>"></asp:Label></strong></td>
                                                                                                                    <td align="left" width="8%"><strong>
                                                                                                                        <asp:Label ID="Label42" runat="server" Text="<%$ Resources:lang,ShouLiRen %>"></asp:Label></strong></td>
                                                                                                                    <td align="left" width="15%"><strong>
                                                                                                                        <asp:Label ID="Label43" runat="server" Text="<%$ Resources:lang,ShouLiRenDeGongZuo %>"></asp:Label></strong></td>
                                                                                                                    <td align="left" width="12%"><strong>
                                                                                                                        <asp:Label ID="Label44" runat="server" Text="<%$ Resources:lang,KaiShiShiJian %>"></asp:Label></strong></td>
                                                                                                                    <td align="left" width="12%"><strong>
                                                                                                                        <asp:Label ID="Label45" runat="server" Text="<%$ Resources:lang,JieShuShiJian %>"></asp:Label></strong></td>
                                                                                                                    <td align="left" width="9%"><strong>
                                                                                                                        <asp:Label ID="Label46" runat="server" Text="<%$ Resources:lang,FeiYong %>"></asp:Label></strong></td>
                                                                                                                    <td align="left" width="10%"><strong>
                                                                                                                        <asp:Label ID="Label47" runat="server" Text="<%$ Resources:lang,LuXian %>"></asp:Label></strong></td>
                                                                                                                    <td align="left" width="9%"><strong>
                                                                                                                        <asp:Label ID="Label48" runat="server" Text="<%$ Resources:lang,ZhuangTai %>"></asp:Label></strong></td>
                                                                                                                </tr>
                                                                                                            </table>
                                                                                                        </td>
                                                                        ...
                                                                        <asp:DataList ID="DataList3" runat="server" CellPadding="0" ForeColor="#333333" Height="1px"
                                                                            ...
                                                                            <ItemTemplate>
                                                                                <table cellpadding="4" cellspacing="0" style="width: 100%;">
                                                                                    <tr>
                                                                                        <td style="text-align: right">
                                                                                            <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,RenWuNeiRong%>"></asp:Label>：
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td style="text-align: left">
