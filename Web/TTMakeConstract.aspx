<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTMakeConstract.aspx.cs"
    Inherits="TTMakeConstract" %>
                                                                            ...
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr>
                                                                                    <td width="5%" align="left">
                                                                                        <strong>
                                                                                            <asp:Label ID="Label106" runat="server" Text="<%$ Resources:lang,BianJi %>" /></strong>
                                                                                    </td>
                                                                                    <td width="5%" align="left">
                                                                                        <strong>
                                                                                            <asp:Label ID="Label107" runat="server" Text="<%$ Resources:lang,ShanChu %>" /></strong>
                                                                                    </td>
                                                                                    ...
                                                                                    <td colspan="3" align="left"><strong>工作流 </strong></td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="text-align: center;">
                                                                                            ...
                                                                                            <div onclick="popShowByURL('TTRelatedDIYWorkflowForm.aspx?RelatedType=Constract&RelatedID=<%# ShareClass.URLEncode(Eval("ConstractID").ToString()) %>','ConstractReview', 600, 500)">
                                                                                                <asp:Label ID="Label19022" Text="<%$ Resources:lang, BiaoDan%>" runat="server"></asp:Label>
                                                                                            </div>
                                                                        ...
                                                                        <td>
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr>
                                                                                    <td width="5%" align="left">
                                                                                        <strong>
                                                                                            <asp:Label ID="Label108" runat="server" Text="<%$ Resources:lang,BianJi %>" /></strong>
                                                                                    </td>
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popwindow"
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="text-align: left; overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <cc1:TabContainer CssClass="ajax_tab_menu" ID="TabContainer4" Width="100%" runat="server" ActiveTabIndex="0">
                                                    ...
                                                    <table width="100%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                        <tr>
                                                            ...
                                                            <td class="formItemBgStyle" colspan="3">
                                                                <asp:TextBox ID="TB_ParentConstract" Width="97%" runat="server"></asp:TextBox>
                                                            ...
                                                            <td class="formItemBgStyle">
                                                                <table>
                                                                    <tr>
                                                                        ...
                                                                        <td style="display: none;" id="td_CSNotice" runat="server">
                                                        ...
                                                        <tr>
                                                            <td class="formItemBgStyle" style=" height: 13px;"></td>
                                                                ...
                                                                <table>
                                                                    <tr>
                                                                        <td align="left">
                                                                            ...
                                                                            <asp:TextBox ID="TB_PartA" runat="server" Width="200px"></asp:TextBox>
                                                                        </td>
                                ...
                                <cc1:TabPanel ID="TabPanel3" runat="server" HeaderText="VisiblePersonnel" TabIndex="2">
                                    <HeaderTemplate>
                                                                        ...
                                                                        <td>
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr>
                                                                                    <td width="5%" align="left">
                                                                                        <strong>
                                                                                            <asp:Label ID="Label109" runat="server" Text="<%$ Resources:lang,BianJi %>" /></strong>
                                                                                    </td>
                                                                                    <td width="5%" align="left">
                                                                                        <strong>
                                                                                            <asp:Label ID="Label110" runat="server" Text="<%$ Resources:lang,ShanChu %>" /></strong>
                                                                                    </td>
                                                                        ...
                                                                        <td>
                                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                <tr>
                                                                                    <td width="5%" align="left">
                                                                                        <strong>
                                                                                            <asp:Label ID="Label111" runat="server" Text="<%$ Resources:lang,BianJi %>" /></strong>
                                                                                    </td>
                                                                                    <td width="5%" align="left">
                                                                                        <strong>
                                                                                            <asp:Label ID="Label112" runat="server" Text="<%$ Resources:lang,ShanChu %>" /></strong>
                                                                                    </td>
                                                                        ...
                                                                        <td>
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr>
                                                                                    <td width="5%" align="left">
                                                                                        <strong>
                                                                                            <asp:Label ID="Label113" runat="server" Text="<%$ Resources:lang,BianJi %>" /></strong>
                                                                                    </td>
                                                                                    <td width="5%" align="left">
                                                                                        <strong>
                                                                                            <asp:Label ID="Label114" runat="server" Text="<%$ Resources:lang,ShanChu %>" /></strong>
                                                                                    </td>
                                                                ...
                                                                <asp:DataGrid ID="DataGrid18" runat="server" AutoGenerateColumns="False" GridLines="None"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundColumn DataField="OperatorName" HeaderText="变更人">
                                                                            <ItemStyle CssClass="itemBorder" Horizontalalign="left"></ItemStyle>
                                                                        </asp:BoundColumn>
                                                                    </Columns>
                                                                    <EditItemStyle BackColor="#2461BF" />
                                                                    <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                    ...
                                    <td width="60%">
                                        <table align="left" cellpadding="3" cellspacing="0" class="formBgStyle" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td style="" colspan="5" class="formItemBgStyle">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" style="text-align: left;" class="formItemBgStyle">
                                        <asp:DropDownList ID="DL_ChangeType" runat="server">
                                            <asp:ListItem Value="PartyAReason" Text="<%$ Resources:lang,JiaFangYuanYing %>" />
                                            <asp:ListItem Value="PartyBReason" Text="<%$ Resources:lang,YifangYuanYing %>" />
                                            <asp:ListItem Value="BothPartiesReason" Text="<%$ Resources:lang,ShuangFangYuanYing %>" />
                                        </asp:DropDownList>
