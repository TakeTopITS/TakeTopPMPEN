                                                        ...
                                                        <asp:DataGrid runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4"
                                                            ...
                                                            <Columns>
                                                                <asp:BoundColumn DataField="DocID" HeaderText="SerialNumber">
                                                                    <ItemStyle Horizontalalign="left" CssClass="itemBorder" Width="5%"></ItemStyle>
                                                                </asp:BoundColumn>
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        ...
                                                                                        <asp:DataGrid ID="DataGrid4" runat="server" AutoGenerateColumns="False" Height="1px"
                                                                                            ...
                                                                                            <PagerStyle CssClass="Page" Horizontalalign="left" BackColor="#2461BF" ForeColor="White" />
                                                                                            ...
                                                                                            <Columns>
                                                                                                ...
                                                                                                <asp:TemplateColumn>
                                                                                                    ...
                                                                                                    <ItemStyle CssClass="itemBorder" Width="10%" Horizontalalign="left" />
                                                                                                </asp:TemplateColumn>
                                                                                            </Columns>
