                            ...
                            <td style="text-align: left; font-weight: bold; color: #394f66; background-image: url('ImagesSkin/titleBG.jpg')">
                                ...
                                <table width="100%">
                                    <tr>
                                            ...
                                            <a id="a_return" runat="server" href="TTAppWorkFlow.aspx" onclick="javascript:document.getElementById('IMG_Waiting').style.display = 'block';" target="_top">
                                                <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titleziAPP" style="width: 60px;">
                                        ...
                                        <td style="width: 60px; text-align: left; color: #394f66; background-image: url('ImagesSkin/titleBG.jpg')">
                                            <asp:HyperLink ID="HL_WLRelatedDoc" runat="server" Target="_blank" ToolTip="上传文档">
                                                <img src="ImagesSkin/UploadDoc.png" width="24" height="24" class="noBorder" />
                                            </asp:HyperLink>
                                        </td>
                                        <td style="width: 30px; text-align: left;">
                                            <a href="javascript:ChangeMenu(0)">
                                                <asp:Image ID="IMG_LRArrow" ImageUrl="Images/UpDnArrow.png" Width="18px" Height="24px" border="0" alt="放大缩小" runat="server" ToolTip="放大缩小" />
                                            </a>
                                        </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 60px; text-align: center;">
                                                        ...
                                                        <NickLee:NumberBox MaxAmount="1000000000000" MinAmount="-1000000000000" ID="NB_ManHour" runat="server" OnBlur="" OnFocus="" OnKeyPress=""
                                                            PositiveColor="" Width="60px">
                                                            0.00</NickLee:NumberBox>
                                                    </td>
                                                    <td style="text-align: left; padding-top: 1px; color: #394f66; background-image: url('ImagesSkin/titleBG.jpg')">
                                                        <asp:Button ID="BT_SaveWFRelatedData" CssClass="inpuSave" Width="24" Height="24" runat="server" OnClick="BT_SaveWFRelatedData_Click" />
                                                    </td>
                                                    ...
                                                    <td style="width: 60px; text-align: center; display: none;">
                                                        <asp:Button ID="BT_GetRelatedData" runat="server" CssClass="inpuQuery" OnClick="BT_GetRelatedData_Click" ToolTip="<%$ Resources:lang,ChaKanXiangGanShuJi %>" />
                                                    </td>
                                                    ...
                                                    <td style="width: 100px; text-align: left;">
                                                        <asp:TextBox ID="DLC_SignDate" Width="99%" runat="server" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" onFocus="WdatePicker({lang:'auto'})"></asp:TextBox>
                    ...
                    <table cellpadding="0" cellspacing="0" class="bian" width="100%">
                        ...
                        <tr>
                            <td colspan="7">
                                ...
                                <asp:TextBox ID="TB_Content" onchange="reviewCommentTextChange()" TextMode="MultiLine" runat="server" Width="99%" Height="30"></asp:TextBox>
                                <%--</div>--%>
                            </td>
                        </tr>
                                                ...
                                                <ItemTemplate>
                                                    <table style="width: 100%;" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                        <tr>
                                                            ...
                                                            <td style="width: 80px; height: 15px; " class="formItemBgStyle">
                                                        ...
                                                        <table style="width: 100%; text-align: left;">
                                                            ...
                                                            <tr style="display: none;">
                                                                <td>
                                                                    ...
                                                                    <table style="width: 100%; display: none;" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                                        <tr>
                                                                            <td style="width: 10%; height: 15px; " class="formItemBgStyle">
                        ...
                        <table width="100%">
                            <tr>
                                <td class="formItemBgStyle" colspan="3">
                                    <table width="100%">
                                        <tr>
                                            <td class="formItemBgStyle" style="width: 10%; padding: 5px 5px 5px 5px; ">
                            ...
                            <tr>
                                ...
                                <td width="200px" class="formItemBgStyle" align="left" valign="top">
