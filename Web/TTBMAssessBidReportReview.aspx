                ...
                <ContentTemplate>
                    <div id="AboveDiv">
                        <table cellpadding="0" cellspacing="0" width="100%" align="left" class="bian">
                            ...
                            <tr>
                                <td align="left" style="padding-top: 5px; width: 50%">
                                ...
                                <td align="left" style="padding-top: 5px; width: 50%">
                                    <table cellpadding="2" cellspacing="0" class="formBgStyle" width="98%">
                                        <tr>
                                            ...
                                            <td align="left" rowspan="2" style="text-align: center">
                                    ...
                                    <table cellpadding="2" cellspacing="0" class="formBgStyle" width="98%">
                                        <tr>
                                            <td align="left" style="text-align: left" class="formItemBgStyle">&nbsp;&nbsp;<asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,PingBiaoBaoGaoLieBiao%>"></asp:Label>：</td>
                                        </tr>
                                        <tr>
                                            <td align="left" class="formItemBgStyle">
                            ...
                            <tr>
                                <td colspan="2" align="left" style="padding-top: 5px; width: 100%">
                                    <table cellpadding="2" cellspacing="0" class="formBgStyle" width="98%">
                                        <tr>
                                            <td align="left" style="text-align: left" class="formItemBgStyle">&nbsp;&nbsp;<asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,GongYingShangTouBiaoLieBiao%>"></asp:Label>：</td>
                                        </tr>
                                        <tr>
                                            <td align="left" class="formItemBgStyle">
                                                <table width="98%" border="0" cellpadding="0" cellspacing="0" background="ImagesSkin/main_n_bj.jpg">
