<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTUserInfor_StudentCostListNot.aspx.cs" Inherits="TTUserInfor_StudentCostListNot" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,XueShengWeiShouFei%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                            ...
                            <tr>
                                <td valign="top">
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td align="left">
                                                <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,Nian%>"></asp:Label><asp:DropDownList ID="DDL_SYear" runat="server"></asp:DropDownList>&nbsp;
                                                                                    <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,Yue%>"></asp:Label><asp:DropDownList ID="DDL_SMonth" runat="server"></asp:DropDownList>&nbsp;
                                                                        <asp:Button ID="BT_Seach" runat="server" Text="<%$ Resources:lang,ChaXun%>" CssClass="inpu" OnClick="BT_Seach_Click" />
                                            </td>
                                        </tr>
                                        <tr>

                                            <td align="left" style="width: 80%; border-right: solid 1px #D8D8D8; padding: 0px 0px 0px 5px"
                                                valign="top">
                                                <div style="width: 80%;">
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        ...
                                                                        <td width="12%" align="center">
                                                                            <strong>
                                                                                <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,MingChen%>"></asp:Label> </strong>
                                                                        </td>
                                                                        <td width="12%" align="center">
                                                                            <strong>
                                                                                <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,BanJi%>"></asp:Label> </strong>
                                                                        </td>
                                                                        <td width="12%" align="center">
                                                                            <strong>
                                                                                <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,XingBie%>"></asp:Label> </strong>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
