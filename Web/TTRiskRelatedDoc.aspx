<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTRiskRelatedDoc.aspx.cs"
    Inherits="TTRiskRelatedDoc" %>
                        ...
                        <tr>
                            <td>
                                <table width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="width: 200px; text-align: left; padding: 5px 5px 0px 5px; border-right: solid 1px #D8D8D8; vertical-align: top;" rowspan="5">
                                        ...
                                        <td valign="top" style="height: 24px; text-align: left; padding: 5px 5px 5px 5px;">
                                            <table align="left" cellpadding="3" cellspacing="0" width="98%">
                                                <tr>
                                                    <td style="display: none;">
                                                        <asp:Label ID="LB_FindCondition" runat="server"></asp:Label>
                                                        <asp:Label ID="LB_RiskID" runat="server"></asp:Label>
                                                                                ...
                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td width="5%" align="left">
                                                                                            <strong>
                                                                                                <asp:Label ID="Label29" runat="server" Text="<%$ Resources:lang,ShanChu %>"></asp:Label></strong>
                                                                                        </td>
                                                                    ...
                                                                    <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                                                                            ...
                                                                            <table class="FullBorderTable" style="width: 100%">
                                                                                ...
                                                                                <tr>
                                                                                    <td style="width: 100%; height: 25px; text-align: left;">
                                                                                        <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,LeiXing%>"></asp:Label>：<asp:Label ID="LB_DocTypeID" runat="server"></asp:Label>
                                                                                    ...
                                                                                    <td style="width: 100%; text-align: left;">
                                                                                        ...
                                                                                        <div id="uploader" class="wu-example">
                                                                                            <div id="thelist" class="uploader-list">
                                                                                                <asp:Label ID="Label9" Text="<%$ Resources:lang,DuWenJianShangZhuan%>" runat="server"></asp:Label>：
                                                                                            </div>
                                                                                            <div id="btns" class="btns">
                                                                                                <table>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <div id="picker">
                                                                                                                <asp:Label ID="Label27" runat="server" Text="<%$ Resources:lang,XuanZeWenJian%>"></asp:Label>
                                                                                                            </div>
                                                                                                        </td>
                                                                                                        <td style="padding-top: 10px; padding-left: 20px;">
                                                                                                            <button id="ctlBtn" class="btn btn-default">
                                                                                                                <asp:Label ID="Label28" runat="server" Text="<%$ Resources:lang,ShangChuan%>"></asp:Label>
                                                                                                            </button>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </table>
                                                                        ...
                                                                        <asp:View ID="View2" runat="server">
                                                                            <table style="width: 100%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                                                ...
                                                                                <tr style="font-size: 10pt">
                                                                                    <td style="width: 100%;" class="formItemBgStyleForAlignLeft">
                                                                                        <span style="font-size: 10pt">（<asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,YaoQiuShouDaoXinXi%>"></asp:Label>：<asp:CheckBox ID="CB_RiskuiredMail" runat="server"
                                                                                            Font-Size="10pt" Text="<%$ Resources:lang,YouJian%>" />
                                                                                            <asp:CheckBox ID="CB_RiskuiredSMS" runat="server" Font-Size="10pt" Text="<%$ Resources:lang,DuanXin%>" />）
                                                                                        </span>
                                                                            ...
                                                                            <table width="100%" cellpadding="3" cellspacing="0">
                                                                                <tr>
                                                                                    <td align="left">
                                                                                        <asp:Label ID="Label22" runat="server" Text="<%$ Resources:lang,DuiYingPingShenJiLu%>"></asp:Label>：
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>
