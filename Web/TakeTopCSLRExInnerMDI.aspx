<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TakeTopCSLRExInnerMDI.aspx.cs" Inherits="TakeTopCSLRExInnerMDI" %>
...
<frameset id="TakeTopLRMDI" cols="45,*" rows="*" frameborder="no" border="0" framespacing="0">
    ...
    <frameset rows="43,*,1" name="leftFrame" id="leftFrame" frameborder="no" border="0" framespacing="0">
        ...
        <frame src='TakeTopCSLRLeft.aspx?UserCode=<%=strUserCode%>&Flag=<%=Session["SkinFlag"].ToString()%>' id="leftMiddleFrameID" name="leftMiddleFrame" scrolling="no" noresize />
