                                            ...
                                            <td class="formItemBgStyleForAlignLeft">
                                                ...
                                                <asp:DataGrid ID="DataGrid2" runat="server" AutoGenerateColumns="False" Height="1px"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundColumn DataField="EstimateCompletionDate" HeaderText="预计完成日期" DataFormatString="{0:yyyy-MM-dd}">
                                                            <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="10%" />
                                                            <HeaderStyle BorderColor="#394f66" BorderStyle="Solid" BorderWidth="1px" Font-Bold="true"
                                                                Horizontalalign="left" />
                                                        </asp:BoundColumn>
                                                        <asp:BoundColumn DataField="CorrectiveAction" HeaderText="整改措施">
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popwindow"
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table cellpadding="2" cellspacing="0" class="formBgStyle" width="900px">
                                ...
                                <tr style="color: #000000">
                                    <td class="formItemBgStyleForAlignLeft" style="width: 150px; height: 30px">&nbsp;<asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,LeiXing%>"></asp:Label>：</td>
                                    <td class="formItemBgStyleForAlignLeft" style="height: 30px">
                                ...
                                <tr style="color: #000000">
                                    <td class="formItemBgStyleForAlignLeft" style="width: 150px; height: 30px">&nbsp;<asp:Label ID="Label15" runat="server" Text="<%$ Resources:lang,PingShenRen%>"></asp:Label>：</td>
                                    <td class="formItemBgStyleForAlignLeft" style="height: 30px">
