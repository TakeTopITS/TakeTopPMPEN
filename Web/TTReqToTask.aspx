<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTReqToTask.aspx.cs" Inherits="TTReqToTask" %>
        ...
        <form id="form1" runat="server">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                                                            ...
                                                            <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    ...
                                                                    <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,XuQiuZhuanRenWu%>"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                ...
                                                <table cellpadding="3" cellspacing="0" style="width: 100%">
                                                        ...
                                                        <td style="height: 11px; text-align: left">
                                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" background="ImagesSkin/main_n_bj.jpg">
                                                                <tr>
                                                                    ...
                                                                    <td width="5%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label22" runat="server" Text="<%$ Resources:lang,ShanChu %>" /></strong>
                                                                    </td>
                                                                    <td width="5%" align="left">
                                                                        <strong>
                                                    ...
                                                    <tr>
                                                        <td style="text-align: left;">
                                                            <asp:Label ID="LB_ReqRecordID" runat="server" Visible="False"></asp:Label>
                                ...
                                <cc1:TabPanel ID="TabPanel1" runat="server" HeaderText="基本信息" TabIndex="0">
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <table style="width: 90%;" cellpadding="3" cellspacing="0" class="formBgStyle">
                                            <tr>
                                                <td style="width: 12%;" class="formItemBgStyleAlignLeft">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3" rowspan="2" style="text-align: left" class="formItemBgStyleAlignLeft">
                                                    <asp:TextBox ID="TB_Task" runat="server" Height="45px" TextMode="MultiLine" Width="98%"></asp:TextBox>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left" class="formItemBgStyleAlignLeft">
                                                    <asp:TextBox ID="DLC_BeginDate" runat="server" Width="100px"></asp:TextBox>
                        ...
                        <div id="popwindow_content1" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table cellpadding="3" cellspacing="0" style="width: 100%" class="formBgStyle">
                                ...
                                <tr>
                                    ...
                                    <td class="formItemBgStyleAlignLeft" style="width: 30%; text-align: left;">
                                    ...
                                    <td class="formItemBgStyleAlignLeft" style="text-align: left;">
                                        ...
                                        <asp:HyperLink ID="HL_MemberWorkload" runat="server" Target="_blank">
                                            <asp:Label ID="Label46" runat="server" Text="<%$ Resources:lang,ChaKanGongZuoFuHe %>"></asp:Label>
                                        </asp:HyperLink>
                                ...
                                <tr>
                                    <td class="formItemBgStyleAlignLeft">
                                        <asp:Label ID="Label47" runat="server" Text="<%$ Resources:lang,GongZuoYaoQiu %>"></asp:Label>：
                                    </td>
                                ...
                                <tr>
                                    <td class="formItemBgStyleAlignLeft">
                                        <asp:Label ID="Label48" runat="server" Text="<%$ Resources:lang,KaiShiShiJian %>"></asp:Label>：
                                    </td>
                                    <td style="width: 220px; text-align: left" class="formItemBgStyleAlignLeft">
                                    ...
                                    <td class="formItemBgStyleAlignLeft">
                                        <asp:Label ID="Label49" runat="server" Text="<%$ Resources:lang,JieShuShiJian %>"></asp:Label>：
                                    </td>
                                    <td style="text-align: left;" class="formItemBgStyleAlignLeft">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" style="text-align: left;" class="formItemBgStyleAlignLeft">
                                        ...
                                        <td class="formItemBgStyleAlignLeft" style="height: 21px; text-align: left">&nbsp;&nbsp;
                                        </td>
                                        <tr>
                                            <td class="formItemBgStyleAlignLeft" style="width: 150px; height: 21px; "></td>
                                            <td class="formItemBgStyleAlignLeft" colspan="3" style="height: 21px; text-align: left">
                                                ...
                                                <span style="font-size: 10pt">
                                                    <asp:Label ID="Label50" runat="server" Text="<%$ Resources:lang,TongZhiShouLiRen %>"></asp:Label></span>
                                        ...
                                        <tr>
                                            <td class="formItemBgStyleAlignLeft" colspan="4" style="text-align: left; height: 9px;">
                                                <span><strong>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td width="9%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label51" runat="server" Text="<%$ Resources:lang,XuHao %>"></asp:Label></strong>
                                                            </td>
                                                            ...
                                                            <td width="11%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label53" runat="server" Text="<%$ Resources:lang,RenWu %>"></asp:Label></strong>
                                                            </td>
                                                            <td width="8%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label54" runat="server" Text="<%$ Resources:lang,FenPaiRen %>"></asp:Label></strong>
                                                            </td>
                                                            <td width="8%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label55" runat="server" Text="<%$ Resources:lang,ShouLiRen %>"></asp:Label></strong>
                                                            </td>
                                                            <td width="12%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label56" runat="server" Text="<%$ Resources:lang,ShouLiRenDeGongZuo %>"></asp:Label></strong>
                                                            </td>
                                                            <td width="8%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label57" runat="server" Text="<%$ Resources:lang,KaiShiShiJian %>"></asp:Label></strong>
                                                            </td>
                                                            <td width="8%" align="left">
                                                                <strong>
                                                            ...
                                                            <td width="8%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label60" runat="server" Text="<%$ Resources:lang,LuXian %>"></asp:Label></strong>
                                                            </td>
                                                            <td align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label61" runat="server" Text="<%$ Resources:lang,ZhuangTai %>"></asp:Label></strong>
                                                            </td>
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popOtherWindow" name="fixedDivNoConfirm"
                        style="z-index: 9999; width: 98%; height: 550px; position: absolute; overflow: hidden; display: none; border-radius: 10px;">
                    ...
                    <asp:DataList ID="DataList1" runat="server" Width="100%" CellPadding="0" CellSpacing="0" Visible="false">
                        <ItemTemplate>
                            <table style="width: 100%;" cellpadding="3" cellspacing="0" class="bian">
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 83px; height: 20px; text-align: right;">
                                        <asp:Label ID="Label62" runat="server" Text="<%$ Resources:lang,JianLiRiQi%>"></asp:Label>：<td style="height: 20px; text-align: left; width: 212px;" colspan="2">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" style="text-align: center">
                                        <span style="color: #0000ff;"><a href="TTDocumentTreeView.aspx?RelatedType=Req&RelatedID=<%#DataBinder .Eval (Container .DataItem ,"ReqID")%>"
                                            target="_blank">
                                            <asp:Label ID="Label64" runat="server" Text="<%$ Resources:lang,XiangGuanWenJian%>"></asp:Label></a> &nbsp;<a href="TTReqAssignRecord.aspx?ReqID=<%#DataBinder .Eval (Container .DataItem ,"ReqID")%>"
                                                target="_blank"><asp:Label ID="Label63" runat="server" Text="<%$ Resources:lang,FenPaiJiLu%>"></asp:Label></a>
                                    </td>
                                </tr>
                            </table>
                        </ItemTemplate>
