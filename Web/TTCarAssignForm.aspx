                                    ...
                                    <td class="formItemBgStyleForAlignLeft" colspan="2">
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Label ID="Label47" runat="server" Text="<%$ Resources:lang,Shi%>"></asp:Label>
                                                </td>
                                                <td>
                                    ...
                                    <td colspan="2"  class="formItemBgStyleForAlignLeft">
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Label ID="Label52" runat="server" Text="<%$ Resources:lang,Shi%>"></asp:Label>
                                                </td>
                                                <td>
                                                ...
                                                <td class="formItemBgStyleForAlignLeft" colspan="3">
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,Shi%>"></asp:Label>
                                                            </td>
                                                            <td>
                                                ...
                                                <td class="formItemBgStyleForAlignLeft" colspan="3">
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,Shi%>"></asp:Label>
                                                            </td>
                                                            <td>
                                            ...
                                            <tr>
                                                ...
                                                <td  style="height: 6px" class="formItemBgStyleForAlignLeft">
                                                    <asp:DropDownList ID="DL_Status" runat="server" OnSelectedIndexChanged="DL_Status_SelectedIndexChanged"
                                                        ...
                                                        <asp:ListItem Value="Departure" Text="<%$ Resources:lang,ChuChe%>" />
                                                        <asp:ListItem Value="Return" Text="<%$ Resources:lang,ShouChe%>" />
                                                        <asp:ListItem Value="Closed" Text="<%$ Resources:lang,GuanBi%>" />
