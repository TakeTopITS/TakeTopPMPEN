                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,YuZhongBiaoTongZhiShu%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                    ...
                                    <table cellpadding="2" cellspacing="0" class="formBgStyle" width="75%">
                                        <tr>
                                             <td align="left">
                                                ...
                                                <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,ZhaoBiaoFangAnXinXi%>"></asp:Label>：<asp:TextBox ID="TextBox2" runat="server" Width="120px"></asp:TextBox>
                                           
                                                <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,TongZhiRiQi%>"></asp:Label>：<asp:TextBox ID="TextBox3" runat="server" Width="100px" ReadOnly="false"></asp:TextBox>
                                            ...
                                            <td class="formItemBgStyleForAlignLeft">
                                                        ...
                                                        <td>
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td width="20%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label15" runat="server" Text="<%$ Resources:lang,ZhongBiaoTongZhiNeiRong%>"></asp:Label></strong>
                                                                    </td>
                                                                    <td width="20%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,WeiZhongBiaoTongZhi%>"></asp:Label></strong>
                                                                    </td>
                                                                    <td width="10%" align="left">
                                                                        <strong>
                                                ...
                                                <asp:DataGrid ID="DataGrid2" runat="server" AutoGenerateColumns="False" Height="1px"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundColumn DataField="NoticeDate" HeaderText="通知日期" DataFormatString="{0:yyyy-MM-dd}">
                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="10%" />
                                                            <HeaderStyle BorderColor="#394f66" BorderStyle="Solid" BorderWidth="1px" Font-Bold="true"
                                                                Horizontalalign="left" />
                                                        </asp:BoundColumn>
                                                        <asp:BoundColumn DataField="BidWinContent" HeaderText="中标通知内容">
                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="20%" />
                                                            <HeaderStyle BorderColor="#394f66" BorderStyle="Solid" BorderWidth="1px" Font-Bold="true"
                                                                Horizontalalign="left" />
                                                        </asp:BoundColumn>
                                                        <asp:BoundColumn DataField="NoBidWinContent" HeaderText="未中标通知内容">
                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="20%" />
                                                            <HeaderStyle BorderColor="#394f66" BorderStyle="Solid" BorderWidth="1px" Font-Bold="true"
                                                                Horizontalalign="left" />
                                                        </asp:BoundColumn>
                                                        <asp:TemplateColumn HeaderText="招标文件">
                                                            <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="10%" />
                                                            <ItemTemplate>
                                                                <a href='TTBMBidNoticeContentFile.aspx?BidNoticeContentID=<%# DataBinder.Eval(Container.DataItem,"ID") %>' target="_blank">通知文件</a>
                                                            </ItemTemplate>
                                                            <HeaderStyle BorderColor="#394F66" BorderStyle="Solid" BorderWidth="1px" Font-Bold="True"
                                                                Horizontalalign="left" />
                                                        </asp:TemplateColumn>
                            ...
                            <table cellpadding="2" cellspacing="0" class="formBgStyle" width="900px">
                                ...
                                <tr style="color: #000000" class="formItemBgStyleForAlignLeft">
                                    <td class="formItemBgStyleForAlignRight" style="width: 150px; height: 30px">
                                        <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,TongZhi%>"></asp:Label>：</td>
                                ...
                                <tr style="color: #000000" class="formItemBgStyleForAlignLeft">
                                    <td class="formItemBgStyleForAlignRight" style="width: 150px; height: 30px">
                                        <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,ZhongBiaoTongZhiNeiRong%>"></asp:Label>：</td>
                                    <td class="formItemBgStyleForAlignLeft" colspan="3" style="height: 30px">
                                ...
                                <tr style="color: #000000" class="formItemBgStyleForAlignLeft">
                                    <td class="formItemBgStyleForAlignRight" style="width: 150px; height: 30px">
                                        <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,WeiZhongBiaoTongZhi%>"></asp:Label>： </td>
                                    <td class="formItemBgStyleForAlignLeft" colspan="3" style="height: 30px">
