<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTProPlanRelatedDocForTemplateView.aspx.cs" Inherits="TTProPlanRelatedDocForTemplateView" %>
                        ...
                        <tr>
                            <td style="text-align: left; padding-left: 10px; padding-top: 10px;">
                                <cc1:TabContainer CssClass="ajax_tab_menu" ID="TabContainer1" runat="server" ActiveTabIndex="0"
                                    Width="99%">
                                    <cc1:TabPanel ID="TabPanel1" runat="server" HeaderText="模板文档">
                                        <ContentTemplate>
