...
<head runat="server">
    ...
    <script language="javascript">
        ...
        function ControlStatusChange(objProgress, objQualityEngineer, ObjUserCode) {
            ...
            else if (objProgress == "Registration") {
            ...
            if (objProgress == "Registration" && objQualityEngineer == ObjUserCode) {
                                                ...
                                                <table style="width: 100%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                    <tr>
                                                        <td class="formItemBgStyle" width="100%">
                                                            <table width="1800px">
                                                                <tr>
                                                                    <td width="1100px" class="formItemBgStyle">
                                                                        ...
                                                                        <input type="button" class="inpu" value="选择" onclick="SelectDLCode('TTWZSelectorDLCode.aspx', 'TXT_MainSupplier', '');" />
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="formItemBgStyle" colspan="2" style="text-align: center;">
