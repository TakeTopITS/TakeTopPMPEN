                ...
                <table cellpadding="0" cellspacing="0" width="100%" class="bian">
                    ...
                    <tr>
                        <td valign="top" align="left" width="100%">
                            ...
                            <asp:DropDownList ID="DL_MemberList" DataValueField="UserCode" DataTextField="UserName" Style="width: 99%;" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DL_MemberList_SelectedIndexChanged">
                            </asp:DropDownList>
