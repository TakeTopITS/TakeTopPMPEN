                    ...
                    <div id="AboveDiv">
                        <table cellpadding="0" cellspacing="0" width="100%" class="bian">
                            ...
                            <tr>
                                <td>
                                    <table style="text-align: center;">
                                        ...
                                        <tr>
                                            <td colspan="2" rowspan="5" width="200px;" align="left">
                                                <b>
                            ...
                            <br />
                                                ...
                                                <table background="ImagesSkin/main_n_bj.jpg" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td align="left" width="4%"><strong>ID</strong> </td>
                                        ...
                                        <tr>
                                            <td align="left" colspan="8" align="left">
                                    ...
                                    <table style="width: 100%; text-align: center;">
                                                ...
                                                <table background="ImagesSkin/main_n_bj.jpg" border="0" cellpadding="0" cellspacing="0" width="98%">
                                                    <tr>
                                                        <td>
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td align="left" width="100%"><strong>
                                        ...
                                        <tr>
                                            <td colspan="8" style="background-color: beige; height: 20px;">WebSite</td>
                                        </tr>
                                        <tr>

                                            <td colspan="2" align="center">WebSite:
                                            <asp:Label ID="Label131" runat="server" Text="<%$ Resources:lang,ZhuYongChanPingLeiXing%>"></asp:Label>

                                            </td>
                                            <td>
                                                <strong>WebSite:
                                            <asp:Label ID="Label137" runat="server" Text="<%$ Resources:lang,zhuYongChanPingBanBeng%>"></asp:Label>
                                                </strong>

                                            </td>
                                            <td>
                                                <strong>WebSite:
                                            <asp:Label ID="Label141" runat="server" Text="<%$ Resources:lang,ShiYongChanPingYuanYing%>"></asp:Label>
                                                </strong>
                                        ...
                                        <tr>
                                            <td colspan="2" valign="top" align="center">
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td align="center" width="30%"><strong>
                                                                        <asp:Label ID="Label119" runat="server" Text="<%$ Resources:lang,LeiXingMingCheng%>"></asp:Label>
                                                                    </strong></td>
                                                                    <td align="center" width="10%"><strong>
                                                                        <asp:Label ID="Label120" runat="server" Text="<%$ Resources:lang,LeiXingMingCheng%>"></asp:Label>EN
                                                                    </strong></td>
                                                                    <td align="center" width="50%"><strong>
                                                                        <asp:Label ID="Label123" runat="server" Text="DemoURL"></asp:Label>
                                                                    </strong></td>
                                                                    <td align="center" width="10%"><strong>
                                                                        <asp:Label ID="Label122" runat="server" Text="<%$ Resources:lang,PaiXu%>"></asp:Label>
                                                                    </strong></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                ...
                                                <asp:DataGrid ID="DataGrid25" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnItemCommand="DataGrid25_ItemCommand" ShowHeader="false" Width="98%">
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateColumn HeaderText="类型名称">
                                                            <ItemTemplate>
                                                                <asp:Button ID="BT_RentProductType" runat="server" CssClass="inpu" Text='<%# DataBinder.Eval(Container.DataItem,"Type") %>' />
                                                            </ItemTemplate>
                                                ...
                                                <asp:Label ID="Label126" runat="server" Text="<%$ Resources:lang,LeiXing%>"></asp:Label>
                                                <asp:TextBox ID="TB_RentProductType" runat="server" Width="110px"></asp:TextBox>
                                                <br />
                                                <asp:Label ID="Label127" runat="server" Text="<%$ Resources:lang,LeiXing%>"></asp:Label>EN
                                            ...
                                            <td>
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td align="center" width="60%"><strong>
                                                                        <asp:Label ID="Label132" runat="server" Text="<%$ Resources:lang,LeiXingMingCheng%>"></asp:Label>
                                                                    </strong></td>
                                                ...
                                                <asp:DataGrid ID="DataGrid31" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnItemCommand="DataGrid31_ItemCommand" ShowHeader="false" Width="98%">
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateColumn HeaderText="类型名称">
                                                            <ItemTemplate>
                                                                <asp:Button ID="BT_VersionType" runat="server" CssClass="inpu" Text='<%# DataBinder.Eval(Container.DataItem,"Type") %>' />
                                                            </ItemTemplate>
                                                ...
                                                <asp:Label ID="Label134" runat="server" Text="<%$ Resources:lang,LeiXing%>"></asp:Label>
                                            ...
                                            <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td align="center" width="60%"><strong>
                                                                        <asp:Label ID="Label138" runat="server" Text="<%$ Resources:lang,YuanYing%>"></asp:Label>
                                                                    </strong></td>
                                                                    <td align="center" width="40%"><strong>
                                                                        <asp:Label ID="Label139" runat="server" Text="<%$ Resources:lang,PaiXu%>"></asp:Label>
                                                                    </strong></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                ...
                                                <asp:DataGrid ID="DataGrid36" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnItemCommand="DataGrid36_ItemCommand" ShowHeader="false" Width="98%">
                                                    <FooterStyle BackColor="#57CD1" Font-Bold="True" ForeColor="White" />
                                                    <EditItemStyle BackColor="#2461BF" />
                                                    <SelectedItemStyle BackColor="#D1DDF1" Font-Bold="True" ForeColor="#333333" />
                                                    <PagerStyle CssClass="notTab" HorizontalAlign="Center" Mode="NumericPages" NextPageText="" PrevPageText="" />
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateColumn HeaderText="类型名称">
                                                            <ItemTemplate>
                                                                <asp:Button ID="BT_TryResonType" runat="server" CssClass="inpu" Text='<%# DataBinder.Eval(Container.DataItem,"Type") %>' />
                                                            </ItemTemplate>
                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="Center" Width="60%" />
                                                        </asp:TemplateColumn>
                                                        <asp:BoundColumn DataField="SortNumber" HeaderText="排序">
                                                ...
                                                <asp:Label ID="Label140" runat="server" Text="<%$ Resources:lang,YuanYing%>"></asp:Label>
                                                <asp:TextBox ID="TB_TryProductResonType" runat="server" Width="110px"></asp:TextBox>
                                                <br />
                                                <asp:Label ID="Label142" runat="server" Text="<%$ Resources:lang,ShunXu%>"></asp:Label>
