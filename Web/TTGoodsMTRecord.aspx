<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTGoodsMTRecord.aspx.cs"
    Inherits="TTGoodsMTRecord" %>
                                            ...
                                            <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ShangPinWeiHu%>"></asp:Label>
                                                    </td>
                                                    <td width="5">
                        ...
                        <tr>
                            <td valign="top" style="padding: 5px 5px 5px 5px;">
                                <table cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        <td colspan="6" style="height: 1px; text-align: center" width="90%">
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                              <td width="5%" align="left">
                                                                ...
                                                                <td width="10%" align="left">
                                                                    <strong>
                                                                        <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,WeiXiuShiJian%>"></asp:Label></strong>
                                                                </td>
                                                                <td width="10%" align="left">
                                                                    <strong>
                                    ...
                                    <tr>
                                        <td colspan="6" style="height: 13px; text-align: right">
                                            <asp:Label ID="LB_GoodsCode1" runat="server" Visible="False"></asp:Label>
                                            <asp:Label ID="LB_GoodsCode0" runat="server" Visible="False"></asp:Label>
                            ...
                            <table style="width: 90%;" class="formBgStyle" cellpadding="3" cellspacing="0">
                                ...
                                <tr>
                                    <td class="formItemBgStyleAlignLeft" style="width: 10%; ">
                                        <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,WeiHuRen%>"></asp:Label>：
                                    </td>
                                    ...
                                    <td class="formItemBgStyleAlignLeft" style="width: 20%; ">
                                ...
                                <tr>
                                    <td style="width: 10%;" class="formItemBgStyleAlignLeft">
                                        <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,WeiXiuShiJian%>"></asp:Label>：
                                    </td>
                                    <td style="width: 200px; text-align: left" class="formItemBgStyleAlignLeft">
                                    ...
                                    <td style="text-align: left;" class="formItemBgStyleAlignLeft">
                                        <NickLee:NumberBox MaxAmount="1000000000000" MinAmount="-1000000000000" ID="TB_Cost" runat="server" Width="100px" Precision="3">0.000</NickLee:NumberBox>
                                    </td>
                                </tr>
                            </table>
                        </div>
