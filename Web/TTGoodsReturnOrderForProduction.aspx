                                    ...
                                    <td width="50%" class="formItemBgStyle">
                                        <table align="left" width="100%" cellpadding="1" cellspacing="0" class="formBgStyle">
                                            ...
                                            <tr>
                                                ...
                                                <td class="formItemBgStyle">&nbsp;<asp:Label ID="Label39" runat="server" Text="<%$ Resources:lang,DanWei %>"></asp:Label>： </td>
                                                <td style="text-align: left" class="formItemBgStyle">
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popAssignWindow" name="noConfirm"
                        ...
                        <div id="popwindow_content1" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table cellpadding="3" cellspacing="0" class="formBgStyle" width="100%">
                                ...
                                <tr style="font-size: 10pt">
                                    <td class="formItemBgStyle" style=""></td>
                                    <td class="formItemBgStyle" style="text-align: left; height: 19px;">（<asp:Label ID="Label85" runat="server" Text="<%$ Resources:lang,YaoQiuShouDaoChuLiXinXi%>"></asp:Label>：<asp:CheckBox ID="CB_SMS" runat="server" Text="<%$ Resources:lang,DuanXin%>" /><asp:CheckBox
