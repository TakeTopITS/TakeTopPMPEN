...
public partial class TTAccountBalanceSheet : System.Web.UI.Page
{
    string strUserCode;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Label1.Text = ShareClass.GetPageTitle(this.GetType().BaseType.Name + ".aspx"); bool blVisible = TakeTopSecurity.TakeTopLicense.GetAuthobility(this.GetType().BaseType.Name + ".aspx", strUserCode);  //Label1.Text = ShareClass.GetPageTitle(this.GetType().BaseType.Name + ".aspx"); bool blVisible = TakeTopSecurity.TakeTopLicense.GetAuthobility(this.GetType().BaseType.Name + ".aspx","资产负债表", strUserCode);
        if (blVisible == false)
        {
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            ...
            {
                Random a = new Random();
                string fileName = LanguageHandle.GetWord("ZiChanFuZhaiBiao") + DateTime.Now.ToString("yyyy-MM-dd-HH-mm-ss") + "-" + a.Next(100, 999) + ".xls";
