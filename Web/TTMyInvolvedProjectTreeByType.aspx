<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTMyInvolvedProjectTreeByType.aspx.cs"
    Inherits="TTMyInvolvedProjectTreeByType" %>
                                        ...
                                        <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                    <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,WoCanYuDeXiangMuDeXiangMuShu%>"></asp:Label>
                                                </td>
                        ...
                        <td>
                            <table width="100%" cellpadding="0" cellspacing="0" >
                                <tr>
                                    ...
                                    <td style="width: 98%; height: 1px; vertical-align: top;">
                                        <table cellpadding="5" cellspacing="0" width="95%">
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:DataList ID="DataList2" runat="server" Width="100%" CellPadding="0" CellSpacing="0" ForeColor="#333333">
                                                        <SelectedItemStyle BackColor="#D1DDF1" Font-Bold="True" ForeColor="#333333" />
                                                        <ItemTemplate>
                                                            <table style="width: 100%;" cellpadding="4" cellspacing="0" class="bian">
                                                                <tr>
