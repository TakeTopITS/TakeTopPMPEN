                                            ...
                                            <asp:DataList ID="DataList1" runat="server" CellPadding="0" CellSpacing="0" ForeColor="#333333"
                                                ...
                                                <ItemTemplate>
                                                    <table style="width: 100%;" class="bian">
                                                        ...
                                                        <tr>
                                                            <td style="width: 15%; text-align: right;">
                                                                <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,MiaoShu%>"></asp:Label>£º
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 20%; height: 20px; text-align: right;">
                                                                <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,FaXianRiQi%>"></asp:Label>£º<td colspan="2" style="height: 20px; text-align: left; width: 212px;">
                                    ...
                                    <tr>
                                        <td>
                                            <table width="90%" cellpadding="5" cellspacing="0" class="formBgStyle">
                                                ...
                                                <tr>
                                                    <td class="formItemBgStyleForAlignLeft">
                                                        <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,MingCheng%>"></asp:Label>£º<asp:TextBox ID="TB_WLName" runat="server" Width="270px"></asp:TextBox>&nbsp;
                                                    <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,LeiXing%>"></asp:Label>£º
                                                        <asp:DropDownList ID="DL_WFType" runat="server">
                                                            <asp:ListItem Value="RiskAssessment" Text="<%$ Resources:lang,FengXianPingGu%>" />
                                                        </asp:DropDownList>
                                                        &nbsp;&nbsp;<asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,GongZuoLiuMuBan%>"></asp:Label>£º<asp:DropDownList ID="DL_TemName" runat="server" DataTextField="TemName"
                                                            DataValueField="TemName" Width="144px">
                                                        </asp:DropDownList>
                                                        &nbsp; &nbsp;<asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,ChaXunGuanJianZi%>"></asp:Label>£º<asp:TextBox ID="TB_KeyWord" runat="server" Width="60px"></asp:TextBox>
                                                        &nbsp;<asp:Button ID="BT_Refrash" runat="server" Text="<%$ Resources:lang,ShuaXin%>" OnClick="BT_Refrash_Click"
                                                            CssClass="inpu" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align: left; height: 51px;" class="formItemBgStyleForAlignLeft">
                                                        <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,ShuoMing%>"></asp:Label>£º<asp:TextBox ID="TB_Description" runat="server" TextMode="MultiLine" Width="441px"
                                                            Height="48px"></asp:TextBox>&nbsp;
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="formItemBgStyleForAlignLeft">
                                                        <span>£¨<asp:Label ID="Label15" runat="server" Text="<%$ Resources:lang,YaoQiuShouDaoXinXi%>"></asp:Label>£º<asp:CheckBox ID="CB_Mail" runat="server" Text="<%$ Resources:lang,YouJian%>" />
                            ...
                            <td>
                                <table width="90%" cellpadding="5" cellspacing="0">
                                    <tr>
                                        <td align="left">
                                            <b>
                                                <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,DuiYingGongZuoLiuLieBiao%>"></asp:Label>£º</b>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left">
