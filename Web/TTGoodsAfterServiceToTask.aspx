<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTGoodsAfterServiceToTask.aspx.cs" Inherits="TTGoodsAfterServiceToTask" %>
                                                            ...
                                                            <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    ...
                                                                    <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                                        <asp:Label ID="Label61" runat="server" Text="<%$ Resources:lang,ShangPinShouHouRenWu%>"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                                    ...
                                                                    <td>
                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            <tr>
                                                                                ...
                                                                                <td width="5%" align="left">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,ShanChu %>" /></strong>
                                                                                </td>
                                                                                ...
                                                                                <td align="left" width="20%">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,RenWu%>"></asp:Label></strong>
                                                                                </td>
                                                                                <td align="left" width="8%">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,YouXianJi%>"></asp:Label></strong>
                                                                                </td>
                                                                                <td align="left" width="8%">
                                                                                    <strong>
                                                                                ...
                                                                                <td align="left" width="5%">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,YuSuan%>"></asp:Label></strong>
                                                                                </td>
                                                                                <td align="left" width="7%">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,WanChengChengDu%>"></asp:Label></strong>
                                                                                </td>
                                                                                <td align="left" width="7%">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,FeiYong%>"></asp:Label></strong>
                                                                                </td>
                                                                                <td align="left" width="5%">
                                                                                    <strong>
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="text-align: left; overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <cc1:TabContainer CssClass="ajax_tab_menu" ID="TabContainer1" Width="100%" runat="server" ActiveTabIndex="0">
                                <cc1:TabPanel ID="TabPanel1" runat="server" HeaderText="基本信息" TabIndex="0">
                                    <HeaderTemplate>
                                        <asp:Label ID="Label55" runat="server" Text="<%$ Resources:lang,JiBenXinXi%>"></asp:Label>
                                    </HeaderTemplate>
                                    <ContentTemplate>

                                        <table style="width: 100%;" cellpadding="3" cellspacing="0" class="formBgStyle">
                                            <tr>
                                                <td style="width: 12%;" class="formItemBgStyle">
                                                    <asp:Label ID="Label15" runat="server" Text="<%$ Resources:lang,LeiXingu%>"></asp:Label>
                                                    ：
                                                </td>
                                                ...
                                                <td style="width: 20%;" class="formItemBgStyle">
                                                    <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,YouXianJi%>"></asp:Label>：
                                                </td>
                                                <td style="width: 20%; text-align: left;" class="formItemBgStyle">
                                                ...
                                                <td style="width: 10%;" class="formItemBgStyle">
                                                    <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,YuSuan%>"></asp:Label>：
                                                </td>
                                                <td style="text-align: left" class="formItemBgStyle">
                                                    <NickLee:NumberBox MaxAmount="1000000000000" MinAmount="-1000000000000" ID="TB_Budget" runat="server" Width="67px" OnBlur="" OnFocus=""
                                                        OnKeyPress="" PositiveColor="" Precision="3">0.00</NickLee:NumberBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td rowspan="2" style="" class="formItemBgStyle">
                                                    <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,RenWu%>"></asp:Label>：
                                                </td>
                                                ...
                                                <td class="formItemBgStyle">
                                                    <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,ShiJiFeiYong%>"></asp:Label>：
                                                </td>
                                                <td style="width: 93px; text-align: left" class="formItemBgStyle">
                                                    <NickLee:NumberBox MaxAmount="1000000000000" MinAmount="-1000000000000" ID="TB_Expense" runat="server" Enabled="False" Width="65px" OnBlur=""
                                                        OnFocus="" OnKeyPress="" PositiveColor="" Precision="3">0.00</NickLee:NumberBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="formItemBgStyle">
                                                    <asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,GongShi2%>"></asp:Label>：
                                                </td>
                                                <td style="text-align: left" class="formItemBgStyle">
                                            ...
                                            <tr>
                                                <td class="formItemBgStyle">
                                                    <asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,KaiShiShiJian%>"></asp:Label>：
                                                </td>
                                                <td style="text-align: left" class="formItemBgStyle">
                                                ...
                                                <td class="formItemBgStyle">
                                                    <asp:Label ID="Label22" runat="server" Text="<%$ Resources:lang,JieShuShiJian%>"></asp:Label>：
                                                </td>
                                                <td style="text-align: left;" class="formItemBgStyle">
                                                ...
                                                <td class="formItemBgStyle">
                                                    <asp:Label ID="Label23" runat="server" Text="<%$ Resources:lang,ShiJiGongShi%>"></asp:Label>：
                                                </td>
                                                <td style="text-align: left" class="formItemBgStyle">
                                            ...
                                            <tr>
                                                ...
                                                <td class="formItemBgStyle">
                                                    <asp:Label ID="Label25" runat="server" Text="<%$ Resources:lang,JianLiShiJian%>"></asp:Label>：
                                                </td>
                                                <td class="formItemBgStyle">
                                                    <asp:Label ID="LB_MakeDate" runat="server"></asp:Label>
                                                </td>
                                                <td class="formItemBgStyle">
                                                    <asp:Label ID="Label26" runat="server" Text="<%$ Resources:lang,WanChengChengDu%>"></asp:Label>：
                                                </td>
                                                <td style="text-align: left;" class="formItemBgStyle">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="5" style="text-align: left" class="formItemBgStyle">
                                                    ...
                                                    <asp:Button ID="BT_Active" runat="server" CssClass="inpuActive" ToolTip="<%$ Resources:lang,JiHuo%>" Enabled="False" Visible="false" OnClick="BT_Active_Click" />
                                ...
                                <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="关联信息" TabIndex="2">
                                    <HeaderTemplate>
                                        <asp:Label ID="Label56" runat="server" Text="<%$ Resources:lang,XiangGuanYeWuDan%>"></asp:Label>
                                    </HeaderTemplate>
                                    <ContentTemplate>
                                        <asp:Panel ID="Panel_RelatedBusiness" runat="server" Visible="false">
                                            <table style="width: 100%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                <tr>
                                                    ...
                                                    <td style="width: 20%; " class="formItemBgStyle">
                                                        <asp:Label ID="Label36" runat="server" Text="<%$ Resources:lang,YunXuHouXuXiuGe%>"></asp:Label>：
                                                    </td>
                                                    <td style="text-align: left;" class="formItemBgStyle">
                                    ...
                                    <table class="bian" style="width: 98%;" cellpadding="4" cellspacing="0">
                                        <tr>
                                            <td style="text-align: right" width="10%">
                                                <asp:Label ID="Label54" runat="server" Text="<%$ Resources:lang,BianHao%>"></asp:Label>：
                                            </td>
                                        ...
                                        <tr>
                                            <td class="10%" style="text-align: right">
                                                <asp:Label ID="Label56" runat="server" Text="<%$ Resources:lang,LeiXing%>"></asp:Label>： </td>
                                            <td style="width: 10%; text-align: left;"><%# DataBinder.Eval(Container.DataItem,"Type") %></td>
                                            <td style="width: 10%; text-align: right">单价： </td>
                                        ...
                                        <tr>
                                            <td style="text-align: right">
                                                <asp:Label ID="Label58" runat="server" Text="<%$ Resources:lang,DiZhi%>"></asp:Label>：
                                            </td>
                                            <td colspan="3" style="text-align: left">
                                        ...
                                        <tr>
                                            <td style="text-align: right;">
                                                <asp:Label ID="Label59" runat="server" Text="<%$ Resources:lang,GuanLiRen%>"></asp:Label>：
                                            </td>
                                            <td style="height: 8px; text-align: left;">
                                                <%# DataBinder.Eval(Container.DataItem,"OwnerName") %>
                                            </td>
                                            <td style="text-align: right; height: 8px;">
                                                <asp:Label ID="Label60" runat="server" Text="<%$ Resources:lang,MaiRuShiJian%>"></asp:Label>：
                                            </td>
                                            <td style="height: 8px; text-align: left;">
                            ...
                            <table>
                                <tr>
                                    <td style="text-align: left; display: none;">
                                        <asp:Label ID="LB_GoodsSN" runat="server" Visible="False"></asp:Label>
                            ...
                            <table cellpadding="3" cellspacing="0" style="width: 100%" class="formBgStyle">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 15%; " class="formItemBgStyle">
                                        <asp:Label ID="Label38" runat="server" Text="<%$ Resources:lang,ShouLiRen%>"></asp:Label>：</td>
                                ...
                                <tr>
                                    <td class="formItemBgStyle">
                                        <asp:Label ID="Label39" runat="server" Text="<%$ Resources:lang,GongZuoYaoQiu%>"></asp:Label>：
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" style="text-align: left;" class="formItemBgStyle">
                                        ...
                                        <td class="formItemBgStyle" style="height: 21px; text-align: left"></td>
                                        <tr>
                                            <td class="formItemBgStyle" style="width: 150px; height: 21px; "></td>
                                            <td class="formItemBgStyle" colspan="3" style="height: 21px; text-align: left">
                                                ...
                                                <span style="font-size: 10pt">
                                                    <asp:Label ID="Label42" runat="server" Text="<%$ Resources:lang,TongZhiShouLiRen%>"></asp:Label></span>
                                        ...
                                        <tr>
                                            <td class="formItemBgStyle" colspan="4" style="text-align: left; height: 9px;">
                                                <span><strong>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td width="9%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label43" runat="server" Text="<%$ Resources:lang,BianHao%>"></asp:Label></strong>
                                                            </td>
                                                            ...
                                                            <td width="6%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label45" runat="server" Text="<%$ Resources:lang,RenWuHao%>"></asp:Label></strong>
                                                            </td>
                                                            <td width="8%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label46" runat="server" Text="<%$ Resources:lang,FenPaiRen%>"></asp:Label></strong>
                                                            </td>
                                                            <td width="8%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label47" runat="server" Text="<%$ Resources:lang,ShouLiRen%>"></asp:Label></strong>
                                                            </td>
                                                            <td width="12%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label48" runat="server" Text="<%$ Resources:lang,ShouLiRenDeGongZuo%>"></asp:Label></strong>
                                                            </td>
                                                            <td width="10%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label49" runat="server" Text="<%$ Resources:lang,KaiShiShiJian%>"></asp:Label></strong>
                                                            </td>
                                                            <td width="10%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label50" runat="server" Text="<%$ Resources:lang,JieShuShiJian%>"></asp:Label></strong>
                                                            </td>
                                                            <td width="7%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label51" runat="server" Text="<%$ Resources:lang,FeiYong%>"></asp:Label></strong>
                                                            </td>
                                                            <td width="10%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label52" runat="server" Text="<%$ Resources:lang,LuXian%>"></asp:Label></strong>
                                                            </td>
                                                            <td width="7%" align="left">
                                                                <strong>
                                            ...
                                            <tr>
                                                <td colspan="5" style="text-align: left; height: 4px;" class="formItemBgStyle">
                                                    ...
                                                    &nbsp;<asp:HyperLink ID="HL_RelatedWorkFlowTemplate" runat="server" Enabled="False" Visible="false"
                                                        ...
                                                        <asp:Label ID="Label30" runat="server" Text="<%$ Resources:lang,GuanLianGongZuoLiuMuBan%>"></asp:Label>
                                                    </asp:HyperLink>
                                                    &nbsp;<asp:HyperLink ID="HL_ActorGroup" runat="server" Enabled="False" Visible="false"
                                                        ...
                                                        <asp:Label ID="Label31" runat="server" Text="<%$ Resources:lang,JueSeZuSheZhi%>"></asp:Label>
                                                    </asp:HyperLink>
                                                    &nbsp;<asp:HyperLink ID="HL_WLTem" runat="server" Enabled="False" Visible="false" NavigateUrl="~/TTWorkFlowTemplate.aspx"
                                                        Target="_blank">
                                                        <asp:Label ID="Label32" runat="server" Text="<%$ Resources:lang,MuBanWeiHu%>"></asp:Label>
                                                    </asp:HyperLink>
                                                    <asp:HyperLink ID="HL_RunTaskByWF" runat="server" Enabled="False" Visible="false" Target="_blank">---&gt;<asp:Label ID="Label27" runat="server" Text="<%$ Resources:lang,RWCLLCMS%>"></asp:Label></asp:HyperLink>

                                                    &nbsp;<asp:HyperLink ID="HL_TaskReview" runat="server" Visible="false" Enabled="False" Target="_blank">---&gt;<asp:Label ID="Label28" runat="server" Text="<%$ Resources:lang,RenWuPingShen%>"></asp:Label></asp:HyperLink>
