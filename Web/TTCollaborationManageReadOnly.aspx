<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTCollaborationManageReadOnly.aspx.cs" Inherits="TTCollaborationManageReadOnly" %>
                                                        ...
                                                        <table style="width: 100%">
                                                            <tr>
                                                                ...
                                                                <td colspan="2" width="300" align="right">
                                                                    <asp:Button ID="BT_MakeCollaboration" CssClass="inpuLong" runat="server"
                                                                        Text="<%$ Resources:lang,JianLiXieZuo%>" OnClick="BT_MakeCollaboration_Click" Visible="false" />
                                                                    &nbsp;
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:DataGrid ID="DataGrid4" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:HyperLinkColumn DataNavigateUrlField="CoID" DataNavigateUrlFormatString="TTCollaborationDetailMainReadOnly.aspx?CoID={0}"
                                                                            ...
                                                                            <asp:TemplateColumn>
                                                                                ...
                                                                                <ItemStyle Horizontalalign="left" CssClass="itemBorder" Width="5%" />
                                                                            </asp:TemplateColumn>
                                                                        </Columns>
