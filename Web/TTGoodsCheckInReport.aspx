<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTGoodsCheckInReport.aspx.cs" Inherits="TTGoodsCheckInReport" %>
                                ...
                                <td style="width: 100%; text-align: left;">
                                    <table style="width: 98%;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: right;">
                                                <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,ChangJia%>"></asp:Label>：</td>
                                            <td >
                                                <asp:TextBox ID="TB_Manufacture" runat="server" Width="99%"></asp:TextBox>
                                                <asp:DropDownList ID="DL_VendorList" runat="server" AutoPostBack="true" DataTextField="VendorName" DataValueField="VendorName" Width="200px" OnSelectedIndexChanged="DL_VendorList_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align: right;">
                                                <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,RuKuDanHao%>"></asp:Label>： </td>
                                            <td>
                                                <asp:TextBox ID="TB_CheckInID" runat="server" Width="100px"></asp:TextBox>
                                            </td>
                        ...
                        <table style="width: 98%;">
                            <tr>
                                <td style="width: 100%; height: 80px; font-size: xx-large; text-align: center;">
                                    <br />
                                    <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ShangPinRuKuBaoBiao%>"></asp:Label>
                                    <br />
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align: left;" colspan="4">
                                    <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,ZongShu%>"></asp:Label>：<asp:Label ID="LB_TotalNumber" runat="server"></asp:Label>
                                    &nbsp;
                                                <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,ZongJinE%>"></asp:Label>：<asp:Label ID="LB_TotalAmount" runat="server"></asp:Label>
                            ...
                            <tr>
                                <td style="width: 100%;">
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td width="5%" align="left">
                                                            <strong>
                                                                <asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,RuKuDan%>"></asp:Label></strong>
                                                        </td>
                                                        ...
                                                        <td width="6%" align="left">
                                                            <strong>
                                                                <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,HanShui%>"></asp:Label></strong>
                                                        </td>
                                                        <td width="6%" align="left">
                                                            <strong>
                                                        ...
                                                        <td align="left">
                                                            <strong>
                                                                <asp:Label ID="Label25" runat="server" Text="<%$ Resources:lang,RuKuShiJian%>"></asp:Label></strong>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                    ...
                                    <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            <asp:BoundColumn DataField="CheckInID" HeaderText="Number">
                                            ...
                                            <asp:BoundColumn DataField="Manufacturer" HeaderText="PinPai">
                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="10%" />
                                            </asp:BoundColumn>
                                            ...
                                            <asp:BoundColumn DataField="CheckInDate" HeaderText="入库时间" DataFormatString="{0:yyyy/MM/dd}">
