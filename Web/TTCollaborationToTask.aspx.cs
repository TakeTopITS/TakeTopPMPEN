...
public partial class TTCollaborationToTask : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "clickA", "aHandler();", true); if (Page.IsPostBack != true)
        {
            ...
            if (strIsMobileDevice == "YES")
            {
                HT_Operation.Text = LanguageHandle.GetWord("ZhuTi").ToString().Trim() + collaboration.CollaborationName.Trim() + LanguageHandle.GetWord("brbrNeiRong").ToString().Trim() + collaboration.Comment.Trim();
            }
            else
            {
                HE_Operation.Text = LanguageHandle.GetWord("ZhuTi").ToString().Trim() + collaboration.CollaborationName.Trim() + LanguageHandle.GetWord("brbrNeiRong").ToString().Trim() + collaboration.Comment.Trim();
            }
