                                                        ...
                                                        <Columns>
                                                            <asp:TemplateColumn>
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <%--<asp:Button ID="Button1" runat="server" CssClass="inpu" Text="询价" CommandName="price" CommandArgument='<%# Eval("PurchaseCode") %>' Visible='<%# (Eval("Progress").ToString()=="报批" || Eval("Progress").ToString()=="Approved") ? true : false %>' />--%>
