<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTProjectAssetApplicationWL.aspx.cs"
    Inherits="TTProjectAssetApplicationWL" %>
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popwindow"
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="overflow: auto; padding :0px 5px 0px 5px;">
                            ...
                            <table style="width: 100%;" cellpadding="0" cellspacing="0">
                                    ...
                                    <td valign="middle" colspan="2" style="width: 60%; border-right: solid 1px #D8D8D8; vertical-align: middle; padding: 5px 5px 5px 5px;">
                                        <table class="formBgStyle" cellpadding="3" cellspacing="0" style="width: 98%; margin-top: 5px"
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3" align="left" class="formItemBgStyle">
                                                    <asp:TextBox ID="TB_ApplyReason" runat="server" Width="90%"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right" class="formItemBgStyle">
                                                ...
                                                <td align="left" class="formItemBgStyle">
                                                    <asp:TextBox ID="TB_ApplicantCode" runat="server" Width="100px"></asp:TextBox>
                                ...
                                <tr>
                                    <td colspan="2" style="padding: 5px 5px 5px 5px;" valign="top">
                                        <table width="100%">
                                            <tr>
                                                            ...
                                                            <td>
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                       <td width="5%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label48" runat="server" Text="<%$ Resources:lang,BianJi %>" /></strong>
                                                                    </td>
                                                                    <td width="5%" align="left">
                                                                        <strong>
                                ...
                                <tr>
                                    <td>
                                        <table class="formBgStyle" style="width: 100%;" cellpadding="3" cellspacing="0">
                                            <tr>
                                                <td style="width: 14%; " class="formItemBgStyle">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left" class="formItemBgStyle">
                                                    <asp:TextBox ID="TB_Spec" runat="server" Width="60%" Height="60px" TextMode="MultiLine"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td class="formItemBgStyle" style="text-align: left;">
                                                    <asp:TextBox ID="TB_Manufacturer" runat="server" Width="70%"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="formItemBgStyle" style="">IP： </td>
                                                <td class="formItemBgStyle" style="text-align: left;">
                                                    <asp:TextBox ID="TB_IP" runat="server" Width="50%"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td width="12%" align="left">
                                                                    <strong>
                                                                        <asp:Label ID="Label37" runat="server" Text="<%$ Resources:lang,DaiMa %>"></asp:Label></strong>
                                                                </td>
                                                                <td width="12%" align="left">
                                                                    <strong>
                                                                        <asp:Label ID="Label38" runat="server" Text="<%$ Resources:lang,MingCheng %>"></asp:Label></strong>
                                                                </td>
                                                                <td width="10%" align="left">
                                                                    <strong>
                                                                        <asp:Label ID="Label39" runat="server" Text="<%$ Resources:lang,XingHao %>"></asp:Label></strong>
                                                                </td>
                                                                <td width="19%" align="left">
                                                                    <strong>
                                                                        <asp:Label ID="Label40" runat="server" Text="<%$ Resources:lang,GuiGe %>"></asp:Label></strong>
                                                                </td>
                                                                <td width="10%" align="left">
                                                                    <strong>
                                                                ...
                                                                <td width="6%" align="left">
                                                                    <strong>
                                                                        <asp:Label ID="Label43" runat="server" Text="<%$ Resources:lang,DanJia %>"></asp:Label></strong>
                                                                </td>
                                                                <td width="10%" align="left">
                                                                    <strong>
                                                                        <asp:Label ID="Label44" runat="server" Text="<%$ Resources:lang,ChangJia %>"></asp:Label></strong>
                                                                </td>
                                                                <td width="15%" align="left">
                                                                    <strong>
                                                                        <asp:Label ID="Label45" runat="server" Text="<%$ Resources:lang,DiZhi %>"></asp:Label></strong>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                            ...
                            <table width="100%">
                                <tr>
                                    ...
                                    <td align="left" style="width: 550px; height: 6px">
                                        ...
                                        </asp:DropDownList><asp:Label ID="Label28" runat="server" Text="<%$ Resources:lang,LeiXing%>"></asp:Label>：
                                <asp:DropDownList ID="DL_WFType" runat="server">
                                    <asp:ListItem Value="AssetWithdrawal" Text="<%$ Resources:lang,ZiChanLingYong%>" />
                                </asp:DropDownList><asp:HyperLink
                                    ID="HL_WLTem" runat="server" NavigateUrl="~/TTWorkFlowTemplate.aspx" Target="_blank">
                                    <asp:Label ID="Label29" runat="server" Text="<%$ Resources:lang,MuBanWeiHu%>"></asp:Label>
                                ...
                                <tr>
                                    <td align="left" colspan="2" style="height: 6px; text-align: right;">
                                        <table width="100%">
                                            <tr>
                                                <td align="left" style="width: 550px; height: 27px"><span style="font-size: 10pt">（<asp:Label ID="Label30" runat="server" Text="<%$ Resources:lang,YaoQiuShouDaoXinXi%>"></asp:Label>：</span><asp:CheckBox ID="CB_SMS" runat="server"
                                            ...
                                            <tr>
                                                <td align="left" style="height: 22px; text-align: left;">
                                                    <asp:Label ID="Label31" runat="server" Text="<%$ Resources:lang,DuiYingGongZuoLiuLieBiao%>"></asp:Label>： </td>
                                            </tr>
                                            <tr>
                                                <td align="left">
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        ...
                                                                        <td width="50%" align="left"><strong>
                                                                            <asp:Label ID="Label33" runat="server" Text="<%$ Resources:lang,GongZuoLiu%>"></asp:Label></strong> </td>
                                                                        <td width="20%" align="left"><strong>
                                                                            <asp:Label ID="Label34" runat="server" Text="<%$ Resources:lang,ShenQingShiJian%>"></asp:Label></strong> </td>
                                                                        <td width="10%" align="left"><strong>
