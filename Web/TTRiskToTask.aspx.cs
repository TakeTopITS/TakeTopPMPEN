...
HE_Operation.Language = Session["LangCode"].ToString();
        ...
        if (Page.IsPostBack != true)
        {
            ...
            if (strIsMobileDevice == "YES")
            {
                HT_Operation.Text = LanguageHandle.GetWord("FengXianNeiRong") + projectRisk.Detail.Trim();
            }
            else
            {
                HE_Operation.Text = LanguageHandle.GetWord("FengXianNeiRong") + projectRisk.Detail.Trim();
            }
