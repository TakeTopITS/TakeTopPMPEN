                                                    ...
                                                    <div class="wenzi">
                                                        ...
                                                        <div id="id5" style="padding-left: 20px;">
                                                            ...
                                                            <li>
                                                                ...
                                                                <br />
                                                                <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,YaoXieZhuQingLianXiTaiDingKeFu%>"></asp:Label><asp:Label ID="Label53535" runat="server" Text="<%$ Resources:lang,DianHua%>"></asp:Label>：(086) 021-51085119）
                                                                ...
                                                                <%--  &nbsp;&nbsp;<a href="tencent://message/?uin=3166455252&amp;Site=&amp;Menu=yes"><img align="absmiddle" src="../../../images/qq.png" /><asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,KeFu%>"></asp:Label></a>，<asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,DianHua%>"></asp:Label>：<a href="tel:02151085119" class="call">(086) 021-51085119</a><br />--%>
                                                            </li>
