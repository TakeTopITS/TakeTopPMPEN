...
public partial class TTProAssignTask : System.Web.UI.Page
{
...
HE_Operation.Language = Session["LangCode"].ToString();
    ...
    protected void DataGrid1_ItemCommand(object sender, DataGridCommandEventArgs e)
    {
        if (e.CommandName != "Page")
        {
            ...
            if (e.CommandName == "Update" | e.CommandName == "Assign")
            {
                ...
                try
                {
                    DL_UnitName.SelectedValue = projectTask.UnitName.Trim();
                }
                catch
                {
                }
    ...
    protected void AddTask()
    {
        ...
        else
        {
            ...
            try
            {
                ...
                LoadProjectTask(intProjectID.ToString());
            }
            catch
            {
    ...
    protected void LoadProjectTask(string strProjectID)
    {
    ...
    protected ProjectTask getProjectTask(string strTaskID)
    {
        string strHQL;
        IList lst;
