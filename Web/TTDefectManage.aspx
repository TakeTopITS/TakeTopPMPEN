<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTDefectManage.aspx.cs" Inherits="TTDefectManage" %>
...
<body>
                                                                    ...
                                                                    <td style="width: 100%; text-align: left; padding: 5px 5px 5px 5px;">
                                                                        <cc2:TabContainer CssClass="ajax_tab_menu" ID="TabContainer1" runat="server" ActiveTabIndex="0" Width="100%">
                                                                            <cc2:TabPanel ID="TabPanel1" runat="server" HeaderText="我要处理的缺陷：">
                                                                                <HeaderTemplate>
                                                                                    <asp:Label ID="Label77881" runat="server" Text="<%$ Resources:lang,WoYaoChuLiDeQueXian%>"></asp:Label>
                                                                                </HeaderTemplate>
                                                                                <ContentTemplate>
                                                                                            ...
                                                                                            <td style="width: 100%; text-align: Left;">
                                                                                                            ...
                                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td width="8%" align="left">
                                                                                                                        <strong>
                                                                                                                            <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,QueXianHao %>"></asp:Label></strong>
                                                                                                                    </td>
                                                                                                                    <td width="23%" align="left">
                                                                                                                        <strong>
                                                                                                                            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,QueXianMing %>"></asp:Label></strong>
                                                                                                                    </td>
                                                                                                ...
                                                                                                <asp:DataGrid ID="DataGrid4" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                                                                    ...
                                                                                                    <Columns>
                                                                                                        ...
                                                                                                        <asp:HyperLinkColumn DataNavigateUrlField="ID" DataNavigateUrlFormatString="TTDefectDetail.aspx?ID={0}"
                                                                                                        ...
                                                                                                        <td>
                                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td width="8%" align="left">
                                                                                                                        <strong>
                                                                                                                            <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,QueXianHao%>"></asp:Label></strong>
                                                                                                                    </td>
                                                                                                                    <td width="23%" align="left">
                                                                                                                        <strong>
                                                                                                                            <asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,QueXianMing%>"></asp:Label></strong>
                                                                                                                    </td>
                                                                                                                    <td width="10%" align="left">
                                                                                                                        <strong>
                                                                ...
                                                                <tr>
                                                                    <td style="width: 100%; height: 3px; text-align: left; padding: 5px 5px 5px 5px;">
                                                                        <span style="font-size: 10pt;">
                                                                            <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,WoYiFenPaiDeQueXian%>"></asp:Label>：</span>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                                ...
                                                                                <td>
                                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td width="8%" align="left">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,QueXianHao%>"></asp:Label></strong>
                                                                                            </td>
                                                                                            <td width="23%" align="left">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label22" runat="server" Text="<%$ Resources:lang,QueXianMing%>"></asp:Label></strong>
                                                                                            </td>
                                                                                            <td width="10%" align="left">
                                                                                                <strong>
                                                                                ...
                                                                                <td>
                                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td width="8%" align="left">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label30" runat="server" Text="<%$ Resources:lang,QueXianHao%>"></asp:Label></strong>
                                                                                            </td>
                                                                                            <td width="23%" align="left">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label31" runat="server" Text="<%$ Resources:lang,QueXianMing%>"></asp:Label></strong>
                                                                                            </td>
                                                                                            <td width="10%" align="left">
                                                                                                <strong>
    ...
    <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="8%" />
                                                                ...
                                                                <tr>
                                                                    <td style="width: 100%; height: 3px; text-align: left; padding: 5px 5px 5px 5px;">
                                                                        <span style="font-size: 10pt;">
                                                                            <asp:Label ID="Label36" runat="server" Text="<%$ Resources:lang,WoJianLiDeQueXian%>"></asp:Label>：</span>
                                                                    </td>
                                                                </tr>
                                                                <tr>
