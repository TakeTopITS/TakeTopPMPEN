<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTDefectDetailThirdPart.aspx.cs" Inherits="TTDefectDetailThirdPart" %>
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="2">
                                                                                <cc1:TabContainer CssClass="ajax_tab_menu" ID="TabContainer1" runat="server" ActiveTabIndex="0" Width="98%">
                                                                                    ...
                                                                                    <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="分派缺陷">
                                                                                        <HeaderTemplate>
                                                                                        ...
                                                                                        <ContentTemplate>
                                                                                            <table width="100%">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td class="formItemBgStyleAlignLeft" colspan="4" style="text-align: left;">
                                                                                                                            ...
                                                                                                                            <td>
                                                                                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                                                    <tr>
                                                                                                                                        ...
                                                                                                                                        <td align="left" width="9%"><strong></strong></td>
                                                                                                                                    </tr>
                                                                                                                                </table>
                                                                                                                            </td>
                                                                                    ...
                                                                                    <cc1:TabPanel ID="TabPanel3" runat="server" HeaderText="转成项目">
                                                                                        <ContentTemplate>
                                                                                            <table width="450" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="width: 400px; height: 62px; vertical-align: top;" class="formItemBgStyleAlignLeft">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td colspan="2" style="height: 11px" class="formItemBgStyleAlignLeft">
