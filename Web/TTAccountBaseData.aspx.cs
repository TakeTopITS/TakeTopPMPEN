...
public partial class TTAccountBaseData : System.Web.UI.Page
{
    ...
    protected void BT_AccountAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "alert('" + LanguageHandle.GetWord("ZZTSZDNRBNWKJC") + "')", true);
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "alert('" + LanguageHandle.GetWord("ZZTSGKMXXYCZJC") + "')", true);
            TB_AccountCode.Focus();
            TB_AccountType.Focus();
            TB_TypeArea.Focus();
            return;
    ...
    protected void BT_AccountUpdate_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "alert('" +LanguageHandle.GetWord("ZZJingGaoBuNengShuaZiShenZuoWe")+"')", true);
            return;
        }
    ...
    protected void BT_AccountDelete_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "alert('" +LanguageHandle.GetWord("ZZDiShiGaiLanguageHandleGetWor")+"')", true); 
            return;
        }
        if (IsAccountChild(strCode))
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "alert('" + LanguageHandle.GetWord("ZZTSGKMXYZKMXSCZKM") + "')", true);
            return;
        }
        ...
        try
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "alert('" + LanguageHandle.GetWord("ZZSCCGGKMBMYBYYJKBCGKMBM") + "')", true);
            }
            else
            {
