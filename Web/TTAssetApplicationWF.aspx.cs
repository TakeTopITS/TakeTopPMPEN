...
public partial class TTAssetApplicationWF : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("TTAPPAssetApplicationWF.aspx?BusinessID=" + strWLBusinessID + "&WLID=" + strToDoWLID);
        }
    ...
    protected void DataGrid1_ItemCommand(object sender, DataGridCommandEventArgs e)
    {
        ...
        if (e.CommandName != "Page")
        {
            ...
            if (e.CommandName == "Update" | e.CommandName == "Assign")
            {
                ...
                //从流程中打开的业务单
                strAllowFullEdit = ShareClass.GetWorkflowTemplateStepFullAllowEditValue("AssetWithdrawal", "Assets", strAAID, "0");
                if (strToDoWLID != null | strAllowFullEdit == "YES")
                {
                    BT_NewMain.Visible = true;
                    BT_NewDetail.Visible = true;
    ...
    protected string SubmitApply()
    {
        ...
        try
        {
            ...
            workFlow.RelatedCode = "AssetAA" + strAAID;
