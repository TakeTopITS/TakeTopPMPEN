                                                        ...
                                                        <Columns>
                                                            <asp:TemplateColumn>
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <%--<asp:Button ID="Button2" runat="server" CssClass="inpu" Text="Approved" CommandName="approve" CommandArgument='<%# Eval("ID") %>' Visible='<%# Eval("Progress").ToString()=="报批" ? true : false %>' />--%>
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
