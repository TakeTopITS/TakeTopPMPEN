<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTHSEDiseasePrevention.aspx.cs" Inherits="TTHSEDiseasePrevention" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ZhiYeBingYuFang%>"></asp:Label></td>
                                                        <td width="5">
                            ...
                            <tr>
                                <td align="left" style="padding-top: 5px;">
                                    ...
                                    <table cellpadding="2" cellspacing="0" class="formBgStyle" width="75%">
                                        <tr>
                                            <td align="left">
                                                <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,YuFangXinXi%>"></asp:Label>：<asp:TextBox ID="TextBox1" runat="server" Width="120px"></asp:TextBox>
                                        
                                                <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,XiangMuXinXi%>"></asp:Label>：<asp:TextBox ID="TextBox2" runat="server" Width="120px"></asp:TextBox>
                                            ...
                                            <td class="formItemBgStyleForAlignLeft">
                                                        ...
                                                        <td>
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td width="10%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,ZhongLei%>"></asp:Label></strong>
                                                                    </td>
                                                                    <td width="40%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,JianYaoMiaoShu%>"></asp:Label></strong>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                ...
                                                <asp:DataGrid ID="DataGrid2" runat="server" AutoGenerateColumns="False" Height="1px"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundColumn DataField="DiseaseType" HeaderText="种类">
                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="10%" />
                                                            <HeaderStyle BorderColor="#394f66" BorderStyle="Solid" BorderWidth="1px" Font-Bold="true"
                                                                Horizontalalign="left" />
                                                        </asp:BoundColumn>
                                                        <asp:BoundColumn DataField="BriefDescription" HeaderText="简要描述">
                            ...
                            <table cellpadding="2" cellspacing="0" class="formBgStyle" width="900px">
                                ...
                                <tr style="color: #000000">
                                    ...
                                    <td class="formItemBgStyleForAlignLeft" style="height: 30px">
                                        <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,ZhongLei%>"></asp:Label>：</td>
                                    <td class="formItemBgStyleForAlignLeft" style="height: 30px">
                                        <asp:DropDownList ID="DL_DiseaseType" runat="server" CssClass="shuru">
                                            <asp:ListItem Value="Pneumoconiosis" Text="<%$ Resources:lang,ChenFei%>" />
                                            <asp:ListItem Value="RadiationSickness" Text="<%$ Resources:lang,FangSheBing%>" />
                                            <asp:ListItem Value="Poisoning" Text="<%$ Resources:lang,ZhongDu%>" />
                                            <asp:ListItem Value="PhysicalFactors" Text="<%$ Resources:lang,WuLiYinSu%>" />
                                            <asp:ListItem Value="BiologicalFactors" Text="<%$ Resources:lang,ShengWuYinSu%>" />
                                            <asp:ListItem Value="SkinDisease" Text="<%$ Resources:lang,PiFuBing%>" />
                                            <asp:ListItem Value="EyeDisease" Text="<%$ Resources:lang,YanBing%>" />
                                            <asp:ListItem Value="ENTDisease" Text="<%$ Resources:lang,ErBiHouJiBing%>" />
                                            <asp:ListItem Value="Tumor" Text="<%$ Resources:lang,ZhongLiu%>" />
                                ...
                                <tr style="color: #000000">
                                    <td class="formItemBgStyleForAlignLeft" style="width: 150px; height: 30px">
                                        <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,JianYaoMiaoShu%>"></asp:Label>： </td>
                                    <td class="formItemBgStyleForAlignLeft" style="height: 30px" colspan="3">
                                        <asp:TextBox ID="TB_BriefDescription" runat="server" CssClass="shuru" Height="35px" TextMode="MultiLine" Width="90%"></asp:TextBox>
                                    </td>
                                </tr>
