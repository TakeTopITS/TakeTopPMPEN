...
public partial class TakeTopSoftRent_BaseDataSet : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Label1.Text = ShareClass.GetPageTitle(this.GetType().BaseType.Name + ".aspx"); bool blVisible = TakeTopSecurity.TakeTopLicense.GetAuthobility(this.GetType().BaseType.Name + ".aspx", strUserCode);  //Label1.Text = ShareClass.GetPageTitle(this.GetType().BaseType.Name + ".aspx"); bool blVisible = TakeTopSecurity.TakeTopLicense.GetAuthobility(this.GetType().BaseType.Name + ".aspx", LanguageHandle.GetWord("RuanJianZuYongJianZhanCanShu").ToString().Trim(), strUserCode);
        if (blVisible == false)
        {
    ...
    protected void BT_Copy_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", LanguageHandle.GetWord("ShiBaiYaoFuZhiDeZhanDianBuNeng").ToString().Trim(), true);
        }
    }
    ...
    protected void BT_Delete_Click(object sender, EventArgs e)
    {
        ...
        if (strHomeSiteURL != "")
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", LanguageHandle.GetWord("TiShiCiZhanDianDeShuJuYiYingYo").ToString().Trim(), true);
            }
        }
        else
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", LanguageHandle.GetWord("ShiBaiYaoShanChuDeZhanDianBuNe").ToString().Trim(), true);
    ...
    protected void DL_IsAutoBuildSite_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", LanguageHandle.GetWord("QuanBuGengXinChengGong").ToString().Trim(), true);
    }
