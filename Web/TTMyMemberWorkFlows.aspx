<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTMyMemberWorkFlows.aspx.cs"
    Inherits="TTMyMemberWorkFlows" %>
                            ...
                            <tr>
                                <td height="31" class="page_topbj">
                                    <table width="96%" border="0" align="left" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td align="left" style="width: 10%;" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                ...
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: left;">
                                                            <asp:Label ID="Label11112" runat="server" Text="<%$ Resources:lang,BianHao%>"></asp:Label></td>
                                                        <td style="text-align: left;">
                                                        ...
                                                        <td style="text-align: left;">
                                                            <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,MoBan%>"></asp:Label>
                                                        </td>
                                                        <td style="text-align: left;">
                                                    ...
                                                    <tr>
                                                        <td align="left" style="height: 30px;">
                                                            <asp:Button ID="BT_AllWorkFlow" runat="server" CssClass="inpuLong" OnClick="BT_AllWorkFlow_Click"
                                                                Text="<%$ Resources:lang,SuoYouZhiJieChengYuanGongZuoLiu%>" />
                                                            <br />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                                    ...
                                                                    <td>
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td align="left">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,BuMenRenYuan%>"></asp:Label></strong>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                                    ...
                                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td width="27%" align="left">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,GongZuo%>"></asp:Label></strong>
                                                                                            </td>
                                                                                            ...
                                                                                            <td width="10%" align="left">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,FaQiRen%>"></asp:Label></strong>
                                                                                            </td>
                                                                                            <td width="20%" align="left">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,FaQiShiJian%>"></asp:Label></strong>
                                                                                            </td>
