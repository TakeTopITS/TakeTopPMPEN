<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTKPIThirdPartReview.aspx.cs"
    Inherits="TTKPIThirdPartReview" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,DSFCYJXPH%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popwindow"
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table class="formBgStyle" style="width: 100%; text-align: left;" cellpadding="3"
                                        ...
                                        <asp:DataList ID="DataList3" runat="server" CellPadding="0" ForeColor="#333333" Height="16px"
                                            ...
                                            <ItemTemplate>
                                                <table cellpadding="4" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td align="left">
                                                            <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,DiSanFangPing%>"></asp:Label>：
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" class="tdLeft" style="color: Blue; font-style: italic;">
                                                            <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,PingHeFen%>"></asp:Label>：
                                                            ******
                                                            <br />
                                        ...
                                        <asp:DataList ID="DataList2" runat="server" CellPadding="0" ForeColor="#333333" Height="16px"
                                            ...
                                            <ItemTemplate>
                                                <table cellpadding="4" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td align="left">
                                                            <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,LingDaoPing%>"></asp:Label>：
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" class="tdLeft" style="color: Blue; font-style: italic;">
                                                            <asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,PingHeFen%>"></asp:Label>：<%#DataBinder.Eval(Container.DataItem, "LeaderName")%><br /><%#DataBinder.Eval(Container.DataItem, "Comment")%></td>
                                                    </tr>
                                                </table>
                                            </ItemTemplate>
                                            <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                        ...
                                        <asp:DataList ID="DataList1" runat="server" CellPadding="0" ForeColor="#333333" Height="16px"
                                            ...
                                            <ItemTemplate>
                                                <table cellpadding="4" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td align="left">
                                                            <asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,ZiPingYuZongPing%>"></asp:Label>：
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" class="tdLeft" style="color: Blue; font-style: italic;">
                                                            <asp:Label ID="Label22" runat="server" Text="<%$ Resources:lang,ZiPing%>"></asp:Label>：
                                                                                        <%#DataBinder.Eval(Container.DataItem, "SelfComment")%>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" class="tdLeft" style="color: Blue; font-style: italic;">
                                                            <asp:Label ID="Label23" runat="server" Text="<%$ Resources:lang,ZongPingPingHeFen%>"></asp:Label>：<%#DataBinder.Eval(Container.DataItem, "OperatorName")%><br /><%#DataBinder.Eval(Container.DataItem, "TotalComment")%></td>
                                                    </tr>
                                                </table>
                                            </ItemTemplate>
                                            <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                ...
                                <tr>
                                    <td class="formItemBgStyle">
                                        <asp:Label ID="Label24" runat="server" Text="<%$ Resources:lang,YiJian%>"></asp:Label>：
                                    </td>
                                    <td align="left" valign="top" class="formItemBgStyle">
                                        <CKEditor:CKEditorControl ID="HE_UserSummary" runat="server" Height="150px" Width="98%" Visible="false" />
                                        <CKEditor:CKEditorControl runat="server" ID="HT_UserSummary" Width="98%" Height="150px" Visible="False" />
                                    </td>
                                </tr>
                            </table>
                            <br />
