<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTWorkFlowList.aspx.cs" Inherits="TTWorkFlowList" %>
                                    ...
                                    <tr>
                                        <td align="left">
                                            ...
                                            <asp:DataGrid ID="DataGrid2" runat="server" AutoGenerateColumns="False" Height="1px"
                                                Width="100%" OnItemCommand="DataGrid2_ItemCommand" CellPadding="4" ShowHeader="false"
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td style="text-align: left; padding: 5px 5px 5px 5px;">
                                    ...
                                    <asp:Label ID="LB_StepID" runat="server"></asp:Label>
                            ...
                            <tr>
                                <td align="left">
                                            ...
                                            <td>
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        ...
                                                        <td width="10%" align="center">
                                                            <strong>
                                                                <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,ChuLiRen%>"></asp:Label>
                                                            </strong>
                                                        </td>
                                                        <td width="20%" align="center">
                                                            <strong>
                                    ...
                                    <asp:DataGrid ID="DataGrid4" runat="server" AutoGenerateColumns="False" Height="1px" OnItemCommand="DataGrid4_ItemCommand"
                                ...
                                <td align="left">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="Label29" runat="server" Text="<%$ Resources:lang,GuanLianMoKuiLieBiao%>"></asp:Label>:
                                            </td>
                                            <td>
                                                <asp:Repeater ID="RP_RelatedModule" runat="server">
                                                    <ItemTemplate>
                                                        <a href='<%# DataBinder.Eval(Container.DataItem,"PageName") %>&MainTableCanAdd=<%# DataBinder.Eval(Container.DataItem,"MainTableCanAdd").ToString().Trim() %>&DetailTableCanAdd=<%# DataBinder.Eval(Container.DataItem,"DetailTableCanAdd").ToString().Trim() %>&MainTableCanEdit=<%# DataBinder.Eval(Container.DataItem,"MainTableCanEdit").ToString().Trim() %>&MainTableCanDelete=<%# DataBinder.Eval(Container.DataItem,"MainTableCanDelete").ToString().Trim() %>&DetailTableCanEdit=<%# DataBinder.Eval(Container.DataItem,"DetailTableCanEdit").ToString().Trim() %>&&DetailTableCanDelete=<%# DataBinder.Eval(Container.DataItem,"DetailTableCanDelete").ToString().Trim() %>&RelatedWorkFlowID=<%# DataBinder.Eval(Container.DataItem,"WorkflowID").ToString().Trim() %>&RelatedWorkflowStepID=<%# DataBinder.Eval(Container.DataItem,"WorkflowStepID") %>&RelatedWorkflowStepDetailID=<%# DataBinder.Eval(Container.DataItem,"WorkflowStepDetailID") %>' target="_blank">
