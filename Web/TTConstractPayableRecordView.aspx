<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTConstractPayableRecordView.aspx.cs" Inherits="TTConstractPayableRecordView" %>
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td align="left" width="7%">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,WeiFuJinE%>"></asp:Label></strong>
                                                                                            </td>
                                                                                            <td align="left" width="14%">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,ShouKuanFang%>"></asp:Label></strong>
                                                                                            </td>
                                                    ...
                                                    <tr>
                                                        <td style="height: 20px;" align="left">
                                                            <table width="90%">
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td align="left" width="7%">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label15" runat="server" Text="<%$ Resources:lang,ShiFuJinE%>"></asp:Label></strong>
                                                                                            </td>

                                                                                            <td align="left" width="7%">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,BenBiJinE%>"></asp:Label></strong>
                                                                                            </td>

                                                                                            <td align="left" width="7%">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,ShouXuFei%>"></asp:Label></strong>
                                                                                            </td>

                                                                                            <td align="left" width="8%">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,ShiFuRiQi%>"></asp:Label></strong>
                                                                                            </td>

                                                                                            <td align="left" width="8%">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,ShouKuanFangShi%>"></asp:Label></strong>
                                                                                            </td>
                                                                                            <td align="left" width="8%">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,BiBie%>"></asp:Label></strong>
                                                                                            </td>
                                                                                            <td align="left" width="8%">
                                                                                                <strong>
                                                                        ...
                                                                        <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                                            ...
                                                                            <Columns>
                                                                                <asp:TemplateColumn HeaderText="Number">
                                                                                    <ItemTemplate>
                                                                                        <asp:Button ID="BT_PayableID" runat="server" CssClass="inpu" Text='<%# DataBinder.Eval(Container.DataItem,"ID") %>' />
                                                                                    </ItemTemplate>
                                                                ...
                                                                <tr>
                                                                    <td align="right">
                                                                        <asp:Label ID="Label25" runat="server" Text="<%$ Resources:lang,YingFuZongE%>"></asp:Label>：<asp:Label ID="LB_PayableAmount" runat="server"></asp:Label>&#160;<asp:Label ID="Label24" runat="server" Text="<%$ Resources:lang,ShiFuZongE%>"></asp:Label>：<asp:Label
                                                                            ID="LB_OutOfPocketAmount" runat="server"></asp:Label>
                                                                        &#160;<asp:Label ID="Label26" runat="server" Text="<%$ Resources:lang,DaiFuZongE%>"></asp:Label>：<asp:Label ID="LB_UNOutOfPocketAmount" runat="server"></asp:Label>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
