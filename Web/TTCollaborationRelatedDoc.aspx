<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTCollaborationRelatedDoc.aspx.cs"
    Inherits="TTCollaborationRelatedDoc" %>
                        ...
                        <tr>
                            <td>
                                <table width="100%" cellpadding="5px" cellspacing="0">
                                    <tr>
                                        <td width="18%" align="left" valign="top" rowspan="5" style="border-right: solid 1px #D8D8D8;">
                                        ...
                                        <td style="width: 22%; height: 24px; text-align: left; display: none;">
                                            <asp:Label ID="LB_FindCondition" runat="server"></asp:Label>
                                            <asp:Label ID="LB_CoID" runat="server"></asp:Label>
                                                                ...
                                                                <table width="100%" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                                    <tr style="font-size: 10pt">
                                                                        <td style="text-align: left; width: 100%;" class="formItemBgStyle">
                                                                            <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,MingCheng%>"></asp:Label>：<asp:TextBox ID="TB_WLName" runat="server" Width="309px"></asp:TextBox>&nbsp;
                                                                            <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,LeiXing%>"></asp:Label>： 
                                                                    ...
                                                                    <tr style="font-size: 10pt">
                                                                        <td style="text-align: left; width: 100%; height: 51px;" class="formItemBgStyle">
                                                                            <asp:Label ID="Label26" runat="server" Text="<%$ Resources:lang,ShuoMing%>"></asp:Label>：<asp:TextBox ID="TB_Description" runat="server" TextMode="MultiLine" Width="441px"
