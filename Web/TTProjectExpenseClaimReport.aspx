<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTProjectExpenseClaimReport.aspx.cs"
    Inherits="TTProjectExpenseClaimReport" %>
                                            ...
                                            <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,XiangMuFeiYongBaoXiaoHuiZong%>"></asp:Label>
                        ...
                        <tr>
                            <td>
                                <table cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td width="200px" valign="top" style="padding: 5px 5px 0px 5px; border-right: solid 1px #D8D8D8; text-align: left;">
                                            ...
                                            <table style="width: 100%;">
                                                <tr>
                                                    <td colspan="3" style="width: 100%;">
                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                            <tr>
                                                                <td align="left" style="padding: 0px 5px 0 5px; font-weight: bold; height: 24px; color: #394f66; background-image: url('ImagesSkin/titleBG.jpg')">
                                                                    <table style="width: 100%">
                                                                        <tr>
                                                                            <td style="background: #f0f0f0; text-align: left; width: 65%; height: 25px;" colspan="2">
                                                                                <asp:Label ID="LB_MyQueryScope" runat="server" Text="<%$ Resources:lang,MyQueryScope%>"></asp:Label>:<asp:Label ID="LB_QueryScope" runat="server" Font-Names="Arial,宋体"
                                                                    ...
                                                                    <table width="100%" style="margin-top: 5px;">
                                                                        <tr>
                                                                            <td>
                                                                                ...
                                                                                <asp:DataGrid ID="DataGrid2" runat="server" AllowCustomPaging="True" ShowHeader="false"
                                                                            ...
                                                                            <td colspan="3" style="text-align: left">
                                                                                <table>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,BaoXiaoFeiYongZongE%>"></asp:Label>:<asp:Label ID="LB_Amount" runat="server" Font-Bold="True" Width="93px"></asp:Label>
                                                                                        </td>
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="3" style="text-align: left">
                                                                                <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,BaoXiaoFeiYongMingXi%>"></asp:Label>：
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td colspan="3">
                                                                                        ...
                                                                                        <td>
                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td width="10%" align="center">
                                                                                                        <strong>
                                                                                                            <asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,FeiYongID%>"></asp:Label></strong>
                                                                                                    </td>
                                                                                                    <td width="20%" align="center">
                                                                                                        <strong>
                                                                                                            <asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,KeMu%>"></asp:Label></strong>
                                                                                                    </td>
                                                                                                    <td width="35%" align="center">
                                                                                                        <strong>
                                                                                                            <asp:Label ID="Label22" runat="server" Text="<%$ Resources:lang,MiaoShu%>"></asp:Label></strong>
                                                                                                    </td>
                                                                                                    <td width="10%" align="center">
                                                                                                        <strong>
                                                                                                    ...
                                                                                                    <td width="15%" align="center">
                                                                                                        <strong>
                                                                                                            <asp:Label ID="Label24" runat="server" Text="<%$ Resources:lang,DengJiShiJian%>"></asp:Label></strong>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </td>
                                                                                ...
                                                                                <asp:DataGrid ID="DataGrid5" runat="server" AutoGenerateColumns="False" Height="30px"
                                                                                    OnItemCommand="DataGrid2_ItemCommand" Width="98%" CellPadding="4" ShowHeader="false"
