<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTAccountPayRecordSummarySAAS.aspx.cs" Inherits="TTAccountPayRecordSummarySAAS" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="LB_FuKuanMingXiHuiZongBiao" runat="server" Text="<%$ Resources:lang,FuKuanMingXiHuiZongBiao%>"></asp:Label></td>
                                                        <td width="5">
                                                        ...
                                                        <td align="left">
                                                            <table width="100%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                                <tr>
                                                                    ...
                                                                    <td class="formItemBgStyleForAlignLeft">
                                                                        <asp:Label ID="Label21" runat="server" Text="Project"></asp:Label>：
                                                                    </td>
                                                                    <td class="formItemBgStyleForAlignLeft" style="width: 100px;" align="left">
                                                                    ...
                                                                    <td class="formItemBgStyleForAlignLeft">
                                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ShiFuZongE%>"></asp:Label>：
                                                                    </td>
                                                                    <td class="formItemBgStyleForAlignLeft">
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td align="left" width="8%">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,GuanLianXiangMu%>"></asp:Label></strong>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
