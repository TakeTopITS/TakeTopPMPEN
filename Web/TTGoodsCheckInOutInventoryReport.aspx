            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <div id="AboveDiv">
                        <table style="width: 980px;">
                            ...
                            <tr>
                                <td style="text-align: right;">
                                    <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,XingHao%>"></asp:Label>：</td>
                                <td>
                            ...
                            <tr>
                                <td style="text-align: right;">
                                    <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,YueFen%>"></asp:Label>：

                                </td>
                                <td colspan="3">
                                    <asp:TextBox ID="TB_Monthly" runat="server" Width="200px"></asp:TextBox>
                                    (<asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,GeShi%>"></asp:Label>：201507)</td>
                        ...
                        <table style="width: 98%;">
                            <tr>
                                <td style="width: 100%; height: 80px; font-size: xx-large; text-align: center;">
                                    <br />
                                    <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,LiaoPingShouFaChengBaoBiao%>"></asp:Label>
                                    <br />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="width: 100%;">
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td width="8%" align="left">
                                                            <strong>
                                                                <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,YueFen%>"></asp:Label></strong>
                                                        </td>
                                                        ...
                                                        <td width="8%" align="left">
                                                            <strong>
                                                                <asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,RuKuLiang%>"></asp:Label></strong>
                                                        </td>
                                                        <td width="8%" align="left">
                                                            <strong>
                                                                <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,ChuKuLiang%>"></asp:Label></strong>
                                                        </td>
                                                        <td width="8%" align="left">
                                                            <strong>
                                                                <asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,DangYueJieYuLiang%>"></asp:Label></strong>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                    ...
                                    <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            <asp:BoundColumn DataField="CheckTime" HeaderText="Month">
                                            ...
                                            <asp:BoundColumn DataField="TotalCheckInNumber" HeaderText="入库量">
                                                <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="8%" />
                                            </asp:BoundColumn>
