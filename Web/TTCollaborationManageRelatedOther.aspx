<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTCollaborationManageRelatedOther.aspx.cs" Inherits="TTCollaborationManageRelatedOther" %>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="2" width="300" align="right">
                                                                    <asp:Button ID="BT_MakeCollaboration" CssClass="inpuLong" runat="server"
                                                                        Text="<%$ Resources:lang,JianLiXieZuo%>" OnClick="BT_MakeCollaboration_Click" />
                                                                    &nbsp;
