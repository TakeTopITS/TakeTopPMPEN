<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTConstractExecuteReport.aspx.cs" Inherits="TTConstractExecuteReport" %>
                ...
                <ContentTemplate>
                    ...
                    <table cellpadding="3" cellspacing="0" class="formBgStyle" style="width: 900px;">
                        <tr>
                            ...
                            <td width="20%" colspan ="3" align="center" class="formItemBgStyle">
                    ...
                    <table width="1200px" cellpadding="0" cellspacing="0">
                        <tr>
                            <td colspan="5" style="width: 1200px; height: 80px;" align="center">
                                <br />

                                <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,HeTongTiQianZhiXingBaoBiao%>" Font-Size="XX-Large"></asp:Label>
                                <br />
                                <br />
                                <asp:Label ID="Label26" runat="server" Text="<%$ Resources:lang,QianDingShiJianWanYuKaiShiShiJian%>" Font-Size="Small"></asp:Label>
                            </td>
                        </tr>
                    </table>
                    <table width="1200px" cellpadding="0" cellspacing="0">
                                        ...
                                        <td>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td width="7%" align="center">
                                                        <strong>
                                                            <asp:Label ID="Label14" runat="server" Text="甲方单位"></asp:Label></strong>
                                                    </td>
                                                    ...
                                                    <td width="7%" align="center">
                                                        <strong>
                                                            <asp:Label ID="Label16" runat="server" Text="所属项目"></asp:Label></strong>
                                                    </td>
                                                      <td width="7%" align="center">
                                                        <strong>
                                                            <asp:Label ID="Label7" runat="server" Text="所属部门"></asp:Label></strong>
                                                    </td>
                                                    <td width="7%" align="center">
                                                        <strong>
                                                            <asp:Label ID="Label20" runat="server" Text="开始时间"></asp:Label></strong>
                                                    </td>
                                                    <td width="7%" align="center">
                                                        <strong>
                                                            <asp:Label ID="Label21" runat="server" Text="结束时间"></asp:Label></strong>
                                                    </td>
                                                    <td width="7%" align="center">
                                                        <strong>
                                                    ...
                                                    <td width="9%" align="center">
                                                        <strong>
                                                            <asp:Label ID="Label17" runat="server" Text="合同金额"></asp:Label></strong>
                                                    </td>

                                                    <td width="7%" align="center">
                                                        <strong>
                                                            <asp:Label ID="Label25" runat="server" Text="甲方单位"></asp:Label></strong>
                                                    </td>
                                                    <td width="7%" align="center">
                                                        <strong>
                                                            <asp:Label ID="Label3" runat="server" Text="乙方单位"></asp:Label></strong>
                                                    </td>
                                                    <td width="7%" align="center">
                                                        <strong>
                            ...
                            <td>
                                <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" ShowHeader="true"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="Startdate" DataFormatString="{0:yyyy/MM/dd}" HeaderText="<%$ Resources:lang,KaiShiRiQi%>" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle HorizontalAlign="Center" Width="7%" />
                                        </asp:BoundColumn>
                                        <asp:BoundColumn DataField="EndDate" DataFormatString="{0:yyyy/MM/dd}" HeaderText="<%$ Resources:lang,JieShuRiQi%>" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle HorizontalAlign="Center" Width="7%" />
                                        </asp:BoundColumn>
                                        <asp:BoundColumn DataField="SignDate" DataFormatString="{0:yyyy/MM/dd}" HeaderText="<%$ Resources:lang,QianDingRiQi%>" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle HorizontalAlign="Center" Width="7%" />
                                        </asp:BoundColumn>
                                        <asp:BoundColumn DataField="ArchiveTime" HeaderText="<%$ Resources:lang,GuiDangRiQi%>" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle HorizontalAlign="Left" Width="7%" />
                                        </asp:BoundColumn>
                                        <asp:BoundColumn DataField="Amount" HeaderText="<%$ Resources:lang,HeTongJinE%>" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle HorizontalAlign="Center" Width="9%" />
                                        </asp:BoundColumn>
                                        <asp:BoundColumn DataField="PartA" HeaderText="<%$ Resources:lang,JiaFangDanWei%>" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle HorizontalAlign="Left" Width="7%" />
                                        </asp:BoundColumn>
                                        <asp:BoundColumn DataField="PartB" HeaderText="<%$ Resources:lang,YiFangDanWei%>" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle HorizontalAlign="Left" Width="7%" />
                                        </asp:BoundColumn>
                                        <asp:BoundColumn DataField="Exception" HeaderText="<%$ Resources:lang,YiChangMiaoShu%>" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle HorizontalAlign="Left" Width="7%" />
                                        </asp:BoundColumn>
                                    </Columns>
