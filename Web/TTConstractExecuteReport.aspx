                ...
                <ContentTemplate>
                    ...
                    <table cellpadding="3" cellspacing="0" class="formBgStyle" style="width: 900px;">
                        <tr>
                            ...
                            <td width="20%" colspan ="3"  class="formItemBgStyleForAlignLeft">
                                        ...
                                        <td>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td width="7%" align="left">
                                                        <strong>
                                                            <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,SuoShuXiangMu%>"></asp:Label></strong>
                                                    </td>
                                                      <td width="7%" align="left">
                                                        <strong>
                                                            <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,SuoShuBuMen%>"></asp:Label></strong>
                                                    </td>
                                                    <td width="7%" align="left">
                                                        <strong>
                                                    ...
                                                    <td width="7%" align="left">
                                                        <strong>
                                                            <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,YiFangChanWei%>"></asp:Label></strong>
                                                    </td>
                                                    <td width="7%" align="left">
                                                        <strong>
                            ...
                            <td>
                                <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" ShowHeader="true"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="ProjectName" HeaderText="<%$ Resources:lang,SuoShuXiangMu%>" HeaderStyle-Horizontalalign="left">
                                            <ItemStyle HorizontalAlign="Left" Width="7%" />
                                        </asp:BoundColumn>
                                        <asp:BoundColumn DataField="DepartName" HeaderText="<%$ Resources:lang,SuoShuBuMen%>" HeaderStyle-Horizontalalign="left">
                                            <ItemStyle HorizontalAlign="Left" Width="7%" />
                                        </asp:BoundColumn>
                                        ...
                                        <asp:BoundColumn DataField="ArchiveTime" HeaderText="<%$ Resources:lang,GuiDangRiQi%>" HeaderStyle-Horizontalalign="left">
                                            <ItemStyle HorizontalAlign="Left" Width="7%" />
                                        </asp:BoundColumn>
                                        ...
                                        <asp:BoundColumn DataField="PartB" HeaderText="<%$ Resources:lang,YiFangDanWei%>" HeaderStyle-Horizontalalign="left">
                                            <ItemStyle HorizontalAlign="Left" Width="7%" />
                                        </asp:BoundColumn>
