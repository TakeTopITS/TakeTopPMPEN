...
public partial class TTConstractPayableVisaEdit : System.Web.UI.Page
{
    ...
    protected void DataGrid5_ItemCommand(object sender, DataGridCommandEventArgs e)
    {
        if (e.CommandName != "Page")
        {
            ...
            intWLNumber = GetRelatedWorkFlowNumber("VisaManagement", LanguageHandle.GetWord("GeTongQianZheng"), strVisaID);
            if (intWLNumber > 0)
            {
            ...
            //从流程中打开的业务单
            string strAllowFullEdit = ShareClass.GetWorkflowTemplateStepFullAllowEditValue("VisaManagement", LanguageHandle.GetWord("GeTongQianZheng"), strVisaID, "0");
            ...
            if (e.CommandName == "Update" | e.CommandName == "Assign")
            {
                ...
                TB_WLName.Text = LanguageHandle.GetWord("HeTongQiaZhen") + constractPayableVisa.VisaName.Trim() + LanguageHandle.GetWord("ShenQing");

                LoadRelatedWL("VisaManagement", LanguageHandle.GetWord("GeTongQianZheng"), constractPayableVisa.ID);
    ...
    protected void AddMain()
    {
        ...
        try
        {
            ...
            TB_WLName.Text = LanguageHandle.GetWord("HeTongQiaZhen") + strVisaName + LanguageHandle.GetWord("ShenQing");
    ...
    protected void UpdateMain()
    {
        ...
        try
        {
            ...
            //从流程中打开的业务单
            //更改工作流关联的数据文件
            string strAllowFullEdit = ShareClass.GetWorkflowTemplateStepFullAllowEditValue("VisaManagement", LanguageHandle.GetWord("GeTong"), strVisaID, "0");
            if (strToDoWLID != null | strAllowFullEdit == "YES")
            {
                string strCmdText;
                ...
                if (strToDoWLID == null)
                {
                    strToDoWLID = ShareClass.GetBusinessRelatedWorkFlowID("VisaManagement", LanguageHandle.GetWord("GeTong"), strVisaID);
                }
    ...
    protected void DataGrid1_ItemCommand(object sender, DataGridCommandEventArgs e)
    {
        if (e.CommandName != "Page")
        {
            ...
            int intWLNumber = GetRelatedWorkFlowNumber("VisaManagement", LanguageHandle.GetWord("GeTong"), strVisaID);
            if (intWLNumber > 0)
            {
                BT_NewMain.Visible = false;
            ...
            if (e.CommandName == "Delete")
            {
                ...
                try
                {
                    ...
                    //从流程中打开的业务单
                    //更改工作流关联的数据文件
                    strAllowFullEdit = ShareClass.GetWorkflowTemplateStepFullAllowEditValue("VisaManagement", LanguageHandle.GetWord("GeTongQianZheng"), strVisaID, "0");
                    if (strToDoWLID != null | strAllowFullEdit == "YES")
                    {
                        string strCmdText = "select * from T_ConstractPayableVisa where ID = " + strVisaID;
                        if (strToDoWLID == null)
                        {
                            strToDoWLID = ShareClass.GetBusinessRelatedWorkFlowID("VisaManagement", LanguageHandle.GetWord("GeTongQianZheng"), strVisaID);
                        }
    ...
    protected void BT_NewDetail_Click(object sender, EventArgs e)
    {
        ...
        strVisaID = LB_VisaID.Text.Trim();
        int intWLNumber = GetRelatedWorkFlowNumber("VisaManagement", LanguageHandle.GetWord("GeTongQianZheng"), strVisaID);
    ...
    protected string SubmitApply()
    {
        ...
        workFlow.RelatedType = LanguageHandle.GetWord("GeTongQianZheng");
        workFlow.Status = "New";
        ...
        try
        {
            ...
            LoadRelatedWL(strWLType, LanguageHandle.GetWord("GeTongQianZheng"), int.Parse(strVisaID));
