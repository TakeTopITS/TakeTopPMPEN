                                                    ...
                                                    <td>
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                ...
                                                                <td width="8%" align="left" class="auto-style1"><strong>
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="overflow: auto; padding :0px 5px 0px 5px;">
                            ...
                            <table style="width: 100%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                <tr style="display:none;">
                                    ...
                                    <td  style="width: 80%" class="formItemBgStyleForAlignLeft">
                                ...
                                <tr>
                                    ...
                                    <td class="formItemBgStyleForAlignLeft" style="width: 650px; height: 27px">
                                        ...
                                        <asp:DropDownList ID="DL_WFType" runat="server">
                                            <asp:ListItem Text="<%$ Resources:lang,FeiYongShengQing%>" Value="ExpenseRequest" />
                                        </asp:DropDownList>
