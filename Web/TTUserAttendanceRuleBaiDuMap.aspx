...
<script type="text/javascript">
    ...
    window.onload = function () {
        ...
        geolocation.getCurrentPosition(function (r) {
            if (this.getStatus() == BMAP_STATUS_SUCCESS) {
                ...
                var lng = window.parent.document.getElementById("TB_Longitude").value;
                var lat = window.parent.document.getElementById("TB_Latitude").value;
                var address = window.parent.document.getElementById("TB_Address").value;
    ...
    function setLngLat() {
        ...
        window.parent.document.getElementById("TB_Longitude").value = lng;
