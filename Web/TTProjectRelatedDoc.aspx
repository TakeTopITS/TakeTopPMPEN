<%@ Page Language="C#" AutoEventWireup="true" Async="true" CodeFile="TTProjectRelatedDoc.aspx.cs"
    Inherits="TTProjectRelatedDoc" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        //        var selectedRows = [];
        //        // 获取所有被CB_Select复选框选中的行
        //        $('#TabContainer1_TabPanel1_DataGrid1 input[type=checkbox][name*=CB_Select]:checked').each(function () {
        ...
        function DownloadFiles(selectedRows) {
            var urls = [];

            // 获取所有选中行的URL
            $.each(selectedRows, function (_, row) {

                var addressCell = row.find('.address-cell');

                /*    alert(JSON.stringify(addressCell, null, 2));*/

                alert(addressCell.attr('href'));

                /*  addressCell.click();*/


                //var fullDomainWithProtocolAndPort = window.location.protocol + '//' + window.location.hostname + ':' + window.location.port;
                //var appName = window.location.pathname.split('/')[1];

                //var url = fullDomainWithProtocolAndPort + '/' + appName + "/" + addressCell.attr('href').replace("\\", "/");
                            ...
                            <tr>
                                <td style="text-align: left;" valign="top">
                                    <cc1:TabContainer CssClass="ajax_tab_menu" ID="TabContainer1" runat="server" ActiveTabIndex="0" Width="100%">
                                                                    ...
                                                                    <td>
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                ...
                                                                                <td width="7%" align="left">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,QuanXian %>"></asp:Label></strong>
                                                                                </td>
                                                            ...
                                                            <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                                                                    ...
                                                                    <table class="FullBorderTable" style="width: 100%;">
                                                                        ...
                                                                        <tr>
                                                                            <td style="width: 100%; text-align: left;">
                                                                                <div>
                                                                                    <asp:Label ID="Label25" Text="<%$ Resources:lang,WenJianShangChuan%>" runat="server"></asp:Label>：
                                                                                    <br />
                                                                ...
                                                                <asp:View ID="View2" runat="server">
                                                                    <table style="width: 98%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                                        ...
                                                                        <tr>
                                                                            <td style="text-align: left; width: 100%;" class="formItemBgStyleAlignLeft">
                                                                                ...
                                                                                <asp:Label ID="LB_tbWFType" runat="server" Text="<%$ Resources:lang,Type %>"></asp:Label>
                                                                                ...
                                                                                <asp:Label ID="LB_tbWFTemplage" runat="server"
                                                                                    Text="<%$ Resources:lang,WFTemplate %>"></asp:Label>

                                                                                :<asp:DropDownList ID="DL_TemName" runat="server" DataTextField="TemName"
                                                                                    DataValueField="TemName" Width="144px">
                                                                                </asp:DropDownList>

                                                                                <asp:HyperLink ID="HL_WLTem" runat="server" NavigateUrl="~/TTWorkFlowTemplate.aspx"
                                                                                    Target="_blank" Text="<%$ Resources:lang,TemplateMaintain %>"></asp:HyperLink>
                                                                    ...
                                                                    <table width="98%">
                                                                        <tr>
                                                                            <td align="left">
                                                                                <asp:Label ID="LB_tbApplyRecord" runat="server" Text="<%$ Resources:lang,ApplyRecord %>"></asp:Label>
                                                                                            ...
                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                <tr>
                                                                                                    <td width="20%" align="left"><strong>
                                                                                                        <asp:Label ID="LB_tbWFID" runat="server" Text="<%$ Resources:lang,ID %>"></asp:Label>
                                                                                                    </strong></td>
                                                                                                    <td width="40%" align="left"><strong>
                                                                                                        <asp:Label ID="LB_tbWorkflow" runat="server" Text="<%$ Resources:lang,Workflow %>"></asp:Label>
                                                                                                    </strong></td>
                                                                                                    <td width="20%" align="left"><strong>
                                                                                                        <asp:Label ID="LB_tbApplyTime" runat="server" Text="<%$ Resources:lang,ApplyTime %>"></asp:Label>
                                                                                                    </strong></td>
                                        ...
                                        <cc1:TabPanel ID="TabPanel3" runat="server" HeaderText="文档上传">
                                            <HeaderTemplate>
                                                <asp:Label ID="Label24" runat="server" Text="<%$ Resources:lang,WenDangMoBan%>"></asp:Label>
                                            </HeaderTemplate>
                                            <ContentTemplate>
                                                <table style="width: 100%;">
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 80%; text-align: left; padding: 5px 5px 5px 5px;" valign="top">
                                                            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,MuBanXiangMu %>"></asp:Label>：<asp:Label ID="LB_TemplateProjectID" runat="server"></asp:Label><asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,JiHuaBanBen %>"></asp:Label>：<asp:Label ID="LB_TemplatePlanVerID" runat="server"></asp:Label><asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,JiHua %>"></asp:Label>：<asp:Label ID="LB_TemplatePlanID" runat="server"></asp:Label><asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,DeWenDangLieBiao %>"></asp:Label>：
                                                             <table width="98%" align="left" border="0" cellpadding="0" cellspacing="0" background="ImagesSkin/main_n_bj.jpg">
                                                                 <tr>
                                                                     <td width="7">
                                                                         <img src="ImagesSkin/main_n_l.jpg" width="7" height="26" /></td>
                                                                     <td>
