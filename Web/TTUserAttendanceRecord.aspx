                                ...
                                <td valign="top">
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            ...
                                            <td align="left" style="width: 170px; border-right: solid 1px #D8D8D8; padding: 5px 0px 0px 5px"
                                                valign="top">
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td align="left"><strong>
                                                                                    <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,BuMenRenYuan%>"></asp:Label></strong></td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                ...
                                                                                <td width="5%" align="left">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,ChiDao%>"></asp:Label>
                                                                                    </strong>(<asp:Label ID="Label26" runat="server" Text="<%$ Resources:lang,Minute%>"></asp:Label>)</td>
                                                                                <td width="5%" align="left">
                                                                                    <strong>
