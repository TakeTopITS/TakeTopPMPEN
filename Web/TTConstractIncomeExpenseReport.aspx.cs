...
public partial class TTConstractIncomeExpenseReport : System.Web.UI.Page
{
    ...
    protected void BT_ExportToExcel_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            {
                Random a = new Random();
                string fileName = LanguageHandle.GetWord("HeTongShouZhiBaoBiao").ToString().Trim() + DateTime.Now.ToString("yyyy-MM-dd-HH-mm-ss") + "-" + a.Next(100, 999) + ".xls";
