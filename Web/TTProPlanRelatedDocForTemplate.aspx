<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTProPlanRelatedDocForTemplate.aspx.cs" Inherits="TTProPlanRelatedDocForTemplate" %>
                        ...
                        <tr>
                            <td style="text-align: left; padding-left: 10px; padding-top: 10px;">
                                <cc1:TabContainer CssClass="ajax_tab_menu" ID="TabContainer1" runat="server" ActiveTabIndex="0"
                                    Width="99%">
                                    <cc1:TabPanel ID="TabPanel1" runat="server" HeaderText="模板文档上传">
                                        <ContentTemplate>
                                                    ...
                                                    <td style="width: 100%; height: 12px; text-align: left;">
                                                        <table>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:Label ID="Label50" runat="server" Text="<%$ Resources:lang,WenJianMing %>"></asp:Label>：</td>
                                                                <td>
                                                                    <asp:TextBox ID="TB_DocName" runat="server" Width="300px"></asp:TextBox></td>
                                                                <td>
                                                                    <asp:Button ID="BT_AddDoc" runat="server" class="inpu" OnClick="BT_AddDoc_Click" Text="<%$ Resources:lang,New %>"></asp:Button>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                                ...
                                                                <table style="width: 98%" align="left" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                                    ...
                                                                    <tr style="font-size: 10pt">
                                                                        <td style="width: 100%;" class="formItemBgStyleForAlignLeft">
                                                                            ...
                                                                            <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,GongZuoLiuMuBan %>"></asp:Label>：
                                                ...
                                                <tr>
                                                    ...
                                                    <table width="98%" align="left" border="0" cellpadding="0" cellspacing="0" background="ImagesSkin/main_n_bj.jpg">
                                                        ...
                                                        <asp:DataGrid ID="DataGrid2" runat="server" AutoGenerateColumns="False"
                                                            Height="1px" Horizontalalign="left" ShowHeader="False"
