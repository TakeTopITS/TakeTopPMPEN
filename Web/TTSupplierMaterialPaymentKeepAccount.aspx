<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTSupplierMaterialPaymentKeepAccount.aspx.cs" Inherits="TTSupplierMaterialPaymentKeepAccount" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,LiaoPingCaiGouFuKanJiZhang%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                            ...
                            <tr>
                                <td style="padding: 5px 5px 5px 5px;">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td align="center" width="20%">
                                                            <strong>
                                                                <asp:Label ID="Label12234234" runat="server" Text="<%$ Resources:lang,GongYingShang%>"></asp:Label></strong>
                                                        </td>
                                    ...
                                    <asp:DataGrid ID="DataGrid5" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                        ...
                                        Width="100%">
                                        <Columns>
                                            <asp:TemplateColumn HeaderText="Ã÷Ï¸">
