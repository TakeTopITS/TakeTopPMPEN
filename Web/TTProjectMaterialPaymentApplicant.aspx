<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTProjectMaterialPaymentApplicant.aspx.cs" Inherits="TTProjectMaterialPaymentApplicant" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,WuZiCaiGouFuKuanShengQing%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                ...
                                <td style="padding: 5px 5px 5px 5px;">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td width="6%" align="left">
                                                            <strong>
                                                                <asp:Label ID="Label66" runat="server" Text="<%$ Resources:lang,FaQiShengQing%>" /></strong>
                                                        </td>
                                    ...
                                    <asp:DataGrid ID="DataGrid5" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundColumn DataField="AOName" HeaderText="Name">
                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="8%" />
                                            </asp:BoundColumn>
                                            <asp:BoundColumn DataField="ProjectName" HeaderText="Name">
                                            ...
                                            <asp:BoundColumn DataField="CreateTime" DataFormatString="{0:yyyy/MM/dd}" HeaderText="CreationTime">
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popwindow" name="fixedDiv"
                        style="z-index: 9999; width: 950px; height: 530px; position: absolute; overflow: hidden; display: none; border-radius: 10px;">
                                    ...
                                    <td colspan="2" align="left">
                                        <table width="98%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                    ...
                                                    <table width="100%">
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                ...
                                                                <asp:TextBox ID="TB_PartAContactInformation" runat="server" Width="40%"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3" class="formItemBgStyleForAlignLeft">
                                                    <asp:TextBox ID="TB_PaymentMethod" runat="server" Width="120px"></asp:TextBox>
                                                    ...
                                                    <NickLee:NumberBox ID="NB_AleadyTotalInvoice" runat="server" MaxAmount="1000000000000" MinAmount="-1000000000000" OnBlur="" OnFocus="" OnKeyPress="" PositiveColor="" Width="60px" Amount="1" Precision="3">1.0001.000</NickLee:NumberBox>

                                                    <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,LeiJiYingJiaoFaPiao%>"></asp:Label>：
                                               
                                                    <NickLee:NumberBox ID="NB_ShouldTotalInvoice" runat="server" MaxAmount="1000000000000" MinAmount="-1000000000000" OnBlur="" OnFocus="" OnKeyPress="" PositiveColor="" Width="60px" Amount="1" Precision="3">1.0001.000</NickLee:NumberBox>
                                                ...
                                                <td colspan="3" class="formItemBgStyleForAlignLeft">
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Button ID="BT_SelectProject" runat="server" Text="<%$ Resources:lang,XiangMu%>" />
                                ...
                                <tr>
                                    <td width="50%">
                                        ...
                                        <table align="left" cellpadding="3" cellspacing="0" class="formBgStyle" width="99%">
                                            <tr>
                                                <td style="width: 6%;" class="formItemBgStyleForAlignLeft">
                                    ...
                                    <td width="50%">
                                        <cc1:TabContainer ID="TabContainer2" runat="server" ActiveTabIndex="0" Width="100%" CssClass="ajax_tab_menu">
                                            <cc1:TabPanel ID="TabPanel4" runat="server" HeaderText="入库单" TabIndex="0">
                                                ...
                                                <ContentTemplate>
                                                    <br />
                                                    <div id="DivID12" style="width: 100%; height: 350px; overflow: auto; text-align: left;">
                                                        <table width="200%" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td align="left" style="width: 100%;">
                                                                                ...
                                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                    <tr>
                                                                                        <td align="left" width="10%"><strong>
                                                                                            <asp:Label ID="Label92" runat="server" Text="<%$ Resources:lang,QingZhang%>"></asp:Label></strong></td>

                                                                                        <td align="left" width="10%"><strong>
                                                                                            <asp:Label ID="Label31" runat="server" Text="<%$ Resources:lang,BianHao %>"></asp:Label></strong></td>
                                                                                        <td align="left" width="15%"><strong>
                                                                                            <asp:Label runat="server" Text="<%$ Resources:lang,DanHao %>"></asp:Label></strong></td>
                                                                                        <td align="left" width="25%"><strong>
                                                                                            <asp:Label runat="server" Text="<%$ Resources:lang,GongYingShang %>"></asp:Label></strong></td>
                                                                                        <td align="left" width="20%"><strong>
                                                                                            <asp:Label ID="Label32" runat="server" Text="<%$ Resources:lang,CangKu %>"></asp:Label></strong></td>
                                                                                        <td align="left" width="20%"><strong>
                                                                                            <asp:Label ID="Label36" runat="server" Text="<%$ Resources:lang,RuKuShiJian %>"></asp:Label></strong></td>
                                                                    ...
                                                                    <asp:DataGrid ID="DataGrid3" runat="server" AutoGenerateColumns="False" AllowPaging="true" PageSize="5" OnPageIndexChanged="DataGrid3_PageIndexChanged"
                                                                        CellPadding="4" ForeColor="#333333" GridLines="None" Height="1px" OnItemCreated="DataGrid3_ItemCreated"
                                                                        ShowHeader="False"
                                                                        Width="100%">
                                                                        <Columns>
                                                                            <asp:TemplateColumn>
                                                                                <ItemTemplate>
                                                                                    <asp:CheckBox ID="CB_ClearPay" runat="server" AutoPostBack="true" />
                                                                                </ItemTemplate>
                                                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="left" Width="10%" />
                                                                            </asp:TemplateColumn>
                                                                            <asp:BoundColumn DataField="CheckInID" HeaderText="ID">
                                                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="left" Width="10%" />
                                                                            </asp:BoundColumn>
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    ...
                                                                    <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,RuKuDanMingXi%>"></asp:Label>： </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="formItemBgStyleForAlignLeft" colspan="2">
                                                                            ...
                                                                            <td>
                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td width="8%" align="left"><strong>
                                                                                            <asp:Label ID="Label91" runat="server" Text="<%$ Resources:lang,WeiShenQing%>"></asp:Label></strong></td>
                                                                                        <td width="8%" align="left"><strong>
                                                                                            <asp:Label ID="Label172" runat="server" Text="<%$ Resources:lang,DanWei %>"></asp:Label></strong></td>
                                                                                        <td width="8%" align="left"><strong>
                                                                                            <asp:Label ID="Label110" runat="server" Text="<%$ Resources:lang,PinPai %>"></asp:Label></strong></td>
                                                                                        <td width="15%" align="left"><strong>
                                                                                            <asp:Label ID="Label114" runat="server" Text="<%$ Resources:lang,GuiGe %>"></asp:Label></strong></td>
                                                                                        <td align="left"><strong>
                                                                                            <asp:Label ID="Label174" runat="server" Text="<%$ Resources:lang,HanShui %>"></asp:Label></strong></td>
                                                                                    </tr>
                                                                                </table>
                                                                            </td>
                                                                    ...
                                                                    <asp:DataGrid ID="DataGrid15" runat="server" AutoGenerateColumns="False"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateColumn HeaderText="末申请额">
                                                                                <ItemTemplate>
                                                                                    <%# SummaryNoApplyAmount("CheckInOrderRecord", Eval("ID").ToString()) %>
                                                                                </ItemTemplate>
                                                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="8%" />
                                                                            </asp:TemplateColumn>
                                                                ...
                                                                <td>
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td width="10%" align="left"><strong>
                                                                                <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,PinPai %>"></asp:Label></strong> </td>
                                                                            <td align="left"><strong>
                                                                ...
                                                                <td>
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td width="8%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label143" runat="server" Text="<%$ Resources:lang,YuCaiGouLiang %>"></asp:Label></strong>
                                                                            </td>
                                                                            <td width="8%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,YuRuKuLiang %>"></asp:Label></strong>
                                                                            </td>
                                                                            <td width="8%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label144" runat="server" Text="<%$ Resources:lang,YuChuKuLiang %>"></asp:Label></strong>
                                                                            </td>
                                                                            <td width="8%" align="left">
                                                                                <strong>
                                                                                    <asp:Label ID="Label168" runat="server" Text="<%$ Resources:lang,YuShengChanLiang %>"></asp:Label></strong>
                                                                            </td>
                                                                            <td width="8%" align="left">
                                                                                <strong>
                                            ...
                                            <cc1:TabPanel ID="TabPanel8" runat="server" HeaderText="供应商物料">
                                                ...
                                                <ContentTemplate>
                                                    <br />
                                                    <div id="Div11" style="width: 100%; height: 300px; overflow: auto;">
                                                                            ...
                                                                            <td>
                                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td width="10%" align="left"><strong>
                                                                                            <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,PinPai %>"></asp:Label></strong> </td>
                                ...
                                <tr style="font-size: 10pt">
                                    ...
                                    <td class="formItemBgStyleForAlignLeft">
                                        <asp:DropDownList ID="DL_WFType" runat="server">
                                            <asp:ListItem Value="MaterialProcurementPaymentRequest" Text="<%$ Resources:lang,WuZiCaiGouFuKuanShengQing%>" />
                                                ...
                                                <td>
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td width="5%" align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label62" runat="server" Text="<%$ Resources:lang,BianJi %>" /></strong>
                                                            </td>
                                                            <td width="5%" align="left">
                                                                <strong>
