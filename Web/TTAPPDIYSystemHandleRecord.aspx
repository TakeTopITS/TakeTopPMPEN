                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" class="bian">
                        <tr>
                            <td colspan="2" height="31" class="page_topbj">
                                <table id="table_return" width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td align="left">
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        ...
                                                                                        <div class="npb">
                                                                                            ...
                                                                                            <div class="nprig wfinfo">
                                                                                                ...
                                                                                                <h4 onclick="javascript:ChangeMenu(0);"><a href='TTAppMyWorkDetailMain.aspx?WLID=<%# DataBinder.Eval(Container.DataItem,"WLID") %>' target="rightFrame"><%# DataBinder.Eval(Container.DataItem,"WLName")%></a></h4>
