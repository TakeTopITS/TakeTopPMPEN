<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTAssetCheckReport.aspx.cs"
    Inherits="TTAssetCheckReport" %>
                    ...
                    <div>
                        <table style="width: 980px;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="TB_Position" runat="server" Width="120px"></asp:TextBox>
                        ...
                        <table style="width: 98%;">
                            <tr>
                                <td style="width: 100%; height: 80px; font-size: xx-large; text-align: center;">
                                    <br />
                                    <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ZiChanPanDianBaoBiao%>"></asp:Label>
                                    <br />
                                </td>
                            </tr>
                             <tr>
                                <td style="text-align: left;" colspan="4">
                                    ...
                                    &nbsp;
                                    <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,ZongJinE%>"></asp:Label>总：<asp:Label ID="LB_TotalAmount" runat="server"></asp:Label>
                                            ...
                                            <td>
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        ...
                                                        <td width="6%" align="center">
                                                            <strong>
                                                                <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,DanJia%>"></asp:Label>价</strong>
                                                        </td>
                                                        <td width="6%" align="center">
                                                            <strong>
                                                        ...
                                                        <td width="8%" align="center">
                                                            <strong>
                                                                <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,ChangJia%>"></asp:Label></strong>
                                                        </td>
                                                        <td width="8%" align="center">
                                                            <strong>
                                                                <asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,YongHu%>"></asp:Label></strong>
                                                        </td>
                                                        <td width="8%" align="center">
                                                            <strong>
                            ...
                            <tr>
                                <td style="width: 1200px; text-align: center;">
                                    <asp:Label ID="Label23" runat="server" Text="<%$ Resources:lang,Di%>"></asp:Label>：<asp:Label ID="LB_PageIndex" runat="server"></asp:Label>
                                    &nbsp;<asp:Label ID="Label24" runat="server" Text="<%$ Resources:lang,YeGong%>"></asp:Label>
