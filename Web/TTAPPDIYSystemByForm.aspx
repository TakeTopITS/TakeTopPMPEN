...
<head>
    ...
    <script type="text/javascript">
        ...
        jQuery(function () {
            ...
            jQuery("table:eq(1)").width(jQuery(document).width() + 300);
    ...
    <script type="text/javascript">
        ...
        function ChangeMenu(way) {
            ...
            var preFrameW = window.parent.document.getElementById("bodyFrame").cols;

            /*   alert(preFrameW);*/

            if (preFrameW !== "90%,*") {

                window.parent.document.getElementById("bodyFrame").cols = "90%,*";

            }
            if (preFrameW !== "10%,*") {

                window.parent.document.getElementById("bodyFrame").cols = "10%,*";
                                ...
                                <table style="width: 100%;">
                                    <tr>
                                        <td class="tdLeft" align="left">
                                            ...
                                            <asp:TextBox Width="85%" ID="TB_WorkFlowName" runat="server"></asp:TextBox>
                                        <td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,MiaoShu%>"></asp:Label>
                                            <asp:TextBox ID="TB_WLDescription" runat="server" Width="85%"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
            ...
            <table style="display: none;">
                <tr>
                    <td>
                        ...
                        <td id="td_WFMain" width="300" style="padding: 5px 5px 5px 5px; vertical-align: top;">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr style="display: none;">
                                                ...
                                                <td colspan="2" class="tdRight" align="left">
                                                    <asp:Button ID="BT_Download" runat="server" OnClick="BT_Download_Click" Text="<%$ Resources:lang,XiaZai%>"
                                                        Enabled="False" /><asp:Button ID="BT_SaveXMLFile" runat="server" Enabled="False" OnClick="BT_SaveXMLFile_Click"
                                                            Text="<%$ Resources:lang,BaoCunGengGai%>" />
                                                </td>
                                                <td class="tdLeft" align="right"></td>
                                                <td colspan="2" class="tdRight" align="left">
                                ...
                                <tr>
                                    <td colspan="3" class="tdRight" style="padding-right: 20px; text-align: center;">
