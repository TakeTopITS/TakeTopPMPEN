<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTMyScheduleEdit.aspx.cs" Inherits="TTMyScheduleEdit" %>
                    ...
                    <td>
                        <table width="99%">
                            <tr>
                                ...
                                <td align="right">
                                    <asp:ImageButton ID="BT_Delete" runat="server" OnClientClick="return confirm(getDeleteMsgByLangCode())" ImageUrl="ImagesSkin/Delete.png" OnClick="BT_Delete_Click"></asp:ImageButton></td>
                            </tr>
                        </table>
