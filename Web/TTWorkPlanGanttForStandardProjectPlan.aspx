<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTWorkPlanGanttForStandardProjectPlan.aspx.cs" Inherits="TTWorkPlanGanttForStandardProjectPlan" %>
...
<head>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function changeGanttChartProperty() {
            ...
            $("#button-1080-btnWrap").click();

            if (varBusinessType == "COMPARE") {

                for (i = 0; i < 2; i++) {
                    $("#button-1054-btnWrap").click();
                }
