<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTDefectRelatedDoc.aspx.cs" Inherits="TTDefectRelatedDoc" %>
                        ...
                        <tr>
                            <td>
                                <table width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="width: 200px; text-align: left; padding: 5px 5px 0px 5px; border-right: solid 1px #D8D8D8; vertical-align: top;"
                                            rowspan="5">
                                                                            ...
                                                                            <table style="width: 100%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                                                ...
                                                                                <tr style="font-size: 10pt">
                                                                                    <td style="text-align: left; width: 100%;" class="formItemBgStyleForAlignLeft">
                                                                                        <span style="font-size: 10pt">（<asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,YaoQiuShouDaoXinXi%>"></asp:Label>：<asp:CheckBox ID="CB_DefectdMail" runat="server"
                                                                                            Font-Size="10pt" Text="<%$ Resources:lang,YouJian%>" />
                                                                                            <asp:CheckBox ID="CB_DefectdSMS" runat="server" Font-Size="10pt" Text="<%$ Resources:lang,DuanXin%>" />）
                                                                                        </span>
