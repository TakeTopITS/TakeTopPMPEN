<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTWorkPlanRelatedResources.aspx.cs" Inherits="TTWorkPlanRelatedResources" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="LB_Title" runat="server" Text="<%$ Resources:lang,JiHuaCanYiRenYuan%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td align="left" width="100%">
                                                                        <strong>
                                                                            <asp:Button ID="BT_ProjectMember" runat="server" CssClass="inpuLong" Text="<%$ Resources:lang,XiangMuChengYuan%>" OnClick="BT_ProjectMember_Click" />
                                                                        </strong>
                                                                    </td>
                                                                </tr>
                                                            </table>
