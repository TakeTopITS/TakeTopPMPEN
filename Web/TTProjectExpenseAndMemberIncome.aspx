                                ...
                                <tr>
                                    <td class="formItemBgStyleForAlignLeft">
                                        <table cellpadding="2" cellspacing="0" class="formBgStyle">
                                            ...
                                            <tr>
                                                <td  class="formItemBgStyleForAlignLeft"> <asp:Label ID="Label23" runat="server" Font-Bold="True" Text="<%$ Resources:lang,MeiGongLiFeiYong%>" ></asp:Label>：
                                            ...
                                            <tr>
                                                <td  class="formItemBgStyleForAlignLeft"><asp:Label ID="Label22" runat="server" Text="<%$ Resources:lang,GongLiShu%>" />：</td>
                                                <td  class="formItemBgStyleForAlignLeft">
                                                    <%@ Register Assembly="NickLee.Web.UI" Namespace="NickLee.Web.UI" TagPrefix="NickLee" %>
