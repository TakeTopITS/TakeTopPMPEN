                                                            ...
                                                            <table background="ImagesSkin/main_n_bj.jpg" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td>
                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            <tr>
                                                                                <%-- <td align="left" width="4%"><strong>编号</strong></td>--%>
                                                                                ...
                                                                                <%--    <td align="left" width="5%"><strong><asp:Label runat="server" Text="<%$ Resources:lang,BanBen%>"></asp:Label></strong></td>--%>
                                                                                ...
                                                                                <%--     <td align="left" width="1%"><strong><asp:Label runat="server" Text="<%$ Resources:lang,FaKuanJinE%>"></asp:Label></strong></td>--%>
                                                                                <%-- <td align="left" width="5%"><strong><asp:Label runat="server" Text="<%$ Resources:lang,DuZheLeiXing%>"></asp:Label></strong></td>--%>
                                                                                <td align="left" width="5%"><strong>
