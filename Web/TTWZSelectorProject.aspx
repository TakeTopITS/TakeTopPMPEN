    ...
    <script type="text/jscript">
        ...
        function clickMember(resultList) {
            ...
            if (resultList != "" && resultList != undefined) {
                ...
                window.parent.document.getElementById("HF_PlatformID").value = resultList;
                window.parent.document.getElementById("BT_PlatformProject").click();
                                        ...
                                        <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                    <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,PingTaiXiangMu%>"></asp:Label>
                                                </td>
                                                <td width="5">
                                                                ...
                                                                <td>
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td width="10%" align="center">
                                                                                <strong>
                                                                                    <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,XiangMuJinE%>"></asp:Label></strong>
                                                                            </td>
                                                                            <td width="10%" align="center">
                                                                                <strong>
                                                        ...
                                                        <asp:DataGrid ID="DG_List" runat="server" AllowPaging="false" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                <asp:TemplateColumn>
                                                                    ...
                                                                    <HeaderTemplate>
                                                                        <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,CaoZuo%>"></asp:Label>
                                                                    </HeaderTemplate>
                                                                    <ItemTemplate>

                                                                        <input id='<%#Eval("ProjectID") %>' type="radio" name="name1" />
                                                                ...
                                                                <asp:TemplateColumn>
                                                                    ...
                                                                    <HeaderTemplate>
                                                                        <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,XiangMuMing%>"></asp:Label>
                                                                    </HeaderTemplate>
                                                                    <ItemTemplate>
