                                                            ...
                                                            <div style="width: 100%;">
                                                                <table class="formBgStyle" width="80%">
                                                                    <tr>
                                                                       ...
                                                                       <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,WuZiDaiMa%>"></asp:Label>£º</td>
                                                                    ...
                                                                    <tr>
                                                                        <td style="text-align: left" class="formItemBgStyle">
                                                                            <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,GuiGeXingHao%>"></asp:Label>£º</td>
                                                                    ...
                                                                    <tr>
                                                                        <td style="text-align: left" class="formItemBgStyle">
                                                                            <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,JiLiangDanWei%>"></asp:Label>£º</td>
                                                                        <td style="text-align: left" class="formItemBgStyle">
                                                                            <asp:DropDownList ID="DDL_Unit" DataTextField="UnitName" DataValueField="ID" runat="server"></asp:DropDownList>
                                                                        </td>
                                                                        <td style="text-align: left" class="formItemBgStyle">
                                                                            <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,HuanSuanDanWei%>"></asp:Label>£º</td>
                                                                        <td style="text-align: left" class="formItemBgStyle">
                                                                    ...
                                                                    <tr>
                                                                        <td style="text-align: left" class="formItemBgStyle">
                                                                            <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,ShiChangHangQing%>"></asp:Label>£º</td>
                                                                        <td style="text-align: left" class="formItemBgStyle">
                                                                            <asp:TextBox ID="TXT_Market" runat="server"></asp:TextBox>
                                                                        </td>
                                                                        <td style="text-align: left" class="formItemBgStyle">
                                                                            <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,HuanSuanXiShu%>"></asp:Label>£º</td>
                                                                        <td style="text-align: left" class="formItemBgStyle">
                                                                    ...
                                                                    <tr>
                                                                        <td style="text-align: left" class="formItemBgStyle">
                                                                            <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,BiaoZhun%>"></asp:Label>&nbsp;&nbsp;£º</td>
                                                                        <td style="text-align: left" class="formItemBgStyle" colspan="5">
                                                                    ...
                                                                    <tr>
                                                                        <td style="text-align: left" class="formItemBgStyle">
                                                                            <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,DuiZhaoBiaoZhun%>"></asp:Label>£º</td>
                                                                        <td style="text-align: left" class="formItemBgStyle" colspan="5">
                                                                    ...
                                                                    <tr>
                                                                        <td style="text-align: left" class="formItemBgStyle">
                                                                            <asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,DuiZhaoMiaoShu%>"></asp:Label>£º</td>
                                                                        <td style="text-align: left" class="formItemBgStyle" colspan="5">
