                ...
                <ContentTemplate>
                    <div id="AboveDiv">
                        <table id="AboveTable" cellpadding="0" width="100%" cellspacing="0" class="bian">
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,QingJiaShenQing%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                            ...
                            <tr>
                                <td class="formItemBgStyleForAlignLeft" colspan="2" style="padding: 5px 5px 5px 5px;">
                                            ...
                                            <td>
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                <tr>
                                                                    ...
                                                                    <td align="left" width="10%"><strong>
                                                                        <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,SuoShuBuMen %>"></asp:Label>
                                                                    </strong></td>
                                                                    <td align="left" width="10%"><strong>
                                                                        <asp:Label ID="Label15" runat="server" Text="<%$ Resources:lang,ShenQingRen %>"></asp:Label>
                                                                    </strong></td>
                                                                    ...
                                                                    <td align="left" width="10%"><strong>
                                                                        <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,QingJieLeiXing %>"></asp:Label>
                                                                    </strong></td>
                                                                    <td align="left" width="18%"><strong>
                                                                        <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,QingJieShiYou %>"></asp:Label>
                                                                    </strong></td>
                                                ...
                                                <asp:DataGrid ID="DataGrid2" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="1px" OnItemCommand="DataGrid2_ItemCommand" OnPageIndexChanged="DataGrid2_PageIndexChanged" PageSize="15" ShowHeader="False" Width="100%">
                                                    <Columns>
                                                        ...
                                                        <asp:BoundColumn DataField="LeaveType" HeaderText="LeaveType">
                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="10%" />
                                                        </asp:BoundColumn>
                                                        <asp:BoundColumn DataField="ApplyBecause" HeaderText="ReasonForLeave">
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popwindow" name="fixedDiv"
                                ...
                                <tr>
                                    ...
                                    <td class="formItemBgStyleForAlignLeft" style="width: 40%">
                                        <asp:Label ID="LB_LeaveType" runat="server"></asp:Label>:
                                                            ...
                                                            <asp:Label ID="Label32" runat="server" Text="<%$ Resources:lang,DangYue%>"></asp:Label>:
                                                            <asp:Label ID="LB_TotalLeaveDaysForCurrentMonth" runat="server"></asp:Label>
                                        <asp:Label ID="Label33" runat="server" Text="<%$ Resources:lang,DangNian%>"></asp:Label>:
                                                            <asp:Label ID="LB_TotalLeaveDaysForCurrentYear" runat="server"></asp:Label>
                                        <asp:Label ID="LB_Day" runat="server" Text="<%$ Resources:lang,Tian%>"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <div id="popwindow_footer" class="layui-layer-btn" style="border-top: 1px solid #ccc;">
                            <asp:LinkButton ID="BT_New" runat="server" class="layui-layer-btn notTab" OnClick="BT_New_Click" Text="<%$ Resources:lang,BaoCun%>"></asp:LinkButton><a class="layui-layer-btn notTab" onclick="return popClose();"><asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,GuanBi%>" /></a>
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td align="left" style="width: 650px; height: 27px"><span style="font-size: 10pt"></span>
                                        ...
                                        <asp:Label ID="LB_RelatedType" runat="server" Visible="False"></asp:Label><asp:Label
                                            ID="LB_RelatedID" runat="server" Visible="False"></asp:Label></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td align="left" colspan="2">
                                        <table width="100%" border="0" cellpadding="0" cellspacing="0" background="ImagesSkin/main_n_bj.jpg">
                                            <tr>
                                                <td width="7">
                                                    <img src="ImagesSkin/main_n_l.jpg" width="7" height="26" alt="" /></td>
                                                <td>
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            ...
                                                            <td width="50%" align="left"><strong>
                                                                <asp:Label ID="Label27" runat="server" Text="<%$ Resources:lang,GongZuoLiu%>"></asp:Label></strong></td>
                                                            <td width="20%" align="left"><strong>
                                                                <asp:Label ID="Label28" runat="server" Text="<%$ Resources:lang,ShenQingShiJian%>"></asp:Label></strong></td>
                                                            <td width="10%" align="left"><strong>
