<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTUserPlanList.aspx.cs" Inherits="TTUserPlanList" %>
                                                                                            ...
                                                                                            <table border="0" cellpadding="4" cellspacing="0" width="100%">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td class="tdLeft" style="text-align: center; font-size: 10pt;">
                                                                                                        <asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,JiHuaNeiRong%>"></asp:Label> 
                                                                                                    </td>
                                                                            ...
                                                                            <tr>
                                                                                <td align="left">
                                                                                    <asp:HyperLink ID="HL_RelatedDoc" runat="server" Enabled="False" NavigateUrl="~/TTPlanRelatedDoc.aspx"
                                                                                        Target="_blank">--&gt;<asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,XiangGuanWenDang%>"></asp:Label> </asp:HyperLink>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                    ...
                                                                                    <cc2:TabContainer CssClass="ajax_tab_menu" ID="TabContainer1" runat="server" ActiveTabIndex="0" Width="90%">
                                                                                                                    ...
                                                                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <td align="left" width="60%">
                                                                                                                                ...
                                                                                                                                <strong>
                                                                                                                                    <asp:Label ID="Label15" runat="server" Text="<%$ Resources:lang,RiZhiNeiRong%>"></asp:Label> </strong>
                                                                                                                            ...
                                                                                                                            <td align="left" width="10%">
                                                                                                                                ...
                                                                                                                                <strong>
                                                                                                                                    <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,JingDu%>"></asp:Label> </strong>
                                                                                        ...
                                                                                        <cc2:TabPanel ID="TabPanel2" runat="server" HeaderText="关键目标" TabIndex="1">
                                                                                            ...
                                                                                            <HeaderTemplate>
                                                                                                ...
                                                                                                <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,GuanJianMuBiao%>"></asp:Label> 
                                                                                                                        ...
                                                                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td align="left" width="70%">
                                                                                                                                    ...
                                                                                                                                    <strong>
                                                                                                                                        <asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,NuBiao%>"></asp:Label> </strong>
                                                                                                                                ...
                                                                                                                                <td align="left" width="20%">
                                                                                                                                    ...
                                                                                                                                    <strong>
                                                                                                                                        <asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,JingDu%>"></asp:Label> </strong>
                                                                                        ...
                                                                                        <cc2:TabPanel ID="TabPanel3" runat="server" HeaderText="领导评核" TabIndex="2">
                                                                                            ...
                                                                                            <HeaderTemplate>
                                                                                                ...
                                                                                                <asp:Label ID="Label22" runat="server" Text="<%$ Resources:lang,LingDaoPingHe%>"></asp:Label> 
                                                                                                                                ...
                                                                                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                                                    ...
                                                                                                                                    <tr>
                                                                                                                                        ...
                                                                                                                                        <td align="left" width="10%">
                                                                                                                                            ...
                                                                                                                                            <strong>
                                                                                                                                                <asp:Label ID="Label24" runat="server" Text="<%$ Resources:lang,LingDao%>"></asp:Label> </strong>
                                                                                                                                        ...
                                                                                                                                        <td align="left" width="50%">
                                                                                                                                            ...
                                                                                                                                            <strong>
                                                                                                                                                <asp:Label ID="Label25" runat="server" Text="<%$ Resources:lang,PingHeNeiRong%>"></asp:Label> </strong>
                                                                                                                                        ...
                                                                                                                                        <td align="left" width="10%">
                                                                                                                                            ...
                                                                                                                                            <strong>
                                                                                                                                                <asp:Label ID="Label26" runat="server" Text="<%$ Resources:lang,FenShu%>"></asp:Label> </strong>
                                                                                        ...
                                                                                        <cc2:TabPanel ID="TabPanel4" runat="server" HeaderText="评论记录" TabIndex="0">
                                                                                            ...
                                                                                            <HeaderTemplate>
                                                                                                ...
                                                                                                <asp:Label ID="Label28" runat="server" Text="<%$ Resources:lang,WoDeYiJian%>"></asp:Label> 
