                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="text-align: left; overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table style="width: 100%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                ...
                                <tr>
                                    ...
                                    <td class="formItemBgStyleForAlignLeft" colspan="5" style="text-align: left; height: 2px;">&nbsp;<asp:Button ID="BT_Active" runat="server" CssClass="inpu" Enabled="False" OnClick="BT_Active_Click" Text="<%$ Resources:lang,GuiDang%>" />
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="text-align: left; overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table style="width: 100%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                ...
                                <tr>
                                    ...
                                    <td colspan="5" rowspan="1" style="text-align: left" class="formItemBgStyleForAlignLeft">
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="text-align: left; overflow: auto; padding: 0px 5px 0px 5px;">
                            <table style="width: 100%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" rowspan="1" style="text-align: left" class="formItemBgStyleForAlignLeft">
