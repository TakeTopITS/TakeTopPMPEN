                    ...
                    <div class="layui-layer layui-layer-iframe" id="popwindowGraphRegistration"
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="text-align: left; overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table style="width: 100%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                <tr>
                                    <td style="width: 8%; " class="formItemBgStyleAlignLeft">
                                ...
                                <tr>
                                    <td class="formItemBgStyleAlignLeft" style="width: 8%; ">
                                        <asp:Label ID="Label49" runat="server" Text="<%$ Resources:lang,TuCeHao%>"></asp:Label>：</td>
                                    <td class="formItemBgStyleAlignLeft" style="width: 20%; text-align: left;">
                                    ...
                                    <td class="formItemBgStyleAlignLeft" style="text-align: left;" colspan="3">
                                ...
                                <tr>
                                    <td class="formItemBgStyleAlignLeft" style="height: 2px;">&nbsp;</td>
                                    <td class="formItemBgStyleAlignLeft" colspan="5" style="text-align: left; height: 2px;">&nbsp;<asp:Button ID="BT_Active" runat="server" CssClass="inpu" Enabled="False" OnClick="BT_Active_Click" Text="<%$ Resources:lang,GuiDang%>" />
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="text-align: left; overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table style="width: 100%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                ...
                                <tr>
                                    ...
                                    <td colspan="5" rowspan="1" style="text-align: left" class="formItemBgStyleAlignLeft">
                                ...
                                <tr>
                                    ...
                                    <td colspan="5" style="text-align: left; height: 2px;" class="formItemBgStyleAlignLeft"></td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popwindowReceiptRegistration"
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="text-align: left; overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table style="width: 100%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                ...
                                <tr>
                                    <td style="height: 2px;" class="formItemBgStyleAlignLeft">&nbsp;</td>
                                    <td colspan="5" style="text-align: left; height: 2px;" class="formItemBgStyleAlignLeft">
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="text-align: left; overflow: auto; padding: 0px 5px 0px 5px;">
                            <table style="width: 100%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" rowspan="1" style="text-align: left" class="formItemBgStyleAlignLeft">
                                ...
                                <tr>
                                    <td align="left">
                                        <table>
                                            ...
                                            <tr>
                                                <td colspan="2" style="text-align: center" class="formItemBgStyleAlignLeft">
