<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTGoodsProductionManagement.aspx.cs" Inherits="TTGoodsProductionManagement" %>
                                                ...
                                                <table width="990" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <td align="left">（<asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,DanHao%>"></asp:Label>：
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>&nbsp;</td>
                                                                    <td align="left">
                                                                        <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,DingDanMingCheng%>"></asp:Label>：
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="TB_PDName" runat="server" Width="120px"></asp:TextBox>
                                                                    </td>
                                                                    <td>&nbsp;</td>
