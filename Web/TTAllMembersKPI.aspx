<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTAllMembersKPI.aspx.cs"
    Inherits="TTAllMembersKPI" %>
                ...
                <ContentTemplate>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ChaKanSuoYouChengYuanJiXiao%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                        ...
                                        <tr>
                                            <td valign="top">
                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td style="width: 220px; padding: 5px 0px 0px 5px; border-right: solid 1px #D8D8D8;"
                                                        ...
                                                        <td valign="top" style="width: 170px; padding: 5px 5px 5px 5px; border-right: solid 1px #D8D8D8;">
                                                            <table width="100%" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                        ...
                                                        <td valign="top" style="padding: 5px 5px 0px 5px; border-right: solid 1px #D8D8D8"
                                                            ...
                                                            <table class="formBgStyle" style="width: 90%; text-align: left;" cellpadding="3"
                                                                cellspacing="0">
                                                                <tr>
                                                                    <td width="100px" class="formItemBgStyle" align="right">
                                                                        <asp:Label ID="Label15" runat="server" Text="<%$ Resources:lang,ZiPingZongFen%>"></asp:Label>：
                                                                    </td>
                                                                    ...
                                                                    <td width="100px" align="right" class="formItemBgStyle">
                                                                        <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,LingDaoPingZongFen%>"></asp:Label>：
                                                                    </td>
                                                                    <td class="formItemBgStyle">
                                                                        <b>
                                                                    ...
                                                                    <td width="100px" align="right" class="formItemBgStyle">
                                                                        <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,DiSanFangPingZongFen%>"></asp:Label>：
                                                                    </td>
                                                                    <td class="formItemBgStyle">
                                                                        <b>
                                                                    ...
                                                                    <td align="right" class="formItemBgStyle" width="100px">
                                                                        <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,XiTongZongPingFen%>"></asp:Label>：</td>
                                                                    ...
                                                                    <td width="80px" class="formItemBgStyle" align="right">
                                                                        <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,ZongFen%>"></asp:Label>：
                                                                    </td>
                                                                    <td class="formItemBgStyle">
                                                                        <b>
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popwindow"
                        ...
                        <div class="layui-layer-title" style="background: #e7e7e8;" id="popwindow_title">
                            <asp:Label ID="Label29" runat="server" Text="&lt;div&gt;&lt;img src=ImagesSkin/Update.png border=0 width=30px height=30px alt='BusinessForm' /&gt;&lt;/div&gt;"></asp:Label>
                        </div>
                        <div id="popwindow_content" class="layui-layer-content" style="text-align: left; overflow: auto; padding: 0px 5px 0px 5px;">

                            <table class="formBgStyle" style="width: 800px; text-align: left;" cellpadding="3"
                                cellspacing="0">
                                <tr>
                                    <td align="left" class="formItemBgStyle">
                                        <asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,PingHeYiJian%>"></asp:Label>：
                                        ...
                                        <asp:DataList ID="DataList3" runat="server" CellPadding="0" ForeColor="#333333" Height="16px"
                                            ...
                                            <ItemTemplate>
                                                <table cellpadding="4" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td align="left">
                                                            <asp:Label ID="Label23" runat="server" Text="<%$ Resources:lang,DiSanFangPing%>"></asp:Label>：
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" class="tdLeft" style="color: Blue; font-style: italic;">
                                                            <asp:Label ID="Label24" runat="server" Text="<%$ Resources:lang,PingHeRen%>"></asp:Label>：
                                        ...
                                        <asp:DataList ID="DataList2" runat="server" CellPadding="0" ForeColor="#333333" Height="16px"
                                            ...
                                            <ItemTemplate>
                                                <table cellpadding="4" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td align="left">
                                                            <asp:Label ID="Label25" runat="server" Text="<%$ Resources:lang,LingDaoPing%>"></asp:Label>：
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" class="tdLeft" style="color: Blue; font-style: italic;">
                                                            <asp:Label ID="Label28" runat="server" Text="<%$ Resources:lang,PingHeRen%>"></asp:Label>：<%#DataBinder.Eval(Container.DataItem, "LeaderName")%><br />
                                        ...
                                        <asp:DataList ID="DataList4" runat="server" CellPadding="0" ForeColor="#333333" Height="16px"
                                            ...
                                            <ItemTemplate>
                                                <table cellpadding="4" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td align="left">
                                                            <asp:Label ID="Label26" runat="server" Text="<%$ Resources:lang,ZongPing%>"></asp:Label>：
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" class="tdLeft" style="color: Blue; font-style: italic;">
                                                            <asp:Label ID="Label27" runat="server" Text="<%$ Resources:lang,PingHeRen%>"></asp:Label>：<%#DataBinder.Eval(Container.DataItem, "HRName")%><br />
                                                            <%#DataBinder.Eval(Container.DataItem, "Comment")%></td>
                                                    </tr>
                                                </table>
                                            </ItemTemplate>
