<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTMakeWLMeeting.aspx.cs"
    Inherits="TTMakeWLMeeting" %>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                               <td width="5%" align="center">
                                                                        <strong>
                                                                            <asp:Label ID="Label29" runat="server" Text="<%$ Resources:lang,BianJi %>" /></strong>
                                                                    </td>
                                                                    <td width="5%" align="center">
                                                                        <strong>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="border-right: solid 1px #D8D8D8;">
                                        <table align="center" cellpadding="3" cellspacing="0" style="width: 98%; margin-top: 5px;"
                                            class="formBgStyle">
                                            <tr>
                                                <td align="center" colspan="2" style="font-weight: bold; font-size: 15px; height: 22px; text-align: center; background-color: #f0f0f0"
                                                    class="formItemBgStyle">
                                                    <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,GZLHYWTJDXMHY%>"></asp:Label>
                                                </td>
                                            </tr>
                                            ...
                                            <tr style="color: #000000">
                                                ...
                                                <td align="left" style="height: 13px" class="formItemBgStyle">
                                                    ...
                                                    <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,HuiYiShi%>"></asp:Label>：<asp:TextBox ID="TB_MeetingRoom" runat="server"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" style="height: 21px" class="formItemBgStyle">
                                                    ...
                                                    &nbsp;<asp:HyperLink ID="HL_RelatedDoc" runat="server" Enabled="False" NavigateUrl="~/TTProjectRelatedDoc.aspx"
                                                        Target="_blank">
                                                        <asp:Label ID="Label27" runat="server" Text="<%$ Resources:lang,XiangGuanWenJian%>"></asp:Label>
                                                    </asp:HyperLink>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right" colspan="2" style="height: 21px; text-align: left" class="formItemBgStyle">
                                    ...
                                    <td style="width: 170px; text-align: left; vertical-align: top; border-right: solid 1px #D8D8D8; padding: 5px 5px 0px 5px">
                                        ...
                                        <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" CellPadding="3"
                                            CellSpacing="0" OnItemCommand="DataGrid1_ItemCommand" ShowHeader="false" Width="170px"
                                            GridLines="None">
                                            <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                            <EditItemStyle BackColor="#2461BF" />
                                            <SelectedItemStyle BackColor="#D1DDF1" Font-Bold="True" ForeColor="#333333" />
