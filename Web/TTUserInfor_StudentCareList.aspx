<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTUserInfor_StudentCareList.aspx.cs" Inherits="TTUserInfor_StudentCareList" %>
                            ...
                            <tr>
                                <td valign="top">
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td align="center" style="width: 75%; border-right: solid 1px #D8D8D8; padding: 5px 0px 0px 5px"
                                                valign="top">
                                                <div style="width: 100%;">
                                                            ...
                                                            <td>
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        ...
                                                                        <td width="12%" align="center">
                                                                            <strong>
                                                                                <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,BanJi%>"></asp:Label>
                                                                            </strong>
                                                                        </td>
                                                                        <td width="12%" align="center">
                                                                            <strong>
                                            ...
                                            <td width="25%" align="left">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,DaiMa%>"></asp:Label></td>
                                                        <td>
                                                            <asp:TextBox ID="TB_UserCode" runat="server" Width="80px"></asp:TextBox></td>
                                                        <td>
                                                            <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,XingMing%>"></asp:Label></td>
                                                        <td>
