                                    ...
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td style="border-right: solid 1px #D8D8D8; padding: 5px 5px 5px 5px;" align="left"
                                                ...
                                                <table style="width: 98%;" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                    <tr>
                                                        <td style="padding: 5px 0px 0px 5px" class="formItemBgStyleForAlignLeft" valign="top" align="left">
                                        ...
                                        <tr>
                                            <td style="border-right: solid 1px #D8D8D8; padding: 5px 5px 5px 5px;" align="left"
                                                ...
                                                <table style="width: 98%;" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                    <tr>
                                                        <td colspan="2" style="padding: 5px 0px 0px 5px" class="formItemBgStyleForAlignLeft" valign="top" align="left">
                                                    ...
                                                    <tr>
                                                        <td style="text-align: left; height: 25px;" class="formItemBgStyleForAlignLeft">
                                                    ...
                                                    <tr>
                                                        <td class="formItemBgStyleForAlignLeft" style="height: 25px;">
                                                            <asp:Label ID="Label43" runat="server" Text="<%$ Resources:lang,ZZSJKZDYHYYDSJBIFSHBBSJ%>"></asp:Label>
                                                        </td>
                                                        <td class="formItemBgStyleForAlignLeft" style="width: 60%; height: 25px;">&nbsp;</td>
                                                    </tr>
                                                </table>
                                                <br />
                                            </td>
                                        ...
                                        <tr>
                                            <td style="border-right: solid 1px #D8D8D8; padding: 5px 5px 5px 5px;" align="left"
                                                ...
                                                <table style="width: 98%;" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                    ...
                                                    <tr>
                                                        <td class="formItemBgStyleForAlignLeft" style="height: 25px; color: red;">
                                                            <asp:Label ID="Label22" runat="server" Text="<%$ Resources:lang,RGYZYGAZLXMLWJQXBXMLCOPY%>"></asp:Label>
                                                        </td>
                                                        <td class="formItemBgStyleForAlignLeft" style="width: 60%; height: 25px;">
                                        ...
                                        <tr style="display:none;">
                                            <td style="border-right: solid 1px #D8D8D8; padding: 5px 5px 5px 5px;" align="left"
                                                ...
                                                <table style="width: 98%;" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                    <tr>
                                                        <td colspan="4" style="padding: 5px 0px 0px 5px" class="formItemBgStyleForAlignLeft" valign="top" align="left">
