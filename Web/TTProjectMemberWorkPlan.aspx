<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTProjectMemberWorkPlan.aspx.cs" Inherits="TTProjectMemberWorkPlan" %>
                                ...
                                <td height="31" class="page_topbj">
                                    <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td align="center" width="100px" style="padding-top: 5px;">
                                                <asp:HyperLink ID="HL_PlanAnlyse" NavigateUrl="~/TTUserPlanAnalyseReport.aspx" runat="server" Target="_blank">
                                                    <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,JiHuaFenXi%>"></asp:Label></asp:HyperLink>
                                            </td>
                                            <td align="right" width="100px" style="padding-top: 5px;">
                                                <asp:HyperLink ID="HL_LogAnlyse" NavigateUrl="~/TTUserPlanLogAnalyseReport.aspx" runat="server" Target="_blank">
                                                    <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,RiZhiFenXi%>"></asp:Label></asp:HyperLink>
                                            </td>
                                            <td>&nbsp;</td>
                                        </tr>
                                    </table>
                                                                            ...
                                                                            <tr>
                                                                                <td align="left">
                                                                                    <asp:HyperLink ID="HL_RelatedDoc" runat="server" Enabled="False" NavigateUrl="~/TTPlanRelatedDoc.aspx"
                                                                                        Target="_blank">--&gt;<asp:Label ID="Label15" runat="server" Text="<%$ Resources:lang,XiangGuanWenDang%>"></asp:Label></asp:HyperLink>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                                                    ...
                                                                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <td width="60%" align="center">
                                                                                                                                <strong>
                                                                                                                                    <asp:Label ID="Label34" runat="server" Text="<%$ Resources:lang,ShenHeYiJian%>"></asp:Label></strong>
                                                                                                                            </td>
                                                                                                                            <td width="10%" align="center">
                                                                                                                                <strong>
                                                                                                                                    <asp:Label ID="Label35" runat="server" Text="<%$ Resources:lang,FenShu%>"></asp:Label></strong>
                                                                                                                            </td>
