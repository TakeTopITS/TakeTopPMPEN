                                                ...
                                                <td class="formItemBgStyle">
                                                    <div id="divAll" style="height: 100%;">
                                                        ...
                                                        <div style="position: absolute;left: 4px; top: 100px;">
                                                            <table class="formBgStyle">
                                                                <tr>
                                                                    <td rowspan="3" style="width: 70px;" class="formItemBgStyle">
                                                                            ...
                                                                            <tr>
                                                                                <td class="formItemBgStyle">
                                                                                    <table class="formBgStyle" style="width: 70px;">
                                                                                        <tr>
                                                                                            <td style="height: 60px; width: 70px;" class="formItemBgStyle">&nbsp;</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td style="height: 60px; width: 70px;" class="formItemBgStyle">
