        ...
        if (Page.IsPostBack != true)
        {
            ...
            try
            {
                if (strSystemType.IndexOf("UNIX") < 0)
                {
                    ...
                    LB_LicenseNumber.Text = "授权类型：" + strLicenseType + "，版本：" + strVerType + "，站点名：" + strSiteName + "，授权用户数：WEB:" + intWEBLicenseNumber.ToString() + ", APP: " + intAPPLicenseNumber.ToString() + "，有效期至：" + strDeadline + "，禁用模块：" + strForbitModule;   //ChineseWord
                ...
                if (strRegisterCode1 == strRegisterCode2)
                {
                    ...
                    if (lst.Count > 0)
                    {
                        ...
                        try
                        {
                            ...
                            LB_LicenseNumber.Text = "授权类型：" + strLicenseType + "，版本：" + strVerType + "，站点名：" + strSiteName + "，用户数 WEB:" + intWEBLicenseNumber.ToString() + ", APP: " + intAPPLicenseNumber.ToString() + "，有效期至：" + strDeadline + "，禁用模块：" + strForbitModule;   //ChineseWord
                    ...
                    else
                    {
                        ...
                        try
                        {
                            ...
                            LB_LicenseNumber.Text = "授权类型：" + strLicenseType + "，版本：" + strVerType + "，站点名：" + strSiteName + "，用户数 WEB:" + intWEBLicenseNumber.ToString() + ", APP: " + intAPPLicenseNumber.ToString() + "，有效期至：" + strDeadline;   //ChineseWord
                            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "alert('" + LanguageHandle.GetWord("ZZZCCG").ToString().Trim() + "')", true);
                        }
                        catch
                        {
