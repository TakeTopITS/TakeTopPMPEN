<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTAssetCheckInReport.aspx.cs" Inherits="TTAssetCheckInReport" %>
                        ...
                        <table style="width: 980px;">
                            ...
                            <tr>
                                <td style="text-align: right;" width="10%">
                                    <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,CaiGouKaiShiShiJian%>"></asp:Label>：
                                </td>
                                <td width="30%">
                                ...
                                <td style="text-align: right;" width="15%">
                                    <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,CaiGouJieShuShiJian%>"></asp:Label>：
                                </td>
                                <td width="20%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="TB_Position" runat="server" Width="160px"></asp:TextBox>
                                ...
                                <td style="text-align: right;">
                                    <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,RuKuDanHao%>"></asp:Label>：
                                </td>
                                <td>
                        ...
                        <table style="width: 98%;">
                            <tr>
                                <td style="width: 100%; height: 80px; font-size: xx-large; text-align: center;">
                                    <br />
                                    <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ZiChanRuKuBaoBiao%>"></asp:Label>
                                    <br />
                                </td>
                            </tr>
                             <tr>
                                ...
                                <td style="width: 100%;">
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td width="5%" align="center">
                                                            <strong>
                                                                <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,RuKuDan%>"></asp:Label></strong>
                                                        </td>
                                                        <td width="5%" align="center">
                                                            <strong>
                                                        ...
                                                        <td width="6%" align="center">
                                                            <strong>
                                                                <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,DanJia%>"></asp:Label></strong>
                                                        </td>
                                                        <td width="6%" align="center">
                                                            <strong>
                                                        ...
                                                        <td width="8%" align="center">
                                                            <strong>
                                                                <asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,ChangJia%>"></asp:Label></strong>
                                                        </td>
                                                        <td width="8%" align="center">
                                                            <strong>
                                                                <asp:Label ID="Label22" runat="server" Text="<%$ Resources:lang,YongHu%>"></asp:Label></strong>
                                                        </td>
                                                        <td width="8%" align="center">
                                                            <strong>
                                                                <asp:Label ID="Label23" runat="server" Text="<%$ Resources:lang,DiZhi%>"></asp:Label></strong>
                                                        </td>
                                    ...
                                    <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundColumn DataField="AssetCode" HeaderText="Number">
                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="Center" Width="5%" />
                                            </asp:BoundColumn>
                            ...
                            <tr>
                                <td style="width: 1200px; text-align: center;">
                                    <asp:Label ID="Label25" runat="server" Text="<%$ Resources:lang,Di%>"></asp:Label>：<asp:Label ID="LB_PageIndex" runat="server"></asp:Label>
                                    ...
                                    &nbsp;<asp:Label ID="Label27" runat="server" Text="<%$ Resources:lang,Ye%>"></asp:Label>
                                </td>
                            </tr>
                        </table>
                        <!--endprint1-->
