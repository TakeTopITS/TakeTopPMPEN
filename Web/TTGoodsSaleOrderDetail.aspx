                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="100%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="formItemBgStyleForAlignLeft" style="width: 106px;">
                                                            <asp:DropDownList ID="DL_SOStatus" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DL_SOStatus_SelectedIndexChanged">
                                                                ...
                                                                <asp:ListItem Value="Selling" Text="<%$ Resources:lang,XiaoShouZhong%>" />
                                        ...
                                        <tr>
                                            <td class="formItemBgStyleForAlignLeft" style="width: 100%; padding: 5px 5px 5px 5px;">
                                                                ...
                                                                <caption>
                                                                    ...
                                                                    <tr>
                                                                        <td class="formItemBgStyleForAlignLeft">
                                                                            ...
                                                                            ： </td>
                                                                        <td class="formItemBgStyleForAlignLeft" colspan="5" style="height: 15px; text-align: left;">
