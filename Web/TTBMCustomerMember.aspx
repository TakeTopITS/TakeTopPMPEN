<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTBMCustomerMember.aspx.cs" Inherits="TTBMCustomerMember" %>
                                                            ...
                                                            <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    ...
                                                                    <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                                        <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,ChengBaoShangZhangHaoGuanLi%>"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                            ...
                                            <td>
                                                <table cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center;width:170px;" valign="top">
                                                        ...
                                                        <td align="left" style="width: 48%">
                                                            <table class="formBgStyle" style="width: 98%; text-align: left;" cellpadding="3"
                                                                ...
                                                                <tr>
                                                                    <td class="formItemBgStyle">
                                                                        <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,ZhiCheng%>"></asp:Label>：
                                                                    </td>
                                                                    <td class="formItemBgStyle">
                                                                        <asp:TextBox ID="TB_JobTitle" runat="server" Width="200px"></asp:TextBox>
                                                                        <asp:DropDownList
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: left;" class="formItemBgStyle">
                                                                        ...
                                                                        <asp:Button ID="BT_TakePhoto" runat="server" CssClass="inpu" Visible="false"
                                                                ...
                                                                <tr>
                                                                    <td style="height: 28px;" class="formItemBgStyle">
                                                                ...
                                                                <tr>
                                                                    <td class="formItemBgStyle">E_Mail：
                                                                    </td>
                                                                    <td class="formItemBgStyle">
                                                                ...
                                                                <tr>
                                                                    <td class="formItemBgStyle">
                                                                        <asp:Label ID="Label15" runat="server" Text="<%$ Resources:lang,YongGongLeiXing%>"></asp:Label>：</td>
                                                                    <td style="text-align: left" class="formItemBgStyle">
                                                                ...
                                                                <tr>
                                                                    <td style="height: 12px; " class="formItemBgStyle">
                                                                ...
                                                                <tr>
                                                                    <td class="formItemBgStyle" style="height: 12px; ">
                                                                ...
                                                                <%-- <tr>
                                                                <td class="formItemBgStyle">
                                                                    <asp:Label ID="Label23" runat="server" Text="<%$ Resources:lang,ZhaoPianShangChuan%>"></asp:Label>：
                                                                </td>
                                                        ...
                                                        <td>
                                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" background="ImagesSkin/main_n_bj.jpg">
                                                                <tr>
                                                                    <td align="left" class="formItemBgStyle">
                                                                        <asp:Label ID="Label24" runat="server" Text="<%$ Resources:lang,QiYeXinXi%>"></asp:Label>：<asp:TextBox ID="txt_SupplierInfo" runat="server" Width="80px"></asp:TextBox>
                                                                        &nbsp;
                                                                    <asp:Label ID="LB_Sql" runat="server" Visible="False"></asp:Label>
                                                                    </td>
                                                                    <td align="left" class="formItemBgStyle" rowspan="2" style="vertical-align: middle; text-align: center">
                                                                        <asp:Button ID="BT_Query" runat="server" CssClass="inpu" Text="<%$ Resources:lang,ChaXun%>" OnClick="BT_Query_Click" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="left" class="formItemBgStyle">
                                                                        <asp:Label ID="Label25" runat="server" Text="<%$ Resources:lang,ShenPiRiQi%>"></asp:Label>：<asp:TextBox ID="TextBox2" runat="server" ReadOnly="false" Width="80px"></asp:TextBox>
                                                                        <cc1:CalendarExtender ID="CalendarExtender4" runat="server" Format="yyyy-MM-dd" TargetControlID="TextBox2">
                                                                        </cc1:CalendarExtender>
                                                                        <asp:Label ID="Label32" runat="server" Text="<%$ Resources:lang,Zhi%>"></asp:Label><asp:TextBox ID="TextBox3" runat="server" ReadOnly="false" Width="80px"></asp:TextBox>
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td width="25%" align="left">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label26" runat="server" Text="<%$ Resources:lang,QiYeHuoGeRenBianMa%>"></asp:Label></strong>
                                                                                </td>
                                                                                <td width="25%" align="left">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label27" runat="server" Text="<%$ Resources:lang,QiYeMingCheng%>"></asp:Label></strong>
                                                                                </td>
                                                                                <td width="10%" align="left">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label28" runat="server" Text="<%$ Resources:lang,KaiTong%>"></asp:Label></strong>
                                                                                </td>
                                                                                <td width="10%" align="left">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label29" runat="server" Text="<%$ Resources:lang,JiHuo%>"></asp:Label></strong>
                                                                                </td>
                                                                                <td width="15%" align="left">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label30" runat="server" Text="<%$ Resources:lang,PingJiaDengJi%>"></asp:Label></strong>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                            ...
                                                            <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" OnItemCommand="DataGrid1_ItemCommand"
                                                                ...
                                                                <Columns>
                                                                    <asp:BoundColumn DataField="LinkPerID" HeaderText="联系人编号" Visible="false">
                                                                        <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="1%" />
                                                                    </asp:BoundColumn>
                                                                    <asp:TemplateColumn HeaderText="企业或个人编码">
                                                                        <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="25%" />
                                                                        <ItemTemplate>
                                                                            <asp:Button ID="BT_SupplierID" runat="server" CssClass="inpu" Style="text-align: center; width: 110px" Text='<%# DataBinder.Eval(Container.DataItem,"LinkCode") %>' />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateColumn>
                                                                    ...
                                                                    <asp:TemplateColumn HeaderText="开通">
                                                                        <ItemTemplate>
                                                                            <%# GetProjectMember(Eval("LinkCode").ToString().Trim()) %>
                                                                        </ItemTemplate>
                                                                        <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="10%" />
                                                                    </asp:TemplateColumn>
                                                                    <asp:TemplateColumn HeaderText="Active">
                                                                        <ItemTemplate>
                                                                            <%# GetSystemActionUser(Eval("LinkCode").ToString().Trim()) %>
                                                                        </ItemTemplate>
                                                                        <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="10%" />
                                                                    </asp:TemplateColumn>
                                                                    <asp:BoundColumn DataField="EvalueDegree" HeaderText="评价等级">
