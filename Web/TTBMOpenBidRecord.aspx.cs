...
public partial class TTBMOpenBidRecord : System.Web.UI.Page
{
   ...
   //         "Datediff(day,BidEndDate,'" + DateTime.Now.ToString() + "')<=0 Order By ID Desc";
    ...
    protected void BT_Add_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "alert('"+LanguageHandle.GetWord("ZZJGZBJHYKBJC")+"')", true);
            DL_BidPlanID.Focus();
            return;
        }
    ...
    protected void BT_Delete_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "alert('"+LanguageHandle.GetWord("ZZJGKBJLYBDYSCSB")+"')", true);
            return;
        }
