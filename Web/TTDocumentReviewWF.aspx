<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTDocumentReviewWF.aspx.cs"
    Inherits="TTDocumentReviewWF" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label28" runat="server" Text="<%$ Resources:lang,WenJianPingShen%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                    ...
                                    <table style="width: 100%;" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td style="width: 82%; text-align: left;">
                                                ...
                                                <asp:Label ID="LB_UserCode" runat="server" Visible="False"></asp:Label><span style="font-size: 11pt">
                                            ...
                                            <td valign="top" align="left">
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td width="5%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,ShanChu%>"></asp:Label></strong>
                                                                    </td>
                                                                    <td width="10%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,PingShen%>"></asp:Label></strong>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                ...
                                                <asp:DataGrid runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:ButtonColumn ButtonType="LinkButton" CommandName="Delete" Text="&lt;div&gt;&lt;img src=ImagesSkin/icon_del.gif border=0 alt='Deleted' /&gt;&lt;/div&gt;">
                                                        ...
                                                        <table class="FullBorderTable" style="width: 98%">
                                                            ...
                                                            <tr>
                                                                <td style="width: 100%; height: 13px; text-align: left;">
                                                                    <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,LeiXing%>"></asp:Label>：<asp:DropDownList ID="DL_DocType" runat="server" DataTextField="Type" DataValueField="ID"
                                                                        Width="100px" CssClass="DDList">
                                                                    </asp:DropDownList>
                                                                    <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,QuanXian%>"></asp:Label>：<asp:DropDownList ID="DL_Visible" runat="server"  DataTextField="HomeName"
                                                            ...
                                                            <tr>
                                                                <td style="width: 100%; text-align: left">
                                                                    ...
                                                                    <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,TongZhiJueSeZuChengYuan%>"></asp:Label><asp:TextBox ID="TB_Message" runat="server" Width="224px"></asp:TextBox>
                                                        ...
                                                        <table style="width: 98%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                            ...
                                                            <tr style="font-size: 10pt">
                                                                <td style="text-align: left; width: 100%;" class="formItemBgStyleForAlignLeft">
                                                                    <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,MingCheng%>"></asp:Label>：<asp:TextBox ID="TB_WLName" runat="server" Width="250px"></asp:TextBox>
                                                                    ...
                                                                    <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,GongZuoLiuMuBan%>"></asp:Label>：<asp:DropDownList ID="DL_TemName" runat="server" DataTextField="TemName"
                                                                        DataValueField="TemName" Width="120px">
                                                                    </asp:DropDownList>
