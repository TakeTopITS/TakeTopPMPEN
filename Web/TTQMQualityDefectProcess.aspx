<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTQMQualityDefectProcess.aspx.cs" Inherits="TTQMQualityDefectProcess" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ZhiLiangQueXianChuLi%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                            ...
                            <tr>
                                <td align="left" style="padding-top: 5px;">
                                    ...
                                    <table cellpadding="2" cellspacing="0" class="formBgStyle" width="75%">
                                        <tr>
                                               <td align="left">
                                                <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,ChuLiXinXi%>"></asp:Label>：<asp:TextBox ID="TextBox1" runat="server" Width="120px"></asp:TextBox>
                                            
                                           
                                                <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,TongZhiXinXi%>"></asp:Label>：<asp:TextBox ID="TextBox2" runat="server" Width="120px"></asp:TextBox>
                                         
                                                <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,ChuangJianRiQi%>"></asp:Label>：<asp:TextBox ID="TextBox3" runat="server" Width="90px" ReadOnly="false"></asp:TextBox>
                                                <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="yyyy-MM-dd" TargetControlID="TextBox3">
                                                </cc1:CalendarExtender>
                                                <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,Zhi%>"></asp:Label><asp:TextBox ID="TextBox4" runat="server" Width="90px" ReadOnly="false"></asp:TextBox>
                                            ...
                                            <td align="left" class="formItemBgStyle">
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td width="20%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,ZhiLiangQueXianTongZhiDan%>"></asp:Label></strong>
                                                                    </td>
                                                                    <td width="10%" align="left">
                                                                        <strong>
                                                                    ...
                                                                    <td width="45%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label15" runat="server" Text="<%$ Resources:lang,ChuLiFangAn%>"></asp:Label></strong>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                ...
                                                <asp:DataGrid ID="DataGrid2" runat="server" AutoGenerateColumns="False" Height="1px"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundColumn DataField="QualityDefectNoticeName" HeaderText="质量缺陷通知单">
                                                        ...
                                                        <asp:BoundColumn DataField="DealRemark" HeaderText="处理方案">
                            ...
                            <table cellpadding="2" cellspacing="0" class="formBgStyle" width="900px">
                                ...
                                <tr>
                                    <td align="right" style="width: 150px" class="formItemBgStyle">
                                        ...
                                        <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,ZhiLiangQueXianTongZhiDan%>"></asp:Label>：
                                    </td>
                                ...
                                <tr style="color: #000000">
                                    <td align="right" class="auto-style2">
                                        <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,ChuangJianRen%>"></asp:Label>：</td>
                                ...
                                <tr style="color: #000000;">
                                    <td align="right" class="auto-style2">
                                        <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,ChuLiFangAn%>"></asp:Label>：</td>
