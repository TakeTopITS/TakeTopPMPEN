                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ChaKanSuoYouQueXian%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                                                                                ...
                                                                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                                                                    <tr>
                                                                                                        <td style="text-align: center; height: 30px;">
                                                                                                            <asp:Button ID="BT_AllDefect" runat="server" CssClass="inpuLong" OnClick="BT_AllDefect_Click"
                                                                                                                Text="<%$ Resources:lang,ChaXunSuoYouQueXian%>" />
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td style="text-align: center; height: 1px;" valign="top">
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                            <tr>
                                                                                                                                <td width="5%" align="left">
                                                                                                                                    <strong>
                                                                                                                                        <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,QueXianZhuangTai%>"></asp:Label></strong>
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                        </table>
                                                                                                                    </td>
                                                                                                            ...
                                                                                                            <asp:DataGrid ID="DataGrid2" runat="server" AutoGenerateColumns="False" OnItemCommand="DataGrid2_ItemCommand"
                                                                                                                ...
                                                                                                                <Columns>
                                                                                                                    <asp:TemplateColumn HeaderText="缺陷状态：">
                                                                                                                        <ItemTemplate>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td align="left">&nbsp;<asp:Label ID="LB_OperatorCode" runat="server"
                                                                                            ...
                                                                                            <td valign="top">
                                                                                                            ...
                                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td width="35%" align="left">
                                                                                                                        <strong>
                                                                                                                            <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,QueXianMingCheng%>"></asp:Label></strong>
                                                                                                                    </td>
                                                                                                ...
                                                                                                <asp:DataGrid ID="DataGrid3" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                                                                    ...
                                                                                                    <Columns>
                                                                                                        ...
                                                                                                        <asp:BoundColumn DataField="DefectFinishedDate" DataFormatString="{0:yyyy-MM-dd}" HeaderText="要求完成时间">
