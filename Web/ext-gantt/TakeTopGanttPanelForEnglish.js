...
Ext.define("MyApp.DemoGanttPanel", {
    ...
    onUndo: function () {
        ...
        if (this.undoStack.length > 0) {
            ...
            Ext.Msg.alert('Prompt', 'No operations to undo！');
        }
    },
    ...
    onRedo: function () {
        ...
        if (this.redoStack.length > 0) {
            ...
            Ext.Msg.alert('Prompt', 'No operations to redo！');
        }
    },
        ...
        return [
            ...
            //编辑功能
            {
                ...
                items: [
                    ...
                    // 撤销按钮定义
                    {
                        text: 'Undo<div id="divNumber">0</div>', // 使用 HTML
                    ...
                    // 重做按钮定义
                    {
                        text: 'Redo<div id="divRedoNumber">0</div>', // 使用 HTML
