                            ...
                            <asp:DataList ID="DataList20" runat="server" Width="100%" CellPadding="0" CellSpacing="0">
                                <ItemTemplate>
                                    <table class="bian" style="width: 100%; border-collapse: collapse; margin: 0px auto;" cellpadding="4"
                                        ...
                                        <tr>
                                            <td style="text-align: left;">
                                                <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,GongFang%>"></asp:Label>£º
                                                <%#DataBinder.Eval(Container.DataItem, "PartA")%>
                                            </td>

                                            <td style="text-align: left" colspan="2">
                                                <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,QianDingDeDian%>"></asp:Label>£º
                                        ...
                                        <tr>
                                            <td style="text-align: left;">
                                                <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,XuFang%>"></asp:Label>£º
                                                <%#DataBinder.Eval(Container.DataItem, "PartB")%>
                                            </td>

                                            <td style="text-align: left" colspan="2">
                                                <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,QianDingShiJian%>"></asp:Label>£º
