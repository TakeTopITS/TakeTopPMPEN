<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTMakeProjectFromOther.aspx.cs" Inherits="TTMakeProjectFromOther" %>
                ...
                <ContentTemplate>
                                                        ...
                                                        <td width="80%" align="center">
                                                            <table width="750px">
                                                                <tr>
                                                                    ...
                                                                    <td width="20%" align="right">
                                                                        <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,XiangMuJingLi%>"></asp:Label>：</td>
                                                                    <td width="25%" align="left">
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td colspan="2" width="10%" align="center">
                                                                        <strong>
                                                                            <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,Budget%>" />
                                                                        </strong>
                                                                    </td>
                                                                    <td width="5%" align="center">
                                                                        <strong></strong>
                    ...
                    <asp:Panel ID="Panel1" runat="server" CssClass="modalPopup" Style="display: none;">
                        <div class="modalPopup-text" style="width: 420px; height: 400px; overflow: auto;">
                            <table>
                                <tr>
                                    <td colspan="2" style="width: 420px; padding: 5px 5px 5px 5px;" valign="top" align="center">
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popwindow"
                            ...
                            <cc1:TabContainer CssClass="ajax_tab_menu" ID="TabContainer1" Width="100%" runat="server" ActiveTabIndex="0">
                                ...
                                <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="关联信息" TabIndex="2">
                                    ...
                                    <ContentTemplate>
                                            ...
                                            <table style="width: 100%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                <%--<tr>
                                                    <td colspan="8" align="center">
                                                        <asp:Label ID="Label33333" runat="server" Text="<%$ Resources:lang,XiangGuanYeWuDan %>"></asp:Label>
                                                    </td>
                                                </tr>--%>
                                                <tr>
                                        ...
                                        <iframe id="IFrame_RelatedInformation" name="IFrame_RelatedInformation" src="TTRelatedDIYBusinessForm.aspx" runat="server" style="width: 100%; height: 400px; overflow: auto;"></iframe>
                                    </ContentTemplate>
                                </cc1:TabPanel>
                            </cc1:TabContainer>
                        </div>
                        ...
                        <div id="popwindow_footer" class="layui-layer-btn" style="border-top: 1px solid #ccc;">
                            <asp:LinkButton ID="LinkButton1" runat="server" class="layui-layer-btn notTab" OnClientClick="window.frames['IFrame_RelatedInformation'].document.getElementById('BT_SaveXMLFile').click()" OnClick="BT_New_Click" Text="<%$ Resources:lang,BaoCun%>"></asp:LinkButton><a class="layui-layer-btn notTab" onclick="return popClose();"><asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,GuanBi%>" /></a>
                        </div>
