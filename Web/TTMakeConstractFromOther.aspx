<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTMakeConstractFromOther.aspx.cs" Inherits="TTMakeConstractFromOther" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function SaveScroll() {
            disPostion = popwindow.scrollTop;
        }
        ...
        function EndRequestHandler(sender, args) {
            popwindow.scrollTop = disPostion;
        }
                ...
                <ContentTemplate>
                            ...
                            <tr>
                                <td>
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td align="left" style="width: 70%; padding: 5px 5px 5px 5px;">
                                                <cc2:TabContainer CssClass="ajax_tab_menu" ID="TabContainer3" runat="server" ActiveTabIndex="0"
                                                    ...
                                                    <cc2:TabPanel ID="TabPanel8" runat="server" HeaderText="在用合同" TabIndex="0">
                                                        ...
                                                        <ContentTemplate>
                                                            ...
                                                            <div id="Div3" style="text-align: left; width: 100%; height: 800px; overflow: auto;">
                                                                            ...
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr>
                                                                                    <td width="5%" align="left">
                                                                                        <strong>
                                                                                            <asp:Label ID="Label187" runat="server" Text="<%$ Resources:lang,BianJi %>" /></strong>
                                                                                    </td>
                                                                                    <td width="5%" align="left">
                                                                                        <strong>
                                                                                            <asp:Label ID="Label188" runat="server" Text="<%$ Resources:lang,ShanChu %>" /></strong>
                                                                                    </td>
                                                                                    ...
                                                                                    <td width="5%" align="left"><strong>
                                                                                        <asp:Label ID="Label107" runat="server" Text=""></asp:Label></strong></td>
                                                                                    <td width="5%" align="left"><strong>
                                                                                    ...
                                                                                    <td width="5%" align="left"><strong>
                                                                                        <asp:Label ID="Label38" runat="server" Text="<%$ Resources:lang,FuZeRen %>"></asp:Label></strong></td>
                                                                                    <td width="7%" align="left"><strong>
                                                                                        <asp:Label ID="Label39" runat="server" Text="<%$ Resources:lang,YiFangDanWei %>"></asp:Label></strong></td>
                                                                                    <td width="5%" align="left"><strong>
                                                                                        <asp:Label ID="Label40" runat="server" Text="<%$ Resources:lang,FuZeRen %>"></asp:Label></strong></td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                                ...
                                                                <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False" ShowHeader="False"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundColumn DataField="ConstractClass" HeaderText="MajorCategory">
                                                                            <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="5%" />
                                                                        </asp:BoundColumn>
                                                                        ...
                                                                        <asp:TemplateColumn>
                                                                            <ItemTemplate>
                                                                                <div onclick="javascript:POBrowser.openWindowModeless('TTOpenWord.aspx?DocURL=<%# ShareClass.URLEncode(Eval("MainContent").ToString()) %>','fullscreen=yes;');">
                                                                        ...
                                                                        <asp:BoundColumn DataField="PartBOperator" HeaderText="ResponsiblePerson">
                                                    ...
                                                    <cc2:TabPanel ID="TabPanel11" runat="server" HeaderText="已删合同" TabIndex="0">
                                                        ...
                                                        <ContentTemplate>
                                                            <br />
                                                            <div id="Div6" style="text-align: left; width: 100%; height: 800px; overflow: auto;">
                                                                        ...
                                                                        <td>
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr>
                                                                                    <td width="5%" align="left">
                                                                                        <strong>
                                                                                            <asp:Label ID="Label190" runat="server" Text="<%$ Resources:lang,BianJi %>" /></strong>
                                                                                    </td>
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popwindow"
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="text-align: left; overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <cc1:TabContainer CssClass="ajax_tab_menu" ID="TabContainer4" Width="100%" runat="server" ActiveTabIndex="0">
                                <cc1:TabPanel ID="TabPanel15" runat="server" HeaderText="基本信息" TabIndex="0">
                                    <HeaderTemplate>
                                        <asp:Label ID="Label184" runat="server" Text="<%$ Resources:lang,JiBenXinXi%>"></asp:Label>
                                    </HeaderTemplate>
                                    <ContentTemplate>
                                        ...
                                        <table width="100%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                            <tr>
                                                ...
                                                <td class="formItemBgStyle" colspan="3">
                                                    ...
                                                    <asp:Label ID="LB_ParentCode" runat="server" Font-Bold="False" Text="" Visible="True"> </asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="formItemBgStyle" style="width: 15%; ">
                                                ...
                                                <td class="formItemBgStyle">
                                                    <asp:TextBox ID="TB_ConstractCode" runat="server" Width="95%"></asp:TextBox>
                                                    <span style="color: #ff0000">*</span> </td>
                                                <td class="formItemBgStyle" style="width: 15%; ">
                                                    <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,HeTongMingCheng%>"></asp:Label>
                                                    ： </td>
                                                <td class="formItemBgStyle" width="80%">
                                                    <asp:TextBox ID="TB_ConstractName" runat="server" Width="95%"></asp:TextBox>
                                                    <span style="color: #ff0000">*</span> </td>
                                            </tr>
                                            <tr>
                                                <td class="formItemBgStyle" style=" height: 13px;">
                                                ...
                                                <td class="formItemBgStyle">
                                                    ...
                                                    <asp:DropDownList ID="DL_ConstractNotice" runat="server" DataTextField="Name" DataValueField="ID">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="formItemBgStyle">
                                                    <asp:TextBox ID="DLC_SignDate" ReadOnly="false" runat="server"></asp:TextBox>
                                                    <ajaxToolkit:CalendarExtender Format="yyyy-MM-dd" ID="CalendarExtender3" runat="server" TargetControlID="DLC_SignDate">
                                            ...
                                            <tr>
                                                ...
                                                <td class="formItemBgStyle">
                                                    <NickLee:NumberBox ID="NB_Amount" runat="server" Width="150px" MaxAmount="1000000000000" MinAmount="-1000000000000" Precision="3">
                                                                         0.000
                                                    </NickLee:NumberBox>
                                                </td>
                                                <td class="formItemBgStyle" style="width: 15%; ">
                                            ...
                                            <tr>
                                                ...
                                                <td class="formItemBgStyle" style="width: 15%; ">
                                                    <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,JieZhiRiQi%>"></asp:Label>：
                                                </td>
                                                <td class="formItemBgStyle">
                                            ...
                                            <tr>
                                                <td class="formItemBgStyle" style=" height: 13px;">
                                                    <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,ZhuYaoNeiRong%>"></asp:Label>：
                                                </td>
                                                <td colspan="3" class="formItemBgStyle">
                                                    <CKEditor:CKEditorControl ID="TB_MainContent" runat="server" Width="95%" Height="120" Visible="false" />
                                                    <customEditors:Lite runat="server" ID="HT_MainContent" Width="95%" Height="120px" Visible="false" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="formItemBgStyle" style=" height: 13px;">
                                                    <asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,YiChangMiaoShu%>"></asp:Label>：
                                                </td>
                                                <td colspan="3" class="formItemBgStyle">
                                                    <CKEditor:CKEditorControl ID="TB_Exception" runat="server" Width="95%" Height="100" Visible="false" />
                                                    <customEditors:Lite runat="server" ID="HT_Exception" Width="95%" Height="120px" Visible="false" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="formItemBgStyle" style=" height: 13px;">
                                                ...
                                                <td class="formItemBgStyle">
                                                    ...
                                                    <asp:TextBox ID="TB_PartA" runat="server"></asp:TextBox>
                                                </td>
                                                <td class="formItemBgStyle" style="width: 15%; ">
                                                    <asp:Label ID="Label15" runat="server" Text="<%$ Resources:lang,FuZeRen%>"></asp:Label>：
                                                </td>
                                                <td class="formItemBgStyle">
                                                    <asp:TextBox ID="TB_PartAOperator" runat="server"></asp:TextBox>
                                                    <asp:DropDownList ID="DL_CustomerList" runat="server" DataTextField="CustomerName" DataValueField="CustomerCode" AutoPostBack="true" OnSelectedIndexChanged="DL_Customer_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="formItemBgStyle">
                                                    ...
                                                    <asp:TextBox ID="TB_PartB" runat="server"></asp:TextBox>
                                                </td>
                                                <td class="formItemBgStyle" style="width: 15%; ">
                                                    <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,FuZeRen%>"></asp:Label>：
                                                </td>
                                                <td class="formItemBgStyle">
                                                    <asp:TextBox ID="TB_PartBOperator" runat="server"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3" class="formItemBgStyle">
                                                    <asp:DropDownList ID="DL_Status" runat="server">
                                                        ...
                                                        <asp:ListItem Value="Executing" Text="<%$ Resources:lang,ZhiXingZhong%>" />
                                                        <asp:ListItem Value="Completed" Text="<%$ Resources:lang,WanCheng%>" />
                                                        <asp:ListItem Value="Cancel" Text="<%$ Resources:lang,QuXiao%>" />
                                                        <asp:ListItem Value="Deleted" Text="<%$ Resources:lang,ShanChu%>" />
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr style="display: none;">
                                                <td colspan="4">
                                                    <asp:HyperLink ID="HL_RelatedDoc" runat="server" Target="_blank">
                                                        <asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,HeTongWenDang%>"></asp:Label>
                                                    </asp:HyperLink>
                                                    &nbsp;&nbsp;
                                        <asp:HyperLink ID="HL_MakeCollaboration" runat="server" Enabled="false" NavigateUrl="~/TTMakeCollaboration.aspx" Target="_blank" Text="<%$ Resources:lang,hlMakeCollaboration%>"></asp:HyperLink>
                                                    &nbsp;&nbsp;
                                        <asp:HyperLink ID="HL_TransferProject" runat="server" Enabled="false" Target="_blank">---&gt;<asp:Label ID="Label23" runat="server" Text="<%$ Resources:lang,ZhuanChengXiangMu%>"></asp:Label></asp:HyperLink>

                                                    &nbsp&nbsp;<asp:HyperLink ID="HL_ConstractReviewBYWF" runat="server" Target="_blank">--&gt;<asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,HeTongPingShenBiaoDan%>"></asp:Label></asp:HyperLink>
                                                    &nbsp;
                                        <asp:HyperLink ID="HL_ConstractReview" runat="server" Target="_blank">--><asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,HeTongPingShenChangGui%>"></asp:Label></asp:HyperLink>
                                                    &nbsp;
                                        <asp:HyperLink ID="HL_WFTemName" runat="server" Enabled="False" Target="_blank">
                                            <asp:Label ID="Label22" runat="server" Text="<%$ Resources:lang,GuanLianGongZuoLiuMuBan%>"></asp:Label>
                                        </asp:HyperLink>
                                                    ...
                                                    <asp:Label ID="LB_UserCode" runat="server" Text="" Visible="false"></asp:Label>
                                                    <asp:Label ID="LB_UserName" runat="server" Text="" Visible="false"></asp:Label>
                                                    <asp:Label ID="LB_Sql1" runat="server" Text="" Visible="false"></asp:Label>
                                                    <asp:Label ID="LB_Sql15" runat="server" Text="" Visible="false"></asp:Label>
                                                    <asp:Label ID="LB_Sql16" runat="server" Text="" Visible="false"></asp:Label>
                                                    <asp:Label ID="LB_Sql17" runat="server" Text="" Visible="false"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
                                ...
                                <cc1:TabPanel ID="TabPanel16" runat="server" HeaderText="关联信息" TabIndex="1">
                                    <HeaderTemplate>
                                        <asp:Label ID="Label185" runat="server" Text="<%$ Resources:lang,XiangGuanYeWuDan%>"></asp:Label>
                                    </HeaderTemplate>
                                    <ContentTemplate>
                                        ...
                                        <asp:Panel ID="Panel_RelatedBusiness" runat="server" Visible="false">
                                            <table style="width: 100%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                <tr>
                                                    ...
                                                    <td style="width: 20%; " class="formItemBgStyle">
                                                        <asp:Label ID="Label186" runat="server" Text="<%$ Resources:lang,YunXuHouXuXiuGe%>"></asp:Label>： </td>
                                                    <td style="text-align: left;" class="formItemBgStyle">
                        ...
                        <div id="popwindow_footer" class="layui-layer-btn" style="border-top: 1px solid #ccc;">
                            <asp:LinkButton ID="LinkButton1" runat="server" class="layui-layer-btn notTab" OnClientClick="window.frames['IFrame_RelatedInformation'].document.getElementById('BT_SaveXMLFile').click()" OnClick="BT_New_Click" Text="<%$ Resources:lang,BaoCun%>"></asp:LinkButton><a class="layui-layer-btn notTab" onclick="return popClose();"><asp:Label ID="Label189" runat="server" Text="<%$ Resources:lang,GuanBi%>" /></a>
                        </div>
                                ...
                                <tr>
                                    <td align="left">
                                        <cc2:TabContainer CssClass="ajax_tab_menu" ID="TabContainer1" runat="server" ActiveTabIndex="0"
                                                            ...
                                                            <td>
                                                                        ...
                                                                        <td>
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr>
                                                                                    <td width="5%" align="left">
                                                                                        <strong>
                                                                                            <asp:Label ID="Label192" runat="server" Text="<%$ Resources:lang,BianJi %>" /></strong>
                                                                                    </td>
                                                                                    <td width="5%" align="left">
                                                                                        <strong>
                                                                                            <asp:Label ID="Label194" runat="server" Text="<%$ Resources:lang,ShanChu %>" /></strong>
                                                                                    </td>
                                                                ...
                                                                <asp:DataGrid ID="DataGrid2" runat="server" AutoGenerateColumns="False" GridLines="None"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:ButtonColumn CommandName="Delete" Text="&lt;div&gt;&lt;img src=ImagesSkin/Delete.png border=0 alt='Deleted' /&gt;&lt;/div&gt;">
                                                                            <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="5%" />
                                                                        </asp:ButtonColumn>
                                            ...
                                            <cc2:TabPanel ID="TabPanel3" runat="server" HeaderText=" 关联项目" TabIndex="0">
                                                <HeaderTemplate>
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateColumn HeaderText="Permission">
                                                                            ...
                                                                            <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                                                                Font-Underline="False" BorderColor="#394F66" BorderStyle="Solid" BorderWidth="1px" Horizontalalign="left" />
                                                                        </asp:TemplateColumn>
                                                                        <asp:TemplateColumn>
                                                                            <ItemTemplate>
                                            ...
                                            <cc2:TabPanel ID="TabPanel7" runat="server" HeaderText="物料清单">
                                                <HeaderTemplate>
                                                    <asp:Label ID="Label76" runat="server" Text="<%$ Resources:lang,ShangPinQingDan%>"></asp:Label>
                                                </HeaderTemplate>
                                                <ContentTemplate>
                                                    <table align="left" cellpadding="0" cellspacing="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td align="right" style="padding-right: 5px;">
                                                                <asp:Button ID="BT_CreateGoodsList" runat="server" Text="<%$ Resources:lang,New %>" CssClass="inpuYello" OnClick="BT_CreateGoodsList_Click" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <table background="ImagesSkin/main_n_bj.jpg" border="0" cellpadding="0" cellspacing="0"
                                                                        ...
                                                                        <td>
                                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                <tr>
                                                                                    <td width="5%" align="left">
                                                                                        <strong>
                                                                                            <asp:Label ID="Label195" runat="server" Text="<%$ Resources:lang,BianJi %>" /></strong>
                                                                                    </td>
                                                                                    <td width="5%" align="left">
                                                                                        <strong>
                                                                                    ...
                                                                                    <td align="left" width="5%"><strong>
                                                                                        <asp:Label ID="Label77" runat="server" Text="<%$ Resources:lang,BianHao %>"></asp:Label></strong></td>
                                                                                    <td align="left" width="10%"><strong>
                                                                                        <asp:Label ID="Label78" runat="server" Text="<%$ Resources:lang,DaiMa %>"></asp:Label></strong></td>
                                                                                    <td align="left" width="20%"><strong>
                                                                                        <asp:Label ID="Label79" runat="server" Text="<%$ Resources:lang,MingCheng %>"></asp:Label></strong></td>
                                                                                    <td align="left" width="8%"><strong>
                                                                                        <asp:Label ID="Label80" runat="server" Text="<%$ Resources:lang,ShuLiang %>"></asp:Label></strong></td>
                                                                                    <td align="left" width="8%"><strong>
                                                                                        <asp:Label ID="Label81" runat="server" Text="<%$ Resources:lang,DanWei %>"></asp:Label></strong></td>
                                                                                    <td align="left" width="10%"><strong>
                                                                                        <asp:Label ID="Label82" runat="server" Text="<%$ Resources:lang,DanJia %>"></asp:Label></strong></td>
                                                                                    <td align="left" width="10%"><strong>
                                                                                        <asp:Label ID="Label83" runat="server" Text="<%$ Resources:lang,JinE %>"></asp:Label></strong></td>
                                                                                    <td align="left" width="7%"><strong>
                                                                                        <asp:Label ID="Label84" runat="server" Text="<%$ Resources:lang,ZaiDanLiangXiaoShouDan %>"></asp:Label></strong></td>
                                                                                    <td align="left" width="7%"><strong>
                                                                                        <asp:Label ID="Label85" runat="server" Text="<%$ Resources:lang,ZaiDanLiangCaiGouDan %>"></asp:Label></strong></td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                                        <td align="right" width="6">
                                                                ...
                                                                <asp:DataGrid ID="DataGrid11" runat="server" AutoGenerateColumns="False"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundColumn DataField="SaleOrderNumber" HeaderText="在单量">
                                                                            <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="7%" />
                                                                        </asp:BoundColumn>
                                                    ...
                                                    <table width="100%" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td valign="top" align="left">
                                                                <asp:Label ID="Label115" runat="server" Text="<%$ Resources:lang,GuanLianXiangMu%>"></asp:Label>：<asp:TextBox ID="TB_ProjectID" runat="server" Width="48px"></asp:TextBox><asp:Button ID="BT_AddProjectID" runat="server" Text="Add" CssClass="inpu" Enabled="False"
                                                ...
                                                <ContentTemplate>
                                                    <table width="100%" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                                ...
                                                                <div id="GoodsListDivID" style="width: 100%; height: 300px; overflow: auto;">
                                                                    ...
                                                                    <asp:DataGrid ID="DataGrid6" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="1px" ShowHeader="False" Width="150%" OnItemCommand="DataGrid6_ItemCommand">
                                                                        <Columns>
                                                                            ...
                                                                            <asp:HyperLinkColumn DataNavigateUrlField="SOID" DataNavigateUrlFormatString="TTGoodsSaleOrderView.aspx?SOID={0}" DataTextField="SOName" HeaderText="Name" Target="_blank">
                                                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="25%" />
                                                                            </asp:HyperLinkColumn>
                                                                            <asp:HyperLinkColumn DataNavigateUrlField="SalesCode" DataNavigateUrlFormatString="TTUserInforSimple.aspx?UserCode={0}" DataTextField="SalesName" HeaderText="Salesperson" Target="_blank">
                                                                                <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="10%" />
                                                                            </asp:HyperLinkColumn>
                                                                        </Columns>
                                                                        <EditItemStyle BackColor="#2461BF" />
                                                            ...
                                                            <td valign="top" align="left">
                                                                <asp:Label ID="Label126" runat="server" Text="<%$ Resources:lang,GuanLianDingDan%>"></asp:Label>：<asp:TextBox ID="TB_GoodsSaleOrderID" runat="server" Width="48px"></asp:TextBox><asp:Button ID="BT_AddSaleOrder" runat="server" Text="Add" CssClass="inpu" Enabled="False" OnClick="BT_AddSaleOrder_Click" /><br />
                                                                <table background="ImagesSkin/main_n_bj.jpg" border="0" cellpadding="0" cellspacing="0"
                                                                    width="100%">
                                                                    <tr>
                                                                        <td width="7">
                                                        ...
                                                        <table width="200%" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td style="width: 400px; border-right: solid 1px #D8D8D8; padding: 10px 5px 5px 5px" valign="top" align="left">
                                                                    ...
                                                                    <asp:DataGrid ID="DataGrid7" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="1px" ShowHeader="False" Width="100%" OnItemCommand="DataGrid7_ItemCommand">
                                                                        <Columns>
                                                                            <asp:TemplateColumn HeaderText="单号">
                                                                                <ItemTemplate>
                                                                            ...
                                                                            <asp:HyperLinkColumn DataNavigateUrlField="POID" DataNavigateUrlFormatString="TTGoodsPurchaseOrderView.aspx?POID={0}" DataTextField="GPOName" HeaderText="Name" Target="_blank">
                                                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="25%" />
                                                                            </asp:HyperLinkColumn>
                                                                            <asp:HyperLinkColumn DataNavigateUrlField="PurManCode" DataNavigateUrlFormatString="TTUserInforSimple.aspx?UserCode={0}" DataTextField="PurManName" HeaderText="Salesperson" Target="_blank">
                                                                                <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="10%" />
                                                                            </asp:HyperLinkColumn>
                                                                        </Columns>
                                                                        <EditItemStyle BackColor="#2461BF" />
                                                                ...
                                                                <td valign="top" align="left">
                                                                    <asp:Label ID="Label137" runat="server" Text="<%$ Resources:lang,GuanLianDingDan%>"></asp:Label>：<asp:TextBox ID="TB_GoodsPurchaseOrderID" runat="server" Width="48px"></asp:TextBox><asp:Button ID="BT_AddPurchaseOrder" runat="server" Text="Add" CssClass="inpu" Enabled="False" OnClick="BT_AddPurchaseOrder_Click" /><br />
                                                                    <table background="ImagesSkin/main_n_bj.jpg" border="0" cellpadding="0" cellspacing="0"
                                                                        width="100%">
                                                                        <tr>
                                                                            <td width="7">
                                                ...
                                                <ContentTemplate>
                                                    <table width="100%" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                                ...
                                                                <div id="Div2" style="width: 100%; height: 300px; overflow: auto;">
                                                                    ...
                                                                    <asp:DataGrid ID="DataGrid9" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="1px" ShowHeader="False" Width="150%" OnItemCommand="DataGrid9_ItemCommand">
                                                                        <Columns>
                                                                            ...
                                                                            <asp:HyperLinkColumn DataNavigateUrlField="POID" DataNavigateUrlFormatString="TTAssetPurchaseOrderView.aspx?POID={0}" DataTextField="POName" HeaderText="Name" Target="_blank">
                                                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="25%" />
                                                                            </asp:HyperLinkColumn>
                                                                            <asp:HyperLinkColumn DataNavigateUrlField="PurManCode" DataNavigateUrlFormatString="TTUserInforSimple.aspx?UserCode={0}" DataTextField="PurManName" HeaderText="Salesperson" Target="_blank">
                                                                                <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="10%" />
                                                            ...
                                                            <td valign="top" align="left">
                                                                <asp:Label ID="Label148" runat="server" Text="<%$ Resources:lang,GuanLianDingDan%>"></asp:Label>：<asp:TextBox ID="TB_AssetPurchaseOrderID" runat="server" Width="48px"></asp:TextBox><asp:Button ID="BT_AddAssetPurchaseOrder" runat="server" Text="Add" CssClass="inpu" Enabled="False" OnClick="BT_AddAssetPurchaseOrder_Click" /><br />
                                                                <div id="Div2" style="width: 100%; height: 300px; overflow: auto;">
                                                                    <table background="ImagesSkin/main_n_bj.jpg" border="0" cellpadding="0" cellspacing="0"
                                                                        width="200%">
                                                                        <tr>
                                                                    ...
                                                                    <asp:DataGrid ID="DataGrid10" runat="server" AutoGenerateColumns="False"
                                                                        CellPadding="4" ForeColor="#333333" GridLines="None" Height="1px"
                                                                        ShowHeader="False"
                                                                        Width="200%" OnItemCommand="DataGrid10_ItemCommand">
                                                                        <Columns>
                                                                            <asp:BoundColumn DataField="POID" HeaderText="Number">
                                                                                <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="10%" />
                                                                            </asp:BoundColumn>
                                                    ...
                                                    <div id="Div2" style="width: 100%; height: 300px; overflow: auto;">
                                                        <table width="200%" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                ...
                                                                <td valign="top" align="left">
                                                                    <asp:Label ID="Label162" runat="server" Text="<%$ Resources:lang,GuanLianHeTong%>"></asp:Label>：<asp:TextBox ID="TB_RelatedConstractCode" runat="server" Width="48px"></asp:TextBox><asp:Button ID="BT_AddRelatedConstractCode" runat="server" Text="Add" CssClass="inpu" Enabled="False" OnClick="BT_AddRelatedConstractCode_Click" /><br />
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popGoodsListWindow"
                        ...
                        <div class="layui-layer-title" style="background: #e7e7e8;" id="popwindow_title2223">
                            <asp:Label ID="Label182" runat="server" Text="&lt;div&gt;&lt;img src=ImagesSkin/Update.png border=0 width=30px height=30px alt='BusinessForm' /&gt;&lt;/div&gt;"></asp:Label>
                        </div>
                                ...
                                <tr>
                                    <td width="60%">
                                        <table align="left" cellpadding="3" cellspacing="0" class="formBgStyle" width="100%">
                                            <tr>
                                                <td class="formItemBgStyle" style="width: 15%; ">
                                                    <asp:Label ID="Label89" runat="server" Text="<%$ Resources:lang,LeiXing %>"></asp:Label>： </td>
                                            ...
                                            <tr>
                                                <td class="formItemBgStyle" style="width: 15%; ">
                                                    <asp:Label ID="Label87" runat="server" Text="<%$ Resources:lang,DaiMa %>"></asp:Label>： </td>
                                                <td class="formItemBgStyle" style="text-align: left;">
                                                    <asp:TextBox ID="TB_GoodsCode" runat="server" Height="20px" Width="95%"></asp:TextBox></td>
                                                <td class="formItemBgStyle" style="">
                                                    <asp:Label ID="Label88" runat="server" Text="<%$ Resources:lang,MingCheng %>"></asp:Label>： </td>
                                            ...
                                            <tr>
                                                <td class="formItemBgStyle" style="">
                                                    <asp:Label ID="Label90" runat="server" Text="<%$ Resources:lang,XingHao %>"></asp:Label>：</td>
                                            ...
                                            <tr>
                                                <td class="formItemBgStyle" style="">
                                                    <asp:Label ID="Label91" runat="server" Text="<%$ Resources:lang,GuiGe %>"></asp:Label>： </td>
                                                <td style="text-align: left;" colspan="5" class="formItemBgStyle">
                                                    <asp:TextBox ID="TB_Spec" runat="server" Height="40px" TextMode="MultiLine" Width="60%"></asp:TextBox><asp:Button ID="BT_FindGoods" runat="server" CssClass="inpu" OnClick="BT_FindGoods_Click" Text="<%$ Resources:lang,ChaXun %>" /><asp:Button ID="BT_Clear" runat="server" CssClass="inpu" Text="<%$ Resources:lang,QingKong %>" OnClick="BT_Clear_Click" /></td>
                                            </tr>
                                            <tr>
                                                <td class="formItemBgStyle" style="">
                                                    <asp:Label ID="Label86" runat="server" Text="<%$ Resources:lang,PinPai %>"></asp:Label>： </td>
                                                <td style="text-align: left;" colspan="5" class="formItemBgStyle">
                                                    <asp:TextBox ID="TB_Brand" runat="server" Width="60%"></asp:TextBox><asp:Button ID="Button1" runat="server" CssClass="inpu" OnClick="BT_FindGoods_Click" Text="<%$ Resources:lang,ChaXun %>" /><asp:Button ID="Button2" runat="server" CssClass="inpu" Text="<%$ Resources:lang,QingKong %>" OnClick="BT_Clear_Click" /></td>
                                            </tr>
                                            <tr>
                                                <td class="formItemBgStyle" style="">
                                                    <asp:Label ID="Label92" runat="server" Text="<%$ Resources:lang,ShuLiang %>"></asp:Label>： </td>
                                                <td class="formItemBgStyle" style="text-align: left">
                                                ...
                                                <td class="formItemBgStyle" style="">
                                                    <asp:Label ID="Label93" runat="server" Text="<%$ Resources:lang,DanJia %>"></asp:Label>： </td>
                                                <td class="formItemBgStyle" style="text-align: left">
                                                ...
                                                <td class="formItemBgStyle" style="">
                                                    <asp:Label ID="Label94" runat="server" Text="<%$ Resources:lang,DanWei %>"></asp:Label>： </td>
                                                <td class="formItemBgStyle" style="text-align: left">
                                            ...
                                            <tr>
                                                <td class="formItemBgStyle" style="">
                                                    <asp:Label ID="Label95" runat="server" Text="<%$ Resources:lang,ChengDanShiJian %>"></asp:Label>： </td>
                                                <td class="formItemBgStyle" style="text-align: left">
                                                    <asp:TextBox ID="DLC_SaleTime" runat="server"></asp:TextBox><ajaxToolkit:CalendarExtender Format="yyyy-MM-dd" ID="CalendarExtender5" runat="server" TargetControlID="DLC_SaleTime" Enabled="True"></ajaxToolkit:CalendarExtender>
                                                </td>
                                                <td class="formItemBgStyle" style="">
                                                    <asp:Label ID="Label96" runat="server" Text="<%$ Resources:lang,SongHuoShiJian %>"></asp:Label>：</td>
                                                <td class="formItemBgStyle" style="text-align: left" colspan="2">
                                                    <asp:TextBox ID="DLC_DeleveryTime" runat="server"></asp:TextBox><ajaxToolkit:CalendarExtender Format="yyyy-MM-dd" ID="CalendarExtender6" runat="server" TargetControlID="DLC_DeleveryTime" Enabled="True"></ajaxToolkit:CalendarExtender>
                                                </td>
                                                <td class="formItemBgStyle"></td>
                                            </tr>
                                            <tr>
                                                <td class="formItemBgStyle" style="">
                                                    <asp:Label ID="Label97" runat="server" Text="<%$ Resources:lang,YiXiaoLiangXiaoShouDan %>"></asp:Label>：</td>
                                                <td class="formItemBgStyle" style="text-align: left">
                                                ...
                                                <td colspan="2" class="formItemBgStyle" style="">
                                                    <asp:Label ID="Label98" runat="server" Text="<%$ Resources:lang,ZaiDanLiangCaiGouDan %>"></asp:Label>：</td>
                                                <td class="formItemBgStyle" style="text-align: left">
                                    ...
                                    <td>
                                        <cc2:TabContainer CssClass="ajax_tab_menu" ID="TabContainer2" runat="server" ActiveTabIndex="0"
                                            ...
                                            <cc2:TabPanel ID="TabPanel9" runat="server">
                                                ...
                                                <ContentTemplate>
                                                    <asp:Label ID="Label99" runat="server" Text="<%$ Resources:lang,QingXuanQuYaoCaiGouDeShangPin %>"></asp:Label>：
                                                                    ...
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td width="12%" align="left"><strong>
                                                                                <asp:Label ID="Label100" runat="server" Text="<%$ Resources:lang,DaiMa %>"></asp:Label></strong></td>
                                                                            <td width="12%" align="left"><strong>
                                                                                <asp:Label ID="Label101" runat="server" Text="<%$ Resources:lang,MingCheng %>"></asp:Label></strong></td>
                                                                            <td width="10%" align="left"><strong>
                                                                                <asp:Label ID="Label102" runat="server" Text="<%$ Resources:lang,XingHao %>"></asp:Label></strong></td>
                                                                            <td width="19%" align="left"><strong>
                                                                                <asp:Label ID="Label103" runat="server" Text="<%$ Resources:lang,GuiGe %>"></asp:Label></strong></td>
                                                                            <td width="10%" align="left"><strong>
                                                                                <asp:Label ID="Label104" runat="server" Text="<%$ Resources:lang,PinPai %>"></asp:Label></strong></td>
                                                                            <td align="left"><strong>
                                                                                <asp:Label ID="Label105" runat="server" Text="<%$ Resources:lang,ShuLiang %>"></asp:Label></strong></td>
                                                                            <td align="left"><strong>
                                                                                <asp:Label ID="Label106" runat="server" Text="<%$ Resources:lang,DanJia %>"></asp:Label></strong></td>

                                                                            <td align="left"><strong>
                                                                                <asp:Label ID="Label108" runat="server" Text="<%$ Resources:lang,DiZhi %>"></asp:Label></strong></td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                                <td width="6" align="right">
                                            ...
                                            <cc2:TabPanel ID="TabPanel10" runat="server">
                                                ...
                                                <ContentTemplate>
                                                    <asp:Label ID="Label109" runat="server" Text="<%$ Resources:lang,QingXuanQuShangPin%>"></asp:Label>：
                                                                ...
                                                                <td>
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td width="10%" align="left"><strong>
                                                                                <asp:Label ID="Label112" runat="server" Text="<%$ Resources:lang,LeiXing%>"></asp:Label></strong></td>
                                                                            <td width="35%" align="left"><strong>
                                                                                <asp:Label ID="Label113" runat="server" Text="<%$ Resources:lang,GuiGe%>"></asp:Label></strong></td>
                                                                            <td align="left"><strong>
                                                                                <asp:Label ID="Label114" runat="server" Text="<%$ Resources:lang,DanJia%>"></asp:Label></strong></td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                                <td width="6" align="right">
                        ...
                        <div id="popwindow_footer0001" class="layui-layer-btn" style="border-top: 1px solid #ccc;">
                            <asp:LinkButton ID="LinkButton7" runat="server" class="layui-layer-btn notTab" OnClick="BT_SaveGoods_Click" Text="<%$ Resources:lang,BaoCun%>"></asp:LinkButton><a class="layui-layer-btn notTab" onclick="return popClose();"><asp:Label ID="Label183" runat="server" Text="<%$ Resources:lang,GuanBi%>" /></a>
                        </div>
                        <span class="layui-layer-setwin"><a onclick="return popClose();" class="layui-layer-ico layui-layer-close layui-layer-close1 notTab" href="javascript:;"></a></span>
                    </div>
