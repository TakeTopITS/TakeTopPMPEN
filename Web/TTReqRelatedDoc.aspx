<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTReqRelatedDoc.aspx.cs"
    Inherits="TTReqRelatedDoc" %>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td style="padding-top: 10px; padding-left: 20px;">
                                                                                                            <button id="ctlBtn" class="btn btn-default">
                                                                                                                <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,ShangChuan%>"></asp:Label>
                                                                                                            </button>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </table>
