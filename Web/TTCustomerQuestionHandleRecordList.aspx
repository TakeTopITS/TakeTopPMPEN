                                    ...
                                    <tr>
                                        <td style="text-align: Left;">
                                            ...
                                            <table border="0" cellpadding="5" cellspacing="0" width="100%">
                                                <tr>
                                                    <td align="right" class="tdTopLine">
                                                ...
                                                <td align="left">
                                                    <cc2:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" CssClass="ajax_tab_menu" Width="100%">
                                                        <cc2:TabPanel ID="TabPanel1" runat="server" HeaderText="协作日志" TabIndex="0">
                                                            ...
                                                            <ContentTemplate>
                                                                <asp:DataList ID="DataList3" runat="server" CellPadding="0" ForeColor="#333333" Height="1px" HorizontalAlign="left" Width="98%">
                                                        ...
                                                        <cc2:TabPanel ID="TabPanel2" runat="server" HeaderText="相关文件" TabIndex="1">
                                                            ...
                                                            <HeaderTemplate>
                                                                <asp:Label ID="Label36" runat="server" Text="<%$ Resources:lang,XiangGuanWenJian%>"></asp:Label>
                                                            </HeaderTemplate>
                                                            <ContentTemplate>
