                    ...
                    <div class="layui-layer layui-layer-iframe" id="popwindow" name="fixedDiv"
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="overflow: auto; text-align: left;">
                            <table width="100%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                ...
                                <tr>
                                    <td class="formItemBgStyleForAlignLeft">
                                        <asp:DropDownList ID="DL_CustomerQuestionType" runat="server" CssClass="DDList" DataTextField="Type" DataValueField="Type" Width="99%">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="formItemBgStyleForAlignLeft">
                                        <asp:DropDownList ID="DL_IsImportant" runat="server" Width="99%">
                                ...
                                <tr>
                                    <td class="formItemBgStyleForAlignLeft">
                                        <CKEditor:CKEditorControl ID="TB_Question" runat="server" Width="90%" Height="120px" Visible="False" /><CKEditor:CKEditorControl runat="server" ID="HT_Question" Width="99%" Height="120px" Visible="False" />
                                ...
                                <tr>
                                    <td class="formItemBgStyleForAlignLeft">
                                        <asp:TextBox ID="TB_Company" runat="server" Width="60%"></asp:TextBox><span class="auto-style1">*</span>
                                ...
                                <tr>
                                    <td class="formItemBgStyleForAlignLeft" width="25%">
                                        <asp:DropDownList ID="DL_Stage" runat="server" CssClass="DDList" AutoPostBack="true" DataTextField="Stage" DataValueField="Stage" OnSelectedIndexChanged="DL_Stage_SelectedIndexChanged" Width="99%">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
