<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTProjectReqDetail.aspx.cs"
    Inherits="TTProjectReqDetail" %>
            ...
            <ContentTemplate>
                                                        ...
                                                        <table width="100%">
                                                            <tr>
                                                                ...
                                                                <td align="left">
                                                                    ...
                                                                    &nbsp;&nbsp;
                                                                        <asp:HyperLink ID="HL_ReqToTask" runat="server" Target="_blank">
                                                                            ---><asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,ZhuanChengRenWu%>"></asp:Label>
                                                                        </asp:HyperLink>

                                                                    &nbsp;<asp:HyperLink ID="HL_ReqReview" runat="server" Target="_blank" Visible="false">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="formItemBgStyleForAlignLeft">
                                                                                           ...
                                                                                           <asp:Button ID="BT_Finish" runat="server" CssClass="inpu" OnClick="BT_Finish_Click"
                                                                                            ...
                                                                                            <asp:Button runat="server" Text="<%$ Resources:lang,ZhuanChengXiangMu %>" CssClass="inpu" ID="BT_PopTranferProjectWindow" OnClick="BT_PopTranferProjectWindow_Click" Height="25px"></asp:Button>
                                                                                                        ...
                                                                                                        <table>
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td style="padding-left: 20px;">
                                                                                                                    <asp:Button ID="BT_CloseReq" runat="server" CssClass="inpuClose" Enabled="False"
                                                                                                                        OnClick="BT_CloseReq_Click" />
                                                                                                                    &#160;
                                                                                                          <asp:Button ID="BT_ActiveReq" runat="server" CssClass="inpuActive" Enabled="False"
                                                                                        ...
                                                                                        <td align="left">
                                                                                            <table width="700px">
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td style="width: 45%" class="formItemBgStyleForAlignLeft">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td class="formItemBgStyleForAlignLeft" s></td>
                                                                                                    <td colspan="3" class="formItemBgStyleForAlignLeft">
                ...
                <div class="layui-layer layui-layer-iframe" id="popwindow" name="fixedDivNoConfirm"
                    ...
                    <div id="popwindow_content" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                        ...
                        <table>
                            <tr>
                                <td class="formItemBgStyleForAlignLeft" style="padding: 5px 5px 0px 5px; vertical-align: top;">
                                        ...
                                        <tr>
                                            <td align="left" style="width: 100%; vertical-align: top; padding: 5px 5px 5px 5px;">
                                                <table width="100%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                    ...
                                                    <tr>
                                                        <td class="formItemBgStyleForAlignLeft">
                                                            <asp:Label ID="Label26" runat="server" Text="<%$ Resources:lang,XiangMuMingCheng %>"></asp:Label>：<br />
                                                    ...
                                                    <tr>
                                                        <td class="formItemBgStyleForAlignLeft">
                                                            <asp:Button ID="BT_TransferProject" runat="server" OnClick="BT_TransferProject_Click"
                                                                CssClass="inpu" Text="<%$ Resources:lang,ZhuanChengXiangMu %>" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
