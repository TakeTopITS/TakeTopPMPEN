                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td align="left" class="formItemBgStyle">
                                                <input type="button" class="inpuLong" value="新增管径尺寸" onclick="window.location.href = 'TTGDStandardSizeEdit.aspx'" />
                                            </td>
                                        </tr>
                                        <tr>
                                                ...
                                                <div style="width: 100%;">
                                                    ...
                                                    <asp:DataGrid ID="DG_List" runat="server" AllowPaging="true" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundColumn DataField="ODGB" HeaderText="外径">
                                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="Center" Width="10%" />
                                                            </asp:BoundColumn>
                                                            <asp:BoundColumn DataField="ODANSI" HeaderText="外径ANSI">
                                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="Center" Width="10%" />
                                                            </asp:BoundColumn>
                                                            <asp:BoundColumn DataField="BQMainCode" HeaderText="主要编号">
