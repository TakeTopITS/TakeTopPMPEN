<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTAPPGoodsInforViewForCheck.aspx.cs" Inherits="TTAPPGoodsInforViewForCheck" %>
                ...
                <tr>
                    <td height="31" class="page_topbj">
                        <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="left">
                                    <a href="TTAPPGoodsCheckReport.aspx" onclick="javascript:document.getElementById('IMG_Waiting').style.display = 'block';">
                                                ...
                                                <table class="bian" style="width: 100%;" cellpadding="4" cellspacing="0">
                                                    <tr>
                                                        <td style="text-align: right; width: 23%;">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,MingCheng%>"></asp:Label>£º
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td style="text-align: right">
                                                            <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,DanJia%>"></asp:Label>£º </td>
