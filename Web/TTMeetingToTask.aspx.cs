...
HE_Operation.Language = Session["LangCode"].ToString();
        ...
        if (Page.IsPostBack != true)
        {
            ...
            if (strIsMobileDevice == "YES")
            {
                HT_Operation.Text = LanguageHandle.GetWord("ZhuTi") + meeting.Name.Trim() + LanguageHandle.GetWord("brbrNeiRong") + meeting.Content.Trim();
            }
            else
            {
                HE_Operation.Text = LanguageHandle.GetWord("ZhuTi") + meeting.Name.Trim() + LanguageHandle.GetWord("brbrNeiRong") + meeting.Content.Trim();
            }
