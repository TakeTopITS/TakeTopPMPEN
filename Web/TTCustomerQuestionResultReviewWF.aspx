                                            ...
                                            <table width="95%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                ...
                                                <tr style="font-size: 10pt">
                                                    ...
                                                    <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,LeiXing%>"></asp:Label>£º<asp:DropDownList ID="DL_WFType" runat="server">
                                                        ...
                                                        &nbsp; &nbsp;<asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ChaXunGuanJianZi%>"></asp:Label>£º<asp:TextBox ID="TB_KeyWord" runat="server" Width="60px"></asp:TextBox>
                                        ...
                                        <td>
                                            <table align="left" width="90%">
                                                <tr>
                                                    <td align="left">
                                                        <b>
                                                            <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,DuiYingGongZuoLiuLieBiao%>"></asp:Label>£º</b>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="left">
