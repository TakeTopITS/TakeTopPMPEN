(function (b) {
    ...
    a.editors = {
        ...
        textTaskEditor: function () {
            ...
            this.init = function (i, h, m, l, j) {
                ...
                g = l;
                f = j;
                var $txt = b('<input  style="width:125px;" />');
                ...
                ////添加选择按钮 
                b('<input type="button" value="Select" onclick="showModuleTree(this)" style="width:60px;margin-left:5px;" />').appendTo('#' + c);
    ...
    a.init = function (x, r) {
        ...
        b(document).click(function () {
            //点击阴影或者选择步骤弹窗标题栏  不执行下面事件
            if (arguments[0].target.className == "layui-layer-shade" || arguments[0].target.className == "layui-layer-title") {
                return;
            }
...
function LoadWFChart() {
    ...
    if (varPageName.indexOf("TTTakeTopMFDesignerJSWorker.aspx") >= 0) {
