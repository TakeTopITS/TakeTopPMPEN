...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function AddAttachment() {
            ...
            tr.insertCell(0).innerHTML = "<input name='File' style='width:300px' type='file'>&nbsp;<input class=btn type=button value='Deleted' style='width:50px' onclick='delAttachment(this.parentElement.parentElement.rowIndex)'>";
        }
