<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTProjectRelatedDefect.aspx.cs" Inherits="TTProjectRelatedDefect" %>
                                                ...
                                                <table style="width: 98%; margin-top: 5px">
                                                    <tr>
                                                        <td style="text-align: left;">
                                                            <asp:Label ID="LB_DefectType" runat="server"></asp:Label>&nbsp;
                                                        <asp:Label ID="LB_tbDefectList" runat="server" Text="<%$ Resources:lang,DefectList%>"></asp:Label>:
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
