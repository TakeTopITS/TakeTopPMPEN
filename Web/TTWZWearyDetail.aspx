                                                        ...
                                                        <Columns>
                                                            <asp:TemplateColumn>
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <%--<asp:Button ID="Button1" runat="server" CssClass="inpu" Text="Approved" CommandName="submit" CommandArgument='<%# Eval("WearyCode") %>' Visible='<%# Eval("Process").ToString()=="报批" ? true : false %>' />--%>
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
