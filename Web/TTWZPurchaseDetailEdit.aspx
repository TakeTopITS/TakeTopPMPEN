                                                    ...
                                                    <tr>
                                                        <td align="left" style="width: 100%; padding: 5px 5px 5px 5px;" class="formItemBgStyle" valign="top">
                                                            <table class="formBgStyle" style="width: 80%;">
                                                                <tr>
                                                                    <td class="formItemBgStyle"><asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,XuHao%>"></asp:Label>£º</td>
                                                                    <td class="formItemBgStyle">
                                                                        <asp:TextBox ID="TXT_SerialNumber" runat="server"></asp:TextBox>
                                                                    </td>
                                                                    <td class="formItemBgStyle"><asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,BiaoDuan%>"></asp:Label>£º</td>
                                                                    <td class="formItemBgStyle" colspan="3">
                                                                        <asp:TextBox ID="TXT_Tenders" runat="server"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="formItemBgStyle"><asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,CaiGouShuLiang%>"></asp:Label>£º</td>
                                                                    <td class="formItemBgStyle">
                                                                    ...
                                                                    <td class="formItemBgStyle"><asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,HuanSuanShuLiang%>"></asp:Label>£º</td>
                                                                    <td class="formItemBgStyle">
                                                                    ...
                                                                    <td class="formItemBgStyle"><asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,YuJiFeiYong%>"></asp:Label>£º</td>
                                                                    <td class="formItemBgStyle">
                                                                        <asp:TextBox ID="TXT_PlanMoney" runat="server"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="formItemBgStyle"><asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,ShengChanChangJia%>"></asp:Label>£º</td>
                                                                ...
                                                                <tr>
                                                                    <td class="formItemBgStyle"><asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,GuiGeShuBianHao%>"></asp:Label>£º</td>
                                                                    <td class="formItemBgStyle" colspan="5">
                                                                        <asp:TextBox ID="TXT_StandardCode" runat="server" Width="400px"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="formItemBgStyle"><asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,BeiZhu%>"></asp:Label>£º</td>
                                                                    <td class="formItemBgStyle" colspan="5">
