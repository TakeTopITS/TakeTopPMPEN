<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTDIYModuleByWFFormRelatedOther.aspx.cs" Inherits="TTDIYModuleByWFFormRelatedOther" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        jQuery(function () {
            ...
            //var divFormHeight = document.getElementById("divWorkFlow").offsetHeight;
            //var divWorkHeight = document.getElementById("tableWorkFlow").offsetHeight;
            //if (divFormHeight > divWorkHeight) {
            //    document.getElementById("tdForm").style.height = divFormHeight + 100 + "px";
            //} else {
            //    document.getElementById("tdForm").style.height = divWorkHeight + 100 + "px";
            //}
            var divFormHeight = jQuery("#divWorkFlow").height();
            var divWorkHeight = jQuery("#tableWorkFlow").height();
            if (divFormHeight > divWorkHeight) {
                jQuery("#tdForm").css("height", divFormHeight + 100 + "px");
                jQuery("#divWork").css("height", divFormHeight + 100 + "px");
                //jQuery("#divWork").height(divFormHeight + 100 + "px");
                //jQuery("#divWork").height() = divFormHeight + 500 + "px";
            } else {
                jQuery("#tdForm").css("height", divWorkHeight + 100 + "px");
                jQuery("#divWork").css("height", divWorkHeight + 100 + "px");
                //document.getElementById("tdForm").style.height = divWorkHeight + 100 + "px";
                //jQuery("#divWork").height() = divWorkHeight + 100 + "px";
        ...
        <form id="form1" runat="server">
            <div style="z-index: -2;">
                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td valign="top" style="width: 100%; height: 100%;" id="tdForm">
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td valign="top" style="padding: 5px 5px 30px 5px; width: 100%; height: 100%">
            ...
            <table style="display: none;">
                <tr>
                    <td>
                        <div style="float: left; width: 30%; height: 100%;" id="divForm" onmousemove="hideWFMain()" onmouseout="displayWFMain()">
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td valign="top" style="padding: 5px 5px 5px 5px; width: 100%; height: 100%">
                                        <table width="100%" cellpadding="0" cellspacing="0" id="tableWorkFlow">
                                                ...
                                                <td class="tdLeft" style="padding: 1px 1px 1px 1px; border-bottom: solid 1px #D8D8D8; border-right: solid 1px #D8D8D8;">
                                                    <table style="width: 100%;" cellpadding="3" cellspacing="0">
                                                        ...
                                                        <tr style="display: none;">
                                                            ...
                                                            <td colspan="2" class="tdRight" align="left">
                                                                <span style="font-size: 10pt; font-family: 宋体">
                                                                    <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,ChuLiJinDuFanKui%>"></asp:Label>：</span><asp:CheckBox
                                                        ...
                                                        <tr style="display: none;">
                                                            <td class="tdLeft" align="right">
                                                                <span style="font-size: 10pt; font-family: 宋体">XML: </span>
                                                            </td>
                                                            <td colspan="2" class="tdRight" align="left">
                                                        ...
                                                        <tr style="display: none;">
                                                            <td colspan="3" class="tdRight" style="text-align: center; padding: 2px 0px 2px 5px; border-bottom: solid 1px  #D8D8D8;">
                                                                <asp:HyperLink ID="HL_WFXSNFile" runat="server"
                                                                    ...
                                                                    <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,XGYWBGMBXZ%>"></asp:Label>
                                                                </asp:HyperLink>
                                            ...
                                            <tr>
                                                ...
                                                <td class="tdRight" style="padding-right: 20px; text-align: center;">
            ...
            <asp:HiddenField ID="HF_RelatedCode" runat="server"></asp:HiddenField>
        </form>
    </center>
</body>
