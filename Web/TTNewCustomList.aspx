                                ...
                                <table width="300" border="0" align="left" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,XinKeHuMoZuLieBiao%>"></asp:Label>
                                        </td>
                                        <td width="5">
                                ...
                                <table style="width: 100%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                    ...
                                    <tr style="font-size: 12pt">
                                        <td align="left" style="width: 10%;" class="formItemBgStyle">
                                            <asp:DataGrid ID="DG_CustomerModuleList" runat="server" AllowPaging="False" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    <asp:BoundColumn DataField="CustomModuleName" HeaderText="客户模组">
                                                        <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="10%" />
                                                    </asp:BoundColumn>
                                                    <asp:BoundColumn DataField="Type" HeaderText="Type">
                                                        <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="10%" />
                                                    </asp:BoundColumn>
                                                    <asp:BoundColumn DataField="TemName" HeaderText="流程名称">
                                                        <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="10%" />
                                                    </asp:BoundColumn>
                                                    <asp:TemplateColumn>
                                                        <ItemTemplate>
                                                            <a href='TTNewCustomAdd.aspx?id=<%# DataBinder.Eval(Container.DataItem,"ID") %>'>
                                                                <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,BianJi%>"></asp:Label></a>&nbsp;&nbsp;
                                                            <asp:LinkButton ID="LB_Del" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"ID") %>' CommandName="del">
                                                                <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,ShanChu%>"></asp:Label></asp:LinkButton>
                                                        </ItemTemplate>
