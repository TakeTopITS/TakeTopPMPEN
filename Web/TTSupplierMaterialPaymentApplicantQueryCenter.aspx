<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTSupplierMaterialPaymentApplicantQueryCenter.aspx.cs" Inherits="TTSupplierMaterialPaymentApplicantQueryCenter" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                           <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,WuLiaoCaiGouFuKuanShengQing%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                            ...
                                            <td align="left" style="padding-top: 4px;">
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="Label1111" runat="server" Text="<%$ Resources:lang,XiangMu%>"></asp:Label>
                                                        </td>
                                                        <td>
