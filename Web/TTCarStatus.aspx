                                    ...
                                    <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,CheLiangZhuangTai%>"></asp:Label>
                                            </td>
                                            <td width="5">
                ...
                <tr>
                    <td style="padding: 5px 5px 5px 5px">
                        ...
                        <NickLeeVB:ScheduleGeneral ID="Schedule1" runat="server" GridLines="Both" SeparateDateHeader="True"
                            DataRangeStartField="DepartTime" DataRangeEndField="BackTime" TitleField="CarCode"
                            ...
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"ID") %>'
                                    CommandName="Edit" Text='<%# DataBinder.Eval(Container.DataItem,"Destination") %>'>
                                </asp:LinkButton>
                            </ItemTemplate>
