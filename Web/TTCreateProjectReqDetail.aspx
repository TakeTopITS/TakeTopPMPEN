<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTCreateProjectReqDetail.aspx.cs"
    Inherits="TTCreateProjectReqDetail" %>
                ...
                <ContentTemplate>
                                                                                ...
                                                                                <td class="formItemBgStyleForAlignLeft">
                                                                                    <table style="width: 80%">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <asp:HyperLink ID="HL_ReqToTask" runat="server" Target="_blank">---><asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,ZhuanChengRenWu%>"></asp:Label></asp:HyperLink>
                                                                                                &nbsp;
                                                                                    <asp:HyperLink ID="HL_RelatedDoc" runat="server" NavigateUrl="~/TTReqRelatedDoc.aspx"
                                                                                        ...
                                                                                        <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,XiangGuanWenDang%>"></asp:Label>
                                                                                                ...
                                                                                                <asp:HyperLink ID="HL_ReqReview" runat="server" Enabled="False" Visible="false" Target="_blank">---&gt;<asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,XuQiuPingShen%>"></asp:Label></asp:HyperLink>
                                                                                                &nbsp;
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popwindow" name="fixedDivNoConfirm"
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table>
                                <tr>
                                    <td class="formItemBgStyleForAlignLeft" style="padding: 5px 5px 0px 5px; text-align: left; vertical-align: top;">
