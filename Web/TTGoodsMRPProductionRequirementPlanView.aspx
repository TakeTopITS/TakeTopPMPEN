<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTGoodsMRPProductionRequirementPlanView.aspx.cs" Inherits="TTGoodsMRPProductionRequirementPlanView" %>
                                                ...
                                                <table width="100%">
                                                    <tr>
                                                        ...
                                                        <td width="550px" style="font-size: xx-large; text-align: center;">
                                                            <br />
                                                            <asp:Label ID="LB_ReportName" runat="server" Text="<%$ Resources:lang,ZuoYeXuQiuJiHua%>"></asp:Label>
                                                            <br />
                                                        </td>
                                                        <td>&nbsp;</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            ...
                                                            <table>
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="Label27" runat="server" Text="<%$ Resources:lang,ZuoYeXuQiuJiHua%>"></asp:Label>（Ver:
