                                                            ...
                                                            <table class="formBgStyle">
                                                                <tr>
                                                                    <td style="text-align: left" class="formItemBgStyle">
                                                                        <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,WuZiMingCheng%>"></asp:Label>£º</td>
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: left" class="formItemBgStyle">
                                                                        <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,GuiGeXingHao%>"></asp:Label>£º</td>
                                                                    <td style="text-align: left" class="formItemBgStyle" colspan="3">
                                                                        <asp:TextBox ID="TXT_Model" runat="server" Width="400" ReadOnly="true"></asp:TextBox>
                                                                    </td>
                                                                    <td style="text-align: left" class="formItemBgStyle">
                                                                        <asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,JiBie%>"></asp:Label>£º</td>
                                                                    <td style="text-align: left" class="formItemBgStyle">
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: left" class="formItemBgStyle">
                                                                        <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,JiHuaShuLiang%>"></asp:Label>£º</td>
                                                                    <td style="text-align: left" class="formItemBgStyle">
