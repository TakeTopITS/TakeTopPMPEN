<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTGoodsSaleManagementForThirdPart.aspx.cs" Inherits="TTGoodsSaleManagementForThirdPart" %>
                                        ...
                                        <tr>
                                                ...
                                                <table width="990" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,XiaoShouGuanLi%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                                        ...
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="TB_SOID" runat="server" Width="60px"></asp:TextBox>
                                                                    </td>
                                                                    <td>&nbsp;</td>
                                                                    <td align="left">
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="TB_SOName" runat="server" Width="120px"></asp:TextBox>
                                                                    </td>
                                                                    <td>&nbsp;</td>
                                                                    <td align="left">
                                                                        <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,KeHu%>"></asp:Label>：
                                                                    </td>
                                                                    <td>
                                            ...
                                            <td style="padding-top: 4px; padding-right: 5px; text-align: right; width: 30%; height: 25px;" colspan="2">
                                                <asp:Button ID="BT_MakeGoodsSaleOrderThirdPart" runat="server" CssClass="inpuLong" Font-Size="10pt"
                                                    Text="下单" OnClick="BT_MakeGoodsSaleOrderThirdPart_Click" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td align="left" width="15%">
                                                            <strong>
                                                                <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,ZongJinE%>"></asp:Label></strong>
                                                        </td>
                                                        <td align="left" width="15%">
                                                            <strong>
                                                                <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,KeHu%>"></asp:Label></strong>
                                                        </td>
                                    ...
                                    <asp:DataGrid ID="DataGrid5" runat="server" AutoGenerateColumns="False" AllowPaging="true" PageSize="15" OnPageIndexChanged="DataGrid5_PageIndexChanged"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:HyperLinkColumn DataNavigateUrlField="CustomerCode" DataNavigateUrlFormatString="TTCustomerInfoView.aspx?CustomerCode={0}"
                                                DataTextField="CustomerName" HeaderText="Name" Target="_blank">
                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="15%" />
                                            </asp:HyperLinkColumn>
                                    ...
                                    <table width="100%">
                                        <tr>
                                            ...
                                            <td rowspan="2">
                                                ...
                                                <iframe runat="server" id="IFrame_Chart_SaleTendency" src="TTTakeTopAnalystChartSet.aspx" style="width: 800px; height: 295px; border: 1px solid white; overflow: hidden;"></iframe>

                                               <%-- <asp:Chart ID="Chart_SaleTendency" runat="server" ImageType="Png" Width="800px">
                                                    <Legends>
