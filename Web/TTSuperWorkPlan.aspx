                                ...
                                <table width="950" border="0" align="left" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td style="padding-top: 6px;">
                                            <asp:Button ID="BT_CopyVersion" runat="server" CssClass="inpu" OnClick="BT_CopyVersion_Click" OnClientClick="return confirm('复制操作会完全覆盖原来的计划数据，您确定要复制吗(Copy operation will delete all old plan data,Are you sure you want to copy it)？')"
                                    ...
                                    <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div id="PlanTreeDivID" style="width: 300px; height: 600px; overflow: auto; vertical-align: top;">
                                                            <asp:TreeView ID="TreeView1" runat="server" NodeWrap="True" OnSelectedNodeChanged="TreeView1_SelectedNodeChanged"
                                                                ShowLines="True" Font-Bold="False" Font-Names="宋体" Style="width: 300px; height: 100%;">
                                        ...
                                        <td style="width: 100%;" align="left" valign="top">
                                            <table style="width: 100%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                <tr>
                                                    <td style="padding-right: 30px;" class="formItemBgStyleForAlignLeft" colspan="4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="formItemBgStyleForAlignLeft">&nbsp;<asp:Label ID="LB_tbBudget1" runat="server" Text="<%$ Resources:lang,GongShi2%>" />
                                                    </td>
                                                    <td class="formItemBgStyleForAlignLeft">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="formItemBgStyleForAlignLeft">
                                                        ...
                                                        <%--  <asp:Label ID="Label12" runat="server" Text="Unit" />：--%>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="formItemBgStyleForAlignLeft">
                                                        <asp:DropDownList ID="DL_Status" runat="server" CssClass="DDList" DataTextField="HomeName"
                                                            DataValueField="Status" class="formItemBgStyleForAlignLeft">
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td class="formItemBgStyleForAlignLeft">
                                                    ...
                                                    <td colspan="3" style="padding-top: 20px;" class="formItemBgStyleForAlignLeft">
                                                        ...
                                                        &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                                                                    <asp:Button ID="BT_Delete" runat="server" Enabled="False" OnClick="BT_Delete_Click" OnClientClick="return confirm(getDeleteMsgByLangCode())"
                                                                        CssClass="inpu" Text="<%$ Resources:lang,Delete%>" />
                                                    </td>
                                                </tr>
