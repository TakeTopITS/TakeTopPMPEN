<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTAssetMantanceReport.aspx.cs"
    Inherits="TTAssetMantanceReport" %>
                ...
                <ContentTemplate>
                    <table style="width: 980px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="TB_AssetType" runat="server" Width="190px"></asp:TextBox>
                            </td>
                            <td style="text-align: right;">
                                <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,WeiHuRen%>"></asp:Label>：</td>
                            <td colspan="2">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <asp:Button ID="BT_Find" runat="server" OnClick="BT_Find_Click" CssClass="inpu" Text="<%$ Resources:lang,ChaXun%>" />
                            </td>
                        </tr>
                        <tr>
                                ...
                                <table style="width: 100%;">
                                    <tr>
                                        <td style="width: 100%; height: 80px; font-size: xx-large; text-align: center;">
                                            <br />
                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ZiChanWeiHuBaoBiao%>"></asp:Label>
                                            <br />
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="width: 100%;">
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                ...
                                                                <td width="10%" align="center">
                                                                    <strong>
                                                                        <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,ZiChanDaiMa%>"></asp:Label></strong>
                                                                </td>
                                                                <td width="15%" align="center">
                                                                    <strong>
                                                                        <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,ZiChanMingCheng%>"></asp:Label></strong>
                                                                </td>
                                                                <td width="8%" align="center">
                                                                    <strong>
                                                                        <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,WeiHuRen%>"></asp:Label></strong>
                                                                </td>
                                                                <td width="8%" align="center">
                                                                    <strong>
                                                                ...
                                                                <td width="27%" align="center">
                                                                    <strong>
                                                                        <asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,WeiHuNeiRong%>"></asp:Label></strong>
                                                                </td>
                                                                <td width="16%" align="center">
                                                                    <strong>
                                                                        <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,WeiXiuShiJian%>"></asp:Label></strong>
                                                                </td>
                                                                <td width="8%" align="center">
                                                                    <strong>
                                                                        <asp:Label ID="Label15" runat="server" Text="<%$ Resources:lang,FeiYong%>"></asp:Label></strong>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                            ...
                                            <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False"
                                                ShowHeader="false" OnPageIndexChanged="DataGrid1_PageIndexChanged"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:HyperLinkColumn DataNavigateUrlField="AssetCode" DataNavigateUrlFormatString="TTAssetInforView.aspx?AssetCode={0}"
                                                        DataTextField="AssetName" HeaderText="资产名称" Target="_blank">
                                    ...
                                    <tr>
                                        <td style="width: 100%; text-align: Center; display: none;">
                                            <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,Di%>"></asp:Label>：<asp:Label ID="LB_PageIndex" runat="server"></asp:Label>
                                            &nbsp;<asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,YeGong%>"></asp:Label>
