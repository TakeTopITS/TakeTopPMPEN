<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTLTCustomerRequirementManage.aspx.cs" Inherits="TTLTCustomerRequirementManage" %>
                                    ...
                                    <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td align="right" style="padding-top: 5px; padding-right: 8px;">
                                                <asp:Button ID="BT_AllQuestion" runat="server" CssClass="inpuLong" OnClick="BT_AllQuestion_Click" Text="<%$ Resources:lang,SuoYouKeHuFuWuXuQiu%>" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                                            ...
                                                            <table width="100%">
                                                                <tr>
                                                                    <td align="left" width="50%">
                                                                        <asp:Label ID="Label134234" runat="server" Text="<%$ Resources:lang,DaiChuLiDeFuWuXuQiu%>"></asp:Label>
                                                                    </td>
                                                                    ...
                                                                    <td width="50%">
                                                                        ...
                                                                        <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="1px" OnPageIndexChanged="DataGrid1_PageIndexChanged" PageSize="6" ShowHeader="false" Width="100%">
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:HyperLinkColumn DataNavigateUrlField="ID" DataNavigateUrlFormatString="TTLTCustomerRequirementHandleDetail.aspx?ID={0}" DataTextField="Question" HeaderText="服务需求" Target="_blank">
