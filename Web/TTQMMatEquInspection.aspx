<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTQMMatEquInspection.aspx.cs" Inherits="TTQMMatEquInspection" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,XiangMuYanShou%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                            ...
                            <tr>
                                <td align="center" style="padding-top: 5px;">
                                    ...
                                    <table cellpadding="2" cellspacing="0" class="formBgStyle" width="75%">
                                        <tr>
                                            <td align="left">
                                                <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,YanShouXinXi%>"></asp:Label>：<asp:TextBox ID="TextBox1" runat="server" Width="120px"></asp:TextBox>
                                          
                                                <asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,HeTongXinXi%>"></asp:Label>：<asp:TextBox ID="TextBox2" runat="server" Width="120px"></asp:TextBox>
                                          
                                                <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,YanShouRiQi%>"></asp:Label>：<asp:TextBox ID="TextBox3" runat="server" Width="90px" ReadOnly="false"></asp:TextBox>
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td width="15%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,HeTongMingCheng%>"></asp:Label></strong>
                                                                    </td>
                                                                    <td width="10%" align="left">
                                                                        <strong>
                                                                    ...
                                                                    <td width="15%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,YanShouRiQi%>"></asp:Label></strong>
                                                                    </td>
                                                                    ...
                                                                    <td width="30%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label22" runat="server" Text="<%$ Resources:lang,YanShouJieGuo%>"></asp:Label></strong>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                              ...
                              <table cellpadding="2" cellspacing="0" class="formBgStyle" width="900px">
                                  ...
                                  <tr>
                                      <td class="formItemBgStyleForAlignLeft" style="width: 150px">
                                          <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,XiangMuHeTong%>"></asp:Label>：</td>
                                      <td class="formItemBgStyleForAlignLeft">
                                      ...
                                      <td class="formItemBgStyleForAlignLeft">
                                          <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,GongYingShang%>"></asp:Label>：</td>
                                      <td class="formItemBgStyleForAlignLeft">
                                  ...
                                  <tr style="color: #000000">
                                      <td  style="width: 150px; height: 30px" class="formItemBgStyleForAlignLeft">
                                          <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,YunShuDanWei%>"></asp:Label>：
                                      </td>
                                      <td  style="height: 30px" class="formItemBgStyleForAlignLeft">
                                          <asp:TextBox ID="TB_TransportUnit" runat="server" CssClass="shuru" Width="150px"></asp:TextBox>
                                      </td>
                                      ...
                                      <td class="formItemBgStyleForAlignLeft" style="height: 30px">
                                          <asp:TextBox ID="TB_ReceivingUnit" runat="server" CssClass="shuru" Width="150px"></asp:TextBox>
                                      </td>
                                  </tr>
                                  <tr style="color: #000000">
                                      <td  style="width: 150px; height: 30px" class="formItemBgStyleForAlignLeft">
                                          <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,YanShouRen%>"></asp:Label>：
                                      </td>
                                      <td  style="height: 30px" class="formItemBgStyleForAlignLeft">
                                          <asp:TextBox ID="TB_InspectionPer" runat="server" CssClass="shuru" Width="150px"></asp:TextBox>
                                      </td>
                                      <td class="formItemBgStyleForAlignLeft" style="height: 30px">
                                          <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,YanShouRiQi%>"></asp:Label>：</td>
                                      <td class="formItemBgStyleForAlignLeft" style="height: 30px">
                                          <asp:TextBox ID="DLC_InspectionDate" runat="server" CssClass="shuru" ReadOnly="false" Width="150px"></asp:TextBox>
                                  ...
                                  <tr style="color: #000000">
                                      <td class="formItemBgStyleForAlignLeft" style="width: 150px; height: 30px">
                                          <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,YanShouZhuangTai%>"></asp:Label>：
                                      </td>
                                      <td class="formItemBgStyleForAlignLeft" style="height: 30px">
                                  ...
                                  <tr style="color: #000000;">
                                      <td class="formItemBgStyleForAlignLeft" style="width: 150px; height: 30px">
                                          <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,YanShouJieGuo%>"></asp:Label>：</td>
