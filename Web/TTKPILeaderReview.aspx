<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTKPILeaderReview.aspx.cs"
    Inherits="TTKPILeaderReview" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,ZHCYJXPH%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                                            ...
                                                            <table style="width: 100%; text-align: left;" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                                <tr>
                                                                    <td class="formItemBgStyle" style="height: 26px;">
                                                                        <b>
                                                                            <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,BianHao%>"></asp:Label>：<asp:Label ID="LB_KPICheckID" runat="server"></asp:Label>
                                                                            &nbsp;<asp:Label ID="LB_KPICheckName" runat="server"></asp:Label>
                                                                            &nbsp;KPI：</b>&nbsp;
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <table class="formBgStyle" style="width: 95%; text-align: left;" cellpadding="3"
                                                                cellspacing="0">
                                                                <tr>
                                                                    <td width="80px" align="right" class="formItemBgStyle">
                                                                        <asp:Label ID="Label26" runat="server" Text="<%$ Resources:lang,ZiPingZongFen%>"></asp:Label>：
                                                                    </td>
                                                                    ...
                                                                    <td width="100px" align="right" class="formItemBgStyle">
                                                                        <asp:Label ID="Label27" runat="server" Text="<%$ Resources:lang,LingDaoPingZongFen%>"></asp:Label>：
                                                                    </td>
                                                                    <td class="formItemBgStyle">
                                                                        <b>
                                                                    ...
                                                                    <td width="100px" align="right" class="formItemBgStyle">
                                                                        <asp:Label ID="Label28" runat="server" Text="<%$ Resources:lang,DiSanFangPingZongFen%>"></asp:Label>
                                                                    </td>
                                                                    <td align="left" class="formItemBgStyle" width="100px">
                                                                        <b>
                                                                            <asp:Label ID="LB_TotalThirdPartPoint" runat="server"></asp:Label>
                                                                        </b>
                                                                    </td>
                                                                    <td align="right" class="formItemBgStyle" width="100px">
                                                                        <asp:Label ID="Label29" runat="server" Text="<%$ Resources:lang,XiTongZongPingFen%>"></asp:Label>：</td>
                                                                    <td align="left" class="formItemBgStyle"><b>
                                                                        <asp:Label ID="LB_TotalSqlPoint" runat="server"></asp:Label>
                                                                    </b></td>
                                                                    <td align="right" class="formItemBgStyle" width="100px">
                                                                        <asp:Label ID="Label30" runat="server" Text="<%$ Resources:lang,RenShiPingZongFen%>"></asp:Label>：
                                                                    </td>
                                                                    <td class="formItemBgStyle">
                                                                        <b>
                                                                    ...
                                                                    <td align="right" class="formItemBgStyle" width="100px">
                                                                        <asp:Label ID="Label31" runat="server" Text="<%$ Resources:lang,ZongFen%>"></asp:Label>：
                                                                    </td>
                                                                    <td class="formItemBgStyle">
                                                                        <b>
                                                                    ...
                                                                    <td width="100px" align="right" class="formItemBgStyle">
                                                                        <asp:Label ID="Label32" runat="server" Text="<%$ Resources:lang,ZhuangTai%>"></asp:Label>：
                                                                    </td>
                                                                                    ...
                                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td width="14%" align="center">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,DingYi%>"></asp:Label></strong>
                                                                                            </td>
                                                                                            <td width="10%" align="center">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,MuBiao%>"></asp:Label></strong>
                                                                                            </td>
                                                                                            <td width="10%" align="center">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,GongShi%>"></asp:Label></strong>
                                                                                            </td>
                                                                                            <td width="7%" align="center">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,QuanZhong%>"></asp:Label></strong>
                                                                                            </td>
                                                                                            <td width="7%" align="center">
                                                                                                <strong>
                                                                                            ...
                                                                                            <td width="7%" align="center">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,LingDaoPingFen%>"></asp:Label></strong>
                                                                                            </td>
                                                                                            <td width="7%" align="center">
                                                                                                <strong>
                                                                                            ...
                                                                                            <td width="7%" align="center">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,XiTongPingFen%>"></asp:Label></strong>
                                                                                            </td>
                                                                                            <td width="7%" align="center">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,RenShiPingFen%>"></asp:Label></strong>
                                                                                            </td>
                                                                                            <td width="7%" align="center">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,ZongPingFen%>"></asp:Label></strong>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popwindow"
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table class="formBgStyle" style="width: 100%; text-align: left;" cellpadding="3"
                                cellspacing="0">
                                <tr>
                                    <td width="60px" align="right" class="formItemBgStyle">
                                        <asp:Label ID="Label15" runat="server" Text="<%$ Resources:lang,PingFen%>"></asp:Label>：
                                    </td>
                                    <td width="50%" align="left" class="formItemBgStyle">
                                        <NickLee:NumberBox MaxAmount="1000000000000" MinAmount="-1000000000000" ID="NB_Point" runat="server" Width="53px">0.00</NickLee:NumberBox>
                                        ...
                                        <asp:DataList ID="DataList3" runat="server" CellPadding="0" ForeColor="#333333" Height="16px"
                                            ...
                                            <ItemTemplate>
                                                <table cellpadding="4" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td align="left">
                                                            <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,DiSanFangPing%>"></asp:Label>：
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" class="tdLeft" style="color: Blue; font-style: italic;">
                                                            <asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,PingHeRen%>"></asp:Label>：
                                        ...
                                        <asp:DataList ID="DataList2" runat="server" CellPadding="0" ForeColor="#333333" Height="16px"
                                            ...
                                            <ItemTemplate>
                                                <table cellpadding="4" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td align="left">
                                                            <asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,LingDaoPingFen%>"></asp:Label>：
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" class="tdLeft" style="color: Blue; font-style: italic;">
                                                            <asp:Label ID="Label22" runat="server" Text="<%$ Resources:lang,PingHeRen%>"></asp:Label>：<%#DataBinder.Eval(Container.DataItem, "LeaderName")%><br />
                                        ...
                                        <asp:DataList ID="DataList4" runat="server" CellPadding="0" ForeColor="#333333" Height="16px"
                                            ...
                                            <ItemTemplate>
                                                <table cellpadding="4" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td align="left">
                                                            <asp:Label ID="Label23" runat="server" Text="<%$ Resources:lang,RenShiPingFen%>"></asp:Label>：
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" class="tdLeft" style="color: Blue; font-style: italic;">
                                                            <asp:Label ID="Label24" runat="server" Text="<%$ Resources:lang,PingHeRen%>"></asp:Label>：<%#DataBinder.Eval(Container.DataItem, "HRName")%><br />
                                                            <%#DataBinder.Eval(Container.DataItem, "Comment")%></td>
                                                    </tr>
                                                </table>
                                            </ItemTemplate>
                                ...
                                <tr>
                                    <td class="formItemBgStyle" align="right">
                                        <asp:Label ID="Label25" runat="server" Text="<%$ Resources:lang,YiJian%>"></asp:Label>：
                                    </td>
                                    <td align="left" valign="top" class="formItemBgStyle">
                                        <CKEditor:CKEditorControl ID="HE_LeaderSummary" runat="server" Height="150px" Width="98%" Visible="false" />
                                        <CKEditor:CKEditorControl runat="server" ID="HT_LeaderSummary" Width="98%" Height="150px" Visible="False" />
