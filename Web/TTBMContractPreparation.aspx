<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTBMContractPreparation.aspx.cs" Inherits="TTBMContractPreparation" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,HeTongBianZhi%>"></asp:Label></td>
                                                        <td width="5">
                            ...
                            <tr>
                                <td align="left" style="padding-top: 5px;">
                                    ...
                                    <table cellpadding="2" cellspacing="0" class="formBgStyle" width="75%">
                                        <tr>
                                           <td align="left">
                                                <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,HeTongXinXi%>"></asp:Label>：<asp:TextBox ID="TextBox1" runat="server" Width="120px"></asp:TextBox>
                                          
                                                <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,QiaTanXinXi%>"></asp:Label>：<asp:TextBox ID="TextBox2" runat="server" Width="120px"></asp:TextBox>
                                        
                                                <asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,QianShuRiQi%>"></asp:Label>：<asp:TextBox ID="TextBox3" runat="server" Width="100px" ReadOnly="false"></asp:TextBox>
                                            ...
                                            <td class="formItemBgStyleForAlignLeft">
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td width="10%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,HeTongMingCheng%>"></asp:Label></strong>
                                                                    </td>
                                                                    <td width="10%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,HeTongQiaTanMingCheng%>"></asp:Label></strong>
                                                                    </td>
                                                                    <td width="10%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,JiaFang%>"></asp:Label></strong>
                                                                    </td>
                                                                    <td width="10%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,JiaFangDaiBiao%>"></asp:Label></strong>
                                                                    </td>
                                                                    <td width="10%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,YiFang%>"></asp:Label></strong>
                                                                    </td>
                                                                    <td width="10%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label22" runat="server" Text="<%$ Resources:lang,YiFangDaiBiao%>"></asp:Label></strong>
                                                                    </td>
                                                                    <td width="10%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label23" runat="server" Text="<%$ Resources:lang,QianShuRiQi%>"></asp:Label></strong>
                                                                    </td>
                                                                    <td width="10%" align="left">
                                                                        <strong>
                                                                            <asp:Label ID="Label24" runat="server" Text="<%$ Resources:lang,ShengXiaoRiQi%>"></asp:Label></strong>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                ...
                                                <asp:DataGrid ID="DataGrid2" runat="server" AutoGenerateColumns="False" Height="1px"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <%-- <asp:BoundColumn DataField="Name" HeaderText="ContractName">
                                                        ...
                                                        <asp:BoundColumn DataField="ContractDiscussName" HeaderText="合同洽谈名称">
                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="10%" />
                                                            <HeaderStyle BorderColor="#394f66" BorderStyle="Solid" BorderWidth="1px" Font-Bold="true"
                                                                Horizontalalign="left" />
                                                        </asp:BoundColumn>
                                                        <asp:BoundColumn DataField="PartyA" HeaderText="PartyA">
                                                            <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="10%" />
                                                            <HeaderStyle BorderColor="#394f66" BorderStyle="Solid" BorderWidth="1px" Font-Bold="true"
                                                                Horizontalalign="left" />
                                                        </asp:BoundColumn>
                                                        <asp:BoundColumn DataField="PartyAName" HeaderText="甲方代表">
                                                            <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="10%" />
                                                            <HeaderStyle BorderColor="#394f66" BorderStyle="Solid" BorderWidth="1px" Font-Bold="true"
                                                                Horizontalalign="left" />
                                                        </asp:BoundColumn>
                                                        <asp:BoundColumn DataField="PartyB" HeaderText="PartyB">
                                                            <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="10%" />
                                                            <HeaderStyle BorderColor="#394f66" BorderStyle="Solid" BorderWidth="1px" Font-Bold="true"
                                                                Horizontalalign="left" />
                                                        </asp:BoundColumn>
                                                        <asp:BoundColumn DataField="PartyBName" HeaderText="乙方代表">
                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="10%" />
                                                            <HeaderStyle BorderColor="#394f66" BorderStyle="Solid" BorderWidth="1px" Font-Bold="true"
                                                                Horizontalalign="left" />
                                                        </asp:BoundColumn>
                                                        <asp:BoundColumn DataField="SignDate" HeaderText="签署日期" DataFormatString="{0:yyyy-MM-dd}">
                                                            <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="10%" />
                                                            <HeaderStyle BorderColor="#394f66" BorderStyle="Solid" BorderWidth="1px" Font-Bold="true"
                                                                Horizontalalign="left" />
                                                        </asp:BoundColumn>
                                                        <asp:BoundColumn DataField="EffectiveDate" HeaderText="生效日期" DataFormatString="{0:yyyy-MM-dd}">
                                                            <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="10%" />
                                                            <HeaderStyle BorderColor="#394f66" BorderStyle="Solid" BorderWidth="1px" Font-Bold="true"
                                                                Horizontalalign="left" />
                                                        </asp:BoundColumn>
                            ...
                            <table cellpadding="2" cellspacing="0" class="formBgStyle" width="900px">
                                ...
                                <tr>
                                    <td  style="width: 15%;" class="formItemBgStyleForAlignLeft">
                                        <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,QiaTanHeTong%>"></asp:Label>：</td>
                                    <td  style="width: 35%;" class="formItemBgStyleForAlignLeft">
                                        <asp:DropDownList ID="DL_ContractDiscussID" runat="server" DataTextField="Name" DataValueField="ID" AutoPostBack="True" OnSelectedIndexChanged="DL_ContractDiscussID_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </td>
                                    <td class="formItemBgStyleForAlignRight" style="width: 15%;">
                                        <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,YiFang%>"></asp:Label>：</td>
                                    <td class="formItemBgStyleForAlignLeft" style="width: 35%;">
                                        <asp:TextBox ID="TB_PartyB" runat="server" Enabled="False" CssClass="shuru"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr style="color: #000000">
                                    <td  style="width: 15%;" class="formItemBgStyleForAlignLeft">
                                        <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,JiaFang%>"></asp:Label>：</td>
                                    <td  style="width: 35%;" class="formItemBgStyleForAlignLeft">
                                        <asp:TextBox ID="TB_PartyA" runat="server" CssClass="shuru" Width="99%"></asp:TextBox>
                                    </td>
                                    <td class="formItemBgStyleForAlignRight" style="width: 15%;">
                                        <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,YiFangDaiBiao%>"></asp:Label>：</td>
                                    <td class="formItemBgStyleForAlignLeft" style="width: 35%;">
                                        <asp:TextBox ID="TB_PartyBName" runat="server" CssClass="shuru" Width="99%"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr style="color: #000000">
                                    <td class="formItemBgStyleForAlignRight" style="width: 150px; height: 30px">
                                        <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,JiaFangDaiBiao%>"></asp:Label>： </td>
                                    <td class="formItemBgStyleForAlignLeft" style="height: 30px">
                                        <asp:TextBox ID="TB_PartyAName" runat="server" CssClass="shuru"></asp:TextBox>
                                    </td>
                                    <td class="formItemBgStyleForAlignRight" style="height: 30px">
                                        <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,QianShuRiQi%>"></asp:Label>：</td>
                                    <td class="formItemBgStyleForAlignLeft" style="height: 30px">
                                        <asp:TextBox ID="DLC_SignDate" runat="server" ReadOnly="false"></asp:TextBox>
                                        <cc1:CalendarExtender ID="CalendarExtender3" runat="server" Format="yyyy-MM-dd" TargetControlID="DLC_SignDate">
                                        </cc1:CalendarExtender>
                                    </td>
                                </tr>
                                <tr style="color: #000000">
                                    <td class="formItemBgStyleForAlignRight" style="width: 150px; height: 30px">
                                        <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,ShengXiaoRiQi%>"></asp:Label>：</td>
                                    <td class="formItemBgStyleForAlignLeft" style="height: 30px">
                                        <asp:TextBox ID="DLC_EffectiveDate" runat="server" ReadOnly="false"></asp:TextBox>
                                        <cc1:CalendarExtender ID="DLC_EffectiveDate_CalendarExtender" runat="server" Format="yyyy-MM-dd" TargetControlID="DLC_EffectiveDate">
                                        </cc1:CalendarExtender>
                                    </td>
                                    <td class="formItemBgStyleForAlignRight" style="height: 30px">&nbsp;</td>
                                    <td class="formItemBgStyleForAlignLeft" style="height: 30px">
                                        <asp:Label ID="lbl_SupplierCode" runat="server" Visible="False"></asp:Label>
                                    </td>
                                </tr>
