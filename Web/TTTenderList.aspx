<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTTenderList.aspx.cs" Inherits="TTTenderList" %>
                                            ...
                                            <table cellpadding="2" cellspacing="0" class="formBgStyle" width="75%">
                                                <tr>
                                                   <td align="center">
                                                        ...
                                                        <asp:Label ID="Label34" runat="server" Text="<%$ Resources:lang,ZhaoBiaoBianHao%>"></asp:Label>
                                                        <asp:TextBox ID="TXT_TenderCode" runat="server" Width="100px"></asp:TextBox>
                                                        <asp:Label ID="Label35" runat="server" Text="<%$ Resources:lang,XiangMuMingCheng%>"></asp:Label>
                                                        <asp:TextBox ID="TXT_ProjectName" runat="server" Width="200px"></asp:TextBox>
                                            ...
                                            <table background="ImagesSkin/main_n_bj.jpg" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    ...
                                                    <td width="26%" align="left">
                                                        <strong>
                                                            <asp:Label ID="Label40" runat="server" Text="<%$ Resources:lang,XiangMuSuoSuoZhuanYe%>"></asp:Label></strong>
                                                    </td>
                            ...
                            <tr>
                                <td valign="middle" style="width: 50%; border-right: solid 1px #D8D8D8; padding: 2px 2px 2px 2px;">
                                    <table class="formBgStyle" cellpadding="3" cellspacing="0" style="width: 98%; margin-top: 2px; background-color: white;"
                                        ...
                                        <tr>
                                            <td style="text-align: left;">
                                                <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,QiaoBiaoRen%>"></asp:Label>：</td>
                                            <td align="left" colspan="3">
                                        ...
                                        <tr>
                                            <td style="text-align: left;">
                                                <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,XiangMuJingLi%>"></asp:Label>：</td>
                        ...
                        <table cellpadding="3" cellspacing="0" class="formBgStyle" width="100%">
                            ...
                            <tr style="font-size: 10pt">
                                ...
                                <td class="formItemBgStyleForAlignLeft" colspan="2" style="height: 10px; ">
                                    ...
                                    <strong>
                                        <asp:Label ID="Label36" runat="server" Text="<%$ Resources:lang,TouBiaoLiuChengShenQing%>"></asp:Label>：</strong>
                                </td>
                            </tr>
