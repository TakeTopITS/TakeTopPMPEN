    ...
    <center>
        <form id="form1" runat="server">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <div id="AboveDiv" style="width:100%;padding: 5px 5px 5px 5px;">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td colspan="2" style="width: 100%; height: 80px; font-size: xx-large;" align="center">
                                    <br />
                                    <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ChaXunJeGuo%>"></asp:Label>
                                    <br />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:DataGrid ID="DataGrid1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="Both" Height="1px" ShowHeader="true"  HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                    </asp:DataGrid>
                                    <br />
                                    <br />
                                </td>
