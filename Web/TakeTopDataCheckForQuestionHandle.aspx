                ...
                <ContentTemplate>
                    <div id="AboveDiv" style="width:100%;padding: 5px 5px 5px 5px;">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:DataGrid ID="DataGrid1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="Both" Height="1px" ShowHeader="true"  HeaderStyle-Horizontalalign="left" ItemStyle-Horizontalalign="left">
                                    </asp:DataGrid>
                                    <br />
                                    <br />
                                </td>
