<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTAssetUserRecordList.aspx.cs"
    Inherits="TTAssetUserRecordList" %>
                                            ...
                                            <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ZiChanTiaoPeiJiLu%>"></asp:Label>
                                                    </td>
                                                    <td width="5">
