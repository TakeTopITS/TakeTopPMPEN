<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTProjectRelatedReqMain.aspx.cs"
    Inherits="TTProjectRelatedReqMain" %>
                                    ...
                                    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td style="text-align: right; padding-top: 5px; padding-right: 5px;">
                                                ...
                                                <asp:Button ID="BT_RecordDefect" runat="server" CssClass="inpuYello" Text="<%$ Resources:lang,RecordRequirement %>" OnClick="BT_RecordDefect_Click" />
