<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTGoodsApplicationOrderForFilling.aspx.cs" Inherits="TTGoodsApplicationOrderForFilling" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,ShengChanBuLiaoDan%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td width="5%" align="left">
                                                            <strong>
                                                                <asp:Label ID="Label85" runat="server" Text="<%$ Resources:lang,BianJi %>" /></strong>
                                                        </td>
                                                        <td width="5%" align="left">
                                                            <strong>
                                                        ...
                                                        <td width="10%" align="left">
                                                            <strong>
                                                                <asp:Label ID="Label87" runat="server" Text="<%$ Resources:lang,FaQiShengQing%>" /></strong>
                                                        </td>
                                                        ...
                                                        <td align="left" width="20%">
                                                            <strong>
                                                                <asp:Label ID="Label59" runat="server" Text="<%$ Resources:lang,ShiJian%>"></asp:Label></strong>
                                                        </td>
                                ...
                                <tr>
                                    <td align="left" style="width: 60%;">
                                        <table class="formBgStyle" cellpadding="3" cellspacing="0" style="width: 98%;"
                                            ...
                                            <tr>
                                                <td class="formItemBgStyleForAlignLeft">
                                                    <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,ShenQingShiJian%>"></asp:Label>： </td>
                                                <td class="formItemBgStyleForAlignLeft">
                                                ...
                                                <td class="formItemBgStyleForAlignLeft">
                                                    <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,YaoQiuWanChengShiJian%>"></asp:Label>： </td>
                                                <td class="formItemBgStyleForAlignLeft">
                                            ...
                                            <tr>
                                                <td class="formItemBgStyleForAlignLeft">
                                                    <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,GuanLian%>"></asp:Label>：
                                                </td>
                                                <td class="formItemBgStyleForAlignLeft">
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="5%" align="left">
                                                                            <strong>
                                                                                <asp:Label ID="Label57" runat="server" Text="<%$ Resources:lang,BianJi %>" /></strong>
                                                                        </td>
                                                                        <td width="5%" align="left">
                                                                            <strong>
                                                                                <asp:Label ID="Label72" runat="server" Text="<%$ Resources:lang,ShanChu %>" /></strong>
                                                                        </td>
                                                                        ...
                                                                        <td width="10%" align="left"><strong>
                                                                            ...
                                                                            <asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,JinE %>"></asp:Label></strong> </td>
                                    ...
                                    <td width="50%">
                                        <table class="formBgStyle" style="width: 100%;" cellpadding="3" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td class="formItemBgStyleForAlignLeft">
                                                    <asp:Label ID="Label83" runat="server" Text="<%$ Resources:lang,LeiXing %>"></asp:Label>：
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="formItemBgStyleForAlignLeft">
                                                    ...
                                                    <asp:Label ID="Label26" runat="server" Text="<%$ Resources:lang,LiaoPinDaiMa %>"></asp:Label>： </td>

                                                <td colspan="3" class="formItemBgStyleForAlignLeft" style="height: 19px;">

                                                    <asp:TextBox ID="TB_GoodsCode" runat="server" Width="80px"></asp:TextBox></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="formItemBgStyleForAlignLeft">
                                                    ...
                                                    <asp:Label ID="Label32" runat="server" Text="<%$ Resources:lang,PinPai %>"></asp:Label>： </td>
                                        ...
                                        <cc1:TabContainer CssClass="ajax_tab_menu" ID="TabContainer2" runat="server" ActiveTabIndex="0"
                                            ...
                                            <cc1:TabPanel ID="TabPanel8" runat="server">
                                                ...
                                                <HeaderTemplate>
                                                    ...
                                                    <asp:Label ID="Label43" runat="server" Text="<%$ Resources:lang,LiaoPinKuCunLieBiao%>"></asp:Label>
                                                </HeaderTemplate>

                                                <ContentTemplate>

                                                    <asp:Label ID="Label44" runat="server" Text="<%$ Resources:lang,QingXuanQuYaoXiaoShouDeLiaoPin %>"></asp:Label>：<asp:Label ID="Label2" runat="server" Visible="False"></asp:Label>
                                                                    ...
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="10%" align="left"><strong>
                                                                                ...
                                                                                <asp:Label ID="Label51" runat="server" Text="<%$ Resources:lang,ShuLiang %>"></asp:Label></strong> </td>

                                                                            <td width="6%" align="left"><strong>

                                                                                <asp:Label ID="Label52" runat="server" Text="<%$ Resources:lang,DanWei %>"></asp:Label></strong> </td>

                                                                            <td align="left"><strong>

                                                                                <asp:Label ID="Label53" runat="server" Text="<%$ Resources:lang,DanJia %>"></asp:Label></strong> </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                            ...
                                            <cc1:TabPanel ID="TabPanel6" runat="server" TabIndex="1">
                                                ...
                                                <ContentTemplate>
                                                    ...
                                                    <asp:Label ID="Label54" runat="server" Text="<%$ Resources:lang,QingXuanQuYaoXRuKuDeLiaoPin %>"></asp:Label>：
                                                                    ...
                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" width="15%"><strong>
                                                                                ...
                                                                                <asp:Label ID="Label65" runat="server" Text="<%$ Resources:lang,GuiGe %>"></asp:Label></strong> </td>

                                                                            <td width="10%" align="left"><strong>
                                                                                <asp:Label ID="Label50" runat="server" Text="<%$ Resources:lang,PinPai %>"></asp:Label></strong> </td>

                                                                            <td align="left" width="8%"><strong>

                                                                                <asp:Label ID="Label66" runat="server" Text="<%$ Resources:lang,ShuLiang %>"></asp:Label></strong> </td>
                                                                    ...
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="10%" align="left"><strong>
                                                                                ...
                                                                                <asp:Label ID="Label68" runat="server" Text="<%$ Resources:lang,DaiMa %>"></asp:Label></strong> </td>
                                                                            ...
                                                                            <td width="10%" align="left"><strong>
                                                                                ...
                                                                                <asp:Label ID="Label70" runat="server" Text="<%$ Resources:lang,XingHao %>"></asp:Label></strong> </td>

                                                                            <td width="14%" align="left"><strong>

                                                                                <asp:Label ID="Label71" runat="server" Text="<%$ Resources:lang,GuiGe %>"></asp:Label></strong> </td>

                                                                            <td width="10%" align="left"><strong>
                                                                                <asp:Label ID="Label215" runat="server" Text="<%$ Resources:lang,PinPai %>"></asp:Label></strong> </td>
                                                                            <td width="6%" align="left"><strong>

                                                                                <asp:Label ID="Label73" runat="server" Text="<%$ Resources:lang,ShuLiang %>"></asp:Label></strong> </td>

                                                                            <td width="6%" align="left"><strong>

                                                                                <asp:Label ID="Label74" runat="server" Text="<%$ Resources:lang,DanWei %>"></asp:Label></strong> </td>

                                                                            <td width="10%" align="left"><strong>

                                                                                <asp:Label ID="Label75" runat="server" Text="<%$ Resources:lang,XiaDanShiJian %>"></asp:Label></strong> </td>

                                                                            <td width="10%" align="left"><strong>

                                                                                <asp:Label ID="Label76" runat="server" Text="<%$ Resources:lang,XuQiuShiJian %>"></asp:Label></strong> </td>

                                                                            <td width="10%" align="left"><strong>

                                                                                <asp:Label ID="Label77" runat="server" Text="<%$ Resources:lang,GongYi %>"></asp:Label></strong> </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td align="left" style="width: 100px; height: 6px; text-align: right;">
                                        ...
                                        <asp:Label ID="Label33" runat="server" Text="<%$ Resources:lang,LiuChengMuBan%>"></asp:Label>： </td>
                                    ...
                                    <td align="left" style="width: 550px; height: 6px">
                                        ...
                                        </asp:DropDownList><asp:Label ID="Label34" runat="server" Text="<%$ Resources:lang,LeiXing%>"></asp:Label>：

                                                                                    <asp:DropDownList ID="DL_WFType" runat="server">

                                                                                        <asp:ListItem Value="ProductionReplenishment" Text="<%$ Resources:lang,ShengChanBuLiao%>" />
                                                                                    </asp:DropDownList><asp:HyperLink ID="HL_WLTem" runat="server" NavigateUrl="~/TTWorkFlowTemplate.aspx"
                                                                                        Target="_blank">
                                                                                        <asp:Label ID="Label35" runat="server" Text="<%$ Resources:lang,MoBanWeiHu%>"></asp:Label>
                                    ...
                                    <td align="left" colspan="2" style="height: 6px; text-align: right;">
                                        ...
                                        <table width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" style="width: 550px; height: 27px"><span style="font-size: 10pt">（<asp:Label ID="Label36" runat="server" Text="<%$ Resources:lang,YaoQiuShouDaoXingXi%>"></asp:Label>：</span><asp:CheckBox ID="CB_SMS" runat="server"
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" style="height: 22px; text-align: left;">
                                                    ...
                                                    <asp:Label ID="Label37" runat="server" Text="<%$ Resources:lang,DuiYingGongZuoLiuLieBiao%>"></asp:Label>： </td>
                                            </tr>
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="50%" align="left"><strong>
                                                                            ...
                                                                            <asp:Label ID="Label39" runat="server" Text="<%$ Resources:lang,GongZuoLiu%>"></asp:Label></strong> </td>

                                                                        <td width="20%" align="left"><strong>

                                                                            <asp:Label ID="Label40" runat="server" Text="<%$ Resources:lang,ShenQingShiJian%>"></asp:Label></strong> </td>
                            ...
                            <table>
                                <tr>
                                    <td style="width: 420px; padding: 5px 5px 5px 5px;" valign="top" align="left">
                                        <asp:Label ID="Label78" runat="server" Text="<%$ Resources:lang,LCSQSCHYLJDLCJHYMQJHM%>"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
