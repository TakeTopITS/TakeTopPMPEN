<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTProjectDefectmentHandlePage.aspx.cs" Inherits="TTProjectDefectmentHandlePage" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,XiangMuQueXianGuanLi%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                ...
                                <td valign="top" style="padding: 0px 5px 5px 5px;">
                                    <cc2:TabContainer CssClass="ajax_tab_menu" ID="TabContainer2" runat="server" ActiveTabIndex="0" Width="100%">
                                        ...
                                        <cc2:TabPanel ID="TabPanel3" runat="server" HeaderText="我建立的任务：">
                                            <HeaderTemplate>
                                                <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,WoDeQueXian%>"></asp:Label>
                                            </HeaderTemplate>
                                            <ContentTemplate>
                                                        ...
                                                        <td style="text-align: left; padding: 5px 5px 5px 5px">
                                                            ...
                                                            <asp:DataGrid ID="DataGrid5" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateColumn>
                                                                        <ItemTemplate>
                                                                            <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# DataBinder.Eval(Container, "DataItem.DefectID", "TTDocumentTreeView.aspx?RelatedType=Req&RelatedID={0}") %>'
