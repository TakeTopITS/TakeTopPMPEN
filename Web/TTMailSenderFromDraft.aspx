<%@ Page Language="C#"  ValidateRequest="false" CodeFile="TTMailSenderFromDraft.aspx.cs" Inherits="TTMailSenderFromDraft" %>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" class="bian">
                                            ...
                                            <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,FaSongYouJian%>"></asp:Label>
                                                    </td>
                                                    <td width="5">
                        ...
                        <tr>
                            <td valign="top" style="padding: 10px 5px 10px 5px;">
                                <table align="left" cellspacing="0" cellpadding="3" width="98%" border="0" class="formBgStyle">
                                    <tr style="line-height: 2;">
                                        <td style="width: 108px;"  class="formItemBgStyleForAlignLeft"></td>
                                        <td class="formItemBgStyleForAlignLeft">
                                            <asp:Button ID="SenderBtn" runat="server" Text="<%$ Resources:lang,FaSong%>" CssClass="inpu" OnClick="NewBtn_Click" />&nbsp;&nbsp;<asp:Button ID="BT_Save" runat="server" CssClass="inpu" Text="<%$ Resources:lang,BaoCun%>" OnClick="BT_Save_Click" />
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <asp:Button
                                ...
                                <tr style="line-height: 2;">
                                    <td style="width: 108px"  class="formItemBgStyleForAlignLeft">
                                ...
                                <tr style="line-height: 2;">
                                    ...
                                    <tr style="line-height: 2;">
                                        ...
                                        <td class="formItemBgStyleForAlignLeft">
                                            <input id="HtmlCB" type="checkbox" runat="server" checked="CHECKED" /><asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,HTMLGeShi%>"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr style="line-height: 2;">
                                        <td style="width: 108px; height: 1px;"  valign="top" class="formItemBgStyleForAlignLeft">
                                            <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,NeiRong%>"></asp:Label>:
                                        </td>
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <div>
                                                        ...
                                                        <br />
                                                        <span style="font-size: xx-small; color: #FF3300;">（<asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,ZWBJMBNCG10GHZ%>"></asp:Label>）</span>
                                                        <br />
                                                        <div id="ProgressBar">
                                            ...
                                            <asp:Panel ID="Panel_BigAttachment" runat="server" Style="width: 90%;" Visible="true">
                                                <div>
                                                    ...
                                                    <span style="font-size: xx-small; color: #FF3300;">（<asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,DaFuJian%>"></asp:Label>[</span><span
                                                        style="font-size: xx-small; color: #3333CC;"><asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,YBDY2M%>"></asp:Label></span>]<span
                                                            style="font-size: xx-small; color: #FF3300;"><asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,XTHZDZYJZWDBZJLJGSJFXZ%>"></asp:Label>） </span>
                                                </div>
                                            </asp:Panel>
                                        </td>
                                    </tr>
