...
public partial class TTQMMatEquInspection : System.Web.UI.Page
{
    ...
    protected void Add()
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "alert('" + LanguageHandle.GetWord("ZZJGGCGHTYYSCZSBJC") + "')", true);
            DL_PurchasingContractCode.Focus();
            return;
        }
    ...
    protected void Delete()
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "alert('" + LanguageHandle.GetWord("ZZGYSDYBDYWFSC") + "')", true);
            return;
        }
