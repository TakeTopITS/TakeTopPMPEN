<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTAssetImport.aspx.cs" Inherits="TTAssetImport" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,ZCQCSJDR%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                                                                     ...
                                                                                     <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                                                                         <ContentTemplate>
                                                                                             <div>
                                                                                                 ...
                                                                                                 <asp:Label ID="Label27" runat="server"></asp:Label><asp:Label ID="Label28" runat="server" Text="<%$ Resources:lang,SJDRMBGS%>"></asp:Label>：<a href="Template/资产期初数据导入模板.xls"><asp:Label ID="Label29" runat="server" Text="<%$ Resources:lang,QCSJDRMB%>"></asp:Label></a>
                                                                                                 <div id="ProgressBar">
