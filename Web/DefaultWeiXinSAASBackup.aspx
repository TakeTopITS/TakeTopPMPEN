                ...
                <ContentTemplate>
                    <div id="AboveDiv">
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="center">
                                    <asp:TextBox ID="TB_UserCode" runat="server" Text="«Î ‰»Îƒ„µƒµ«¬º’ ∫≈(UserCode)" onFocus="javascript:this.value='';document.getElementById('LB_ErrorMsg').style.display = 'none';" ForeColor="#cdcccc" class="dengl" Width="103%"></asp:TextBox>
