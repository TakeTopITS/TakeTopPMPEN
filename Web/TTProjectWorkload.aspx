                                    ...
                                    <td>
                                        <table width="100%" cellpadding="2" cellspacing="0" class="formBgStyle">
                                            <tr>
                                                ...
                                                <td style="width: 15%;" class="formItemBgStyle"><asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,GongZuoLiang%>" />：</td>
                                                ...
                                                <td style="width: 15%;" class="formItemBgStyle"><asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,DanJia%>" />：</td>
                                                <td style="text-align: left" class="formItemBgStyle">
                                                    <%@ Register Assembly="NickLee.Web.UI" Namespace="NickLee.Web.UI" TagPrefix="NickLee" %>
