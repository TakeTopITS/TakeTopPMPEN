    ...
    <script type="text/javascript" language="javascript">
        ...
        function clickMember(resultList) {
            ...
            if (resultList != "" && resultList != undefined) {
                ...
                window.parent.document.getElementById("HF_Department").value = arrResult[0];

                //$("#TXT_PickingUnit").val(arrResult[1]);
                //$("#TXT_UnitCode").val(arrResult[0]);
                //$("#HF_Department").val(arrResult[0]);

                window.parent.document.getElementById("BT_Department").click();
            }
