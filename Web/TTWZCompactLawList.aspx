<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTWZCompactLawList.aspx.cs" Inherits="TTWZCompactLawList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>合同-法人代表页面</title>
                                                                    ...
                                                                    <Columns>
                                                                        <asp:TemplateColumn>
                                                                            ...
                                                                            <ItemTemplate>
                                                                                ...
                                                                                <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"CompactCode") %>' CommandName="approve" CssClass="notTab" Visible='<%# Eval("Progress").ToString()=="生效" ? true : false %>'>批准</asp:LinkButton>
                                                                                <asp:LinkButton ID="LinkButton2" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"CompactCode") %>' CommandName="notApprove" CssClass="notTab" Visible='<%# Eval("Progress").ToString()=="生效" ? true : false %>'>退回</asp:LinkButton>
