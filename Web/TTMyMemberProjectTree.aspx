<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTMyMemberProjectTree.aspx.cs"
    Inherits="TTMyMemberProjectTree" %>
                        ...
                        <tr>
                            <td>
                                <table cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td valign="top" width="300" style="padding: 5px 5px 0px 5px; border-right: solid 1px #D8D8D8" align="left">
                                                                ...
                                                                <table style="width: 100%;" cellpadding="4" cellspacing="0" class="bian">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="width: 20%; text-align: right">
                                                                            <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,FeiYongYuSuan%>"></asp:Label>£º
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: right">
                                                                            <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,RenLiYuSuan%>"></asp:Label>£º
                                                                        </td>
                                                                        <td style="text-align: left">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: right;">
                                                                            <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,GongShiYuSuan%>"></asp:Label>£º
                                                                        </td>
                                                                        <td style="text-align: left">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: right">
                                                                            <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,JieShuRiQi%>"></asp:Label>£º
                                                                        </td>
                                                                        <td style="text-align: left">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: right">
                                                                            <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,ZhuangTai%>"></asp:Label>£º
                                                                        </td>
