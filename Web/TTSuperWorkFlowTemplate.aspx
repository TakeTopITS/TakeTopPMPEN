                                                                    ...
                                                                    <td>
                                                                        <table>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:Label ID="Label63" runat="server" Text="自动激活"></asp:Label>：
                                                                                </td>
                                                                                <td>
                                                                                ...
                                                                                <td>
                                                                                    <asp:Label ID="Label67" runat="server" Text="超"></asp:Label>
                                                                                </td>
                                                                                <td>
                                                                                ...
                                                                                <td>
                                                                                    <asp:Label ID="Label69" runat="server" Text="小时自动批准"></asp:Label>
                                                                                </td>
                                                                                <td>
