                    ...
                    <table cellpadding="0" cellspacing="0" width="980px">
                        <tr>
                            <td>
                                <table style="width: 100%;">
                                    <tr>
                                        <td style="width: 100%; height: 80px; font-size: xx-large; text-align: center;">
                                            <br />
                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,JSYCCLCBB%>"></asp:Label>
                                            <br />
                                        </td>
                                    </tr>
                                    <tr>
                                            ...
                                            <table style="width: 90%;">
                                                <tr>
                                                    <td style="text-align: right;">
                                                        <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,CXTJKSSJ%>"></asp:Label>：
                                                    </td>
                                                    <td>

                                                        <asp:TextBox ID="DLC_StartTime" ReadOnly="false" runat="server"></asp:TextBox>
                                                        <ajaxToolkit:CalendarExtender Format="yyyy-MM-dd" ID="CalendarExtender4" runat="server" TargetControlID="DLC_StartTime">
                                                        </ajaxToolkit:CalendarExtender>
                                                    </td>
                                                    <td style="text-align: right;">
                                                        <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,JieShuShiJian%>"></asp:Label>：
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td style="text-align: right;">
                                                        <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,SiJi%>"></asp:Label>：</td>
                                                    <td>
                                ...
                                <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,ZongLiCheng%>"></asp:Label>：<asp:Label ID="LB_TotalMileage" runat="server"></asp:Label>
                                        </td>
                                    </tr>
