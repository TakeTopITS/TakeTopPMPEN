                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:DropDownList ID="DL_ProjectBasis" runat="server">
                                                                                ...
                                                                                <asp:ListItem Value="NoticeOfAward" Text="NoticeOfAward"> </asp:ListItem>
                                                                                <asp:ListItem Value="NoticeOfSuccessfulBid" Text="NoticeOfSuccessfulBid"> </asp:ListItem>
                                                                                <asp:ListItem Value="MeetingMinutes" Text="MeetingMinutes"> </asp:ListItem>
                                                                                <asp:ListItem Value="RequestOrInstruction" Text="RequestOrInstruction"> </asp:ListItem>
