<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTPersonalSpaceMembersWebAddress.aspx.cs" Inherits="TTPersonalSpaceMembersWebAddress" %>
                            ...
                            <td valign="top" style="padding: 1px 1px 1px 10px;">
                                <div class="nTabr">
                                    ...
                                    <div class="TabTitle">
                                        <ul id="myTab5r">
                                            ...
                                            <li class="normal" onmouseover="nTabs(this,1);" style="display: block; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                                                <asp:Label ID="LB_DepartmentMember" runat="server" Text="<%$ Resources:lang,DepartmentMember%>" />
                                            </li>
                                    ...
                                    <div class="TabContent">
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td align="left" colspan="2">
                                                        <div class="reny">
                                                            <ul>
                                                                <asp:Repeater ID="RP_MyDepartmentMember" runat="server">
                                                                    <ItemTemplate>
                                                                        <li><a href='TTUserInforSimple.aspx?UserCode=<%# DataBinder.Eval(Container.DataItem,"UserCode") %>'
                                                                            target="_blank">
                                                                            <%# DataBinder.Eval(Container.DataItem,"UserName") %>
                                        ...
                                        <div id="myTab5r_Content2" class="none">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td align="left" colspan="2">
                                                        <div class="reny">
