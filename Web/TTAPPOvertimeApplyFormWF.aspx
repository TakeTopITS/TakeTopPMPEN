<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTAPPOvertimeApplyFormWF.aspx.cs" Inherits="TTAPPOvertimeApplyFormWF" %>
    ...
    <center>
        <form id="form1" runat="server">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <div id="AboveDiv">
                        <table id="AboveTable" cellpadding="0" width="130%" cellspacing="0" class="bian">
                            <tr>
