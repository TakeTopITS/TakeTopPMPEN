<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTUserKPIReviewByHR.aspx.cs"
    Inherits="TTUserKPIReviewByHR" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,YuanGongJiXiaoPingShen%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="top" width="180px" style="padding: 5px 5px 0px 5px; border-left: solid 1px #D8D8D8; border-right: solid 1px #D8D8D8;">
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td width="5%" align="center">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,BuMenChengYuan%>"></asp:Label></strong>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                            ...
                                                            <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" OnItemCommand="DataGrid1_ItemCommand"
                                                                ShowHeader="false" Width="180px" Height="1px" CellPadding="4" ForeColor="#333333"
                                                                GridLines="None">
                                                             ...
                                                             <table class="formBgStyle" style="width: 100%; text-align: left;" cellpadding="3"
                                                                ...
                                                                <tr>
                                                                    <td width="100px" align="right" class="formItemBgStyle">
                                                                        <asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,ZiPingZongFen%>"></asp:Label>：
                                                                    </td>
                                                                    ...
                                                                    <td width="100px" align="right" class="formItemBgStyle">
                                                                        <asp:Label ID="Label22" runat="server" Text="<%$ Resources:lang,LingDaoPingZongFen%>"></asp:Label>：
                                                                    </td>
                                                                    <td class="formItemBgStyle">
                                                                        <b>
                                                                    ...
                                                                    <td width="100px" align="right" class="formItemBgStyle">
                                                                        <asp:Label ID="Label23" runat="server" Text="<%$ Resources:lang,DiSanFangPingZongFen%>"></asp:Label>：
                                                                    </td>
                                                                    ...
                                                                    <td align="right" class="formItemBgStyle" width="100px">
                                                                        <asp:Label ID="Label24" runat="server" Text="<%$ Resources:lang,XiTongZongPingFen%>"></asp:Label>：</td>
                                                                    <td align="left" class="formItemBgStyle"><b>
                                                                        <asp:Label ID="LB_TotalSqlPoint" runat="server"></asp:Label>
                                                                    </b></td>
                                                                    <td width="100px" align="right" class="formItemBgStyle">
                                                                        <asp:Label ID="Label25" runat="server" Text="<%$ Resources:lang,RenShiZongPingFen%>"></asp:Label>：
                                                                    </td>
                                                                    <td class="formItemBgStyle">
                                                                        <b>
                                                                    ...
                                                                    <td width="100px" align="right" class="formItemBgStyle">
                                                                        <asp:Label ID="Label26" runat="server" Text="<%$ Resources:lang,ZongPingFen%>"></asp:Label>：
                                                                    </td>
                                                                    <td class="formItemBgStyle">
                                                                        <b>
                                                                    ...
                                                                    <td width="100px" align="left" class="formItemBgStyle">
                                                                        <b>
                                                                            <asp:Label ID="LB_Status" runat="server"></asp:Label></b>
                                                                    </td>
                            ...
                            <table class="formBgStyle" style="width: 100%; text-align: left;" cellpadding="3"
                                ...
                                <tr>
                                    <td width="60px" align="right" class="formItemBgStyle">
                                          <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,PingFen%>"></asp:Label>：
                                    </td>
                                    <td width="50%" align="left" class="formItemBgStyle">
                                       <NickLee:NumberBox MaxAmount="1000000000000" MinAmount="-1000000000000" ID="NB_HRPoint" runat="server" Width="53px">0.00</NickLee:NumberBox>
                                       <asp:Label ID="LB_KPIID" runat="server" Visible="false"></asp:Label>
                                    </td>
                                    <td align="left" class="formItemBgStyle" rowspan="2">
                                        <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,PingHeYiJian%>"></asp:Label>：
                                        <asp:DataList ID="DataList1" runat="server" CellPadding="0" ForeColor="#333333" Height="16px"
                                            ...
                                            <ItemTemplate>
                                                <table cellpadding="4" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td align="left">
                                                            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,ZiPing%>"></asp:Label>：
                                                        </td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <asp:DataList ID="DataList3" runat="server" CellPadding="0" ForeColor="#333333" Height="16px"
                                            ...
                                            <ItemTemplate>
                                                <table cellpadding="4" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td align="left">
                                                            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,DiSanFangPing%>"></asp:Label>：
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" class="tdLeft" style="color: Blue; font-style: italic;">
                                                            <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,PingHeRen%>"></asp:Label>：
                                        ...
                                        <asp:DataList ID="DataList2" runat="server" CellPadding="0" ForeColor="#333333" Height="16px"
                                            ...
                                            <ItemTemplate>
                                                <table cellpadding="4" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td align="left">
                                                            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,LingDaoPing%>"></asp:Label>：
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" class="tdLeft" style="color: Blue; font-style: italic;">
                                                            <asp:Label ID="Label28" runat="server" Text="<%$ Resources:lang,PingHeRen%>"></asp:Label>：<%#DataBinder.Eval(Container.DataItem, "LeaderName")%><br /><%#DataBinder.Eval(Container.DataItem, "Comment")%></td>
                                                    </tr>
                                                </table>
                                            </ItemTemplate>
                                            <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                        ...
                                        <asp:DataList ID="DataList4" runat="server" CellPadding="0" ForeColor="#333333" Height="16px"
                                            ...
                                            <ItemTemplate>
                                                <table cellpadding="4" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td align="left">
                                                            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,RenShiPing%>"></asp:Label>：
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" class="tdLeft" style="color: Blue; font-style: italic;">
                                                            <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,PingHeRen%>"></asp:Label>：<%#DataBinder.Eval(Container.DataItem, "HRName")%><br /><%#DataBinder.Eval(Container.DataItem, "Comment")%></td>
                                                    </tr>
                                                </table>
                                            </ItemTemplate>
                                            <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                ...
                                <tr>
                                    ...
                                    <td align="left" valign="top" class="formItemBgStyle">
                                        <CKEditor:CKEditorControl ID="HE_HRSummary" runat="server" Height="150px" Width="98%" Visible="false" />
                                        <CKEditor:CKEditorControl runat="server" ID="HT_HRSummary" Width="98%" Height="150px" Visible="False" />
