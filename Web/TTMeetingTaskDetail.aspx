<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTMeetingTaskDetail.aspx.cs" Inherits="TTMeetingTaskDetail" %>
                                                            ...
                                                            <table style="width: 98%;">
                                                                <tr>
                                                                    <td colspan="2" style="text-align: left;">
                                                                        <span class="style1">
                                                                            <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,RenWuFenPaiJiLuZiLiao%>"></asp:Label>：</span>（<asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,GuanLianHuiYi%>"></asp:Label>：<asp:HyperLink ID="HL_RelatedMeetingID"
                                                                                runat="server" Target="_blank"></asp:HyperLink>

                                                                        <asp:HyperLink ID="HL_RelatedMeetingName" runat="server" Target="_blank"></asp:HyperLink>，
                                                                         &nbsp;
                                                                                            ...
                                                                                            <td style="width: 100%;" align="left" class="formItemBgStyle">
                                                                                                <table width="100%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td style="text-align: Left;" class="formItemBgStyle">
                                                                                                            ...
                                                                                                            <asp:HyperLink ID="HL_Expense" runat="server" NavigateUrl="TTProExpense.aspx" Target="_blank">
                                                                                                                <asp:Label ID="Label47" runat="server" Text="<%$ Resources:lang,FeiYongMingXi %>"></asp:Label>
                                                                                                            </asp:HyperLink>
                                                                                                        ...
                                                                                                        <NickLee:NumberBox MaxAmount="1000000000000" MinAmount="-1000000000000" ID="NB_ManHour" runat="server" OnBlur="" OnFocus="" OnKeyPress=""
                                                                                                            ...
                                                                                                            &nbsp;&nbsp;<asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,JinDu %>"></asp:Label>：<NickLee:NumberBox MaxAmount="1000000000000" MinAmount="-1000000000000" ID="NB_FinishPercent" runat="server" OnBlur="" OnFocus="" OnKeyPress=""
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td style="width: 10%;" class="formItemBgStyle">
                                                                                                            <asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,GongZuoZongJie %>"></asp:Label>：
                                                                                                        </td>
                                                                                    ...
                                                                                    <table width="98%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td style="width: 100%; text-align: left;" class="formItemBgStyle">
                                                                                                ...
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label28" runat="server" Text="<%$ Resources:lang,YJXFPRWQXZSLRHSRGZYQ %>"></asp:Label>：<asp:Label ID="LB_ID" runat="server" Visible="False"></asp:Label>
                                                                                                </strong>
                                                                                            </td>
                                                                                        </tr>
                                                                                            ...
                                                                                            <td align="left" class="formItemBgStyle">
                                                                                                ...
                                                                                                <table width="800" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td class="formItemBgStyle" style="width: 40%;">
                                                                                                        ...
                                                                                                        <td class="formItemBgStyle" style="width: 20%; ">
                                                                                                            <asp:Label ID="Label30" runat="server" Text="<%$ Resources:lang,ShouLiRen %>"></asp:Label>：
                                                                                                        </td>
                                                                                                        ...
                                                                                                        <td class="formItemBgStyle" style="width: 50%;">
                                                                                                            ...
                                                                                                            <asp:HyperLink ID="HL_MemberWorkload" runat="server" Target="_blank">
                                                                                                                <asp:Label ID="Label31" runat="server" Text="<%$ Resources:lang,ChaKanGongZuoFuHe %>"></asp:Label>
                                                                                                            </asp:HyperLink>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td class="formItemBgStyle" style="width: 10%; ">
                                                                                                            <asp:Label ID="Label32" runat="server" Text="<%$ Resources:lang,GongZuoYaoQiu %>"></asp:Label>：
                                                                                                        </td>
                                                                                                        ...
                                                                                                        <td class="formItemBgStyle" colspan="3">
                                                                                                            ...
                                                                                                            <CKEditor:CKEditorControl runat="server" Toolbar ID="HT_Operation" Width="" Height="150px" Visible="False" />
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td class="formItemBgStyle" colspan="4">
                                                                                                            ...
                                                                                                            <asp:Label ID="Label35" runat="server" Text="<%$ Resources:lang,TongZhiShouLiRen %>"></asp:Label>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td align="left" class="formItemBgStyle">
                                                                                                ...
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label36" runat="server" Text="<%$ Resources:lang,CiRenWuFenPaiJiLuZiJiLu %>"></asp:Label>（<span style="font-size: 9pt"><asp:Label ID="Label37" runat="server" Text="<%$ Resources:lang,XuanZeKeZaiShangMianXiuGai %>"></asp:Label>）：</span></strong>
                                                                                            </td>
                                                                                        </tr>
                                                                                                            ...
                                                                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td align="left" width="8%">
                                                                                                                        ...
                                                                                                                        <strong>
                                                                                                                            <asp:Label ID="Label40" runat="server" Text="<%$ Resources:lang,ShouLiRen %>"></asp:Label></strong>
                                                                                                                    </td>

                                                                                                                    <td align="left" width="24%">

                                                                                                                        <strong>
                                                                                                                            <asp:Label ID="Label41" runat="server" Text="<%$ Resources:lang,ShouLiRenDeGongZuo %>"></asp:Label></strong>
                                                                                                                    </td>
                                                                                                                    ...
                                                                                                                    <td align="left" width="9%">
                                                                                                                        ...
                                                                                                                        <strong>
                                                                                                                            <asp:Label ID="Label44" runat="server" Text="<%$ Resources:lang,FeiYong %>"></asp:Label></strong>
                                                                                                                    </td>

                                                                                                                    <td align="left" width="10%">

                                                                                                                        <strong>
                                                                                                                            <asp:Label ID="Label45" runat="server" Text="<%$ Resources:lang,LuXian %>"></asp:Label></strong>
                                                                                                                    </td>

                                                                                                                    <td align="left" width="9%">

                                                                                                                        <strong>
                                                                                                                            <asp:Label ID="Label46" runat="server" Text="<%$ Resources:lang,ZhuangTai %>"></asp:Label></strong>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </table>
                                                                                                        </td>
