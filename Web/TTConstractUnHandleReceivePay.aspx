<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTConstractUnHandleReceivePay.aspx.cs"
    Inherits="TTConstractUnHandleReceivePay" %>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="center" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,HeTongShouFuKuanYuJing%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                            ...
                                            <td style="height: 20px; text-align: left;">
                                                <cc2:TabContainer CssClass="ajax_tab_menu" ID="TabContainer1" runat="server" ActiveTabIndex="0" Width="100%">
                                                    <cc2:TabPanel ID="TabPanel1" runat="server" HeaderText=" 待收费合同" TabIndex="0">
                                                        <HeaderTemplate>
                                                            <asp:Label ID="Label47" runat="server" Text="<%$ Resources:lang,ShouKuanYuJing%>"></asp:Label>
                                                        </HeaderTemplate>
                                                        <ContentTemplate>
                                                            <br />
                                                            &nbsp;&nbsp;
                                                            <asp:Label ID="Label22" runat="server" Text="<%$ Resources:lang,YingShouJinE %>"></asp:Label>：<asp:Label ID="LB_ReceivablesAccount" runat="server"></asp:Label>&#160;<asp:Label ID="Label24" runat="server" Text="<%$ Resources:lang,ShiShouJinE %>"></asp:Label>：<asp:Label ID="LB_ReceiverAccount" runat="server"></asp:Label>&#160;<asp:Label ID="Label25" runat="server" Text="<%$ Resources:lang,KaiPiaoJinE %>"></asp:Label>：<asp:Label ID="LB_ReceiverInvoiceAccount" runat="server"></asp:Label>&#160;<asp:Label ID="Label48" runat="server" Text="<%$ Resources:lang,WeiShouJinE %>"></asp:Label>：<asp:Label ID="LB_UNReceiveAmount" runat="server"></asp:Label>
                                                            (
                                                            <asp:Label ID="LB_ConstractReceivableCurrencyType" runat="server"></asp:Label>
                                                            )
                                                                ...
                                                                <caption>
                                                                    <tr>
                                                                        <td align="right" style="width: 80px; padding-top: 5px;">
                                                                            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,HeTongDaiMa %>"></asp:Label>： </td>
                                                                        <td align="left" style="width: 120px;">
                                                                            <asp:TextBox ID="TB_ReceiverConstractCode" runat="server" Width="99%"></asp:TextBox>
                                                                        </td>
                                                                        <td align="right" style="width: 80px; padding-top: 5px;">
                                                                            <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,YeWuYuan %>"></asp:Label>： </td>
                                                                        <td align="left" style="width: 120px;">
                                                                            <asp:TextBox ID="TB_ReceiverSalesName" runat="server" Width="120px"></asp:TextBox>
                                                                        </td>
                                                                        <td align="right" style="width: 80px; padding-top: 5px;">
                                                                            <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,YiFangFuZeRen %>"></asp:Label>： </td>
                                                                        <td style="width: 120px;">
                                                                            <asp:TextBox ID="TB_PartBOperator" runat="server" Width="120px"></asp:TextBox>
                                                                        </td>
                                                                        <td align="right" style="width: 100px;">
                                                                            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,FuKuanFang %>"></asp:Label>： </td>
                                                                        <td align="left" style="width: 220px;">
                                                                            <asp:TextBox ID="TB_Payer" runat="server" Width="220px"></asp:TextBox>
                                                                        </td>
                                                                        <td align="left" style="width: 80px; padding-left: 5px;">
                                                                            <asp:Button ID="BT_ReceiverFind" runat="server" CssClass="inpu " OnClick="BT_FindReceiverFind_Click" Text="<%$ Resources:lang,ChaXun %>" />
                                                                        </td>
                                                                        <td>&nbsp;</td>
                                                                    </tr>
                                                                </caption>
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                ...
                                                                                <td width="11%" align="center"><strong>
                                                                                    <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,YuanShiDanHao %>"></asp:Label></strong> </td>
                                                                                <td width="11%" align="center"><strong>
                                                                                    <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,HeTongHao %>"></asp:Label></strong> </td>
                                                                                <td width="6%" align="center"><strong>
                                                                                    <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,ShouFeiKeMu %>"></asp:Label></strong> </td>
                                                                                <td width="6%" align="center"><strong>
                                                                                    <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,YingShouJinE %>"></asp:Label></strong> </td>
                                                                                <td width="6%" align="center"><strong>
                                                                                    <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,YingShouRiQi %>"></asp:Label></strong> </td>
                                                                                <td width="6%" align="center"><strong>
                                                                                    <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,ShiShouJinE %>"></asp:Label></strong> </td>
                                                                                <td width="6%" align="center"><strong>
                                                                                    <asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,ShiShouRiQi %>"></asp:Label></strong> </td>
                                                                                <td width="6%" align="center"><strong>
                                                                                    <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,KaiPiaoJinE %>"></asp:Label></strong> </td>
                                                                                <td width="7%" align="center"><strong>
                                                                                    <asp:Label ID="Label15" runat="server" Text="<%$ Resources:lang,WeiShouJinE %>"></asp:Label></strong> </td>
                                                                                <td width="14%" align="center"><strong>
                                                                                    <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,FuKuanFang %>"></asp:Label></strong> </td>
                                                                                <td width="5%" align="center"><strong>
                                                                                    <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,TiQian %>"></asp:Label></strong> </td>
                                                                                <td width="5%" align="center"><strong>
                                                                                    <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,ZhuangTai %>"></asp:Label></strong> </td>
                                                                                <td width="7%" align="center"><strong>
                                                                                    <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,DengJiRen %>"></asp:Label></strong> </td>
                                                    ...
                                                    <cc2:TabPanel ID="TabPanel2" runat="server" HeaderText="待付费合同" TabIndex="1">
                                                        <HeaderTemplate>
                                                            <asp:Label ID="Label23" runat="server" Text="<%$ Resources:lang,FuKuanYuJing%>"></asp:Label>
                                                        </HeaderTemplate>
                                                        <ContentTemplate>
                                                            <br />
                                                            ...
                                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" background="ImagesSkin/main_n_bj.jpg">
                                                                <caption>
                                                                    <tr>
                                                                        <td align="right" style="width: 80px; padding-top: 5px;">
                                                                            <asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,HeTongDaiMa%>"></asp:Label>： </td>
                                                                        <td align="left" style="width: 120px;">
                                                                            <asp:TextBox ID="TB_PayerConstractCode" runat="server" Width="99%"></asp:TextBox>
                                                                        </td>

                                                                        <td align="right" style="width: 80px; padding-top: 5px;">
                                                                            <asp:Label ID="Label26" runat="server" Text="<%$ Resources:lang,YeWuYuan%>"></asp:Label>： </td>
                                                                        <td style="width: 120px;">
                                                                            <asp:TextBox ID="TB_PayerSalesName" runat="server" Width="120px"></asp:TextBox></td>
                                                                        <td align="right" style="width: 80px; padding-top: 5px;">
                                                                            <asp:Label ID="Label27" runat="server" Text="<%$ Resources:lang,JiaFangFuZeRen%>"></asp:Label>： </td>
                                                                        <td style="width: 120px;">
                                                                            <asp:TextBox ID="TB_PartAOperator" runat="server" Width="120px"></asp:TextBox></td>
                                                                        <td align="right" style="width: 100px;">
                                                                            <asp:Label ID="Label28" runat="server" Text="<%$ Resources:lang,ShouKuanFang%>"></asp:Label>： </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td width="5%" align="center"><strong>
                                                                                    <asp:Label ID="Label29" runat="server" Text="<%$ Resources:lang,BianHao%>"></asp:Label></strong> </td>
                                                                                <td width="11%" align="center"><strong>
                                                                                    <asp:Label ID="Label30" runat="server" Text="<%$ Resources:lang,YuanShiDanHao%>"></asp:Label></strong> </td>
                                                                                <td width="11%" align="center"><strong>
                                                                                    <asp:Label ID="Label31" runat="server" Text="<%$ Resources:lang,HeTongHao%>"></asp:Label></strong> </td>
                                                                                <td width="6%" align="center"><strong>
                                                                                    <asp:Label ID="Label32" runat="server" Text="<%$ Resources:lang,ShouFeiKeMu%>"></asp:Label></strong> </td>
                                                                                <td width="6%" align="center"><strong>
                                                                                ...
                                                                                <td width="6%" align="center"><strong>
                                                                                    <asp:Label ID="Label36" runat="server" Text="<%$ Resources:lang,ShiFuRiQi%>"></asp:Label></strong> </td>
                                                                                <td width="6%" align="center"><strong>
                                                                                ...
                                                                                <td width="7%" align="center"><strong>
                                                                                    <asp:Label ID="Label42" runat="server" Text="<%$ Resources:lang,DengJiRen%>"></asp:Label></strong> </td>
