...
public partial class TTCreatedProject : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Page.IsPostBack != true)
        {
            ...
            LB_QueryScope.Text = LanguageHandle.GetWord("ZZLiXiangRen") + strUserName + LanguageHandle.GetWord("StatusAll");
            LB_Sql.Text = strHQL;
    ...
    protected void DataGrid2_ItemCommand(object sender, DataGridCommandEventArgs e)
    {
        ...
        LB_Sql.Text = strHQL;
        LB_QueryScope.Text = LB_QueryScope.Text = LanguageHandle.GetWord("ZZLiXiangRen") + strUserName + LanguageHandle.GetWord("nbspnbspZhuangTai") + strStatus;
    }
    ...
    //    LB_Sql.Text = strHQL;
    //    LB_QueryScope.Text = LB_QueryScope.Text = LanguageHandle.GetWord("Project") + strProjectID + LanguageHandle.GetWord("StatusAll");
    //}
    ...
    protected void FinChargePercentByRow()
    {
        ...
        for (i = 0; i < DataGrid1.Items.Count; i++)
        {
            ...
            //((System.Web.UI.WebControls.Label)DataGrid1.Items[i].FindControl("LB_RealChargePercent")).ToolTip = LanguageHandle.GetWord("YiFaShengFeiYong") + deRealCharge.ToString() + LanguageHandle.GetWord("ZongYuSuan") + deBudget.ToString() + "," + strConstractAmontToolTip;
            //((System.Web.UI.WebControls.Label)DataGrid1.Items[i].FindControl("LB_BudgetPercent")).ToolTip = LanguageHandle.GetWord("DangQianRiJiYuSuan") + deDefaultBudget.ToString() + LanguageHandle.GetWord("ZongYuSuan") + deBudget.ToString() + "," + strConstractAmontToolTip;
        }
    }
