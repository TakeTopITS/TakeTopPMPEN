<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTSuperActorGroup.aspx.cs"
    Inherits="TTSuperActorGroup" %>
                ...
                <ContentTemplate>
                                                ...
                                                <table width="345" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:lang,QuanJuJueSeZuSheZhi%>"></asp:Label>
                                                        </td>
                                                        <td width="5">
                                        ...
                                        <tr>
                                            <td align="left">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,QingShuRuJueSeZuMing%>"></asp:Label>
                                                            ：</td>
                                                        <td>
                                                            <asp:TextBox ID="TB_ActorGroup" runat="server" Width="250px"></asp:TextBox>
                                                        </td>
                                                        <td></td>
                                                        <td>
                                                            <asp:Button ID="BT_CreateActorGroup" runat="server" CssClass="inpu" OnClick="BT_CreateActorGroup_Click" Text="<%$ Resources:lang,ChuangJianJueSeZu%>" />
                                                        </td>

                                                        <td style="padding-left:20px;">
                                                            <asp:Button ID="BT_FindActorGroup" runat="server" CssClass="inpu"  Text="<%$ Resources:lang,ChaXun%>" OnClick="BT_FindActorGroup_Click" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                ...
                                                <table cellpadding="0" cellspacing="0" width="90%" class="bian">
                                                    ...
                                                    <tr>
                                                        <td colspan="2" style="text-align: left; padding: 5px 5px 5px 5px;">
                                                            ...
                                                            <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,JueSeZuChengYuanLieBiao%>"></asp:Label>
                                                            ：
                                                                ...
                                                                <tr>
                                                                  <td width="5%" align="left">
                                                                    ...
                                                                    <td align="left" width="45%"><strong>
                                                                        <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,JueSe%>"></asp:Label>
                                                                    </strong></td>
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popwindow" name="fixedDiv"
                                ...
                                <tr>
                                    ...
                                    <td valign="top">
                                        <table align="left" style="width: 98%;">
                                            <tr>
                                                <td align="left">
                                                    <table cellpadding="3" cellspacing="0" class="formBgStyle" style="width: 700px;">
                                                        <tr>
                                                            <td class="formItemBgStyleAlignLeft" style="width: 15%; ">
                                                                <asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,ZuMing%>"></asp:Label>
                                                                ： </td>
                                                            <td colspan ="3" class="formItemBgStyleAlignLeft" style="text-align: left;">
                                                                <asp:Label ID="LB_ActorGroupName" runat="server"></asp:Label><asp:Label ID="LB_ID" runat="server" Visible ="false"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="formItemBgStyleAlignLeft" style="width: 15%;  height: 6px;">
                                                                <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,DaiMa%>"></asp:Label>
                                                                ： </td>
                                                            <td class="formItemBgStyleAlignLeft" style="width: 25%; text-align: left; height: 6px;">
                                                            ...
                                                            <td class="formItemBgStyleAlignLeft" style="width: 15%;  height: 6px;">
                                                                ...
                                                                ： </td>
                                                            <td class="formItemBgStyleAlignLeft" style="width: 45%; height: 6px; text-align: left;">
                                                                <asp:Label ID="LB_RelatedUserName" runat="server"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="formItemBgStyleAlignLeft" style="width: 15%; ">
                                                                <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,JueSe%>"></asp:Label>
                                                                ： </td>
                                                            <td class="formItemBgStyleAlignLeft" style="width: 25%; text-align: left;">
                                                                <asp:TextBox ID="TB_Actor" runat="server" Width="90%"></asp:TextBox>
                                                            </td>
                                                            <td class="formItemBgStyleAlignLeft" style="width: 15%; ">
                                                                <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,BuMen%>"></asp:Label>
                                                                ： </td>
                                                            <td class="formItemBgStyleAlignLeft" style="width: 45%; text-align: left;">
                                                        ...
                                                        <tr>
                                                            <td class="formItemBgStyleAlignLeft" style="width: 15%; ">
                                                                <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,GongZuoNeiRong%>"></asp:Label>
                                                                ： </td>
                                                            <td class="formItemBgStyleAlignLeft" colspan="3" style="text-align: left;">
                                                                <asp:TextBox ID="TB_WorkDetail" runat="server" Height="50px" TextMode="MultiLine" Width="70%"></asp:TextBox>
                                                            </td>
                                                        </tr>
                        ...
                        <div id="popwindow_footer" class="layui-layer-btn" style="border-top: 1px solid #ccc;">
                            <asp:LinkButton ID="BT_New" runat="server" class="layui-layer-btn notTab" OnClick="BT_New_Click" Text="<%$ Resources:lang,BaoCun%>"></asp:LinkButton><a class="layui-layer-btn notTab" onclick="return popClose();"><asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,GuanBi%>" /></a>
                        </div>
