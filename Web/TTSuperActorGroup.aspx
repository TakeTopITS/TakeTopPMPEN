                                                    ...
                                                    <table cellpadding="3" cellspacing="0" class="formBgStyle" style="width: 700px;">
                                                        <tr>
                                                            <td class="formItemBgStyleForAlignLeft" style="width: 15%; ">
                                                                ...
                                                                ： </td>
                                                            <td colspan ="3" class="formItemBgStyleForAlignLeft" style="text-align: left;">
                                                                <asp:Label ID="LB_ActorGroupName" runat="server"></asp:Label><asp:Label ID="LB_ID" runat="server" Visible ="false"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="formItemBgStyleForAlignLeft" style="width: 15%;  height: 6px;">
                                                                <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,DaiMa%>"></asp:Label>
                                                                ： </td>
                                                            <td class="formItemBgStyleForAlignLeft" style="width: 25%; text-align: left; height: 6px;">
                                                            ...
                                                            <td class="formItemBgStyleForAlignLeft" style="width: 15%;  height: 6px;">
                                                                ...
                                                                ： </td>
                                                            <td class="formItemBgStyleForAlignLeft" style="width: 45%; height: 6px; text-align: left;">
                                                        ...
                                                        <tr>
                                                            <td class="formItemBgStyleForAlignLeft" style="width: 15%; ">
                                                                ...
                                                                ： </td>
                                                            <td class="formItemBgStyleForAlignLeft" style="width: 25%; text-align: left;">
