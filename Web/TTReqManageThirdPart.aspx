<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTReqManageThirdPart.aspx.cs"
    Inherits="TTReqManageThirdPart" %>
...
<body>
                                                                                            ...
                                                                                            <td style="width: 100%; text-align: Left;">
                                                                                                ...
                                                                                                <asp:DataGrid ID="DataGrid4" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                                                                    ...
                                                                                                    <Columns>
                                                                                                        ...
                                                                                                        <asp:HyperLinkColumn DataNavigateUrlField="ID" DataNavigateUrlFormatString="TTReqDetailThirdPart.aspx?ID={0}"
    ...
    <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="8%" />
                                                                                ...
                                                                                <asp:TemplateColumn>
                                                                                    <ItemTemplate>
                                                                                        <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# DataBinder.Eval(Container, "DataItem.ReqID", "TTDocumentTreeView.aspx?RelatedType=Type&RelatedID={0}") %>'
                                                                                            Target="_blank"><img src ="ImagesSkin/Doc.gif"  class="noBorder" /></asp:HyperLink>
                                                                                    </ItemTemplate>
                                                                                    <ItemStyle CssClass="itemBorder" HorizontalAlign="Center" Width="4%" />
                                                                                </asp:TemplateColumn>
