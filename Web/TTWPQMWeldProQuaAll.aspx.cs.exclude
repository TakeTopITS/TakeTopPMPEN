...
public partial class TTWPQMWeldProQuaAll : System.Web.UI.Page
{
    ...
    protected void LoadWPQMAllDataName()
    {
        ...
        strHQL = "From WPQMAllData as wPQMAllData Where wPQMAllData.Type='WeldingMaterialStandard' Order By wPQMAllData.ID Desc";
        lst = wPQMAllDataBLL.GetAllWPQMAllDatas(strHQL);
    ...
    protected void LoadWPQMWeldProQuaList(string strcode)
    {
        ...
        if (lst.Count > 0 && lst != null)
        {
            ...
            DL_WeldingArcType.SelectedValue = string.IsNullOrEmpty(wPQMWeldProQua.WeldingArcType) ? "PleaseSelect" : wPQMWeldProQua.WeldingArcType.Trim();
        ...
        else
        {
            ...
            DL_WeldingArcType.SelectedValue = "PleaseSelect";
    ...
    protected void BT_Update_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "alert('"+LanguageHandle.GetWord("ZZTSGYPDBMWKCZSBJC").ToString().Trim()+"')", true);
            TB_Code.Focus();
            return;
        }
