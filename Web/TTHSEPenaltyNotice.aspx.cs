...
public partial class TTHSEPenaltyNotice : System.Web.UI.Page
{
    ...
    protected void Add()
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "alert('" + LanguageHandle.GetWord("ZZJGAYHZGWBXCZSBJC") + "')", true);
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "alert('" + LanguageHandle.GetWord("ZZJGGAYHZGDBHGCZSBJC") + "')", true);
            DL_RectificationCode.Focus();
            return;
        }
        if (IsHSEPenaltyNoticeCode(string.Empty, TB_Name.Text.Trim(), DL_RectificationCode.SelectedValue.Trim()))
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "alert('" + LanguageHandle.GetWord("ZZJGMCHAYHZGDYCZCZSBJC") + "')", true);
            TB_Name.Focus();
            DL_RectificationCode.Focus();
            return;
        }
